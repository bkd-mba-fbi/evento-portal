...
| _Role_                                                                                                                                    | _Contact_                                                                                                                                                                                                                         | _Expectations_                                                                                                                                                      |
| ----------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Application Managers<br>([BKD-MBA-FBI](https://www.bkd.be.ch/de/start/ueber-uns/die-organisation/mittelschul-und-berufsbildungsamt.html)) | [Franziska Bünzli](https://github.com/fbufbi) (Specialist Application Manager), [Sandro Scheidt](https://github.com/schefbi) (Technical Application Manager), [Walid Boulhazayez](https://github.com/WalidBoul) (Service Manager) | Integration of the various EVENTO frontends (apps) into a single portal, creating easy-to-use and high quality UIs for EVENTO features. Low maintenance costs.      |
| Teachers & Administrative Personnel                                                                                                       |                                                                                                                                                                                                                                   | Access to the most important features of EVENTO for school operation in a usable way through a unified platform/login from various devices, incl. mobile phones.    |
| Students                                                                                                                                  |                                                                                                                                                                                                                                   | Access to personal data, grades and absences in a usable way through a unified platform/login from various devices, incl. mobile phones.                            |
| Project Manager<br>([Puzzle ITC](https://www.puzzle.ch/))                                                                                 | Joel Baldinger                                                                                                                                                                                                                    | Constructive collaborations of all stakeholders, adherence to budget, reducing of risks.                                                                            |
| Software Engineers<br>([Puzzle ITC](https://www.puzzle.ch/))                                                                              | [Mathis Hofer](https://github.com/hupf) (Software Architect), [Claudia Asti](https://github.com/caebr) (Software Engineer & UX), [Stephan Girod](https://github.com/StephGit) (Software Engineer)                                 | Development of highly usable web standards based frontend, ensuring good extensibility and maintenance. Constructive collaboration with BKD and other stakeholders. |
