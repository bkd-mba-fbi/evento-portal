 ...
 */
export declare const LOCALE_STATUS_EVENT = "lit-localize-status";
declare global {
 ...
 */
export declare type LocaleStatusEventDetail = LocaleLoading | LocaleReady | LocaleError;
/**
...
//# sourceMappingURL=locale-status-event.d.ts.map