 ...
 */
export declare type TemplateMap = {
    [id: string]: TemplateLike;
};
/**
...
declare function msg(template: TemplateLike, options?: MsgOptions): string | TemplateResult;
export declare type MsgFn = typeof msg & {
    _LIT_LOCALIZE_MSG_?: never;
};
export {};
