define({
    ...
    urlArgs: 'bust=EVT2022.R2.Alpha01.20220727041833',
    //baseUrl: '../JSModules',
    ...
    paths: {
        ...
        'appConfig': './appConfig',
        'configService': './Framework/configService',
        ...
        'ember': './Lib/ember-2.11.1.min',
        'text': './Lib/text-2.0.10.min',
        'modernizr': './Lib/modernizr.custom',
        'jquery.plugin': './Lib/jquery-plugins/jquery.plugin.min',
        'jstepper': './Lib/jquery-plugins/jstepper-1.5.3.min',
        'tristate': './Lib/jquery-plugins/jquery.tristate.min',
        ...
        //globalization
        'globalize': './Lib/globalize/globalize-0.1.1.min',
        'de-CH': './Lib/globalize/cultures/globalize.culture.de-CH.min',
        'de-DE': './Lib/globalize/cultures/globalize.culture.de-DE.min',
        'fr-CH': './Lib/globalize/cultures/globalize.culture.fr-CH.min',
