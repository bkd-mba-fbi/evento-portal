...
var c=0
function d(e){return c--,e}i.Test?(i.Test.registerWaiter((function(){return 0===c})),t.default=function(){return c++,t.fetch.apply(e,arguments).then((function(e){return e.clone().blob().then(d,d),e}),(function(e){throw d(e),e}))}):t.default=t.fetch,s.forEach((function(e){delete t[e]}))}))})("undefined"!=typeof window&&window||"undefined"!=typeof globalThis&&globalThis||"undefined"!=typeof self&&self||"undefined"!=typeof global&&global)}/*! UIkit 3.23.5 | https://www.getuikit.com | (c) 2014 - 2025 YOOtheme | MIT License */
...
const dt={start:function(e,t,r=400,n="linear"){return r=Math.round(r),Promise.all(j(e).map((e=>new Promise(((i,o)=>{const s=setTimeout((()=>Ke(e,ut)),r)
Ze(e,[ut,ct],(({type:r})=>{!0!==a&&(st(e,t),cancelAnimationFrame(a)),clearTimeout(s),J(e,lt),st(e,{transitionProperty:"",transitionDuration:"",transitionTimingFunction:""}),r===ct?o():i(e)}),{self:!0}),X(e,lt)
let a=requestAnimationFrame((()=>(a=!0,st(e,{transitionProperty:Object.keys(t).map(at).join(","),transitionDuration:`${r}ms`,transitionTimingFunction:n,...t}))))})))))},async stop(e){Ke(e,ut),await Promise.resolve()},async cancel(e){Ke(e,ct),await Promise.resolve()},inProgress:e=>te(e,lt)},ht="uk-animation",pt="animationend",ft="animationcanceled"
...
return(null==(r=null==e?void 0:e.tagName)?void 0:r.toLowerCase())===t.toLowerCase()}))}function bt(e){return(e=jt(e))&&(e.innerHTML=""),e}function yt(e,t){return S(t)?jt(e).innerHTML:_t(bt(e),t)}const wt=Ct("prepend"),_t=Ct("append"),xt=Ct("before"),Et=Ct("after")
...
return i}function fr(e){br(e)&&_r(e,{func:"playVideo",method:"play"}),vr(e)&&e.play().catch(q)}function mr(e){br(e)&&_r(e,{func:"pauseVideo",method:"pause"}),vr(e)&&e.pause()}function gr(e){br(e)&&_r(e,{func:"mute",method:"setVolume",value:0}),vr(e)&&(e.muted=!0)}function vr(e){return vt(e,"video")}function br(e){return vt(e,"iframe")&&(yr(e)||wr(e))}function yr(e){return!!e.src.match(/\/\/.*?youtube(-nocookie)?\.[a-z]+\/(watch\?v=[^&\s]+|embed)|youtu\.be\/.*/)}function wr(e){return!!e.src.match(/vimeo\.com\/video\/.*/)}async function _r(e,t){await function(e){if(e[Er])return e[Er]
const t=yr(e),r=wr(e),n=++Cr
let i
return e[Er]=new Promise((o=>{t&&Ze(e,"load",(()=>{const t=()=>xr(e,{event:"listening",id:n})
i=setInterval(t,100),t()})),Ze(window,"message",o,!1,(({data:e})=>{try{return e=JSON.parse(e),t&&(null==e?void 0:e.id)===n&&"onReady"===e.event||r&&Number(null==e?void 0:e.player_id)===n}catch(i){}})),e.src=`${e.src}${c(e.src,"?")?"&":"?"}${t?"enablejsapi=1":`api=1&player_id=${n}`}`})).then((()=>clearInterval(i)))}(e),xr(e,t)}function xr(e,t){e.contentWindow.postMessage(JSON.stringify({event:"command",...t}),"*")}const Er="_ukPlayer"
let Cr=0
function kr(e,{offset:t=0}={}){const r=_e(e)?Tr(e,!1,["hidden"]):[]
return r.reduce(((n,i,o)=>{const{scrollTop:s,scrollHeight:a,offsetHeight:l}=i,u=Mr(i),c=a-u.height,{height:d,top:h}=r[o-1]?Mr(r[o-1]):$t(e)
...
var l
const u=Date.now(),c=Nr(e)===e,d=$t(n).top+(c?0:s)
let h=0,p=15;(function l(){const f=(m=U((Date.now()-u)/a),.5*(1-Math.cos(Math.PI*m)))
var m
let g=0
r[0]===e&&s+t<i&&(g=$t(n).top+(c?0:e.scrollTop)-d-Lt(Rr(n)).height),"auto"!==st(e,"scrollBehavior")&&st(e,"scrollBehavior","auto"),e.scrollTop=s+(t+g)*f,st(e,"scrollBehavior",""),1!==f||h!==g&&p--?(h=g,requestAnimationFrame(l)):o()})()}))}(i,p-s,e,c).then(n)}),(()=>Promise.resolve()))()}function Or(e,t=0,r=0){if(!_e(e))return 0
const n=Sr(e,!0),{scrollHeight:i,scrollTop:o}=n,{height:s}=Mr(n),a=i-s,l=Bt(e)[0]-Bt(n)[0],u=Math.max(0,l-s+t),c=Math.min(a,l+e.offsetHeight-r)
return u<c?U((o-u)/(c-u)):1}function Tr(e,t=!1,r=[]){const n=Nr(e)
let i=Pe(e).reverse()
i=i.slice(i.indexOf(n)+1)
const o=d(i,(e=>"fixed"===st(e,"position")))
return~o&&(i=i.slice(o)),[n].concat(i.filter((e=>st(e,"overflow").split(" ").some((e=>c(["auto","scroll",...r],e)))&&(!t||e.scrollHeight>Mr(e).height)))).reverse()}function Sr(...e){return Tr(...e)[0]}function Pr(e){return Tr(e,!1,["hidden","clip"])}function Mr(e){const t=N(e),r=Nr(e),n=!w(e)||e.contains(r)
...
i[d]+=R(st(l,`border-${d}-width`)),i[u]=i[c]=l[`client${a(u)}`]-(e?e<.5?-e:1-e:0),i[h]=i[u]+i[d]}return i}function Rr(e){const{left:t,width:r,top:n}=Lt(e)
for(const i of n?[0,n]:[0]){let n
for(const o of N(e).document.elementsFromPoint(t+r/2,i))o.contains(e)||te(o,"uk-togglable-leave")||!(jr(o,"fixed")&&Ar(Pe(e).reverse().find((e=>!e.contains(o)&&!jr(e,"static"))))<Ar(o)||jr(o,"sticky")&&Oe(o).contains(e))||n&&!(Lt(n).height<Lt(o).height)||(n=o)
if(n)return n}}function Ar(e){return R(st(e,"zIndex"))}function jr(e,t){return st(e,"position")===t}function Nr(e){return N(e).document.scrollingElement}const Dr=[["width","x","left","right"],["height","y","top","bottom"]]
function Ir(e,t,r){r={attach:{element:["left","top"],target:["left","top"],...r.attach},offset:[0,0],placement:[],...r},h(t)||(t=[t,t]),$t(e,Lr(e,t,r))}function Lr(e,t,r){const n=$r(e,t,r),{boundary:i,viewportOffset:o=0,placement:s}=r
let a=n
for(const[l,[u,,c,d]]of Object.entries(Dr)){const h=Hr(e,t[l],o,i,l)
if(Vr(n,h,l))continue
let p=0
if("flip"===s[l]){const i=r.attach.target[l]
if(i===d&&n[d]<=h[d]||i===c&&n[c]>=h[c])continue
p=Wr(e,t,r,l)[c]-n[c]
const s=zr(e,t[l],o,l)
if(!Vr(Fr(n,p,l),s,l)){if(Vr(n,s,l))continue
if(r.recursion)return!1
const i=Yr(e,t,r)
if(i&&Vr(i,s,1-l))return i
continue}}else if("shift"===s[l]){const e=$t(t[l]),{offset:i}=r
p=U(U(n[c],h[c],h[d]-n[u]),e[c]-n[u]+i[l],e[d]-i[l])-n[c]}a=Fr(a,p,l)}return a}function $r(e,t,r){let{attach:n,offset:i}={attach:{element:["left","top"],target:["left","top"],...r.attach},offset:[0,0],...r},o=$t(e)
for(const[s,[a,,l,u]]of Object.entries(Dr)){const e=n.target[s]===n.element[s]?Mr(t[s]):$t(t[s])
o=Fr(o,e[l]-o[l]+Br(n.target[s],u,e[a])-Br(n.element[s],u,o[a])+ +i[s],s)}return o}function Fr(e,t,r){const[,n,i,o]=Dr[r],s={...e}
return s[i]=e[n]=e[i]+t,s[o]+=t,s}function Br(e,t,r){return"center"===e?r/2:e===t?r:0}function Hr(e,t,r,n,i){let o=qr(...Ur(e,t).map(Mr))
return r&&(o[Dr[i][2]]+=r,o[Dr[i][3]]-=r),n&&(o=qr(o,$t(h(n)?n[i]:n))),o}function zr(e,t,r,n){const[i,o,s,l]=Dr[n],[u]=Ur(e,t),c=Mr(u)
return["auto","scroll"].includes(st(u,`overflow-${o}`))&&(c[s]-=u[`scroll${a(s)}`],c[l]=c[s]+u[`scroll${a(i)}`]),c[s]+=r,c[l]-=r,c}function Ur(e,t){return Pr(t).filter((t=>t.contains(e)))}function qr(...e){let t={}
for(const r of e)for(const[,,e,n]of Dr)t[e]=Math.max(t[e]||0,r[e]),t[n]=Math.min(...[t[n],r[n]].filter(Boolean))
return t}function Vr(e,t,r){const[,,n,i]=Dr[r]
return e[n]>=t[n]&&e[i]<=t[i]}function Wr(e,t,{offset:r,attach:n},i){return $r(e,t,{attach:{element:Gr(n.element,i),target:Gr(n.target,i)},offset:Zr(r,i)})}function Yr(e,t,r){return Lr(e,t,{...r,attach:{element:r.attach.element.map(Qr).reverse(),target:r.attach.target.map(Qr).reverse()},offset:r.offset.reverse(),placement:r.placement.reverse(),recursion:!0})}function Gr(e,t){const r=[...e],n=Dr[t].indexOf(e[t])
return~n&&(r[t]=Dr[t][1-n%2+2]),r}function Qr(e){for(let t=0;t<Dr.length;t++){const r=Dr[t].indexOf(e)
if(~r)return Dr[1-t][r%2+2]}}function Zr(e,t){return(e=[...e])[t]*=-1,e}var Kr=Object.freeze({__proto__:null,$:jt,$$:Nt,Animation:gt,Dimensions:Q,MouseTracker:ar,Transition:dt,addClass:X,after:Et,append:_t,apply:At,assign:f,attr:ie,before:xt,boxModelAdjust:qt,camelize:s,children:Me,clamp:U,createEvent:Xe,css:st,data:ae,dimensions:Lt,each:$,empty:bt,endsWith:u,escape:Ye,fastdom:Jt,filter:Te,find:Ie,findAll:Le,findIndex:d,flipPosition:Vt,fragment:Mt,getCoveringElement:Rr,getEventPos:it,getIndex:Z,getTargetedElement:je,hasAttr:oe,hasClass:te,hasOwn:r,hasTouch:ce,height:Ht,html:yt,hyphenate:i,inBrowser:le,includes:c,index:Re,intersectRect:V,isArray:h,isBoolean:E,isDocument:y,isElement:_,isEmpty:T,isEqual:D,isFocusable:ke,isFunction:m,isInView:function(e,t=0,r=0){return!!_e(e)&&V(...Pr(e).map((e=>{const{top:n,left:i,bottom:o,right:s}=Mr(e)
return{top:n-t,left:i-r,bottom:o+t,right:s+r}})).concat($t(e)))},isInput:Ee,isNode:w,isNumber:k,isNumeric:O,isObject:g,isPlainObject:v,isRtl:ue,isSameSiteAnchor:Ae,isString:C,isTag:vt,isTouch:nt,isUndefined:S,isVisible:_e,isVoidElement:ye,isWindow:b,last:L,matches:Se,memoize:K,mute:gr,noop:q,observeIntersection:lr,observeMutation:hr,observeResize:cr,observeViewportResize:dr,off:Qe,offset:$t,offsetPosition:Bt,offsetViewport:Mr,on:Ge,once:Ze,overflowParents:Pr,parent:Oe,parents:Pe,pause:mr,pick:z,play:fr,pointInRect:W,pointerCancel:ve,pointerDown:he,pointerEnter:me,pointerLeave:ge,pointerMove:pe,pointerUp:fe,position:Ft,positionAt:Ir,prepend:wt,propName:at,query:Ne,queryAll:De,ready:function(e){"loading"===document.readyState?Ze(document,"DOMContentLoaded",e):e()},remove:kt,removeAttr:se,removeClass:J,replaceClass:ee,scrollIntoView:kr,scrollParent:Sr,scrollParents:Tr,scrolledOver:Or,selFocusable:Ce,selInput:xe,sortBy:F,startsWith:l,sumBy:B,swap:I,toArray:p,toBoolean:P,toEventTargets:rt,toFloat:R,toNode:A,toNodes:j,toNumber:M,toPx:Wt,toWindow:N,toggleClass:re,trigger:Ke,ucfirst:a,uniqueBy:H,unwrap:St,width:zt,wrapAll:Ot,wrapInner:Tt}),Xr={connected(){X(this.$el,this.$options.id)}}
const Jr=["days","hours","minutes","seconds"]
var en={mixins:[Xr],props:{date:String,clsWrapper:String,role:String,reload:Boolean},data:{date:"",clsWrapper:".uk-countdown-%unit%",role:"timer",reload:!1},connected(){ie(this.$el,"role",this.role),this.date=R(Date.parse(this.$props.date)),this.started=this.end=!1,this.start()},disconnected(){this.stop()},events:{name:"visibilitychange",el:()=>document,handler(){document.hidden?this.stop():this.start()}},methods:{start(){this.stop(),this.update()},stop(){this.timer&&(clearInterval(this.timer),Ke(this.$el,"countdownstop"),this.timer=null)},update(){const e=function(e){const t=Math.max(0,e-Date.now())/1e3
...
for(const t of Jr){const r=jt(this.clsWrapper.replace("%unit%",t),this.$el)
if(!r)continue
...
const tn={}
function rn(e,t,r){return tn.computed(m(e)?e.call(r,r):e,m(t)?t.call(r,r):t)}function nn(e,t){return e=e&&!h(e)?[e]:e,t?e?e.concat(t):h(t)?t:[t]:e}function on(e,t){return S(t)?e:t}function sn(e,t,n){const i={}
if(m(t)&&(t=t.options),t.extends&&(e=sn(e,t.extends,n)),t.mixins)for(const r of t.mixins)e=sn(e,r,n)
for(const r in e)o(r)
for(const s in t)r(e,s)||o(s)
function o(r){i[r]=(tn[r]||on)(e[r],t[r],n)}return i}function an(e,t=[]){try{return e?l(e,"{")?JSON.parse(e):t.length&&!c(e,":")?{[t[0]]:e}:e.split(";").reduce(((e,t)=>{const[r,n]=t.split(/:(.*)/)
return r&&!S(n)&&(e[r.trim()]=n.trim()),e}),{}):{}}catch(r){return{}}}function ln(e,t){return e===Boolean?P(t):e===Number?M(t):"list"===e?function(e){return h(e)?e:C(e)?e.split(un).map((e=>O(e)?M(e):P(e.trim()))):[e]}(t):e===Object&&C(t)?an(t):e?e(t):t}tn.events=tn.watch=tn.observe=tn.created=tn.beforeConnect=tn.connected=tn.beforeDisconnect=tn.disconnected=tn.destroy=nn,tn.args=function(e,t){return!1!==t&&nn(t||e)},tn.update=function(e,t){return F(nn(e,m(t)?{read:t}:t),"order")},tn.props=function(e,t){if(h(t)){const e={}
for(const r of t)e[r]=String
t=e}return tn.methods(e,t)},tn.computed=tn.methods=function(e,t){return t?e?{...e,...t}:t:e},tn.i18n=tn.data=function(e,t,r){return r?rn(e,t,r):t?e?function(r){return rn(e,t,r)}:t:e}
const un=/,(?![^(]*\))/
function cn(e,t="update"){e._connected&&e._updates.length&&(e._queued||(e._queued=new Set,Jt.read((()=>{e._connected&&function(e,t){for(const{read:r,write:n,events:i=[]}of e._updates){if(!t.has("update")&&!i.some((e=>t.has(e))))continue
let o
r&&(o=r.call(e,e._data,t),o&&v(o)&&f(e._data,o)),n&&!1!==o&&Jt.write((()=>{e._connected&&n.call(e,e._data,t)}))}}(e,e._queued),e._queued=null}))),e._queued.add(t.type||t))}function dn(e){return bn(cr,e,"resize")}function hn(e){return bn(lr,e)}function pn(e){return bn(hr,e)}function fn(e={}){return hn({handler:function(t,r){const{targets:n=this.$el,preload:i=5}=e
for(const e of j(m(n)?n(this):n))Nt('[loading="lazy"]',e).slice(0,i-1).forEach((e=>se(e,"loading")))
for(const e of t.filter((({isIntersecting:e})=>e)).map((({target:e})=>e)))r.unobserve(e)},...e})}function mn(e){return bn(((e,t)=>dr(t)),e,"resize")}function gn(e){return bn(((e,t)=>{return{disconnect:Ge((r=e,j(r).map((e=>{const{ownerDocument:t}=e,r=Sr(e,!0)
return r===t.scrollingElement?t:r}))),"scroll",t,{passive:!0})}
var r}),e,"scroll")}function vn(e){return{observe:(e,t)=>({observe:q,unobserve:q,disconnect:Ge(e,he,t,{passive:!0})}),handler(e){if(!nt(e))return
...
Ke(r,"swipe"),Ke(r,"swipe"+(e=t.x,o=t.y,s=n,a=i,Math.abs(e-s)>=Math.abs(o-a)?e-s>0?"Left":"Right":o-a>0?"Up":"Down"))}))}))},...e}}function bn(e,t,r){return{observe:e,handler(){cn(this,r)},...t}}var yn={props:{margin:String,firstColumn:Boolean},data:{margin:"uk-margin-small-top",firstColumn:"uk-first-column"},observe:[pn({options:{childList:!0}}),pn({options:{attributes:!0,attributeFilter:["style"]}}),dn({handler(e){for(const{borderBoxSize:[{inlineSize:t,blockSize:r}]}of e)if(t||r)return void this.$emit("resize")},target:({$el:e})=>[e,...Me(e)]})],update:{read(){return{rows:wn(Me(this.$el))}},write({rows:e}){for(const t of e)for(const r of t)re(r,this.margin,e[0]!==t),re(r,this.firstColumn,t[ue?t.length-1:0]===r)},events:["resize"]}}
function wn(e){const t=[[]],r=e.some(((t,r)=>r&&e[r-1].offsetParent!==t.offsetParent))
for(const n of e){if(!_e(n))continue
const e=_n(n,r)
for(let i=t.length-1;i>=0;i--){const o=t[i]
if(!o[0]){o.push(n)
break}const s=_n(o[0],r)
if(e.top>=s.bottom-1&&e.top!==s.top){t.push([n])
break}if(e.bottom-1>s.top||e.top===s.top){let t=o.length-1
for(;t>=0;t--){const n=_n(o[t],r)
if(e.left>=n.left)break}o.splice(t+1,0,n)
break}if(0===i){t.unshift([n])
break}}}return t}function _n(e,t=!1){let{offsetTop:r,offsetLeft:n,offsetHeight:i,offsetWidth:o}=e
return t&&([r,n]=Bt(e)),{top:r,left:n,bottom:r+i,right:n+o}}const xn="uk-transition-leave",En="uk-transition-enter"
function Cn(e,t,r,n=0){const i=kn(t,!0),o={opacity:1},s={opacity:0},a=e=>()=>i===kn(t)?e():Promise.reject(),l=a((async()=>{X(t,xn),await Promise.all(Tn(t).map(((e,t)=>new Promise((i=>setTimeout((()=>dt.start(e,s,r/2,"ease").then(i)),t*n)))))),J(t,xn)})),u=a((async()=>{const a=Ht(t)
X(t,En),e(),st(Me(t),{opacity:0}),Ht(t,a),await Sn(),Ht(t,"")
const l=Me(t),u=Ht(t)
st(t,"alignContent","flex-start"),Ht(t,a)
const c=Tn(t)
st(l,s)
const d=c.map((async(e,t)=>{await Sn(t*n),await dt.start(e,o,r/2,"ease")}))
a!==u&&d.push(dt.start(t,{height:u},r/2+c.length*n,"ease")),await Promise.all(d).then((()=>{J(t,En),i===kn(t)&&(st(t,{height:"",alignContent:""}),st(l,{opacity:""}),delete t.dataset.transition)}))}))
return te(t,xn)?On(t).then(u):te(t,En)?On(t).then(l).then(u):l().then(u)}function kn(e,t){return t&&(e.dataset.transition=1+kn(e)),M(e.dataset.transition)||0}function On(e){return Promise.all(Me(e).filter(dt.inProgress).map((e=>new Promise((t=>Ze(e,"transitionend transitioncanceled",t))))))}function Tn(e){return wn(Me(e)).flat().filter(_e)}function Sn(e){return new Promise((t=>setTimeout(t,e)))}async function Pn(e,t,r){await An()
let n=Me(t)
const i=n.map((e=>Mn(e,!0))),o={...st(t,["height","padding"]),display:"block"},s=n.concat(t)
...
const a=ie(t,"style"),l=st(t,["height","padding"]),[u,d]=function(e,t,r){const n=t.map(((e,t)=>!(!Oe(e)||!(t in r))&&(r[t]?_e(e)?Rn(e):{opacity:0}:{opacity:_e(e)?1:0}))),i=n.map(((n,i)=>{const o=Oe(t[i])===e&&(r[i]||Mn(t[i]))
if(!o)return!1
...
n.forEach(((e,t)=>d[t]&&st(e,d[t]))),st(t,o),Ke(t,"scroll"),await An()
const p=n.map(((e,n)=>Oe(e)===t&&dt.start(e,u[n],r,"ease"))).concat(dt.start(t,l,r,"ease"))
try{await Promise.all(p),n.forEach(((e,r)=>{ie(e,h[r]),Oe(e)===t&&st(e,"display",0===u[r].opacity?"none":"")})),ie(t,"style",a)}catch(f){ie(n,"style",""),function(e,t){for(const r in t)st(e,r,"")}(t,o)}}function Mn(e,t){const r=st(e,"zIndex")
return!!_e(e)&&{display:"",opacity:t?st(e,"opacity"):"0",pointerEvents:"none",position:"absolute",zIndex:"auto"===r?Re(e):r,...Rn(e)}}function Rn(e){const{height:t,width:r}=Lt(e)
return{height:t,width:r,transform:"",...Ft(e),...st(e,["marginTop","marginLeft"])}}function An(){return new Promise((e=>requestAnimationFrame(e)))}var jn={props:{duration:Number,animation:Boolean},data:{duration:150,animation:"slide"},methods:{animate(e,t=this.$el){const r=this.animation
return("fade"===r?Cn:"delayed-fade"===r?(...e)=>Cn(...e,40):r?Pn:()=>(e(),Promise.resolve()))(e,t,this.duration).catch(q)}}}
...
await Promise.all(Nt(this.target,this.$el).map((r=>{const n=()=>function(e,t,r){for(const o of r)st(o,"display",Object.values(e.filter).every((e=>!e||Se(o,e)))?"":"none")
const[n,i]=e.sort
...
function qn(e,t){return an(ae(e,t),["filter"])}function Vn(e,t,r){const{filter:n,group:i,sort:o,order:s="asc"}=qn(e,t)
...
return S(a)?s in r&&o===r[s]||!o&&s&&!(s in r)&&!r[""]:n===a&&i===l}var Yn={args:"dataSrc",props:{dataSrc:String,sources:String,margin:String,target:String,loading:String},data:{dataSrc:"",sources:!1,margin:"50%",target:!1,loading:"lazy"},connected(){"lazy"!==this.loading?this.load():Xn(this.$el)&&(this.$el.loading="lazy",Gn(this.$el))},disconnected(){this.img&&(this.img.onload=""),delete this.img},observe:hn({handler(e,t){this.load(),t.disconnect()},options:({margin:e})=>({rootMargin:e}),filter:({loading:e})=>"lazy"===e,target:({$el:e,$props:t})=>t.target?[e,...De(t.target,e)]:e}),methods:{load(){if(this.img)return this.img
const e=Xn(this.$el)?this.$el:function(e,t,r){const n=new Image
return Kn(n,r),Zn(e,n),n.onload=()=>Gn(e,n.currentSrc),ie(n,"src",t),n}(this.$el,this.dataSrc,this.sources)
return se(e,"loading"),Gn(this.$el,e.currentSrc),this.img=e}}}
function Gn(e,t){if(Xn(e)){const t=Oe(e);(vt(t,"picture")?Me(t):[e]).forEach((e=>Zn(e,e)))}else if(t){!c(e.style.backgroundImage,t)&&(st(e,"backgroundImage",`url(${Ye(t)})`),Ke(e,Xe("load",!1)))}}const Qn=["data-src","data-srcset","sizes"]
function Zn(e,t){for(const r of Qn){const n=ae(e,r)
n&&ie(t,r.replace(/data-/g,""),n)}}function Kn(e,t){if((t=function(e){if(!e)return[]
if(l(e,"["))try{e=JSON.parse(e)}catch(t){e=[]}else e=an(e)
h(e)||(e=[e])
return e.filter((e=>!T(e)))}(t)).length){const r=Mt("<picture>")
for(const e of t){const t=Mt("<source>")
ie(t,e),_t(r,t)}_t(r,e)}}function Xn(e){return vt(e,"img")}let Jn
function ei(e){const t=Ge(e,"touchstart",(t=>{if(1!==t.targetTouches.length||Se(t.target,'input[type="range"'))return
let r=it(t).y
const n=Ge(e,"touchmove",(t=>{const n=it(t).y
n!==r&&(r=n,Tr(t.target).some((t=>{if(!e.contains(t))return!1
...
return st(r,{overflowY:CSS.supports("overflow","clip")?"clip":"hidden",touchAction:"none",paddingRight:zt(window)-r.clientWidth||""}),()=>{Jn=!1,t(),st(r,{overflowY:"",touchAction:"",paddingRight:""})}}var ti={props:{container:Boolean},data:{container:!0},computed:{container({container:e}){return!0===e&&this.$container||e&&jt(e)}}},ri={props:{pos:String,offset:Boolean,flip:Boolean,shift:Boolean,inset:Boolean},data:{pos:"bottom-"+(ue?"right":"left"),offset:!1,flip:!0,shift:!0,inset:!1},connected(){this.pos=this.$props.pos.split("-").concat("center").slice(0,2),[this.dir,this.align]=this.pos,this.axis=c(["top","bottom"],this.dir)?"y":"x"},methods:{positionAt(e,t,r){let n=[this.getPositionOffset(e),this.getShiftOffset(e)]
...
function oi(e,t,{_toggle:r}){return gt.cancel(e),dt.cancel(e),r(e,t)}async function si(e,t,{animation:r,duration:n,velocity:i,transition:o,_toggle:s}){var a
...
try{await dt.start(e,O,n,o)}finally{st(e,y),St(C.firstChild),t||s(e,!1)}}function ai(e,t,r){const{animation:n,duration:i,_toggle:o}=r
return t?(o(e,!0),gt.in(e,n[0],i,r.origin)):gt.out(e,n[1]||n[0],i,r.origin).then((()=>o(e,!1)))}const li=[]
var ui={mixins:[Xr,ti,ii],props:{selPanel:String,selClose:String,escClose:Boolean,bgClose:Boolean,stack:Boolean,role:String},data:{cls:"uk-open",escClose:!0,bgClose:!0,overlay:!0,stack:!1,role:"dialog"},computed:{panel:({selPanel:e},t)=>jt(e,t),transitionElement(){return this.panel}},connected(){ie(this.panel||this.$el,"role",this.role),this.overlay&&ie(this.panel||this.$el,"aria-modal",!0)},beforeDisconnect(){c(li,this)&&this.toggleElement(this.$el,!1,!1)},events:[{name:"click",delegate:({selClose:e})=>`${e},a[href*="#"]`,handler(e){const{current:t,defaultPrevented:r}=e,{hash:n}=t
!r&&n&&Ae(t)&&!this.$el.contains(jt(n))?this.hide():Se(t,this.selClose)&&(e.preventDefault(),this.hide())}},{name:"toggle",self:!0,handler(e){e.defaultPrevented||(e.preventDefault(),this.isToggled()===c(li,this)&&this.toggle())}},{name:"beforeshow",self:!0,handler(e){if(c(li,this))return!1
!this.stack&&li.length?(Promise.all(li.map((e=>e.hide()))).then(this.show),e.preventDefault()):li.push(this)}},{name:"show",self:!0,handler(){this.stack&&st(this.$el,"zIndex",R(st(this.$el,"zIndex"))+li.length)
const e=[this.overlay&&di(this),this.overlay&&ei(this.$el),this.bgClose&&hi(this),this.escClose&&pi(this)]
Ze(this.$el,"hidden",(()=>e.forEach((e=>e&&e()))),{self:!0}),X(document.documentElement,this.clsPage)}},{name:"shown",self:!0,handler(){ke(this.$el)||ie(this.$el,"tabindex","-1"),Se(this.$el,":focus-within")||this.$el.focus()}},{name:"hidden",self:!0,handler(){c(li,this)&&li.splice(li.indexOf(this),1),st(this.$el,"zIndex",""),li.some((e=>e.clsPage===this.clsPage))||J(document.documentElement,this.clsPage)}}],methods:{toggle(){return this.isToggled()?this.hide():this.show()},show(){return this.container&&Oe(this.$el)!==this.container?(_t(this.container,this.$el),new Promise((e=>requestAnimationFrame((()=>this.show().then(e)))))):this.toggleElement(this.$el,!0,ci)},hide(){return this.toggleElement(this.$el,!1,ci)}}}
function ci(e,t,{transitionElement:r,_toggle:n}){return new Promise(((i,o)=>Ze(e,"show hide",(()=>{var s
...
var c})))).then((()=>delete e._reject))}function di(e){return Ge(document,"focusin",(t=>{L(li)!==e||e.$el.contains(t.target)||e.$el.focus()}))}function hi(e){return Ge(document,he,(({target:t})=>{L(li)!==e||e.overlay&&!e.$el.contains(t)||!e.panel||e.panel.contains(t)||Ze(document,`${fe} ${ve} scroll`,(({defaultPrevented:r,type:n,target:i})=>{r||n!==fe||t!==i||e.hide()}),!0)}))}function pi(e){return Ge(document,"keydown",(t=>{27===t.keyCode&&L(li)===e&&e.hide()}))}var fi={slide:{show:e=>[{transform:gi(-100*e)},{transform:gi()}],percent:e=>mi(e),translate:(e,t)=>[{transform:gi(-100*t*e)},{transform:gi(100*t*(1-e))}]}}
function mi(e){return Math.abs(new DOMMatrix(st(e,"transform")).m41/e.offsetWidth)}function gi(e=0,t="%"){return e?`translate3d(${e+t}, 0, 0)`:""}function vi(e,t,r){Ke(e,Xe(t,!1,!1,r))}function bi(){let e
return{promise:new Promise((t=>e=t)),resolve:e}}var yi={props:{i18n:Object},data:{i18n:null},methods:{t(e,...t){var r,n,i
let o=0
return(null==(i=(null==(r=this.i18n)?void 0:r[e])||(null==(n=this.$options.i18n)?void 0:n[e]))?void 0:i.replace(/%s/g,(()=>t[o++]||"")))||""}}},wi={props:{autoplay:Boolean,autoplayInterval:Number,pauseOnHover:Boolean},data:{autoplay:!1,autoplayInterval:7e3,pauseOnHover:!0},connected(){ie(this.list,"aria-live",this.autoplay?"off":"polite"),this.autoplay&&this.startAutoplay()},disconnected(){this.stopAutoplay()},update(){ie(this.slides,"tabindex","-1")},events:[{name:"visibilitychange",el:()=>document,filter:({autoplay:e})=>e,handler(){document.hidden?this.stopAutoplay():this.startAutoplay()}}],methods:{startAutoplay(){this.stopAutoplay(),this.interval=setInterval((()=>{this.stack.length||this.draggable&&Se(this.$el,":focus-within")&&!Se(this.$el,":focus")||this.pauseOnHover&&Se(this.$el,":hover")||this.show("next")}),this.autoplayInterval)},stopAutoplay(){clearInterval(this.interval)}}}
const _i={passive:!1,capture:!0},xi={passive:!0,capture:!0},Ei="touchmove mousemove",Ci="touchend touchcancel mouseup click input scroll"
var ki={props:{draggable:Boolean},data:{draggable:!0,threshold:10},created(){for(const e of["start","move","end"]){const t=this[e]
...
!this.draggable||this.parallax||!nt(e)&&(t=e.target,"none"!==st(t,"userSelect")&&p(t.childNodes).some((e=>3===e.nodeType&&e.textContent.trim())))||e.target.closest(xe)||e.button>0||this.length<2||this.start(e)}},{name:"dragstart",handler(e){e.preventDefault()}},{name:Ei,el:({list:e})=>e,handler:q,..._i}],methods:{start(){this.drag=this.pos,this._transitioner?(this.percent=this._transitioner.percent(),this.drag+=this._transitioner.getDistance()*this.percent*this.dir,this._transitioner.cancel(),this._transitioner.translate(this.percent),this.dragging=!0,this.stack=[]):this.prevIndex=this.index,Ge(document,Ei,this.move,_i),Ge(document,Ci,this.end,xi),st(this.list,"userSelect","none")},move(e){const t=this.pos-this.drag
...
let{slides:r,prevIndex:n}=this,i=Math.abs(t),o=this.getIndex(n+this.dir),s=Oi.call(this,n,o)
for(;o!==n&&i>s;)this.drag-=s*this.dir,n=o,i-=s,o=this.getIndex(n+this.dir),s=Oi.call(this,n,o)
this.percent=i/s
const a=r[n],l=r[o],u=this.index!==o,d=n===o
let h
for(const p of[this.index,this.prevIndex])c([o,n],p)||(Ke(r[p],"itemhidden",[this]),d&&(h=!0,this.prevIndex=n));(this.index===n&&this.prevIndex!==n||h)&&Ke(r[this.index],"itemshown",[this]),u&&(this.prevIndex=n,this.index=o,d||(Ke(a,"beforeitemhide",[this]),Ke(a,"itemhide",[this])),Ke(l,"beforeitemshow",[this]),Ke(l,"itemshow",[this])),this._transitioner=this._translate(Math.abs(this.percent),a,!d&&l)},end(){if(Qe(document,Ei,this.move,_i),Qe(document,Ci,this.end,xi),this.dragging)if(setTimeout(Ge(this.list,"click",(e=>e.preventDefault()),_i)),this.dragging=null,this.index===this.prevIndex)this.percent=1-this.percent,this.dir*=-1,this._show(!1,this.index,!0),this._transitioner=null
...
function Oi(e,t){return this._getTransitioner(e,e!==t&&t).getDistance()||this.slides[e].offsetWidth}function Ti(e,t,r){e._watches.push({name:r,...v(t)?t:{handler:t}})}const Si={subtree:!0,childList:!0}
function Pi(e,t,n){e._hasComputed=!0,Object.defineProperty(e,t,{enumerable:!0,get(){const{_computed:i,$props:o,$el:s}=e
if(!r(i,t)&&(i[t]=(n.get||n).call(e,o,s),n.observe&&e._computedObserver)){const t=n.observe.call(e,o)
e._computedObserver.observe(["~","+","-"].includes(t[0])?s.parentElement:s.getRootNode(),Si)}return i[t]},set(r){const{_computed:i}=e
i[t]=n.set?n.set.call(e,r):r,S(i[t])&&delete i[t]}})}function Mi(e){e._hasComputed&&(function(e,t){e._updates.unshift(t)}(e,{read:()=>function(e,t){for(const{name:n,handler:i,immediate:o=!0}of e._watches)(e._initial&&o||r(t,n)&&!D(t[n],e[n]))&&i.call(e,e[n],t[n])
e._initial=!1}(e,Ri(e)),events:["resize","computed"]}),e._computedObserver=hr(e.$el,(()=>cn(e,"computed")),Si),e._disconnect.push((()=>{e._computedObserver.disconnect(),e._computedObserver=null,Ri(e)})))}function Ri(e){const t={...e._computed}
return e._computed={},t}function Ai(e,{name:t,el:r,handler:n,capture:i,passive:o,delegate:s,filter:a,self:l}){a&&!a.call(e,e)||e._disconnect.push(Ge(r?r.call(e,e):e.$el,t,null==s?void 0:s.call(e,e),n.bind(e),{passive:o,capture:i,self:l}))}function ji(e,t){let{observe:n,target:i=e.$el,handler:o,options:s,filter:a,args:l}=t
if(a&&!a.call(e,e))return
const u=`_observe${e._disconnect.length}`
m(i)&&!r(e,u)&&Pi(e,u,(()=>{const t=i.call(e,e)
return h(t)?j(t):t})),o=C(o)?e[o]:o.bind(e),m(s)&&(s=s.call(e,e))
const c=n(r(e,u)?e[u]:i,o,s,l)
m(i)&&h(e[u])&&Ti(e,{handler:Ni(c,s),immediate:!1},u),e._disconnect.push((()=>c.disconnect()))}function Ni(e,t){return(r,n)=>{for(const t of n)c(r,t)||(e.unobserve?e.unobserve(t):e.observe&&e.disconnect())
for(const i of r)c(n,i)&&e.unobserve||e.observe(i,t)}}function Di(e){const t={},{args:r=[],props:n={},el:o,id:a}=e
if(!n)return t
for(const s in n){const e=i(s)
let r=ae(o,e)
S(r)||(r=n[s]===Boolean&&""===r||ln(n[s],r),"target"===e&&l(r,"_")||(t[s]=r))}const u=an(ae(o,a),r)
for(const i in u){const e=s(i)
S(n[e])||(t[e]=ln(n[e],u[i]))}return t}const Ii=K(((e,t)=>{const r=Object.keys(t),n=r.concat(e).map((e=>[i(e),`data-${i(e)}`])).flat()
return{attributes:r,filter:n}}))
function Li(e,t){var r
null==(r=e.$options[t])||r.forEach((t=>t.call(e)))}function $i(e){e._connected||(function(e){const{$options:t,$props:n}=e,i=Di(t)
f(n,i)
const{computed:o,methods:s}=t
for(let a in n)!(a in i)||o&&r(o,a)||s&&r(s,a)||(e[a]=n[a])}(e),Li(e,"beforeConnect"),e._connected=!0,e._disconnect=[],function(e){for(const t of e.$options.events||[])if(r(t,"handler"))Ai(e,t)
else for(const r in t)Ai(e,{name:r,handler:t[r]})}(e),function(e){e._data={},e._updates=[...e.$options.update||[]],e._disconnect.push((()=>e._updates=e._data=null))}(e),function(e){e._watches=[]
for(const t of e.$options.watch||[])for(const[r,n]of Object.entries(t))Ti(e,n,r)
e._initial=!0}(e),function(e){for(const t of e.$options.observe||[])ji(e,t)}(e),function(e){const{$options:t,$props:r}=e,{id:n,props:i,el:o}=t
if(!i)return
const{attributes:a,filter:l}=Ii(n,i),u=new MutationObserver((i=>{const o=Di(t)
i.some((({attributeName:e})=>{const t=e.replace("data-","")
return(t===n?a:[s(t),s(e)]).some((e=>!S(o[e])&&o[e]!==r[e]))}))&&e.$reset()}))
u.observe(o,{attributes:!0,attributeFilter:l}),e._disconnect.push((()=>u.disconnect()))}(e),Mi(e),Li(e,"connected"),cn(e))}function Fi(e){e._connected&&(Li(e,"beforeDisconnect"),e._disconnect.forEach((e=>e())),e._disconnect=null,Li(e,"disconnected"),e._connected=!1)}let Bi=0
function Hi(e,t={}){t.data=function({data:e={}},{args:t=[],props:r={}}){h(e)&&(e=e.slice(0,t.length).reduce(((e,r,n)=>(v(r)?f(e,r):e[t[n]]=r,e)),{}))
for(const n in e)S(e[n])?delete e[n]:r[n]&&(e[n]=ln(r[n],e[n]))
return e}(t,e.constructor.options),e.$options=sn(e.constructor.options,t,e),e.$props={},e._uid=Bi++,function(e){const{data:t={}}=e.$options
...
if(e._computed={},t)for(const r in t)Pi(e,r,t[r])}(e),Li(e,"created"),t.el&&e.$mount(t.el)}const zi=function(e){Hi(this,e)}
zi.util=Kr,zi.options={},zi.version="3.23.5"
const Ui="__uikit__",qi={}
function Vi(e,t){var r,n
const o="uk-"+i(e)
if(!t)return qi[o].options||(qi[o]=zi.extend(qi[o])),qi[o]
e=s(e),zi[e]=(t,r)=>Wi(e,t,r)
const a=null!=(r=t.options)?r:{...t}
return a.id=o,a.name=e,null==(n=a.install)||n.call(a,zi,a,e),zi._initialized&&!a.functional&&requestAnimationFrame((()=>Wi(e,`[${o}],[data-${o}]`))),qi[o]=a}function Wi(e,t,r,...n){const i=Vi(e)
return i.options.functional?new i({data:v(t)?t:[t,r,...n]}):t?Nt(t).map(o)[0]:o()
function o(t){const n=Gi(t,e)
if(n){if(!r)return n
n.$destroy()}return new i({el:t,data:r})}}function Yi(e){return(null==e?void 0:e[Ui])||{}}function Gi(e,t){return Yi(e)[t]}function Qi(e,t){e=e?A(e):document.body
for(const r of Pe(e).reverse())Zi(r,t)
At(e,(e=>Zi(e,t)))}function Zi(e,t){const r=Yi(e)
for(const n in r)cn(r[n],t)}let Ki=1
function Xi(e,t=null){return(null==t?void 0:t.id)||`${e.$options.id}-${Ki++}`}var Ji={i18n:{next:"Next slide",previous:"Previous slide",slideX:"Slide %s",slideLabel:"%s of %s",role:"String"},data:{selNav:!1,role:"region"},computed:{nav:({selNav:e},t)=>jt(e,t),navChildren(){return Me(this.nav)},selNavItem:({attrItem:e})=>`[${e}],[data-${e}]`,navItems(e,t){return Nt(this.selNavItem,t)}},watch:{nav(e,t){ie(e,"role","tablist"),this.padNavitems(),t&&this.$emit()},list(e){vt(e,"ul")&&ie(e,"role","presentation")},navChildren(e){ie(e,"role","presentation"),this.padNavitems(),this.updateNav()},navItems(e){for(const t of e){const e=ae(t,this.attrItem),r=jt("a,button",t)||t
let n,i=null
if(O(e)){const t=M(e),o=this.slides[t]
o&&(o.id||(o.id=Xi(this,o)),i=o.id),n=this.t("slideX",R(e)+1),ie(r,"role","tab")}else this.list&&(this.list.id||(this.list.id=Xi(this,this.list)),i=this.list.id),n=this.t(e)
...
var eo={mixins:[wi,ki,Ji,yi],props:{clsActivated:String,easing:String,index:Number,finite:Boolean,velocity:Number},data:()=>({easing:"ease",finite:!1,velocity:1,index:0,prevIndex:-1,stack:[],percent:0,clsActive:"uk-active",clsActivated:"",clsEnter:"uk-slide-enter",clsLeave:"uk-slide-leave",clsSlideActive:"uk-slide-active",Transitioner:!1,transitionOptions:{}}),connected(){this.prevIndex=-1,this.index=this.getValidIndex(this.$props.index),this.stack=[]},disconnected(){J(this.slides,this.clsActive)},computed:{duration:({velocity:e},t)=>to(t.offsetWidth/e),list:({selList:e},t)=>jt(e,t),maxIndex(){return this.length-1},slides(){return Me(this.list)},length(){return this.slides.length}},watch:{slides(e,t){t&&this.$emit()}},events:{itemshow({target:e}){X(e,this.clsEnter,this.clsSlideActive)},itemshown({target:e}){J(e,this.clsEnter)},itemhide({target:e}){X(e,this.clsLeave)},itemhidden({target:e}){J(e,this.clsLeave,this.clsSlideActive)}},methods:{async show(e,t=!1){var r
...
function to(e){return.5*e+300}var ro={mixins:[eo],props:{animation:String},data:{animation:"slide",clsActivated:"uk-transition-active",Animations:fi,Transitioner:function(e,t,r,{animation:n,easing:i}){const{percent:o,translate:s,show:a=q}=n,l=a(r),{promise:u,resolve:c}=bi()
return{dir:r,show(n,o=0,s){const a=s?"linear":i
return n-=Math.round(n*U(o,-1,1)),this.translate(o),vi(t,"itemin",{percent:o,duration:n,timing:a,dir:r}),vi(e,"itemout",{percent:1-o,duration:n,timing:a,dir:r}),Promise.all([dt.start(t,l[1],n,a),dt.start(e,l[0],n,a)]).then((()=>{this.reset(),c()}),q),u},cancel:()=>dt.cancel([t,e]),reset(){for(const r in l[0])st([t,e],r,"")},async forward(e,t=this.percent()){return await this.cancel(),this.show(e,t,!0)},translate(n){this.reset()
const i=s(n,r)
st(t,i[1]),st(e,i[0]),vi(t,"itemtranslatein",{percent:n,dir:r}),vi(e,"itemtranslateout",{percent:1-n,dir:r})},percent:()=>o(e||t,t,r),getDistance:()=>null==e?void 0:e.offsetWidth}}},computed:{animation:({animation:e,Animations:t})=>({...t[e]||t.slide,name:e}),transitionOptions(){return{animation:this.animation}}},observe:dn(),events:{itemshow({target:e}){X(e,this.clsActive)},itemshown({target:e}){X(e,this.clsActivated)},itemhidden({target:e}){J(e,this.clsActive,this.clsActivated)}}},no={...fi,fade:{show:()=>[{opacity:0,zIndex:0},{zIndex:-1}],percent:e=>1-st(e,"opacity"),translate:e=>[{opacity:1-e,zIndex:0},{zIndex:-1}]},scale:{show:()=>[{opacity:0,transform:io(1.5),zIndex:0},{zIndex:-1}],percent:e=>1-st(e,"opacity"),translate:e=>[{opacity:1-e,transform:io(1+.5*e),zIndex:0},{zIndex:-1}]},pull:{show:e=>e<0?[{transform:gi(30),zIndex:-1},{transform:gi(),zIndex:0}]:[{transform:gi(-100),zIndex:0},{transform:gi(),zIndex:-1}],percent:(e,t,r)=>r<0?1-mi(t):mi(e),translate:(e,t)=>t<0?[{transform:gi(30*e),zIndex:-1},{transform:gi(-100*(1-e)),zIndex:0}]:[{transform:gi(100*-e),zIndex:0},{transform:gi(30*(1-e)),zIndex:-1}]},push:{show:e=>e<0?[{transform:gi(100),zIndex:0},{transform:gi(),zIndex:-1}]:[{transform:gi(-30),zIndex:-1},{transform:gi(),zIndex:0}],percent:(e,t,r)=>r>0?1-mi(t):mi(e),translate:(e,t)=>t<0?[{transform:gi(100*e),zIndex:0},{transform:gi(-30*(1-e)),zIndex:-1}]:[{transform:gi(-30*e),zIndex:-1},{transform:gi(100*(1-e)),zIndex:0}]}}
function io(e){return`scale3d(${e}, ${e}, 1)`}var oo={...fi,fade:{show:()=>[{opacity:0},{opacity:1}],percent:e=>1-st(e,"opacity"),translate:e=>[{opacity:1-e},{opacity:e}]},scale:{show:()=>[{opacity:0,transform:io(.8)},{opacity:1,transform:io(1)}],percent:e=>1-st(e,"opacity"),translate:e=>[{opacity:1-e,transform:io(1-.2*e)},{opacity:e,transform:io(.8+.2*e)}]}},so={i18n:{counter:"%s / %s"},mixins:[ui,ro],functional:!0,props:{counter:Boolean,preload:Number,nav:Boolean,slidenav:Boolean,delayControls:Number,videoAutoplay:Boolean,template:String},data:()=>({counter:!1,preload:1,nav:!1,slidenav:!0,delayControls:3e3,videoAutoplay:!1,items:[],cls:"uk-open",clsPage:"uk-lightbox-page",clsFit:"uk-lightbox-items-fit",clsZoom:"uk-lightbox-zoom",attrItem:"uk-lightbox-item",selList:".uk-lightbox-items",selClose:".uk-close-large",selNav:".uk-lightbox-thumbnav, .uk-lightbox-dotnav",selCaption:".uk-lightbox-caption",selCounter:".uk-lightbox-counter",pauseOnHover:!1,velocity:2,Animations:oo,template:'<div class="uk-lightbox uk-overflow-hidden"> <div class="uk-lightbox-items"></div> <div class="uk-position-top-right uk-position-small uk-transition-fade" uk-inverse> <button class="uk-lightbox-close uk-close-large" type="button" uk-close></button> </div> <div class="uk-lightbox-slidenav uk-position-center-left uk-position-medium uk-transition-fade" uk-inverse> <a href uk-slidenav-previous uk-lightbox-item="previous"></a> </div> <div class="uk-lightbox-slidenav uk-position-center-right uk-position-medium uk-transition-fade" uk-inverse> <a href uk-slidenav-next uk-lightbox-item="next"></a> </div> <div class="uk-position-center-right uk-position-medium uk-transition-fade" uk-inverse style="max-height: 90vh; overflow: auto;"> <ul class="uk-lightbox-thumbnav uk-lightbox-thumbnav-vertical uk-thumbnav uk-thumbnav-vertical"></ul> <ul class="uk-lightbox-dotnav uk-dotnav uk-dotnav-vertical"></ul> </div> <div class="uk-lightbox-counter uk-text-large uk-position-top-left uk-position-small uk-transition-fade" uk-inverse></div> <div class="uk-lightbox-caption uk-position-bottom uk-text-center uk-transition-slide-bottom uk-transition-opaque"></div> </div>'}),created(){let e=jt(this.template)
vt(e,"template")&&(e=Mt(yt(e)))
const t=jt(this.selList,e),r=this.$props.nav
kt(Nt(this.selNav,e).filter((e=>!Se(e,`.uk-${r}`))))
for(const[o,s]of this.items.entries())_t(t,"<div>"),"thumbnav"===r&&Ot(lo(s,this.videoAutoplay),_t(jt(this.selNav,e),`<li uk-lightbox-item="${o}"><a href></a></li>`))
this.slidenav||kt(Nt(".uk-lightbox-slidenav",e)),this.counter||kt(jt(this.selCounter,e)),X(t,this.clsFit)
const n=jt("[uk-close]",e),i=this.t("close")
n&&i&&(n.dataset.i18n=JSON.stringify({label:i})),this.$mount(_t(this.container,e))},events:[{name:"click",self:!0,filter:({bgClose:e})=>e,delegate:({selList:e})=>`${e} > *`,handler(e){e.defaultPrevented||this.hide()}},{name:"click",self:!0,delegate:({clsZoom:e})=>`.${e}`,handler(e){e.defaultPrevented||re(this.list,this.clsFit)}},{name:`${pe} ${he} keydown`,filter:({delayControls:e})=>e,handler(){this.showControls()}},{name:"shown",self:!0,handler(){this.showControls()}},{name:"hide",self:!0,handler(){this.hideControls(),J(this.slides,this.clsActive),dt.stop(this.slides)}},{name:"hidden",self:!0,handler(){this.$destroy(!0)}},{name:"keyup",el:()=>document,handler({keyCode:e}){if(!this.isToggled(this.$el)||!this.draggable)return
let t=-1
e===Fn?t="previous":e===Hn?t="next":e===$n?t=0:e===Ln&&(t="last"),~t&&this.show(t)}},{name:"beforeitemshow",handler(e){yt(jt(this.selCaption,this.$el),this.getItem().caption||""),yt(jt(this.selCounter,this.$el),this.t("counter",this.index+1,this.slides.length))
for(let t=-this.preload;t<=this.preload;t++)this.loadItem(this.index+t)
this.isToggled()||(this.draggable=!1,e.preventDefault(),this.toggleElement(this.$el,!0,!1),this.animation=oo.scale,J(e.target,this.clsActive),this.stack.splice(1,0,this.index))}},{name:"itemshown",handler(){this.draggable=this.$props.draggable}},{name:"itemload",async handler(e,t){const{source:r,type:n,attrs:i={}}=t
...
if("image"===n||uo(r)){const e=ao("img")
Kn(e,t.sources),ie(e,{src:r,...z(t,["alt","srcset","sizes"]),...i}),Ge(e,"load",(()=>this.setItem(t,Oe(e)||e))),Ge(e,"error",(()=>this.setError(t)))}else if("video"===n||co(r)){const e="inline"===this.videoAutoplay,n=ao("video",{src:r,playsinline:"",controls:e?null:"",loop:e?"":null,poster:this.videoAutoplay?null:t.poster,"uk-video":e?"automute: true":Boolean(this.videoAutoplay),...i})
Ge(n,"loadedmetadata",(()=>this.setItem(t,n))),Ge(n,"error",(()=>this.setError(t)))}else if("iframe"===n||r.match(/\.(html|php)($|\?)/i))this.setItem(t,ao("iframe",{src:r,allowfullscreen:"",class:"uk-lightbox-iframe",...i}))
else if(o=r.match(/\/\/(?:.*?youtube(-nocookie)?\..*?(?:[?&]v=|\/shorts\/)|youtu\.be\/)([\w-]{11})[&?]?(.*)?/))this.setItem(t,ao("iframe",{src:`https://www.youtube${o[1]||""}.com/embed/${o[2]}${o[3]?`?${o[3]}`:""}`,width:1920,height:1080,...s,...i}))
...
this.setItem(t,ao("iframe",{src:`https://player.vimeo.com/video/${o[1]}${o[2]?`?${o[2]}`:""}`,width:n,height:e,...s,...i}))}catch(a){this.setError(t)}}},{name:"itemloaded",handler(){this.$emit("resize")}}],update:{read(){for(const e of Nt(`${this.selList} :not([controls]):is(img,video)`,this.$el))re(e,this.clsZoom,(e.naturalHeight||e.videoHeight)-this.$el.offsetHeight>Math.max(0,(e.naturalWidth||e.videoWidth)-this.$el.offsetWidth))},events:["resize"]},methods:{loadItem(e=this.index){const t=this.getItem(e)
this.getSlide(t).childElementCount||Ke(this.$el,"itemload",[t])},getItem(e=this.index){return this.items[Z(e,this.slides)]},setItem(e,t){Ke(this.$el,"itemloaded",[this,yt(this.getSlide(e),t)])},getSlide(e){return this.slides[this.items.indexOf(e)]},setError(e){this.setItem(e,'<span uk-icon="icon: bolt; ratio: 2" uk-inverse></span>')},showControls(){clearTimeout(this.controlsTimer),this.controlsTimer=this.delayControls&&setTimeout(this.hideControls,this.delayControls),X(this.$el,"uk-active","uk-transition-active")},hideControls(){J(this.$el,"uk-active","uk-transition-active")}}}
function ao(e,t){const r=Mt(`<${e}>`)
return ie(r,t),r}function lo(e,t){const r=e.poster||e.thumb&&("image"===e.type||uo(e.thumb))?ao("img",{src:e.poster||e.thumb,alt:""}):e.thumb&&("video"===e.type||co(e.thumb))?ao("video",{src:e.thumb,loop:"",playsinline:"","uk-video":`autoplay: ${Boolean(t)}; automute: true`}):ao("canvas")
return e.thumbRatio&&(r.style.aspectRatio=e.thumbRatio),r}function uo(e){return null==e?void 0:e.match(/\.(avif|jpe?g|jfif|a?png|gif|svg|webp)($|\?)/i)}function co(e){return null==e?void 0:e.match(/\.(mp4|webm|ogv)($|\?)/i)}var ho={install:function(e,t){e.lightboxPanel||e.component("lightboxPanel",so)
...
for(const t of e)vt(t,"a")&&ie(t,"role","button")}},disconnected(){this.hide()},events:{name:"click",delegate:({toggle:e})=>e,handler(e){e.defaultPrevented||(e.preventDefault(),Se(e.current,".uk-disabled *, .uk-disabled, [disabled]")||this.show(e.current))}},methods:{show(e){let t=this.toggles.map(fo)
if("thumbnav"===this.nav&&po.call(this,this.toggles,t),t=H(t,"source"),_(e)){const{source:r}=fo(e)
...
function po(e,t){for(const[r,n]of Object.entries(e)){if(t[r].thumb)continue
const e=Pe(n).reverse().concat(n).find((e=>this.$el.contains(e)&&(e===n||1===Nt(this.toggle,e).length)))
if(!e)continue
const i=jt("img,video",e)
i&&(t[r].thumb=i.currentSrc||i.poster||i.src,t[r].thumbRatio=(i.naturalWidth||i.videoWidth)/(i.naturalHeight||i.videoHeight))}}function fo(e){const t={}
for(const r of e.getAttributeNames()){const n=r.replace(/^data-/,"")
t["href"===n?"source":n]=e.getAttribute(r)}return t.attrs=an(t.attrs),t}var mo={mixins:[ti],functional:!0,args:["message","status"],data:{message:"",status:"",timeout:5e3,group:"",pos:"top-center",clsContainer:"uk-notification",clsClose:"uk-notification-close",clsMsg:"uk-notification-message"},install:function(e){e.notification.closeAll=function(t,r){At(document.body,(n=>{const i=e.getComponent(n,"notification")
...
var go={props:{media:Boolean},data:{media:!1},connected(){const e=function(e,t){if(C(e))if(l(e,"@"))e=R(st(t,`--uk-breakpoint-${e.slice(1)}`))
...
function vo(e){return _e(e)?Math.ceil(Math.max(0,...Nt("[stroke]",e).map((e=>{var t
return(null==(t=e.getTotalLength)?void 0:t.call(e))||0})))):0}const bo={x:_o,y:_o,rotate:_o,scale:_o,color:xo,backgroundColor:xo,borderColor:xo,blur:Eo,hue:Eo,fopacity:Eo,grayscale:Eo,invert:Eo,saturate:Eo,sepia:Eo,opacity:function(e,t,r){1===r.length&&r.unshift(Do(t,e,""))
return r=Mo(r),(t,n)=>{t[e]=Ao(r,n)}},stroke:function(e,t,r){1===r.length&&r.unshift(0)
const n=No(r),i=vo(t)
if(r=Mo(r.reverse(),(e=>(e=R(e),"%"===n?e*i/100:e))),!r.some((([e])=>e)))return q
return st(t,"strokeDasharray",i),(e,t)=>{e.strokeDashoffset=Ao(r,t)}},bgx:Co,bgy:Co},{keys:yo}=Object
var wo={mixins:[go],props:Io(yo(bo),"list"),data:Io(yo(bo),void 0),computed:{props(e,t){const r={}
for(const i in e)i in bo&&!S(e[i])&&(r[i]=e[i].slice())
const n={}
for(const i in r)n[i]=bo[i](i,t,r[i],r)
...
function _o(e,t,r){let n,i=No(r)||{x:"px",y:"px",rotate:"deg"}[e]||""
return"x"===e||"y"===e?(e=`translate${a(e)}`,n=e=>R(R(e).toFixed("px"===i?0:6))):"scale"===e&&(i="",n=e=>{var r
return No([e])?Wt(e,"width",t,!0)/t["offset"+((null==(r=e.endsWith)?void 0:r.call(e,"vh"))?"Height":"Width")]:R(e)}),1===r.length&&r.unshift("scale"===e?1:0),r=Mo(r,n),(t,n)=>{t.transform=`${t.transform||""} ${e}(${Ao(r,n)}${i})`}}function xo(e,t,r){return 1===r.length&&r.unshift(Do(t,e,"")),r=Mo(r,(e=>function(e,t){return Do(e,"color",t).split(/[(),]/g).slice(1,-1).concat(1).slice(0,4).map(R)}(t,e))),(t,n)=>{const[i,o,s]=Ro(r,n),a=i.map(((e,t)=>(e+=s*(o[t]-e),3===t?R(e):parseInt(e,10)))).join(",")
t[e]=`rgba(${a})`}}function Eo(e,t,r){1===r.length&&r.unshift(0)
const n=No(r)||{blur:"px",hue:"deg"}[e]||"%"
return e={fopacity:"opacity",hue:"hue-rotate"}[e]||e,r=Mo(r),(t,i)=>{const o=Ao(r,i)
t.filter=`${t.filter||""} ${e}(${o+n})`}}function Co(e,t,r,n){1===r.length&&r.unshift(0)
const i="bgy"===e?"height":"width"
n[e]=Mo(r,(e=>Wt(e,i,t)))
const o=["bgx","bgy"].filter((e=>e in n))
if(2===o.length&&"bgx"===e)return q
if("cover"===Do(t,"backgroundSize",""))return function(e,t,r,n){const i=function(e){const t=st(e,"backgroundImage").replace(/^none|url\(["']?(.+?)["']?\)$/,"$1")
if(So[t])return So[t]
const r=new Image
if(t&&(r.src=t,!r.naturalWidth&&!To[t]))return Ze(r,"error load",(()=>{So[t]=Po(r),Ke(e,Xe("load",!1))})),To[t]=!0,Po(r)
return So[t]=Po(r)}(t)
if(!i.width)return q
...
a[c]=`max(${ko(t,c)},-${r}px) + ${a[c]}`}const u=Oo(s,a,n)
return(e,t)=>{u(e,t),e.backgroundSize=`${l.width}px ${l.height}px`,e.backgroundRepeat="no-repeat"}}(0,t,0,n)
const s={}
for(const a of o)s[a]=ko(t,a)
return Oo(o,s,n)}function ko(e,t){return Do(e,`background-position-${t.slice(-1)}`,"")}function Oo(e,t,r){return function(n,i){for(const o of e){const e=Ao(r[o],i)
n[`background-position-${o.slice(-1)}`]=`calc(${t[o]} + ${e}px)`}}}const To={},So={}
function Po(e){return{width:e.naturalWidth,height:e.naturalHeight}}function Mo(e,t=R){const r=[],{length:n}=e
let i=0
...
i=0}}return r}function Ro(e,t){const r=d(e.slice(1),(([,e])=>t<=e))+1
return[e[r-1][0],e[r][0],(t-e[r-1][1])/(e[r][1]-e[r-1][1])]}function Ao(e,t){const[r,n,i]=Ro(e,t)
return r+Math.abs(r-n)*i*(r<n?1:-1)}const jo=/^-?\d+(?:\.\d+)?(\S+)?/
function No(e,t){var r
for(const n of e){const e=null==(r=n.match)?void 0:r.call(n,jo)
if(e)return e[1]}return t}function Do(e,t,r){const n=e.style[t],i=st(st(e,t,r),t)
return e.style[t]=n,i}function Io(e,t){return e.reduce(((e,r)=>(e[r]=t,e)),{})}function Lo(e,t){return t>=0?Math.pow(e,t+1):1-Math.pow(1-e,1-t)}var $o={mixins:[wo],props:{target:String,viewport:Number,easing:Number,start:String,end:String},data:{target:!1,viewport:1,easing:1,start:0,end:0},computed:{target:({target:e},t)=>Fo(e&&Ne(e,t)||t),start({start:e}){return Wt(e,"height",this.target,!0)},end({end:e,viewport:t}){return Wt(e||(t=100*(1-t))&&`${t}vh+${t}%`,"height",this.target,!0)}},observe:[mn(),gn({target:({target:e})=>e}),dn({target:({$el:e,target:t})=>[e,t,Sr(t,!0)]})],update:{read({percent:e},t){if(t.has("scroll")||(e=!1),!_e(this.$el))return!1
if(!this.matchMedia)return
const r=e
return{percent:e=Lo(Or(this.target,this.start,this.end),this.easing),style:r!==e&&this.getCss(e)}},write({style:e}){this.matchMedia?e&&st(this.$el,e):this.reset()},events:["scroll","resize"]}}
function Fo(e){return e?"offsetTop"in e?e:Fo(Oe(e)):document.documentElement}var Bo={props:{parallax:Boolean,parallaxTarget:Boolean,parallaxStart:String,parallaxEnd:String,parallaxEasing:Number},data:{parallax:!1,parallaxTarget:!1,parallaxStart:0,parallaxEnd:0,parallaxEasing:0},observe:[dn({target:({$el:e,parallaxTarget:t})=>[e,t],filter:({parallax:e})=>e}),gn({filter:({parallax:e})=>e})],computed:{parallaxTarget({parallaxTarget:e},t){return e&&Ne(e,t)||this.list}},update:{read(){if(!this.parallax)return!1
const e=this.parallaxTarget
if(!e)return!1
const t=Lo(Or(e,Wt(this.parallaxStart,"height",e,!0),Wt(this.parallaxEnd,"height",e,!0)),this.parallaxEasing)
...
var Ho={update:{write(){if(this.stack.length||this.dragging||this.parallax)return
const e=this.getValidIndex()
~this.prevIndex&&this.index===e?this._translate(1):this.show(e)},events:["resize"]}},zo={observe:fn({target:({slides:e})=>e,targets:e=>e.getAdjacentSlides()}),methods:{getAdjacentSlides(){return[1,-1].map((e=>this.slides[this.getIndex(this.index+e)]))}}}
function Uo(e,t,r){const n=Wo(e,t)
return r?n-function(e,t){return Lt(t).width/2-Lt(e).width/2}(e,t):Math.min(n,qo(t))}function qo(e){return Math.max(0,Vo(e)-Lt(e).width)}function Vo(e,t){return B(Me(e).slice(0,t),(e=>Lt(e).width))}function Wo(e,t){return e&&(Ft(e).left+(ue?Lt(e).width-Lt(t).width:0))*(ue?-1:1)||0}function Yo(e,t){t-=1
const r=Lt(e).width,n=t+r+2
return Me(e).filter((i=>{const o=Wo(i,e),s=o+Math.min(Lt(i).width,r)
return o>=t&&s<=n}))}var Go={mixins:[Xr,eo,Ho,Bo,zo],props:{center:Boolean,sets:Boolean,active:String},data:{center:!1,sets:!1,attrItem:"uk-slider-item",selList:".uk-slider-items",selNav:".uk-slider-nav",clsContainer:"uk-slider-container",active:"all",Transitioner:function(e,t,r,{center:n,easing:i,list:o}){const s=e?Uo(e,o,n):Uo(t,o,n)+Lt(t).width*r,a=t?Uo(t,o,n):s+Lt(e).width*r*(ue?-1:1),{promise:l,resolve:u}=bi()
return{dir:r,show(t,n=0,s){const c=s?"linear":i
return t-=Math.round(t*U(n,-1,1)),st(o,"transitionProperty","none"),this.translate(n),st(o,"transitionProperty",""),n=e?n:U(n,0,1),vi(this.getItemIn(),"itemin",{percent:n,duration:t,timing:c,dir:r}),e&&vi(this.getItemIn(!0),"itemout",{percent:1-n,duration:t,timing:c,dir:r}),dt.start(o,{transform:gi(-a*(ue?-1:1),"px")},t,c).then(u,q),l},cancel:()=>dt.cancel(o),reset(){st(o,"transform","")},async forward(e,t=this.percent()){return await this.cancel(),this.show(e,t,!0)},translate(n){if(n===this.percent())return
const i=this.getDistance()*r*(ue?-1:1)
st(o,"transform",gi(U(i-i*n-a,-Vo(o),Lt(o).width)*(ue?-1:1),"px"))
const s=this.getActives(),l=this.getItemIn(),u=this.getItemIn(!0)
n=e?U(n,-1,1):0
for(const a of Me(o)){const i=c(s,a),d=a===l,h=a===u
vi(a,"itemtranslate"+(d||!h&&(i||r*(ue?-1:1)==-1^Wo(a,o)>Wo(e||t))?"in":"out"),{dir:r,percent:h?1-n:d?n:i?1:0})}},percent:()=>Math.abs((new DOMMatrix(st(o,"transform")).m41*(ue?-1:1)+s)/(a-s)),getDistance:()=>Math.abs(a-s),getItemIn(r=!1){let i=this.getActives(),s=Yo(o,Uo(t||e,o,n))
if(r){const e=i
i=s,s=e}return s[d(s,(e=>!c(i,e)))]},getActives:()=>Yo(o,Uo(e||t,o,n))}}},computed:{finite({finite:e}){return e||function(e,t){if(!e||e.length<2)return!0
const{width:r}=Lt(e)
if(!t)return Math.ceil(Vo(e))<Math.trunc(r+function(e){return Math.max(0,...Me(e).map((e=>Lt(e).width)))}(e))
...
return void e.preventDefault()}const r=this.dir<0||!this.slides[this.prevIndex]?this.index:this.prevIndex,n=Vo(this.list)/this.length
this.duration=to(n/this.velocity)*(Lt(this.slides[r]).width/n),this.reorder()},itemshow(){~this.prevIndex&&X(this._getTransitioner().getItemIn(),this.clsActive),this.updateActiveClasses(this.prevIndex)},itemshown(){this.updateActiveClasses()}},methods:{reorder(){if(this.finite)return void st(this.slides,"order","")
...
let r=e*(this.center?Vo(this.list)-(Lt(this.slides[0]).width/2+Lt(L(this.slides)).width/2):Vo(this.list,this.maxIndex)),n=0
do{const e=Lt(this.slides[++t]).width,i=this.center?e/2+Lt(this.slides[t+1]).width/2:e
n=r/i%1,r-=i}while(r>=0&&t<this.maxIndex)
return[t,n]}}}
var Qo={mixins:[wo],beforeConnect(){this.item=this.$el.closest(`.${this.$options.id.replace("parallax","items")} > *`)},disconnected(){this.item=null},events:[{name:"itemin itemout",self:!0,el:({item:e})=>e,handler({type:e,detail:{percent:t,duration:r,timing:n,dir:i}}){Jt.read((()=>{if(!this.matchMedia)return
const o=this.getCss(Ko(e,i,t)),s=this.getCss(Zo(e)?.5:i>0?1:0)
...
const n=this.getCss(Ko(e,r,t))
Jt.write((()=>st(this.$el,n)))}))}}]}
function Zo(e){return u(e,"in")}function Ko(e,t,r){return r/=2,Zo(e)^t<0?r:1-r}var Xo={mixins:[Xr,ro,Ho,Bo,zo],props:{ratio:String,minHeight:String,maxHeight:String},data:{ratio:"16:9",minHeight:void 0,maxHeight:void 0,selList:".uk-slideshow-items",attrItem:"uk-slideshow-item",selNav:".uk-slideshow-nav",Animations:no},watch:{list(e){st(e,{aspectRatio:this.ratio?this.ratio.replace(":","/"):void 0,minHeight:this.minHeight,maxHeight:this.maxHeight,width:"100%"})}},methods:{getAdjacentSlides(){return[1,-1].map((e=>this.slides[this.getIndex(this.index+e)]))}}},Jo={mixins:[Xr,jn],props:{group:String,threshold:Number,clsItem:String,clsPlaceholder:String,clsDrag:String,clsDragState:String,clsBase:String,clsNoDrag:String,clsEmpty:String,clsCustom:String,handle:String},data:{group:!1,threshold:5,clsItem:"uk-sortable-item",clsPlaceholder:"uk-sortable-placeholder",clsDrag:"uk-sortable-drag",clsDragState:"uk-drag",clsBase:"uk-sortable",clsNoDrag:"uk-sortable-nodrag",clsEmpty:"uk-sortable-empty",clsCustom:"",handle:!1,pos:{}},events:{name:he,passive:!1,handler(e){this.init(e)}},computed:{target:(e,t)=>(t.tBodies||[t])[0],items(){return Me(this.target)},isEmpty(){return!this.items.length},handles({handle:e},t){return e?Nt(e,t):this.items}},watch:{isEmpty(e){re(this.target,this.clsEmpty,e)},handles(e,t){st(t,{touchAction:"",userSelect:""}),st(e,{touchAction:"none",userSelect:"none"})}},update:{write(e){if(!this.drag||!Oe(this.placeholder))return
...
return!ts([r.left,r.right],[t.left,t.right])}))}))
r&&kt(t)
return i}(e,r)||i<s.top+s.height/2?t:t.nextElementSibling
const a=Lt(r),l=ts([s.top,s.bottom],[a.top,a.bottom]),[u,c,d,h]=l?[n,"width","left","right"]:[i,"height","top","bottom"],p=a[c]<s[c]?s[c]-a[c]:0
...
es=setInterval((()=>{let{x:r,y:n}=e
n+=document.scrollingElement.scrollTop
const i=.3*(Date.now()-t)
t=Date.now(),Tr(document.elementFromPoint(r,e.y)).reverse().some((e=>{let{scrollTop:t,scrollHeight:r}=e
const{top:o,bottom:s,height:a}=Mr(e)
if(o<n&&o+35>n)t-=i
...
let es
function ts(e,t){return e[1]>t[0]&&t[1]>e[0]}var rs={mixins:[ti,ii,ri],data:{pos:"top",animation:["uk-animation-scale-up"],duration:100,cls:"uk-active"},connected(){var e
...
return["delay","title"].reduce(((e,r)=>({[r]:ae(t,r),...e})),{...an(ae(t,r),["title"]),...n})}(this.$options)
if(!t)return
...
const o=[Ze(document,`keydown ${he}`,this.hide,!1,(e=>e.type===he&&!this.$el.contains(e.target)||"keydown"===e.type&&e.keyCode===Dn)),Ge([document,...Pr(this.$el)],"scroll",r,{passive:!0})]
...
var ns={mixins:[yi],i18n:{invalidMime:"Invalid File Type: %s",invalidName:"Invalid File Name: %s",invalidSize:"Invalid File Size: %s Kilobytes Max"},props:{allow:String,clsDragover:String,concurrent:Number,maxSize:Number,method:String,mime:String,multiple:Boolean,name:String,params:Object,type:String,url:String},data:{allow:!1,clsDragover:"uk-dragover",concurrent:1,maxSize:0,method:"POST",mime:!1,multiple:!1,name:"files[]",params:{},type:"",url:"",abort:q,beforeAll:q,beforeSend:q,complete:q,completeAll:q,error:q,fail:q,load:q,loadEnd:q,loadStart:q,progress:q},events:{change(e){Se(e.target,'input[type="file"]')&&(e.preventDefault(),e.target.files&&this.upload(e.target.files),e.target.value="")},drop(e){os(e)
const t=e.dataTransfer;(null==t?void 0:t.files)&&(J(this.$el,this.clsDragover),this.upload(t.files))},dragenter(e){os(e)},dragover(e){os(e),X(this.$el,this.clsDragover)},dragleave(e){os(e),J(this.$el,this.clsDragover)}},methods:{async upload(e){if(!(e=p(e)).length)return
Ke(this.$el,"upload",[e])
for(const n of e){if(this.maxSize&&1e3*this.maxSize<n.size)return void this.fail(this.t("invalidSize",this.maxSize))
if(this.allow&&!is(this.allow,n.name))return void this.fail(this.t("invalidName",this.allow))
if(this.mime&&!is(this.mime,n.type))return void this.fail(this.t("invalidMime",this.mime))}this.multiple||(e=e.slice(0,1)),this.beforeAll(this,e)
...
await r(t.shift())}}}
function is(e,t){return t.match(new RegExp(`^${e.replace(/\//g,"\\/").replace(/\*\*/g,"(\\/[^\\/]+)*").replace(/\*/g,"[^\\/]+").replace(/((?!\\))\?/g,"$1.")}$`,"i"))}function os(e){e.preventDefault(),e.stopPropagation()}var ss=Object.freeze({__proto__:null,Countdown:en,Filter:Un,Lightbox:ho,LightboxPanel:so,Notification:mo,Parallax:$o,Slider:Go,SliderParallax:Qo,Slideshow:Xo,SlideshowParallax:Qo,Sortable:Jo,Tooltip:rs,Upload:ns})
function as(e){Ke(document,"uikit:init",e),document.body&&At(document.body,us),new MutationObserver(ls).observe(document,{subtree:!0,childList:!0,attributes:!0}),e._initialized=!0}function ls(e){var t
for(const{addedNodes:r,removedNodes:n,target:i,attributeName:o}of e){for(const t of r)At(t,us)
for(const t of n)At(t,cs)
const e=o&&ds(o)
e&&(oe(i,o)?Wi(e,i):null==(t=Gi(i,e))||t.$destroy())}}function us(e){const t=Yi(e)
for(const r in t)$i(t[r])
for(const r of e.getAttributeNames()){const t=ds(r)
t&&Wi(t,e)}}function cs(e){const t=Yi(e)
for(const r in t)Fi(t[r])}function ds(e){l(e,"data-")&&(e=e.slice(5))
const t=qi[e]
return t&&(t.options||t).name}(function(e){let t
e.component=Vi,e.getComponents=Yi,e.getComponent=Gi,e.update=Qi,e.use=function(e){if(!e.installed)return e.call(null,this),e.installed=!0,this},e.mixin=function(e,t){(t=(C(t)?this.component(t):t)||this).options=sn(t.options,e)},e.extend=function(e){e||(e={})
const t=this,r=function(e){Hi(this,e)}
return(r.prototype=Object.create(t.prototype)).constructor=r,r.options=sn(t.options,e),r.super=t,r.extend=t.extend,r},Object.defineProperty(e,"container",{get:()=>t||document.body,set(e){t=jt(e)}})})(zi),function(e){e.prototype.$mount=function(e){const t=this;(function(e,t){e[Ui]||(e[Ui]={}),e[Ui][t.$options.name]=t})(e,t),t.$options.el=e,e.isConnected&&$i(t)},e.prototype.$destroy=function(e=!1){const t=this,{el:r}=t.$options
r&&Fi(t),Li(t,"destroy"),function(e,t){var r
null==(r=e[Ui])||delete r[t.$options.name],T(e[Ui])&&delete e[Ui]}(r,t),e&&kt(t.$el)},e.prototype.$create=Wi,e.prototype.$emit=function(e){cn(this,e)},e.prototype.$update=function(e=this.$el,t){Qi(e,t)},e.prototype.$reset=function(){Fi(this),$i(this)},e.prototype.$getComponent=Gi,Object.defineProperties(e.prototype,{$el:{get(){return this.$options.el}},$container:Object.getOwnPropertyDescriptor(e,"container")})}(zi)
var hs={mixins:[Xr,ii],props:{animation:Boolean,targets:String,active:null,collapsible:Boolean,multiple:Boolean,toggle:String,content:String,offset:Number},data:{targets:"> *",active:!1,animation:!0,collapsible:!0,multiple:!1,clsOpen:"uk-open",toggle:"> .uk-accordion-title",content:"> .uk-accordion-content",offset:0},computed:{items:({targets:e},t)=>Nt(e,t),toggles({toggle:e}){return this.items.map((t=>jt(e,t)))},contents({content:e}){return this.items.map((t=>{var r
...
ps(t,!e)}this.$emit()}},observe:fn(),events:[{name:"click keydown",delegate:({targets:e,$props:t})=>`${e} ${t.toggle}`,async handler(e){var t
"keydown"===e.type&&e.keyCode!==In||(e.preventDefault(),null==(t=this._off)||t.call(this),this._off=function(e){const t=Sr(e,!0)
let r
...
await dt.cancel(a),ps(r,!1)
const u=B(["marginTop","marginBottom"],(e=>st(r,e)))+Lt(r).height,c=l/u
n=(i*u+n)*(t?1-c:c),st(a,"height",l),await dt.start(a,{height:t?u:0},n,o),St(r),delete e._wrapper,t||ps(r,!0)}(e,r,this)
ps(jt(this.content,e),!r)})))))}}}
function ps(e,t){e&&(e.hidden=t)}var fs={mixins:[Xr,ii],args:"animation",props:{animation:Boolean,close:String},data:{animation:!0,selClose:".uk-alert-close",duration:150},events:{name:"click",delegate:({selClose:e})=>e,handler(e){e.preventDefault(),this.close()}},methods:{async close(){await this.toggleElement(this.$el,!1,ms),this.$destroy(!0)}}}
function ms(e,t,{duration:r,transition:n,velocity:i}){const o=R(st(e,"height"))
return st(e,"height",o),dt.start(e,{height:0,marginTop:0,marginBottom:0,paddingTop:0,paddingBottom:0,borderTop:0,borderBottom:0,opacity:0},i*o+r,n)}var gs={args:"autoplay",props:{automute:Boolean,autoplay:Boolean},data:{automute:!1,autoplay:!0},beforeConnect(){"inview"!==this.autoplay||oe(this.$el,"preload")||(this.$el.preload="none"),vt(this.$el,"iframe")&&!oe(this.$el,"allow")&&(this.$el.allow="autoplay"),"hover"===this.autoplay&&(vt(this.$el,"video")?this.$el.tabindex=0:this.autoplay=!0),this.automute&&gr(this.$el)},events:[{name:`${me} focusin`,filter:({autoplay:e})=>c(e,"hover"),handler(e){var t
!nt(e)||((t=this.$el).paused||t.ended)?fr(this.$el):mr(this.$el)}},{name:`${ge} focusout`,filter:({autoplay:e})=>c(e,"hover"),handler(e){nt(e)||mr(this.$el)}}],observe:[hn({filter:({autoplay:e})=>"hover"!==e,handler([{isIntersecting:e}]){document.fullscreenElement||(e?this.autoplay&&fr(this.$el):mr(this.$el))},args:{intersecting:!1},options:({$el:e,autoplay:t})=>({root:"inview"===t?null:Oe(e).closest(":not(a)")})})]}
var vs={mixins:[gs],props:{width:Number,height:Number},data:{automute:!0},created(){this.useObjectFit=vt(this.$el,"img","video")},observe:dn({target:({$el:e})=>bs(e)||Oe(e),filter:({useObjectFit:e})=>!e}),update:{read(){if(this.useObjectFit)return!1
...
o=n?e(t,"width",n):i?e(t,"height",i):t}const{offsetHeight:s,offsetWidth:a}=bs(r)||Oe(r),l=t(o,{width:a,height:s})
return!(!l.width||!l.height)&&l},write({height:e,width:t}){st(this.$el,{height:e,width:t})},events:["resize"]}}
function bs(e){for(;e=Oe(e);)if("static"!==st(e,"position"))return e}let ys
var ws={mixins:[ti,ri,ii],args:"pos",props:{mode:"list",toggle:Boolean,boundary:Boolean,boundaryX:Boolean,boundaryY:Boolean,target:Boolean,targetX:Boolean,targetY:Boolean,stretch:Boolean,delayShow:Number,delayHide:Number,autoUpdate:Boolean,clsDrop:String,animateOut:Boolean,bgScroll:Boolean,closeOnScroll:Boolean},data:{mode:["click","hover"],toggle:"- *",boundary:!1,boundaryX:!1,boundaryY:!1,target:!1,targetX:!1,targetY:!1,stretch:!1,delayShow:0,delayHide:800,autoUpdate:!0,clsDrop:!1,animateOut:!1,bgScroll:!0,animation:["uk-animation-fade"],cls:"uk-open",container:!1,closeOnScroll:!1},computed:{boundary:({boundary:e,boundaryX:t,boundaryY:r},n)=>[Ne(t||e,n)||window,Ne(r||e,n)||window],target({target:e,targetX:t,targetY:r},n){return t||(t=e||this.targetEl),r||(r=e||this.targetEl),[!0===t?window:Ne(t,n),!0===r?window:Ne(r,n)]}},created(){this.tracker=new ar},beforeConnect(){this.clsDrop=this.$props.clsDrop||this.$options.id},connected(){X(this.$el,"uk-drop",this.clsDrop),this.toggle&&!this.targetEl&&(this.targetEl=function(e){const{$el:t}=e.$create("toggle",Ne(e.toggle,e.$el),{target:e.$el,mode:e.mode})
return ie(t,"aria-haspopup",!0),t}(this)),this._style=z(this.$el.style,["width","height"])},disconnected(){this.isActive()&&(this.hide(!1),ys=null),st(this.$el,this._style)},events:[{name:"click",delegate:()=>".uk-drop-close",handler(e){e.preventDefault(),this.hide(!1)}},{name:"click",delegate:()=>'a[href*="#"]',handler({defaultPrevented:e,current:t}){const{hash:r}=t
!e&&r&&Ae(t)&&!this.$el.contains(jt(r))&&this.hide(!1)}},{name:"beforescroll",handler(){this.hide(!1)}},{name:"toggle",self:!0,handler(e,t){e.preventDefault(),this.isToggled()?this.hide(!1):this.show(null==t?void 0:t.$el,!1)}},{name:"toggleshow",self:!0,handler(e,t){e.preventDefault(),this.show(null==t?void 0:t.$el)}},{name:"togglehide",self:!0,handler(e){e.preventDefault(),Se(this.$el,":focus,:hover")||this.hide()}},{name:`${me} focusin`,filter:({mode:e})=>c(e,"hover"),handler(e){nt(e)||this.clearTimers()}},{name:`${ge} focusout`,filter:({mode:e})=>c(e,"hover"),handler(e){!nt(e)&&e.relatedTarget&&this.hide()}},{name:"toggled",self:!0,handler(e,t){t&&(this.clearTimers(),this.position())}},{name:"show",self:!0,handler(){ys=this,this.tracker.init(),ie(this.targetEl,"aria-expanded",!0)
const e=[_s(this),Es(this),ks(this),this.autoUpdate&&xs(this),this.closeOnScroll&&Cs(this)]
Ze(this.$el,"hide",(()=>e.forEach((e=>e&&e()))),{self:!0}),this.bgScroll||Ze(this.$el,"hidden",ei(this.$el),{self:!0})}},{name:"beforehide",self:!0,handler(){this.clearTimers()}},{name:"hide",handler({target:e}){this.$el===e?(ys=this.isActive()?null:ys,this.tracker.cancel(),ie(this.targetEl,"aria-expanded",null)):ys=null===ys&&this.$el.contains(e)&&this.isToggled()?this:ys}}],update:{write(){this.isToggled()&&!te(this.$el,this.clsEnter)&&this.position()}},methods:{show(e=this.targetEl,t=!0){if(this.isToggled()&&e&&this.targetEl&&e!==this.targetEl&&this.hide(!1,!1),this.targetEl=e,this.clearTimers(),!this.isActive()){if(ys){if(t&&ys.isDelaying())return void(this.showTimer=setTimeout((()=>Se(e,":hover")&&this.show()),10))
let r
for(;ys&&r!==ys&&!ys.$el.contains(this.$el);)r=ys,ys.hide(!1,!1)}this.container&&Oe(this.$el)!==this.container&&_t(this.container,this.$el),this.showTimer=setTimeout((()=>this.toggleElement(this.$el,!0)),t&&this.delayShow||0)}},hide(e=!0,t=!0){const r=()=>this.toggleElement(this.$el,!1,this.animateOut&&t)
this.clearTimers(),this.isDelayedHide=e,e&&this.isDelaying()?this.hideTimer=setTimeout(this.hide,50):e&&this.delayHide?this.hideTimer=setTimeout(r,this.delayHide):r()},clearTimers(){clearTimeout(this.showTimer),clearTimeout(this.hideTimer),this.showTimer=null,this.hideTimer=null},isActive(){return ys===this},isDelaying(){return[this.$el,...Nt(".uk-drop",this.$el)].some((e=>this.tracker.movesTo(e)))},position(){const e=ni(this.$el)
J(this.$el,"uk-drop-stack"),st(this.$el,this._style),this.$el.hidden=!0
const t=this.target.map((e=>function(e,t){return Mr(Pr(t).find((t=>t.contains(e))))}(this.$el,e))),r=this.getViewportOffset(this.$el),n=[[0,["x","width","left","right"]],[1,["y","height","top","bottom"]]]
...
function _s(e){const t=()=>e.$emit(),r=[dr(t),cr(Pr(e.$el).concat(e.target),t)]
return()=>r.map((e=>e.disconnect()))}function xs(e,t=()=>e.$emit()){return Ge([document,...Pr(e.$el)],"scroll",t,{passive:!0})}function Es(e){return Ge(document,"keydown",(t=>{t.keyCode===Dn&&e.hide(!1)}))}function Cs(e){return xs(e,(()=>e.hide(!1)))}function ks(e){return Ge(document,he,(({target:t})=>{e.$el.contains(t)||Ze(document,`${fe} ${ve} scroll`,(({defaultPrevented:r,type:n,target:i})=>{var o
r||n!==fe||t!==i||(null==(o=e.targetEl)?void 0:o.contains(t))||e.hide(!1)}),!0)}))}var Os={mixins:[Xr,ti],props:{align:String,clsDrop:String,boundary:Boolean,dropbar:Boolean,dropbarAnchor:Boolean,duration:Number,mode:Boolean,offset:Boolean,stretch:Boolean,delayShow:Boolean,delayHide:Boolean,target:Boolean,targetX:Boolean,targetY:Boolean,animation:Boolean,animateOut:Boolean,closeOnScroll:Boolean},data:{align:ue?"right":"left",clsDrop:"uk-dropdown",clsDropbar:"uk-dropnav-dropbar",boundary:!0,dropbar:!1,dropbarAnchor:!1,duration:200,container:!1,selNavItem:"> li > a, > ul > li > a"},computed:{dropbarAnchor:({dropbarAnchor:e},t)=>Ne(e,t)||t,dropbar({dropbar:e}){return e?(e=this._dropbar||Ne(e,this.$el)||jt(`+ .${this.clsDropbar}`,this.$el))||(this._dropbar=jt("<div></div>")):null},dropContainer(e,t){return this.container||t},dropdowns({clsDrop:e},t){var r
const n=Nt(`.${e}`,t)
...
if(n===zn)if((null==i?void 0:i.targetEl)===r)e.preventDefault(),null==(t=jt(Ce,i.$el))||t.focus()
...
return null==(t=jt(Ce,e.target))?void 0:t.focus()})))}Ts(e,this.items,i)}},{name:"keydown",el:({dropContainer:e})=>e,delegate:({clsDrop:e})=>`.${e}`,handler(e){var t
...
const t=Nt(Ce,r)
t[Z(s,t,d(t,(e=>Se(e,":focus"))))].focus()}else Ts(e,this.items,o)}},{name:"mouseleave",el:({dropbar:e})=>e,filter:({dropbar:e})=>e,handler(){const e=this.getActive()
...
return c(this.dropdowns,null==(e=ys)?void 0:e.$el)&&ys},async transitionTo(e,t){const{dropbar:r}=this,n=Ht(r)
...
function Ts(e,t,r){var n,i,o
const{current:s,keyCode:a}=e
let l=-1
a===$n?l=0:a===Ln?l="last":a===Fn?l="previous":a===Hn?l="next":a===Nn&&(null==(n=r.targetEl)||n.focus(),null==(i=r.hide)||i.call(r,!1)),~l&&(e.preventDefault(),null==(o=r.hide)||o.call(r,!1),t[Z(l,t,t.indexOf(r.targetEl||s))].focus())}var Ss={mixins:[Xr],args:"target",props:{target:Boolean},data:{target:!1},computed:{input:(e,t)=>jt(xe,t),state(){return this.input.nextElementSibling},target({target:e},t){return e&&(!0===e&&Oe(this.input)===t&&this.input.nextElementSibling||jt(e,t))}},update(){var e
...
o!==s&&(t[i]=s)},events:[{name:"change",handler(){this.$emit()}},{name:"reset",el:({$el:e})=>e.closest("form"),handler(){this.$emit()}}]},Ps={extends:yn,mixins:[Xr],name:"grid",props:{masonry:Boolean,parallax:String,parallaxStart:String,parallaxEnd:String,parallaxJustify:Boolean},data:{margin:"uk-grid-margin",clsStack:"uk-grid-stack",masonry:!1,parallax:0,parallaxStart:0,parallaxEnd:0,parallaxJustify:!1},connected(){this.masonry&&X(this.$el,"uk-flex-top","uk-flex-wrap-top")},observe:gn({filter:({parallax:e,parallaxJustify:t})=>e||t}),update:[{write({rows:e}){re(this.$el,this.clsStack,!e.some((e=>e.length>1)))},events:["resize"]},{read(e){const{rows:t}=e
let{masonry:r,parallax:n,parallaxJustify:i,margin:o}=this
if(n=Math.max(0,Wt(n)),!(r||n||i)||Ms(t)||t[0].some(((e,r)=>t.some((t=>t[r]&&t[r].offsetWidth!==e.offsetWidth)))))return e.translates=e.scrollColumns=!1
...
Rs(n,d,a[l]),Rs(i,d,[(d-l)*u*(ue?-1:1),o[d]-s]),o[d]+=c+t,e=Math.max(e,c)}s+=e+t}return[n,i]}(t,l,"next"===r):s=function(e){const t=[]
for(const r of e)for(const e in r)Rs(t,e,r[e])
return t}(t)
const u=s.map((e=>B(e,"offsetHeight")+l*(e.length-1))),c=Math.max(0,...u)
let d,h,p
return(n||i)&&(d=u.map(((e,t)=>i?c-e+n:n/(t%2||8))),i||(n=Math.max(...u.map(((e,t)=>e+d[t]-c)))),h=Wt(this.parallaxStart,"height",this.$el,!0),p=Wt(this.parallaxEnd,"height",this.$el,!0)),{columns:s,translates:a,scrollColumns:d,parallaxStart:h,parallaxEnd:p,padding:n,height:a?c:""}},write({height:e,padding:t}){st(this.$el,"paddingBottom",t||""),!1!==e&&st(this.$el,"height",e)},events:["resize"]},{read({rows:e,scrollColumns:t,parallaxStart:r,parallaxEnd:n}){return{scrolled:!(!t||Ms(e))&&Or(this.$el,r,n)}},write({columns:e,scrolled:t,scrollColumns:r,translates:n}){(t||n)&&e.forEach(((e,i)=>e.forEach(((e,o)=>{let[s,a]=n&&n[i][o]||[0,0]
t&&(a+=t*r[i]),st(e,"transform",`translate(${s}px, ${a}px)`)}))))},events:["scroll","resize"]}]}
function Ms(e){return e.flat().some((e=>"absolute"===st(e,"position")))}function Rs(e,t,r){e[t]||(e[t]=[]),e[t].push(r)}var As={args:"target",props:{target:String,row:Boolean},data:{target:"> *",row:!0},computed:{elements:({target:e},t)=>Nt(e,t)},observe:dn({target:({$el:e,elements:t})=>t.reduce(((e,t)=>e.concat(t,...t.children)),[e])}),events:{name:"loadingdone",el:()=>document.fonts,handler(){this.$emit("resize")}},update:{read(){return{rows:(this.row?wn(this.elements):[this.elements]).map(js)}},write({rows:e}){for(const{heights:t,elements:r}of e)r.forEach(((e,r)=>st(e,"minHeight",t[r])))},events:["resize"]}}
function js(e){if(e.length<2)return{heights:[""],elements:e}
let t=e.map(Ns)
const r=Math.max(...t)
return{heights:e.map(((e,n)=>t[n].toFixed(2)===r.toFixed(2)?"":r)),elements:e}}function Ns(e){const t=z(e.style,["display","minHeight"])
_e(e)||st(e,"display","block","important"),st(e,"minHeight","")
const r=Lt(e).height-qt(e,"height","content-box")
return st(e,t),r}var Ds={args:"target",props:{target:String},data:{target:""},computed:{target:{get:({target:e},t)=>Ne(e,t),observe:({target:e})=>e}},observe:dn({target:({target:e})=>e}),update:{read(){return!!this.target&&{height:this.target.offsetHeight}},write({height:e}){st(this.$el,"minHeight",e)},events:["resize"]}},Is={props:{expand:Boolean,offsetTop:Boolean,offsetBottom:Boolean,min:Number,property:String},data:{expand:!1,offsetTop:!1,offsetBottom:!1,min:0,property:"min-height"},observe:[mn({filter:({expand:e})=>e}),dn({target:({$el:e})=>Tr(e)})],update:{read(){if(!_e(this.$el))return!1
let e=""
const t=qt(this.$el,"height","content-box"),{body:r,scrollingElement:n}=document,i=Sr(this.$el),{height:o}=Mr(i===r?n:i),s=n===i||r===i
...
!0===this.offsetBottom?e+=` - ${Lt(this.$el.nextElementSibling).height}px`:O(this.offsetBottom)?e+=` - ${this.offsetBottom}vh`:this.offsetBottom&&u(this.offsetBottom,"px")?e+=` - ${R(this.offsetBottom)}px`:C(this.offsetBottom)&&(e+=` - ${Lt(Ne(this.offsetBottom,this.$el)).height}px`)}return e+=(t?` - ${t}px`:"")+")",{minHeight:e}},write({minHeight:e}){st(this.$el,this.property,`max(${this.min||0}px, ${e})`)},events:["resize"]}},Ls='<svg width="20" height="20" viewBox="0 0 20 20"><circle fill="none" stroke="#000" stroke-width="1.1" cx="9" cy="9" r="7"/><path fill="none" stroke="#000" stroke-width="1.1" d="M14,14 L18,18 L14,14 Z"/></svg>',$s={args:"src",props:{width:Number,height:Number,ratio:Number},data:{ratio:1},connected(){this.svg=this.getSvg().then((e=>{if(!this._connected)return
const t=function(e,t){if(ye(t)||vt(t,"canvas")){t.hidden=!0
const r=t.nextElementSibling
return Fs(e,r)?r:Et(t,e)}const r=t.lastElementChild
return Fs(e,r)?r:_t(t,e)}(e,this.$el)
return this.svgEl&&t!==this.svgEl&&kt(this.svgEl),Bs.call(this,t,e),this.svgEl=t}),q)},disconnected(){this.svg.then((e=>{this._connected||(ye(this.$el)&&(this.$el.hidden=!1),kt(e),this.svgEl=null)})),this.svg=null},methods:{async getSvg(){}}}
function Fs(e,t){return vt(e,"svg")&&vt(t,"svg")&&e.innerHTML===t.innerHTML}function Bs(e,t){const r=["width","height"]
let n=r.map((e=>this[e]))
n.some((e=>e))||(n=r.map((e=>ie(t,e))))
const i=ie(t,"viewBox")
i&&!n.some((e=>e))&&(n=i.split(" ").slice(2)),n.forEach(((t,n)=>ie(e,r[n],R(t)*this.ratio||null)))}function Hs(e,t){return t&&c(e,"<symbol")&&(e=Us(e)[t]||e),j(Mt(e)).filter(_)[0]}const zs=/<symbol([^]*?id=(['"])(.+?)\2[^]*?<\/)symbol>/g,Us=K((function(e){const t={}
let r
for(zs.lastIndex=0;r=zs.exec(e);)t[r[3]]=`<svg ${r[1]}svg>`
return t})),qs={spinner:'<svg width="30" height="30" viewBox="0 0 30 30"><circle fill="none" stroke="#000" cx="15" cy="15" r="14"/></svg>',totop:'<svg width="18" height="10" viewBox="0 0 18 10"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 9 9 1 17 9"/></svg>',marker:'<svg width="20" height="20" viewBox="0 0 20 20"><rect width="1" height="11" x="9" y="4"/><rect width="11" height="1" x="4" y="9"/></svg>',"close-icon":'<svg width="14" height="14" viewBox="0 0 14 14"><line fill="none" stroke="#000" stroke-width="1.1" x1="1" y1="1" x2="13" y2="13"/><line fill="none" stroke="#000" stroke-width="1.1" x1="13" y1="1" x2="1" y2="13"/></svg>',"close-large":'<svg width="20" height="20" viewBox="0 0 20 20"><line fill="none" stroke="#000" stroke-width="1.4" x1="1" y1="1" x2="19" y2="19"/><line fill="none" stroke="#000" stroke-width="1.4" x1="19" y1="1" x2="1" y2="19"/></svg>',"drop-parent-icon":'<svg width="12" height="12" viewBox="0 0 12 12"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 3.5 6 8.5 11 3.5"/></svg>',"nav-parent-icon":'<svg width="12" height="12" viewBox="0 0 12 12"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 3.5 6 8.5 11 3.5"/></svg>',"nav-parent-icon-large":'<svg width="14" height="14" viewBox="0 0 14 14"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 4 7 10 13 4"/></svg>',"navbar-parent-icon":'<svg width="12" height="12" viewBox="0 0 12 12"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 3.5 6 8.5 11 3.5"/></svg>',"navbar-toggle-icon":'<svg width="20" height="20" viewBox="0 0 20 20"><style>.uk-navbar-toggle-icon svg&gt;[class*=&quot;line-&quot;]{transition:0.2s ease-in-out;transition-property:transform, opacity;transform-origin:center;opacity:1}.uk-navbar-toggle-icon svg&gt;.line-3{opacity:0}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-3{opacity:1}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-2{transform:rotate(45deg)}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-3{transform:rotate(-45deg)}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-1,.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-4{opacity:0}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-1{transform:translateY(6px) scaleX(0)}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-4{transform:translateY(-6px) scaleX(0)}</style><rect width="20" height="2" y="3" class="line-1"/><rect width="20" height="2" y="9" class="line-2"/><rect width="20" height="2" y="9" class="line-3"/><rect width="20" height="2" y="15" class="line-4"/></svg>',"overlay-icon":'<svg width="40" height="40" viewBox="0 0 40 40"><rect width="1" height="40" x="19" y="0"/><rect width="40" height="1" x="0" y="19"/></svg>',"pagination-next":'<svg width="7" height="12" viewBox="0 0 7 12"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 1 6 6 1 11"/></svg>',"pagination-previous":'<svg width="7" height="12" viewBox="0 0 7 12"><polyline fill="none" stroke="#000" stroke-width="1.2" points="6 1 1 6 6 11"/></svg>',"search-icon":Ls,"search-medium":'<svg width="24" height="24" viewBox="0 0 24 24"><circle fill="none" stroke="#000" stroke-width="1.1" cx="10.5" cy="10.5" r="9.5"/><line fill="none" stroke="#000" stroke-width="1.1" x1="23" y1="23" x2="17" y2="17"/></svg>',"search-large":'<svg width="40" height="40" viewBox="0 0 40 40"><circle fill="none" stroke="#000" stroke-width="1.8" cx="17.5" cy="17.5" r="16.5"/><line fill="none" stroke="#000" stroke-width="1.8" x1="38" y1="39" x2="29" y2="30"/></svg>',"search-toggle-icon":Ls,"slidenav-next":'<svg width="14" height="24" viewBox="0 0 14 24"><polyline fill="none" stroke="#000" stroke-width="1.4" points="1.225,23 12.775,12 1.225,1"/></svg>',"slidenav-next-large":'<svg width="25" height="40" viewBox="0 0 25 40"><polyline fill="none" stroke="#000" stroke-width="2" points="4.002,38.547 22.527,20.024 4,1.5"/></svg>',"slidenav-previous":'<svg width="14" height="24" viewBox="0 0 14 24"><polyline fill="none" stroke="#000" stroke-width="1.4" points="12.775,1 1.225,12 12.775,23"/></svg>',"slidenav-previous-large":'<svg width="25" height="40" viewBox="0 0 25 40"><polyline fill="none" stroke="#000" stroke-width="2" points="20.527,1.5 2,20.024 20.525,38.547"/></svg>'},Vs={install:function(e){e.icon.add=(t,r)=>{const n=C(t)?{[t]:r}:t
$(n,((e,t)=>{qs[t]=e,delete ia[t]})),e._initialized&&At(document.body,(t=>$(e.getComponents(t),(e=>{e.$options.isIcon&&e.icon in n&&e.$reset()}))))}},mixins:[$s],args:"icon",props:{icon:String},isIcon:!0,beforeConnect(){X(this.$el,"uk-icon")},methods:{async getSvg(){const e=function(e){if(e=oa[e]||e,!qs[e])return null
ia[e]||(ia[e]=Hs(qs[function(e){return ue?I(I(e,"left","right"),"previous","next"):e}(e)]||qs[e]))
return ia[e].cloneNode(!0)}(this.icon)
if(!e)throw"Icon not found."
return e}}},Ws={args:!1,extends:Vs,data:e=>({icon:i(e.constructor.options.name)}),beforeConnect(){X(this.$el,this.$options.id)}},Ys={extends:Ws,beforeConnect(){const e=this.$props.icon
this.icon=this.$el.closest(".uk-nav-primary")?`${e}-large`:e}},Gs={extends:Ws,mixins:[yi],i18n:{toggle:"Open Search",submit:"Submit Search"},beforeConnect(){const e=te(this.$el,"uk-search-toggle")||te(this.$el,"uk-navbar-toggle")
...
if(e){ie(e,"aria-label",this.t("submit"))}}}},Qs={extends:Ws,beforeConnect(){ie(this.$el,"role","status")},methods:{async getSvg(){const e=await Vs.methods.getSvg.call(this)
return 1!==this.ratio&&st(jt("circle",e),"strokeWidth",1/this.ratio),e}}},Zs={extends:Ws,mixins:[yi],beforeConnect(){const e=this.$el.closest("a,button")
ie(e,"role",null!==this.role&&vt(e,"a")?"button":this.role)
const t=this.t("label")
t&&!oe(e,"aria-label")&&ie(e,"aria-label",t)}},Ks={extends:Zs,beforeConnect(){X(this.$el,"uk-slidenav")
const e=this.$props.icon
this.icon=te(this.$el,"uk-slidenav-large")?`${e}-large`:e}},Xs={extends:Zs,i18n:{label:"Open menu"}},Js={extends:Zs,i18n:{label:"Close"},beforeConnect(){this.icon="close-"+(te(this.$el,"uk-close-large")?"large":"icon")}},ea={extends:Zs,i18n:{label:"Open"}},ta={extends:Zs,i18n:{label:"Back to top"}},ra={extends:Zs,i18n:{label:"Next page"},data:{role:null}},na={extends:Zs,i18n:{label:"Previous page"},data:{role:null}},ia={}
const oa={twitter:"x"}
var sa={props:{target:String,selActive:String},data:{target:!1,selActive:!1},computed:{target:({target:e},t)=>e?Nt(e,t):t},observe:[hn({handler(e){this.isIntersecting=e.some((({isIntersecting:e})=>e)),this.$emit()},target:({target:e})=>e,args:{intersecting:!1}}),pn({target:({target:e})=>e,options:{attributes:!0,attributeFilter:["class"],attributeOldValue:!0}}),{target:({target:e})=>e,observe:(e,t)=>{const r=cr([...j(e),document.documentElement],t),n=[Ge(document,"scroll itemshown itemhidden",t,{passive:!0,capture:!0}),Ge(document,"show hide transitionstart",(e=>(t(),r.observe(e.target)))),Ge(document,"shown hidden transitionend transitioncancel",(e=>(t(),r.unobserve(e.target))))]
...
for(const e of j(this.target)){let t=!this.selActive||Se(e,this.selActive)?aa(e):""
!1!==t&&ee(e,"uk-light uk-dark",t)}}}}
function aa(e){const t=Lt(e),r=Lt(window)
if(!V(t,r))return!1
...
for(const r of t){if(e.contains(r)||!la(r)||r.closest('[class*="-leave"]')&&t.some((e=>r!==e&&Se(e,'[class*="-enter"]'))))continue
const n=st(r,"--uk-inverse")
if(n){if(n===a)return`uk-${n}`
a=n
break}}}return a?`uk-${a}`:""}function la(e){if("visible"!==st(e,"visibility"))return!1
for(;e;){if("0"===st(e,"opacity"))return!1
e=Oe(e)}return!0}var ua={mixins:[Xr,go],props:{fill:String},data:{fill:"",clsWrapper:"uk-leader-fill",clsHide:"uk-leader-hide",attrFill:"data-fill"},computed:{fill:({fill:e},t)=>e||st(t,"--uk-leader-fill-content")},connected(){[this.wrapper]=Tt(this.$el,`<span class="${this.clsWrapper}">`)},disconnected(){St(this.wrapper.childNodes)},observe:dn(),update:{read(){return{width:Math.trunc(this.$el.offsetWidth/2),fill:this.fill,hide:!this.matchMedia}},write({width:e,fill:t,hide:r}){re(this.wrapper,this.clsHide,r),ie(this.wrapper,this.attrFill,new Array(e).join(t))},events:["resize"]}},ca={install:function({modal:e}){function t(t,r,n=q,i=q){r={bgClose:!1,escClose:!0,...r,i18n:{...e.i18n,...null==r?void 0:r.i18n}}
...
return s.value=r||"",Ge(o,"show",(()=>s.select())),i},e.i18n={ok:"Ok",cancel:"Cancel"}},mixins:[ui],data:{clsPage:"uk-modal-page",selPanel:".uk-modal-dialog",selClose:'[class*="uk-modal-close"]'},events:[{name:"fullscreenchange webkitendfullscreen",capture:!0,handler(e){vt(e.target,"video")&&this.isToggled()&&!document.fullscreenElement&&this.hide()}},{name:"show",self:!0,handler(){te(this.panel,"uk-margin-auto-vertical")?X(this.$el,"uk-flex"):st(this.$el,"display","block"),Ht(this.$el)}},{name:"hidden",self:!0,handler(){st(this.$el,"display",""),J(this.$el,"uk-flex")}}]}
var da={extends:hs,data:{targets:"> .uk-parent",toggle:"> a",content:"> ul"}}
const ha="uk-navbar-transparent"
var pa={extends:Os,props:{dropbarTransparentMode:Boolean},data:{clsDrop:"uk-navbar-dropdown",selNavItem:".uk-navbar-nav > li > a,a.uk-navbar-item,button.uk-navbar-item,.uk-navbar-item a,.uk-navbar-item button,.uk-navbar-toggle",dropbarTransparentMode:!1},computed:{navbarContainer:(e,t)=>t.closest(".uk-navbar-container")},watch:{items(){const e=te(this.$el,"uk-navbar-justify"),t=Nt(".uk-navbar-nav, .uk-navbar-left, .uk-navbar-right",this.$el)
for(const r of t){st(r,"flexGrow",e?Nt(".uk-navbar-nav > li > a, .uk-navbar-item, .uk-navbar-toggle",r).length:"")}}},events:[{name:"show",el:({dropContainer:e})=>e,handler({target:e}){"remove"===this.getTransparentMode(e)&&te(this.navbarContainer,ha)&&(J(this.navbarContainer,ha),this._transparent=!0)}},{name:"hide",el:({dropContainer:e})=>e,async handler(){await new Promise((e=>setTimeout(e))),!this._transparent||ys&&this.dropContainer.contains(ys.$el)||(X(this.navbarContainer,ha),this._transparent=null)}}],methods:{getTransparentMode(e){if(!this.navbarContainer)return
...
var fa={mixins:[ui],args:"mode",props:{mode:String,flip:Boolean,overlay:Boolean,swiping:Boolean},data:{mode:"slide",flip:!1,overlay:!1,clsPage:"uk-offcanvas-page",clsContainer:"uk-offcanvas-container",selPanel:".uk-offcanvas-bar",clsFlip:"uk-offcanvas-flip",clsContainerAnimation:"uk-offcanvas-container-animation",clsSidebarAnimation:"uk-offcanvas-bar-animation",clsMode:"uk-offcanvas",clsOverlay:"uk-offcanvas-overlay",selClose:".uk-offcanvas-close",container:!1,swiping:!0},computed:{clsFlip:({flip:e,clsFlip:t})=>e?t:"",clsOverlay:({overlay:e,clsOverlay:t})=>e?t:"",clsMode:({mode:e,clsMode:t})=>`${t}-${e}`,clsSidebarAnimation:({mode:e,clsSidebarAnimation:t})=>"none"===e||"reveal"===e?"":t,clsContainerAnimation:({mode:e,clsContainerAnimation:t})=>"push"!==e&&"reveal"!==e?"":t,transitionElement({mode:e}){return"reveal"===e?Oe(this.panel):this.panel}},observe:vn({filter:({swiping:e})=>e}),update:{read(){this.isToggled()&&!_e(this.$el)&&this.hide()},events:["resize"]},events:[{name:"touchmove",self:!0,passive:!1,filter:({overlay:e})=>e,handler(e){e.cancelable&&e.preventDefault()}},{name:"show",self:!0,handler(){"reveal"!==this.mode||te(Oe(this.panel),this.clsMode)||X(Ot(this.panel,"<div>"),this.clsMode)
const{body:e,scrollingElement:t}=document
X(e,this.clsContainer,this.clsFlip),st(e,"touchAction","pan-y pinch-zoom"),st(this.$el,"display","block"),st(this.panel,"maxWidth",t.clientWidth),X(this.$el,this.clsOverlay),X(this.panel,this.clsSidebarAnimation,"reveal"===this.mode?"":this.clsMode),Ht(e),X(e,this.clsContainerAnimation),this.clsContainerAnimation&&(ma().content+=",user-scalable=0")}},{name:"hide",self:!0,handler(){J(document.body,this.clsContainerAnimation),st(document.body,"touchAction","")}},{name:"hidden",self:!0,handler(){this.clsContainerAnimation&&function(){const e=ma()
e.content=e.content.replace(/,user-scalable=0$/,"")}(),"reveal"===this.mode&&te(Oe(this.panel),this.clsMode)&&St(this.panel),J(this.panel,this.clsSidebarAnimation,this.clsMode),J(this.$el,this.clsOverlay),st(this.$el,"display",""),st(this.panel,"maxWidth",""),J(document.body,this.clsContainer,this.clsFlip)}},{name:"swipeLeft swipeRight",handler(e){this.isToggled()&&u(e.type,"Left")^this.flip&&this.hide()}}]}
function ma(){return jt('meta[name="viewport"]',document.head)||_t(document.head,'<meta name="viewport">')}var ga={mixins:[Xr],props:{selContainer:String,selContent:String,minHeight:Number},data:{selContainer:".uk-modal",selContent:".uk-modal-dialog",minHeight:150},computed:{container:({selContainer:e},t)=>t.closest(e),content:({selContent:e},t)=>t.closest(e)},observe:dn({target:({container:e,content:t})=>[e,t]}),update:{read(){return!!(this.content&&this.container&&_e(this.$el))&&{max:Math.max(this.minHeight,Ht(this.container)-(Lt(this.content).height-Ht(this.$el)))}},write({max:e}){st(this.$el,{minHeight:this.minHeight,maxHeight:e})},events:["resize"]}},va={props:["width","height"],connected(){X(this.$el,"uk-responsive-width"),st(this.$el,"aspectRatio",`${this.width}/${this.height}`)}},ba={props:{offset:Number},data:{offset:0},connected(){(function(e){ya.size||Ge(document,"click",wa)
ya.add(e)})(this)},disconnected(){var e
e=this,ya.delete(e),ya.size||Qe(document,"click",wa)},methods:{async scrollTo(e){e=e&&jt(e)||document.body,Ke(this.$el,"beforescroll",[this,e])&&(await kr(e,{offset:this.offset}),Ke(this.$el,"scrolled",[this,e]))}}}
const ya=new Set
function wa(e){if(!e.defaultPrevented)for(const t of ya)t.$el.contains(e.target)&&Ae(t.$el)&&(e.preventDefault(),window.location.href!==t.$el.href&&window.history.pushState({},"",t.$el.href),t.scrollTo(je(t.$el)))}const _a="uk-scrollspy-inview"
var xa={args:"cls",props:{cls:String,target:String,hidden:Boolean,margin:String,repeat:Boolean,delay:Number},data:()=>({cls:"",target:!1,hidden:!0,margin:"-1px",repeat:!1,delay:0}),computed:{elements:({target:e},t)=>e?Nt(e,t):[t]},watch:{elements(e){this.hidden&&st(Te(e,`:not(.${_a})`),"opacity",0)}},connected(){this.elementData=new Map},disconnected(){for(const[e,t]of this.elementData.entries())J(e,_a,(null==t?void 0:t.cls)||"")
delete this.elementData},observe:hn({target:({elements:e})=>e,handler(e){const t=this.elementData
...
if(!i)return
let o
if(null==(n=i.off)||n.call(i),st(e,"opacity",!t&&this.hidden?0:""),re(e,_a,t),re(e,i.cls),o=i.cls.match(/\buk-animation-[\w-]+/g)){const r=()=>J(e,o)
t?i.off=Ze(e,"animationcancel animationend",r,{self:!0}):r()}Ke(e,t?"inview":"outview"),i.inview=t}}},Ea={props:{cls:String,closest:Boolean,scroll:Boolean,target:String,offset:Number},data:{cls:"uk-active",closest:!1,scroll:!1,target:'a[href]:not([role="button"])',offset:0},computed:{links:({target:e},t)=>Nt(e,t).filter((e=>Ae(e))),elements({closest:e}){return this.links.map((t=>t.closest(e||"*")))}},watch:{links(e){this.scroll&&this.$create("scroll",e,{offset:this.offset})}},observe:[hn(),gn()],update:[{read(){const e=this.links.map((e=>je(e))).filter(Boolean),{length:t}=e
if(!t||!_e(this.$el))return!1
const r=Sr(e,!0),{scrollTop:n,scrollHeight:i}=r,o=Mr(r)
let s=!1
if(n>=i-o.height)s=t-1
else{const t=this.offset+Lt(Rr()).height+.1*o.height
...
t&&Ke(this.$el,"active",[e,this.elements[e]])},events:["scroll","resize"]}]},Ca={mixins:[Xr,go],props:{position:String,top:null,bottom:null,start:null,end:null,offset:String,offsetEnd:String,overflowFlip:Boolean,animation:String,clsActive:String,clsInactive:String,clsFixed:String,clsBelow:String,selTarget:String,showOnUp:Boolean,targetOffset:Number},data:{position:"top",top:!1,bottom:!1,start:!1,end:!1,offset:0,offsetEnd:0,overflowFlip:!1,animation:"",clsActive:"uk-active",clsInactive:"",clsFixed:"uk-sticky-fixed",clsBelow:"uk-sticky-below",selTarget:"",showOnUp:!1,targetOffset:!1},computed:{target:({selTarget:e},t)=>e&&jt(e,t)||t},connected(){this.start=Oa(this.start||this.top),this.end=Oa(this.end||this.bottom),this.placeholder=jt("+ .uk-sticky-placeholder",this.$el)||jt('<div class="uk-sticky-placeholder"></div>'),this.isFixed=!1,this.setActive(!1)},beforeDisconnect(){this.isFixed&&(this.hide(),J(this.target,this.clsInactive)),Ta(this.$el),kt(this.placeholder),this.placeholder=null},observe:[mn(),gn({target:()=>document.scrollingElement}),dn({target:({$el:e})=>[e,Ma(e),document.scrollingElement],handler(e){this.$emit(this._data.resized&&e.some((({target:e})=>e===Ma(this.$el)))?"update":"resize"),this._data.resized=!0}})],events:[{name:"load hashchange popstate",el:()=>window,filter:({targetOffset:e})=>!1!==e,handler(){const{scrollingElement:e}=document
...
const o=Ht(window),s=Math.max(0,document.scrollingElement.scrollHeight-o)
if(!s)return void(this.inactive=!0)
const a=this.isFixed&&i.has("update")
a&&(Pa(this.target),this.hide()),this.active||(({height:e,width:t}=Lt(this.$el)),r=st(this.$el,"margin")),a&&this.show()
const l=Wt("100vh","height")
let u=this.position
this.overflowFlip&&e>l&&(u="top"===u?"bottom":"top")
const c=this.isFixed?this.placeholder:this.$el
let[d,h]=[this.offset,this.offsetEnd].map((e=>Wt(e,"height",n?this.$el:c)))
"bottom"===u&&(e<o||this.overflowFlip)&&(d+=o-e)
const p=e+d+h,f=this.overflowFlip?0:Math.max(0,p-l),m=$t(c).top-new DOMMatrix(st(c,"transform")).m42,g=Lt(this.$el).height,v=(!1===this.start?m:ka(this.start,this.$el,m))-d,b=!1===this.end?s:Math.min(s,ka(this.end,this.$el,m+e,!0)-g-d+f)
return n=!this.showOnUp&&v+d===m&&b===Math.min(s,ka(!0,this.$el,0,!0)-g-d+f)&&"hidden"!==st(Ma(this.$el),"overflowY"),{start:v,end:b,offset:d,overflow:f,height:e,elHeight:g,width:t,margin:r,top:Bt(c)[0],sticky:n,viewport:l,maxScrollHeight:s}},write({height:e,width:t,margin:r,offset:n,sticky:i}){if((this.inactive||i||!this.isFixed)&&Ta(this.$el),this.inactive)return
...
gt.out(this.$el,this.animation).then((()=>this.hide()),q)}else this.hide()}else this.isFixed?this.update():this.animation&&c?(this.show(),gt.in(this.$el,this.animation).catch(q)):(Pa(this.target),this.show())},events:["resize","resizeViewport","scroll"]}],methods:{show(){this.isFixed=!0,this.update(),this.placeholder.hidden=!1},hide(){const{offset:e,sticky:t}=this._data
...
this.active=e,e?(ee(this.target,this.clsInactive,this.clsActive),t!==e&&Ke(this.$el,"active")):(ee(this.target,this.clsActive,this.clsInactive),t!==e&&(Pa(this.target),Ke(this.$el,"inactive")))}}}
function ka(e,t,r,n){if(!e)return 0
if(O(e)||C(e)&&e.match(/^-?\d/))return r+Wt(e,"height",t,!0)
{const r=!0===e?Ma(t):Ne(e,t)
return $t(r).bottom-(n&&(null==r?void 0:r.contains(t))?R(st(r,"paddingBottom"))+R(st(r,"borderBottomWidth")):0)}}function Oa(e){return"true"===e||"false"!==e&&e}function Ta(e){st(e,{position:"",top:"",marginTop:"",width:""})}const Sa="uk-transition-disable"
function Pa(e){te(e,Sa)||(X(e,Sa),requestAnimationFrame((()=>J(e,Sa))))}function Ma(e){for(;e=Oe(e);)if(_e(e))return e}var Ra={mixins:[$s],args:"src",props:{src:String,icon:String,attributes:"list",strokeAnimation:Boolean},data:{strokeAnimation:!1},observe:[pn({async handler(){const e=await this.svg
e&&Aa.call(this,e)},options:{attributes:!0,attributeFilter:["id","class","style"]}})],async connected(){c(this.src,"#")&&([this.src,this.icon]=this.src.split("#",2))
const e=await this.svg
e&&(Aa.call(this,e),this.strokeAnimation&&function(e){const t=vo(e)
t&&st(e,"--uk-animation-stroke",t)}(e))},methods:{async getSvg(){return vt(this.$el,"img")&&!this.$el.complete&&"lazy"===this.$el.loading&&await new Promise((e=>Ze(this.$el,"load",e))),Hs(await ja(this.src),this.icon)||Promise.reject("SVG not found.")}}}
function Aa(e){const{$el:t}=this
...
ie(r,"role","tab"),n&&(r.id=Xi(this,r),n.id=Xi(this,n),ie(r,"aria-controls",n.id),ie(n,{role:"tabpanel","aria-labelledby":r.id}))}ie(this.$el,"aria-orientation",Se(this.$el,this.selVertical)?"vertical":null)},methods:{index(){return d(this.children,(e=>te(e,this.cls)))},show(e){const t=this.toggles.filter((e=>!Se(e,Na))),r=this.index(),n=Z(!w(e)||c(t,e)?e:0,t,Z(this.toggles[r],t)),i=Z(t[n],this.toggles)
...
return $(Object.freeze({__proto__:null,Accordion:hs,Alert:fs,Close:Js,Cover:vs,Drop:ws,DropParentIcon:Ws,Dropdown:ws,Dropnav:Os,FormCustom:Ss,Grid:Ps,HeightMatch:As,HeightPlaceholder:Ds,HeightViewport:Is,Icon:Vs,Img:Yn,Inverse:sa,Leader:ua,Margin:yn,Marker:ea,Modal:ca,Nav:da,NavParentIcon:Ys,Navbar:pa,NavbarParentIcon:Ws,NavbarToggleIcon:Xs,Offcanvas:fa,OverflowAuto:ga,OverlayIcon:Ws,PaginationNext:ra,PaginationPrevious:na,Responsive:va,Scroll:ba,Scrollspy:xa,ScrollspyNav:Ea,SearchIcon:Gs,SlidenavNext:Ks,SlidenavPrevious:Ks,Spinner:Qs,Sticky:Ca,Svg:Ra,Switcher:Da,Tab:Ia,Toggle:La,Totop:ta,Video:gs}),((e,t)=>zi.component(t,e))),function(e){le&&window.MutationObserver&&(document.body?requestAnimationFrame((()=>as(e))):new MutationObserver(((t,r)=>{document.body&&(as(e),r.disconnect())})).observe(document.documentElement,{childList:!0}))}(zi),$(ss,((e,t)=>zi.component(t,e))),zi})),/*! UIkit 3.23.5 | https://www.getuikit.com | (c) 2014 - 2025 YOOtheme | MIT License */
...
"v"===e&&f>=50&&f<=o?(d(u,{height:f+"px"}),l.options.boundary.height+=p,d(l.elements.boundary,{height:l.options.boundary.height+"px"}),l.options.viewport.height+=p,d(l.elements.viewport,{height:l.options.viewport.height+"px"})):"h"===e&&m>=50&&m<=i&&(d(u,{width:m+"px"}),l.options.boundary.width+=h,d(l.elements.boundary,{width:l.options.boundary.width+"px"}),l.options.viewport.width+=h,d(l.elements.viewport,{width:l.options.viewport.width+"px"})),M.call(l),F.call(l),S.call(l),I.call(l),n=a,t=s}function m(){c=!1,window.removeEventListener("mousemove",f),window.removeEventListener("touchmove",f),window.removeEventListener("mouseup",m),window.removeEventListener("touchend",m),document.body.style[r]=""}h(u,"cr-resizer"),d(u,{width:this.options.viewport.width+"px",height:this.options.viewport.height+"px"}),this.options.resizeControls.height&&(h(s=document.createElement("div"),"cr-resizer-vertical"),u.appendChild(s)),this.options.resizeControls.width&&(h(a=document.createElement("div"),"cr-resizer-horisontal"),u.appendChild(a)),s&&(s.addEventListener("mousedown",p),s.addEventListener("touchstart",p)),a&&(a.addEventListener("mousedown",p),a.addEventListener("touchstart",p)),this.elements.boundary.appendChild(u)}function C(e){if(this.options.enableZoom){var t=this.elements.zoomer,r=Q(e,4)
