...
var A=g,j=s;(function(){var t,n,o,s,l,u,d,h,f,m,g=j,v=x.expando,b=0,y=0,w=ee(),_=ee(),E=ee(),M=ee(),R=function(e,t){return e===t&&(l=!0),0},N="checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",I="(?:\\\\[\\da-fA-F]{1,6}"+S+"?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+",D="\\["+S+"*("+I+")(?:"+S+"*([*^$|!~]?=)"+S+"*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|("+I+"))|)"+S+"*\\]",L=":("+I+")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|"+D+")*)|.*)\\)|)",$=new RegExp(S+"+","g"),F=new RegExp("^"+S+"*,"+S+"*"),B=new RegExp("^"+S+"*([>+~]|"+S+")"+S+"*"),H=new RegExp(S+"|>"),z=new RegExp(L),U=new RegExp("^"+I+"$"),q={ID:new RegExp("^#("+I+")"),CLASS:new RegExp("^\\.("+I+")"),TAG:new RegExp("^("+I+"|[*])"),ATTR:new RegExp("^"+D),PSEUDO:new RegExp("^"+L),CHILD:new RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\("+S+"*(even|odd|(([+-]|)(\\d*)n|)"+S+"*(?:([+-]|)"+S+"*(\\d+)|))"+S+"*\\)|)","i"),bool:new RegExp("^(?:"+N+")$","i"),needsContext:new RegExp("^"+S+"*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\("+S+"*((?:-\\d)?\\d*)"+S+"*\\)|)(?=[^-]|$)","i")},V=/^(?:input|select|textarea|button)$/i,W=/^h\d$/i,Y=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,G=/[+~]/,Q=new RegExp("\\\\[\\da-fA-F]{1,6}"+S+"?|\\\\([^\\r\\n\\f])","g"),Z=function(e,t){var r="0x"+e.slice(1)-65536
...
return r},D=x.expr.match.needsContext,L=/^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i
...
return n>1?x.uniqueSort(r):r},filter:function(e){return this.pushStack($(this,e||[],!1))},not:function(e){return this.pushStack($(this,e||[],!0))},is:function(e){return!!$(this,"string"==typeof e&&D.test(e)?x(e):e||[],!1).length}})
...
var Ie=/<script|<style|<link/i,De=/checked\s*(?:[^=]|=\s*.checked.)/i,Le=/^\s*<!\[CDATA\[|\]\]>\s*$/g
...
if(v||h>1&&"string"==typeof g&&!p.checkClone&&De.test(g))return e.each(function(i){var o=e.eq(i)
...
if("string"==typeof e&&!Ie.test(e)&&!ke[(Ee.exec(e)||["",""])[1].toLowerCase()]){e=x.htmlPrefilter(e)
...
if(Array.isArray(t))x.each(t,function(t,i){r||Rt.test(e)?n(e,i):It(e+"["+("object"==typeof i&&null!=i?t:"")+"]",i,r,n)})
...
var I={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;","`":"&#x60;","=":"&#x3D;"},D=/[&<>"'`=]/,L=/[&<>"'`=]/g
function $(e){return I[e]}function F(e){return null==e?e="":"string"!=typeof e&&(e=String(e)),new N(e)}function B(e){return null!==e&&"object"==typeof e&&"function"==typeof e.toHTML}function H(e,t){return"attrs"===t[0]&&(t.shift(),1===t.length)?(0,a.childRefFor)(e,t[0]):(0,a.childRefFromParts)(e,t)}function z(e){var t=e.indexOf(":")
if(-1===t)return[e,e,!0]
...
return t?(0,a.valueForRef)(t):void 0}toString(){return`<${this.constructor.toString()}:${(0,h.guidFor)(this)}>`}}function je(e){e.remove()}class Ne{constructor(e){this.instance=e}}class Ie{constructor(e,t){this.ModifierClass=e,this.name=t}create(e,t,r,n){var{ModifierClass:i}=this,o=new i(e,t,n)
...
return t||De}isSupportedArgument(e){return!1}onUnsupportedArgument(e){}toString(){return`<${this.constructor}:${(0,h.guidFor)(this)}>`}}var Be=new WeakMap
...
return e.forEach(e=>t.push(e)),this.from(t)}valueFor(e){return this.array[e]}}class Lt extends It{constructor(e){super(e.length),this.array=e}static from(e){return e.length>0?new this(e):null}valueFor(e){return(0,n.objectAt)(this.array,e)}}class $t extends It{constructor(e,t){super(t.length),this.keys=e,this.values=t}static fromIndexable(e){var t=Object.keys(e),{length:r}=t
if(0===r)return null
...
return e.forEach(function(e,o){(i=i||arguments.length>=2)&&t.push(o),r.push(e),n++}),0===n?null:i?new this(t,r):new Dt(r)}valueFor(e){return this.values[e]}memoFor(e){return this.keys[e]}}class Ft{constructor(e,t){this.iterable=e,this.result=t,this.position=0}static from(e){var t=e[Symbol.iterator](),r=t.next(),{done:n}=r
...
function jr(e){return null==e}function Nr(e){return!jr(e)}function Ir(e){return"object"==typeof e&&null!==e&&!0===e.isQueryParams}(0,i.debugFreeze)(Rr),(0,i.debugFreeze)(Ar)
class Dr extends Fe{constructor(){super(...arguments),this.modernized=this.shouldModernize(),this.currentRouteCache=(0,l.createCache)(()=>((0,l.consumeTag)((0,l.tagFor)(this.routing,"currentState")),(0,l.untrack)(()=>this.routing.currentRouteName)))}static toString(){return"LinkTo"}validateArguments(){super.validateArguments()}get class(){var e="ember-view"
...
return a.isActiveForRoute(o,s,i,e)}preventDefault(e){e.preventDefault()}shouldModernize(){return Boolean(!0)&&!1===_e._wasReopened&&!1===b.TargetActionSupport._wasReopened&&!1===Me._wasReopened}isSupportedArgument(e){return-1!==["route","model","models","query","replace","disabled","current-when","activeClass","loadingClass","disabledClass"].indexOf(e)||super.isSupportedArgument(e)}}Mr([(0,_.inject)("-routing")],Dr.prototype,"routing",void 0),Mr([x.action],Dr.prototype,"click",null)
var{prototype:Lr}=Dr,$r=(e,t)=>e?Object.getOwnPropertyDescriptor(e,t)||$r(Object.getPrototypeOf(e),t):null
qe(Dr),Ve(Dr,["id",["id","elementId"],"class",["class","classNames"],["role","ariaRole"],"title","rel","tabindex","target"]),We(Dr)
...
return Ir(t)?null!==(e=t.values)&&void 0!==e?e:Ar:t}var r=Wr.call(this)
...
Object.defineProperty(Lr,"onUnsupportedArgument",{configurable:!0,enumerable:!1,value:function(e){"params"!==e&&Zr.call(this,e)}}),o.JQUERY_INTEGRATION&&Ze(Dr)
var Kr=He(Dr,Pr),Xr=Ct(function(e){return s.loc.apply(null,e)}),Jr=(0,r.templateFactory)({id:"3jT+eJpe",block:'[[[46,[28,[37,1],null,null],null,null,null]],[],false,["component","-outlet"]]',moduleName:"packages/@ember/-internals/glimmer/lib/templates/outlet.hbs",isStrictMode:!1}),en="-top-level",tn="main"
...
return U(()=>{for(var r,n=Object.keys(t),i=0;i<n.length;i++)r=n[i],Oe(e,r,t[r])}),t},e.tagForObject=function(e){if((0,r.isObject)(e))return(0,a.tagFor)(e,I)
return a.CONSTANT_TAG},e.tagForProperty=D,e.tracked=yt,e.trySet=function(e,t,r){return Oe(e,t,r,!0)}
var y=":change"
...
return o}function L(e,t){(0,a.dirtyTagFor)(e,t),(0,a.dirtyTagFor)(e,I)}var $=e.PROPERTY_DID_CHANGE=(0,r.enumerableSymbol)("PROPERTY_DID_CHANGE"),F=0
...
function Ye(){if(Ue.unprocessedNamespaces)for(var e=i.context.lookup,t=Object.keys(e),n=0;n<t.length;n++){var o=t[n]
if(Ke(o.charCodeAt(0))){var s=Xe(e,o)
s&&(0,r.setName)(s,o)}}}function Ge(e){Ze([e.toString()],e,new Set)}function Qe(){var e=Ue.unprocessedNamespaces
...
n.add(a),Ze(e,a,n)}}e.length=i}function Ke(e){return e>=65&&e<=90}function Xe(e,t){try{var r=e[t]
return(null!==r&&"object"==typeof r||"function"==typeof r)&&r.isNamespace&&r}catch(n){}}var Je,et=Array.prototype.concat,{isArray:tt}=Array
...
return f._readOnly=n._readOnly,f._volatile=n._volatile,f._meta=n._meta,f.enumerable=n.enumerable,le(f,Pe)}return t}function it(e,t,n,i){if(void 0!==i[e])return t
var o=n[e]
...
"function"==typeof c?(s=!0,o[u]=it(u,c,i,{})):o[u]=c}return s&&(o._super=r.ROOT),o}function at(e,t,r,n,i,o,s){for(var a,l=0;l<e.length;l++)if(a=e[l],pt.has(a)){if(t.hasMixin(a))continue
t.addMixin(a)
var{properties:u,mixins:c}=a
void 0!==u?lt(t,u,r,n,i,o,s):void 0!==c&&(at(c,t,r,n,i,o,s),void 0!==a._without&&a._without.forEach(e=>{var t=o.indexOf(e);-1!==t&&o.splice(t,1)}))}else lt(t,a,r,n,i,o,s)}function lt(e,t,r,n,i,o,s){for(var a=rt("concatenatedProperties",t,n,i),l=rt("mergedProperties",t,n,i),u=Object.keys(t),c=0;c<u.length;c++){var d=u[c],h=t[d]
...
if(m){var g=de(h)
if(void 0!==g){r[d]=nt(d,h,g,r),n[d]=void 0
continue}}a&&a.indexOf(d)>=0||"concatenatedProperties"===d||"mergedProperties"===d?h=ot(d,h,n):l&&l.indexOf(d)>-1?h=st(d,h,n):m&&(h=it(d,h,n,r)),n[d]=h,r[d]=void 0}}}function ut(e,t,n,i){var o=(0,r.observerListenerMetaFor)(n)
if(void 0!==o){var{observers:s,listeners:a}=o
if(void 0!==s)for(var l=i?C:k,u=0;u<s.paths.length;u++)l(e,s.paths[u],null,t,s.sync)
if(void 0!==a)for(var c=i?g:v,d=0;d<a.length;d++)c(e,a[d],null,t)}}function ct(e,n,i=!1){var o=Object.create(null),s=Object.create(null),a=(0,t.meta)(e),l=[],u=[]
e._super=r.ROOT,at(n,a,o,s,e,l,u)
for(var c=0;c<l.length;c++){var d=l[c],h=s[d],f=o[d]
if(p.ALIAS_METHOD)for(;void 0!==h&&ht(h);){var m=Je(e,h,o,s)
f=m.desc,h=m.value}void 0!==h?("function"==typeof h&&ut(e,d,h,!0),ye(e,d,h,-1!==u.indexOf(d),!i)):void 0!==f&&be(e,d,f,a)}return a.isPrototypeMeta(e)||R(e),e}p.ALIAS_METHOD&&(Je=function(e,t,r,n){var i,o=t.methodName,s=r[o],a=n[o]
...
if(pt.has(e))return gt(e,this)
var r=(0,t.peekMeta)(e)
return null!==r&&r.hasMixin(this)}without(...e){var t=new ft([this])
return t._without=e,t}keys(){return vt(this)}toString(){return"(unknown mixin)"}}function mt(e){var t=e&&e.length||0,r=void 0
if(t>0){r=new Array(t)
for(var n=0;n<t;n++){var i=e[n]
pt.has(i)?r[n]=i:r[n]=new ft(void 0,i)}}return r}function gt(e,t,r=new Set){if(r.has(e))return!1
if(r.add(e),e===t)return!0
var n=e.mixins
return!!n&&n.some(e=>gt(e,t,r))}function vt(e,t=new Set,r=new Set){if(!r.has(e)){if(r.add(e),e.properties)for(var n=Object.keys(e.properties),i=0;i<n.length;i++)t.add(n[i])
else e.mixins&&e.mixins.forEach(e=>vt(e,t,r))
return t}}if(e.Mixin=ft,p.ALIAS_METHOD){var bt=new u._WeakSet
ht=e=>bt.has(e),dt=class{constructor(e){this.methodName=e,bt.add(this)}}}function yt(...e){if(!re(e)){var t=e[0],r=t?t.initializer:void 0,n=t?t.value:void 0,i=function(e,t,i,o,s){return wt([e,t,{initializer:r||(()=>n)}])}
return pe(i),i}return wt(e)}function wt([e,n,i]){var{getter:o,setter:s}=(0,a.trackedData)(n,i?i.initializer:void 0)
function l(){var e=o(this)
return(Array.isArray(e)||(0,r.isEmberArray)(e))&&(0,a.consumeTag)((0,a.tagFor)(e,"[]")),e}function u(e){s(this,e),(0,a.dirtyTagFor)(this,I)}var c={enumerable:!0,configurable:!0,isTracked:!0,get:l,set:u}
return ae.add(u),(0,t.meta)(e).writeDescriptors(n,new _t(l,u)),c}p.ALIAS_METHOD&&(e.aliasMethod=function(e){return new dt(e)})
class _t{constructor(e,t){this._get=e,this._set=t,K.add(this)}get(e){return this._get.call(e)}set(e,t,r){this._set.call(e,r)}}e.TrackedDescriptor=_t}),e("@ember/-internals/overrides/index",["exports"],function(e){"use strict"
...
break}var s=i[o]
n+=I(s)+": "+N(e[s],t,r)}return n+=" }"}(e,r+1,n)}function I(e){return j.test(e)?e:M(e)}function D(e,t){var r=e
...
"number"==typeof n&&(n=(0,t.isSmallInt)(n)?(0,t.encodeImmediate)(n):{type:6,value:n}),e(30,n)}function M(e,t,n,i){e(0),C(e,n,i,!1),e(16,t),e(1),e(36,r.$v0)}function R(e,t,n,i){e(0),C(e,t,n,!1),e(33,r.$fp,1),e(107),i?(e(36,r.$v0),i(),e(1),e(34,1)):(e(1),e(34,1),e(36,r.$v0))}function A(e,t,r){C(e,r,null,!0),e(23,t),e(24),e(61),e(64),e(40),e(1)}function j(e,t){(function(e,t){null!==t?e(63,d({parameters:t})):P(e,null)})(e,t&&t[1]),e(62),D(e,t)}function N(e,t){e(0),D(e,t),e(61),e(2),e(1)}function I(e,t,n){var i=t[1],o=i.length,s=Math.min(n,o)
if(0!==s){if(e(0),s){e(39)
for(var a=0;a<s;a++)e(33,r.$fp,n-a),e(19,i[a])}D(e,t),e(61),e(2),s&&e(40),e(1)}else N(e,t)}function D(e,t){null===t?P(e,null):e(28,{type:4,value:t})}function L(e,t,r){var n=[],i=0
...
var A,j,N=["javascript:","vbscript:"],I=["A","BODY","LINK","IMG","IFRAME","BASE","FORM"],D=["EMBED"],L=["href","src","background","action"],$=["src"]
function F(e,t){return-1!==e.indexOf(t)}function B(e,t){return(null===e||F(I,e))&&F(L,t)}function H(e,t){return null!==e&&(F(D,e)&&F($,t))}function z(e,t){return B(e,t)||H(e,t)}if("object"==typeof URL&&null!==URL&&"function"==typeof URL.parse){var U=URL
A=e=>{var t=null
...
return n}function je(e){return e.map(r.valueForRef)}function Ne(e){return{named:Ae(e.named),positional:je(e.positional)}}var Ie=e.EMPTY_NAMED=Object.freeze(Object.create(null)),De=e.EMPTY_POSITIONAL=Ce,Le=e.EMPTY_ARGS=Re(Ie,De)
...
Object.defineProperty(e,"__esModule",{value:!0}),e.VolatileTag=e.VOLATILE_TAG=e.VOLATILE=e.INITIAL=e.CurrentTag=e.CURRENT_TAG=e.CONSTANT_TAG=e.CONSTANT=e.COMPUTE=e.ALLOW_CYCLES=void 0,e.beginTrackFrame=A,e.beginTrackingTransaction=void 0,e.beginUntrackFrame=N,e.bump=function(){l++},e.combine=void 0,e.consumeTag=D,e.createCache=function(e,t){0
var r={[L]:e,[$]:void 0,[F]:void 0,[B]:-1}
0
return r},e.createTag=function(){return new p(0)},e.createUpdatableTag=g,e.dirtyTag=e.deprecateMutationsInTrackingTransaction=void 0,e.dirtyTagFor=O,e.endTrackFrame=j,e.endTrackingTransaction=void 0,e.endUntrackFrame=I,e.getValue=function(e){H(e,"getValue")
var t=e[L],r=e[F],n=e[B]
if(void 0!==r&&d(r,n))D(r)
else{A()
try{e[$]=t()}finally{r=j(),e[F]=r,e[B]=c(r),D(r)}}return e[$]},e.isConst=function(e){H(e,"isConst")
var t=e[F]
...
return D(S(i,e)),n&&!r.has(i)?(o=t.call(i),r.set(i,o)):o=r.get(i),o},setter:function(t,n){O(t,e),r.set(t,n)}}},e.untrack=function(e){N()
...
return M=R.pop()||null,o(e).combine()}function N(){R.push(M),M=null}function I(){M=R.pop()||null}function D(e){null!==M&&M.add(e)}var L=n("FN"),$=n("LAST_VALUE"),F=n("TAG"),B=n("SNAPSHOT")
n("DEBUG_LABEL")
...
return 2===arguments.length?(t=arguments[0],i=arguments[1],e=null):([e,t,n]=v(...arguments),void 0===n?i=0:s(i=n.pop())||(r=!0===i,i=n.pop())),[e,t,n,i=parseInt(i,10),r]}var y=0,w=0,_=0,x=0,E=0,C=0,k=0,O=0,T=0,S=0,P=0,M=0,R=0,A=0,j=0,N=0,I=0,D=0,L=0,$=0,F=0
...
this._platform=r(this._boundAutorunEnd)}get counters(){return{begin:w,end:_,events:{begin:x,end:0},autoruns:{created:D,completed:L},run:E,join:C,defer:k,schedule:O,scheduleIterable:T,deferOnce:S,scheduleOnce:P,setTimeout:M,later:R,throttle:A,debounce:j,cancelTimers:N,cancel:I,loops:{total:$,nested:F}}}get defaultQueue(){return this._defaultQueue}begin(){w++
...
this._timers.splice(h,0,l,e,t,r,n,p),this._timers.splice(a,6)}0===a&&this._reinstallTimerTimeout()}return e}cancelTimers(){N++,this._clearTimerTimeout(),this._timers=[],this._cancelAutorun()}hasTimers(){return this._timers.length>0||this._autorun}cancel(e){if(I++,null==e)return!1
var t=typeof e
...
return p(this.routeInfos,e=>(t[e.name]=e.params||{},!0)),e.resolveIndex=0,r.Promise.resolve(null,this.promiseLabel("Start transition")).then(j.bind(null,this,e),null,this.promiseLabel("Resolve route")).catch(A.bind(null,this,e),this.promiseLabel("Handle error")).then(()=>this)}}e.TransitionState=I
...
return this.applyToHandlers(e,n,i,t,!1)}applyToHandlers(e,t,r,n,i){var o,s,a=new I,u=this.contexts.slice(0),c=t.length
...
class F extends R{constructor(e,t,r){super(e,r),this.url=t,this.preTransitionState=void 0}applyToState(e){var t,r,n=new I,i=this.router.recognizer.recognize(this.url)
...
return new N(O,e,t).promise})}class D extends N{constructor(e,t,r){super(e,t,!1,r)}}function L(e,t){return O.resolve(e,t).then(function(e){if(null===e||"object"!=typeof e)throw new TypeError("hashSettled must be called with an object")
return new D(O,e,!1,t).promise})}function $(e){throw setTimeout(()=>{throw e}),e}function F(e){var t={resolve:void 0,reject:void 0}
return t.promise=new O((e,r)=>{t.resolve=e,t.reject=r},e),t}D.prototype._setResultAt=E
...
for(var ge in o("instrument",!0),me)me.hasOwnProperty(ge)&&pe(ge,me[ge])}var ve={asap:Q,cast:de,Promise:O,EventTarget:n,all:M,allSettled:A,race:j,hash:I,hashSettled:L,rethrow:$,defer:F,denodeify:S,configure:o,on:pe,off:fe,resolve:z,reject:U,map:H,async:he,filter:W}
...
var c=0
function d(e){return c--,e}i.Test?(i.Test.registerWaiter(function(){return 0===c}),t.default=function(){return c++,t.fetch.apply(e,arguments).then(function(e){return e.clone().blob().then(d,d),e},function(e){throw d(e),e})}):t.default=t.fetch,s.forEach(function(e){delete t[e]})})})("undefined"!=typeof window&&window||"undefined"!=typeof globalThis&&globalThis||"undefined"!=typeof self&&self||"undefined"!=typeof global&&global)}/*! UIkit 3.25.2 | https://www.getuikit.com | (c) 2014 - 2025 YOOtheme | MIT License */
...
return(null==t?void 0:t.defaultView)||window}function I(e,t){return e===t||g(e)&&g(t)&&Object.keys(e).length===Object.keys(t).length&&$(e,(e,r)=>e===t[r])}function D(e,t,r){return e.replace(new RegExp(`${t}|${r}`,"g"),e=>e===t?r:t)}function L(e){return e[e.length-1]}function $(e,t){for(const r in e)if(!1===t(e[r],r))return!1
...
return n?r.getElementById(n)||r.getElementsByName(n)[0]:r.documentElement}}function Ne(e,t){return De(e,$e(e,t))}function Ie(e,t){return Le(e,$e(e,t))}function De(e,t){return A(qe(e,A(t),"querySelector"))}function Le(e,t){return j(qe(e,A(t),"querySelectorAll"))}function $e(e,t=document){return y(t)||He(e).isContextSelector?t:t.ownerDocument}const Fe=/([!>+~-])(?=\s+[!>+~-]|\s*$)/g,Be=/(\([^)]*\)|[^,])+/g,He=K(e=>{let t=!1
if(!e||!C(e))return{}
const r=[]
...
function qe(e,t=document,r){var n
const i=He(e)
if(!i.isContextSelector)return i.selector?Ve(t,r,i.selector):e
e=""
const o=1===i.selectors.length
for(let s of i.selectors){let i,a=t
if("!"===s[0]&&([i,s]=Ue(s),a=null==(n=t.parentElement)?void 0:n.closest(i),!s&&o))return a
if(a&&"-"===s[0]&&([i,s]=Ue(s),a=a.previousElementSibling,a=Se(a,i)?a:null,!s&&o))return a
if(a){if(o)return"~"===s[0]||"+"===s[0]?(s=`:scope > :nth-child(${Re(a)+1}) ${s}`,a=a.parentElement):">"===s[0]&&(s=`:scope ${s}`),Ve(a,r,s)
e+=`${e?",":""}${We(a)} ${s}`}}return y(t)||(t=t.ownerDocument),Ve(t,r,e)}function Ve(e,t,r){try{return e[t](r)}catch{return null}}function We(e){const t=[]
...
for(const o of i)if(C(t)){if(t=lt(t),S(r))return getComputedStyle(o).getPropertyValue(t)
o.style.setProperty(t,!O(r)||ot[t]||ut(t)?r||k(r)?r:"":`${r}px`,n)}else{if(h(t)){const e={}
for(const r of t)e[r]=st(o,r)
return e}if(g(t))for(const e in t)st(o,e,t[e],r)}return i[0]}function at(e,t){for(const r in t)st(e,r,"")}const lt=K(e=>{if(ut(e))return e
e=i(e)
const{style:t}=document.documentElement
if(e in t)return e
for(const r of["webkit","moz"]){const n=`-${r}-${e}`
if(n in t)return n}})
function ut(e){return l(e,"--")}const ct="uk-transition",dt="transitionend",ht="transitioncanceled"
const pt={start:function(e,t,r=400,n="linear",i){return r=Math.round(r),Promise.all(j(e).map(e=>new Promise((o,s)=>{i||e.offsetHeight
const a=setTimeout(()=>Ke(e,dt),r)
Ze(e,[dt,ht],({type:t})=>{clearTimeout(a),J(e,ct),at(e,l),t===ht?s():o(e)},{self:!0}),X(e,ct)
const l={transitionProperty:Object.keys(t).map(lt).join(","),transitionDuration:`${r}ms`,transitionTimingFunction:n}
st(e,{...l,...t})})))},async stop(e){Ke(e,dt),await Promise.resolve()},async cancel(e){Ke(e,ht),await Promise.resolve()},inProgress:e=>te(e,ct)},ft="uk-animation",mt="animationend",gt="animationcanceled"
function vt(e,t,r=200,n,i){return Promise.all(j(e).map(e=>new Promise((o,s)=>{te(e,ft)&&Ke(e,gt)
const a=[t,ft,`${ft}-${i?"leave":"enter"}`,n&&`uk-transform-origin-${n}`,i&&`${ft}-reverse`],l=setTimeout(()=>Ke(e,mt),r)
Ze(e,[mt,gt],({type:t})=>{clearTimeout(l),t===gt?s():o(e),st(e,"animationDuration",""),J(e,a)},{self:!0}),st(e,"animationDuration",`${r}ms`),X(e,a)})))}const bt={in:vt,out:(e,t,r,n)=>vt(e,t,r,n,!0),inProgress:e=>te(e,ft),cancel(e){Ke(e,gt)}}
function yt(e,...t){return t.some(t=>{var r
return(null==(r=null==e?void 0:e.tagName)?void 0:r.toLowerCase())===t.toLowerCase()})}function wt(e){return(e=It(e))&&(e.innerHTML=""),e}function _t(e,t){return S(t)?It(e).innerHTML:Et(wt(e),t)}const xt=Ot("prepend"),Et=Ot("append"),Ct=Ot("before"),kt=Ot("after")
function Ot(e){return function(t,r){var n
const i=j(C(r)?At(r):r)
return null==(n=It(t))||n[e](...i),jt(i)}}function Tt(e){j(e).forEach(e=>e.remove())}function St(e,t){for(t=A(Ct(e,t));t.firstElementChild;)t=t.firstElementChild
return Et(t,e),t}function Pt(e,t){return j(j(e).map(e=>e.hasChildNodes()?St(p(e.childNodes),t):Et(e,t)))}function Mt(e){j(e).map(Oe).filter((e,t,r)=>r.indexOf(e)===t).forEach(e=>e.replaceWith(...e.childNodes))}const Rt=/^<(\w+)\s*\/?>(?:<\/\1>)?$/
function At(e){const t=Rt.exec(e)
if(t)return document.createElement(t[1])
const r=document.createElement("template")
return r.innerHTML=e.trim(),jt(r.content.childNodes)}function jt(e){return e.length>1?e:e[0]}function Nt(e,t){if(_(e))for(t(e),e=e.firstElementChild;e;)Nt(e,t),e=e.nextElementSibling}function It(e,t){return Lt(e)?A(At(e)):De(e,t)}function Dt(e,t){return Lt(e)?j(At(e)):Le(e,t)}function Lt(e){return C(e)&&l(e.trim(),"<")}const $t={width:["left","right"],height:["top","bottom"]}
function Ft(e){const t=_(e)?A(e).getBoundingClientRect():{height:Ut(e),width:qt(e),top:0,left:0}
return{height:t.height,width:t.width,top:t.top,left:t.left,bottom:t.top+t.height,right:t.left+t.width}}function Bt(e,t){t&&st(e,{left:0,top:0})
const r=Ft(e)
if(e){const{scrollY:t,scrollX:n}=N(e),i={height:t,width:n}
for(const e in $t)for(const t of $t[e])r[t]+=i[e]}if(!t)return r
for(const n of["left","top"])st(e,n,t[n]-r[n])}function Ht(e){let{top:t,left:r}=Bt(e)
const{ownerDocument:{body:n,documentElement:i},offsetParent:o}=A(e)
let s=o||i
for(;s&&(s===n||s===i)&&"static"===st(s,"position");)s=s.parentNode
if(_(s)){const e=Bt(s)
t-=e.top+R(st(s,"borderTopWidth")),r-=e.left+R(st(s,"borderLeftWidth"))}return{top:t-R(st(e,"marginTop")),left:r-R(st(e,"marginLeft"))}}function zt(e){const t=[(e=A(e)).offsetTop,e.offsetLeft]
...
return t[0]+=r.scrollY,t[1]+=r.scrollX,t}return t}const Ut=Vt("height"),qt=Vt("width")
function Vt(e){const t=a(e)
return(r,n)=>{if(S(n)){if(b(r))return r[`inner${t}`]
if(y(r)){const e=r.documentElement
return Math.max(e[`offset${t}`],e[`scroll${t}`])}return(n="auto"===(n=st(r=A(r),e))?r[`offset${t}`]:R(n)||0)-Wt(r,e)}return st(r,e,n||0===n?+n+Wt(r,e)+"px":"")}}function Wt(e,t,r="border-box"){return st(e,"boxSizing")===r?B($t[t],t=>R(st(e,`padding-${t}`))+R(st(e,`border-${t}-width`))):0}function Yt(e){for(const t in $t)for(const r in $t[t])if($t[t][r]===e)return $t[t][1-r]
return e}function Gt(e,t="width",r=window,n=!1){return C(e)?B(Zt(e),e=>{const i=Xt(e)
return i?function(e,t){return e*R(t)/100}("vh"===i?function(){if(Jt)return Jt
er||(er=It("<div>"),st(er,{height:"100vh",position:"fixed"}),Ge(window,"resize",()=>Jt=null))
return Et(document.body,er),Jt=er.clientHeight,Tt(er),Jt}():"vw"===i?qt(N(r)):n?r[`offset${a(t)}`]:Ft(r)[t],e):e}):R(e)}const Qt=/-?\d+(?:\.\d+)?(?:v[wh]|%|px)?/g,Zt=K(e=>e.toString().replace(/\s/g,"").match(Qt)||[]),Kt=/(?:v[hw]|%)$/,Xt=K(e=>(e.match(Kt)||[])[0])
let Jt,er
const tr={read:function(e){return rr.push(e),sr(),e},write:function(e){return nr.push(e),sr(),e},clear:function(e){lr(rr,e),lr(nr,e)},flush:or},rr=[],nr=[]
let ir=!1
function or(){ar(rr),ar(nr.splice(0)),ir=!1,(rr.length||nr.length)&&sr()}function sr(){ir||(ir=!0,queueMicrotask(or))}function ar(e){let t
for(;t=e.shift();)try{t()}catch(r){console.error(r)}}function lr(e,t){const r=e.indexOf(t)
return~r&&e.splice(r,1)}class ur{init(){let e
...
const t=Ft(e),{left:r,right:n,top:i,bottom:o}=t,[s]=this.positions,a=L(this.positions),l=[s,a]
if(W(a,t))return!1
...
return r&&W(r,t)})}}function cr(e,t,r={},{intersecting:n=!0}={}){const i=new IntersectionObserver(n?(e,r)=>{e.some(e=>e.isIntersecting)&&t(e,r)}:t,r)
for(const o of j(e))i.observe(o)
return i}const dr=le&&window.ResizeObserver
function hr(e,t,r={box:"border-box"}){if(dr)return mr(ResizeObserver,e,t,r)
const n=[Ge(window,"load resize",t),Ge(document,"loadedmetadata load",t,!0)]
return{disconnect:()=>n.map(e=>e())}}function pr(e){return{disconnect:Ge([window,window.visualViewport],"resize",e)}}function fr(e,t,r){return mr(MutationObserver,e,t,r)}function mr(e,t,r,n){const i=new e(r)
for(const o of j(t))i.observe(o,n)
return i}function gr(e){wr(e)&&Er(e,{func:"playVideo",method:"play"}),yr(e)&&e.play().catch(q)}function vr(e){wr(e)&&e[kr]&&Er(e,{func:"pauseVideo",method:"pause"}),yr(e)&&e.pause()}function br(e){wr(e)&&Er(e,{func:"mute",method:"setVolume",value:0}),yr(e)&&(e.muted=!0)}function yr(e){return yt(e,"video")}function wr(e){return yt(e,"iframe")&&(_r(e)||xr(e))}function _r(e){return!!e.src.match(/\/\/.*?youtube(-nocookie)?\.[a-z]+\/(watch\?v=[^&\s]+|embed)|youtu\.be\/.*/)}function xr(e){return!!e.src.match(/vimeo\.com\/video\/.*/)}async function Er(e,t){await function(e){if(e[kr])return e[kr]
const t=_r(e),r=xr(e),n=++Or
let i
return e[kr]=new Promise(o=>{t&&Ze(e,"load",()=>{const t=()=>Cr(e,{event:"listening",id:n})
i=setInterval(t,100),t()}),Ze(window,"message",o,!1,({data:e})=>{try{return e=JSON.parse(e),t&&(null==e?void 0:e.id)===n&&"onReady"===e.event||r&&Number(null==e?void 0:e.player_id)===n}catch{}}),e.src=`${e.src}${c(e.src,"?")?"&":"?"}${t?"enablejsapi=1":`api=1&player_id=${n}`}`}).then(()=>clearInterval(i))}(e),Cr(e,t)}function Cr(e,t){e.contentWindow.postMessage(JSON.stringify({event:"command",...t}),"*")}const kr="_ukPlayer"
let Or=0
function Tr(e,t=0,r=0){return!!_e(e)&&V(...Ar(e).map(e=>{const{top:n,left:i,bottom:o,right:s}=jr(e)
return{top:n-t,left:i-r,bottom:o+t,right:s+r}}).concat(Bt(e)))}function Sr(e,{offset:t=0}={}){const r=_e(e)?Mr(e,!1,["hidden"]):[]
return r.reduce((n,i,o)=>{const{scrollTop:s,scrollHeight:a,offsetHeight:l}=i,u=jr(i),c=a-u.height,{height:d,top:h}=r[o-1]?jr(r[o-1]):Bt(e)
...
var l
const u=Date.now(),c=Lr(e)===e,d=Bt(n).top+(c?0:s)
let h=0,p=15;(function l(){const f=(m=U((Date.now()-u)/a),.5*(1-Math.cos(Math.PI*m)))
var m
let g=0
r[0]===e&&s+t<i&&(g=Bt(n).top+(c?0:e.scrollTop)-d-Ft(Nr(n)).height),"auto"!==st(e,"scrollBehavior")&&st(e,"scrollBehavior","auto"),e.scrollTop=s+(t+g)*f,st(e,"scrollBehavior",""),1!==f||h!==g&&p--?(h=g,requestAnimationFrame(l)):o()})()})}(i,p-s,e,c).then(n)},()=>Promise.resolve())()}function Pr(e,t=0,r=0){if(!_e(e))return 0
const n=Rr(e,!0),{scrollHeight:i,scrollTop:o}=n,{height:s}=jr(n),a=i-s,l=zt(e)[0]-zt(n)[0],u=Math.max(0,l-s+t),c=Math.min(a,l+e.offsetHeight-r)
return u<c?U((o-u)/(c-u)):1}function Mr(e,t=!1,r=[]){const n=Lr(e)
let i=Pe(e).reverse()
i=i.slice(i.indexOf(n)+1)
const o=d(i,e=>"fixed"===st(e,"position"))
return~o&&(i=i.slice(o)),[n].concat(i.filter(e=>st(e,"overflow").split(" ").some(e=>c(["auto","scroll",...r],e))&&(!t||e.scrollHeight>jr(e).height))).reverse()}function Rr(...e){return Mr(...e)[0]}function Ar(e){return Mr(e,!1,["hidden","clip"])}function jr(e){const t=N(e),r=Lr(e),n=!w(e)||e.contains(r)
if(n&&t.visualViewport){let{height:e,width:r,scale:n,pageTop:i,pageLeft:o}=t.visualViewport
return e=Math.round(e*n),r=Math.round(r*n),{height:e,width:r,top:i,left:o,bottom:i+e,right:o+r}}let i=Bt(n?t:e)
...
i[d]+=R(st(l,`border-${d}-width`)),i[u]=i[c]=l[`client${a(u)}`]-(e?e<.5?-e:1-e:0),i[h]=i[u]+i[d]}return i}function Nr(e){const{document:t}=N(e)
e=e||t.body
const{left:r,width:n,top:i}=Ft(e)
for(const o of i?[0,i]:[0]){let i
for(const s of t.elementsFromPoint(r+n/2,o))s.contains(e)||te(s,"uk-togglable-leave")||!(Dr(s,"fixed")&&Ir(Pe(e).reverse().find(e=>!e.contains(s)&&!Dr(e,"static")))<Ir(s)||Dr(s,"sticky")&&(!e||Oe(s).contains(e)))||i&&!(Ft(i).height<Ft(s).height)||(i=s)
if(i)return i}}function Ir(e){return R(st(e,"zIndex"))}function Dr(e,t){return st(e,"position")===t}function Lr(e){return N(e).document.scrollingElement}const $r=[["width","x","left","right"],["height","y","top","bottom"]]
function Fr(e,t,r){r={attach:{element:["left","top"],target:["left","top"],...r.attach},offset:[0,0],placement:[],...r},h(t)||(t=[t,t]),Bt(e,Br(e,t,r))}function Br(e,t,r){const n=Hr(e,t,r),{boundary:i,viewportOffset:o=0,placement:s}=r
let a=n
for(const[l,[u,,c,d]]of Object.entries($r)){const h=qr(e,t[l],o,i,l)
if(Gr(n,h,l))continue
let p=0
if("flip"===s[l]){const i=r.attach.target[l]
if(i===d&&n[d]<=h[d]||i===c&&n[c]>=h[c])continue
p=Qr(e,t,r,l)[c]-n[c]
const s=Vr(e,t[l],o,l)
if(!Gr(zr(n,p,l),s,l)){if(Gr(n,s,l))continue
if(r.recursion)return!1
const i=Zr(e,t,r)
if(i&&Gr(i,s,1-l))return i
continue}}else if("shift"===s[l]){const e=Bt(t[l]),{offset:i}=r
p=U(U(n[c],h[c],h[d]-n[u]),e[c]-n[u]+i[l],e[d]-i[l])-n[c]}a=zr(a,p,l)}return a}function Hr(e,t,r){let{attach:n,offset:i}={attach:{element:["left","top"],target:["left","top"],...r.attach},offset:[0,0],...r},o=Bt(e)
for(const[s,[a,,l,u]]of Object.entries($r)){const e=n.target[s]===n.element[s]?jr(t[s]):Bt(t[s])
o=zr(o,e[l]-o[l]+Ur(n.target[s],u,e[a])-Ur(n.element[s],u,o[a])+ +i[s],s)}return o}function zr(e,t,r){const[,n,i,o]=$r[r],s={...e}
return s[i]=e[n]=e[i]+t,s[o]+=t,s}function Ur(e,t,r){return"center"===e?r/2:e===t?r:0}function qr(e,t,r,n,i){let o=Yr(...Wr(e,t).map(jr))
return r&&(o[$r[i][2]]+=r,o[$r[i][3]]-=r),n&&(o=Yr(o,Bt(h(n)?n[i]:n))),o}function Vr(e,t,r,n){const[i,o,s,l]=$r[n],[u]=Wr(e,t),c=jr(u)
return["auto","scroll"].includes(st(u,`overflow-${o}`))&&(c[s]-=u[`scroll${a(s)}`],c[l]=c[s]+u[`scroll${a(i)}`]),c[s]+=r,c[l]-=r,c}function Wr(e,t){return Ar(t).filter(t=>t.contains(e))}function Yr(...e){let t={}
for(const r of e)for(const[,,e,n]of $r)t[e]=Math.max(t[e]||0,r[e]),t[n]=Math.min(...[t[n],r[n]].filter(Boolean))
return t}function Gr(e,t,r){const[,,n,i]=$r[r]
return e[n]>=t[n]&&e[i]<=t[i]}function Qr(e,t,{offset:r,attach:n},i){return Hr(e,t,{attach:{element:Kr(n.element,i),target:Kr(n.target,i)},offset:Jr(r,i)})}function Zr(e,t,r){return Br(e,t,{...r,attach:{element:r.attach.element.map(Xr).reverse(),target:r.attach.target.map(Xr).reverse()},offset:r.offset.reverse(),placement:r.placement.reverse(),recursion:!0})}function Kr(e,t){const r=[...e],n=$r[t].indexOf(e[t])
return~n&&(r[t]=$r[t][1-n%2+2]),r}function Xr(e){for(let t=0;t<$r.length;t++){const r=$r[t].indexOf(e)
if(~r)return $r[1-t][r%2+2]}}function Jr(e,t){return(e=[...e])[t]*=-1,e}var en=Object.freeze({__proto__:null,$:It,$$:Dt,Animation:bt,Dimensions:Q,MouseTracker:ur,Transition:pt,addClass:X,after:kt,append:Et,apply:Nt,assign:f,attr:ie,before:Ct,boxModelAdjust:Wt,camelize:s,children:Me,clamp:U,createEvent:Xe,css:st,data:ae,dimensions:Ft,each:$,empty:wt,endsWith:u,escape:Ye,fastdom:tr,filter:Te,find:De,findAll:Le,findIndex:d,flipPosition:Yt,fragment:At,getCoveringElement:Nr,getEventPos:it,getIndex:Z,getTargetedElement:je,hasAttr:oe,hasClass:te,hasOwn:r,hasTouch:ce,height:Ut,html:_t,hyphenate:i,inBrowser:le,includes:c,index:Re,intersectRect:V,isArray:h,isBoolean:E,isDocument:y,isElement:_,isEmpty:T,isEqual:I,isFocusable:ke,isFunction:m,isInView:Tr,isInput:Ee,isNode:w,isNumber:k,isNumeric:O,isObject:g,isPlainObject:v,isRtl:ue,isSameSiteAnchor:Ae,isString:C,isTag:yt,isTouch:nt,isUndefined:S,isVisible:_e,isVoidElement:ye,isWindow:b,last:L,matches:Se,memoize:K,mute:br,noop:q,observeIntersection:cr,observeMutation:fr,observeResize:hr,observeViewportResize:pr,off:Qe,offset:Bt,offsetPosition:zt,offsetViewport:jr,on:Ge,once:Ze,overflowParents:Ar,parent:Oe,parents:Pe,pause:vr,pick:z,play:gr,pointInRect:W,pointerCancel:ve,pointerDown:he,pointerEnter:me,pointerLeave:ge,pointerMove:pe,pointerUp:fe,position:Ht,positionAt:Fr,prepend:xt,propName:lt,query:Ne,queryAll:Ie,ready:function(e){"loading"===document.readyState?Ze(document,"DOMContentLoaded",e):e()},remove:Tt,removeAttr:se,removeClass:J,replaceClass:ee,resetProps:at,scrollIntoView:Sr,scrollParent:Rr,scrollParents:Mr,scrolledOver:Pr,selFocusable:Ce,selInput:xe,sortBy:F,startsWith:l,sumBy:B,swap:D,toArray:p,toBoolean:P,toEventTargets:rt,toFloat:R,toNode:A,toNodes:j,toNumber:M,toPx:Gt,toWindow:N,toggleClass:re,trigger:Ke,ucfirst:a,uniqueBy:H,unwrap:Mt,width:qt,wrapAll:St,wrapInner:Pt}),tn={connected(){X(this.$el,this.$options.id)}}
const rn=["days","hours","minutes","seconds"]
var nn={mixins:[tn],props:{date:String,clsWrapper:String,role:String,reload:Boolean},data:{date:"",clsWrapper:".uk-countdown-%unit%",role:"timer",reload:!1},connected(){this.$el.role=this.role,this.date=R(Date.parse(this.$props.date)),this.started=this.end=!1,this.start()},disconnected(){this.stop()},events:{name:"visibilitychange",el:()=>document,handler(){document.hidden?this.stop():this.start()}},methods:{start(){this.stop(),this.update()},stop(){this.timer&&(clearInterval(this.timer),Ke(this.$el,"countdownstop"),this.timer=null)},update(){const e=function(e){const t=Math.max(0,e-Date.now())/1e3
return{total:t,seconds:t%60,minutes:t/60%60,hours:t/60/60%24,days:t/60/60/24}}(this.date)
e.total?this.timer||(this.started=!0,this.timer=setInterval(this.update,1e3),Ke(this.$el,"countdownstart")):(this.stop(),this.end||(Ke(this.$el,"countdownend"),this.end=!0,this.reload&&this.started&&window.location.reload()))
for(const t of rn){const r=It(this.clsWrapper.replace("%unit%",t),this.$el)
if(!r)continue
let n=Math.trunc(e[t]).toString().padStart(2,"0")
r.textContent!==n&&(n=n.split(""),n.length!==r.children.length&&_t(r,n.map(()=>"<span></span>").join("")),n.forEach((e,t)=>r.children[t].textContent=e))}}}}
const on={}
function sn(e,t,r){return on.computed(m(e)?e.call(r,r):e,m(t)?t.call(r,r):t)}function an(e,t){return e=e&&!h(e)?[e]:e,t?e?e.concat(t):h(t)?t:[t]:e}function ln(e,t){return S(t)?e:t}function un(e,t,n){const i={}
if(m(t)&&(t=t.options),t.extends&&(e=un(e,t.extends,n)),t.mixins)for(const r of t.mixins)e=un(e,r,n)
for(const r in e)o(r)
for(const s in t)r(e,s)||o(s)
function o(r){i[r]=(on[r]||ln)(e[r],t[r],n)}return i}function cn(e,t=[]){try{return e?l(e,"{")?JSON.parse(e):t.length&&!c(e,":")?{[t[0]]:e}:e.split(";").reduce((e,t)=>{const[r,n]=t.split(/:(.*)/)
return r&&!S(n)&&(e[r.trim()]=n.trim()),e},{}):{}}catch{return{}}}function dn(e,t){return e===Boolean?P(t):e===Number?M(t):"list"===e?function(e){return h(e)?e:C(e)?e.split(hn).map(e=>O(e)?M(e):P(e.trim())):[e]}(t):e===Object&&C(t)?cn(t):e?e(t):t}on.events=on.watch=on.observe=on.created=on.beforeConnect=on.connected=on.beforeDisconnect=on.disconnected=on.destroy=an,on.args=function(e,t){return!1!==t&&an(t||e)},on.update=function(e,t){return F(an(e,m(t)?{read:t}:t),"order")},on.props=function(e,t){if(h(t)){const e={}
for(const r of t)e[r]=String
t=e}return on.methods(e,t)},on.computed=on.methods=function(e,t){return t?e?{...e,...t}:t:e},on.i18n=on.data=function(e,t,r){return r?sn(e,t,r):t?e?function(r){return sn(e,t,r)}:t:e}
const hn=/,(?![^(]*\))/
function pn(e,t="update"){e._connected&&e._updates.length&&(e._updateCount||(e._updateCount=0,requestAnimationFrame(()=>e._updateCount=0)),e._queued||(e._queued=new Set,tr.read(()=>{e._connected&&function(e,t){for(const{read:r,write:n,events:i=[]}of e._updates){if(!t.has("update")&&!i.some(e=>t.has(e)))continue
let o
r&&(o=r.call(e,e._data,t),o&&v(o)&&f(e._data,o)),n&&!1!==o&&tr.write(()=>{e._connected&&n.call(e,e._data,t)})}}(e,e._queued),e._queued=null})),e._updateCount++<20&&e._queued.add(t.type||t))}function fn(e){return _n(hr,e,"resize")}function mn(e){return _n(cr,e)}function gn(e){return _n(fr,e)}function vn(e={}){return mn({handler:function(t,r){const{targets:n=this.$el,preload:i=5}=e
for(const e of j(m(n)?n(this):n))Dt('[loading="lazy"]',e).slice(0,i-1).forEach(e=>se(e,"loading"))
for(const e of t.filter(({isIntersecting:e})=>e).map(({target:e})=>e))r.unobserve(e)},...e})}function bn(e){return _n((e,t)=>pr(t),e,"resize")}function yn(e){return _n((e,t)=>{return{disconnect:Ge((r=e,j(r).map(e=>{const{ownerDocument:t}=e,r=Rr(e,!0)
return r===t.scrollingElement?t:r})),"scroll",t,{passive:!0})}
var r},e,"scroll")}function wn(e){return{observe:(e,t)=>({observe:q,unobserve:q,disconnect:Ge(e,he,t,{passive:!0})}),handler(e){if(!nt(e))return
...
Ke(r,"swipe"),Ke(r,"swipe"+(e=t.x,o=t.y,s=n,a=i,Math.abs(e-s)>=Math.abs(o-a)?e-s>0?"Left":"Right":o-a>0?"Up":"Down"))})})},...e}}function _n(e,t,r){return{observe:e,handler(){pn(this,r)},...t}}var xn={props:{margin:String,firstColumn:Boolean},data:{margin:"uk-margin-small-top",firstColumn:"uk-first-column"},observe:[gn({options:{childList:!0}}),gn({options:{attributes:!0,attributeFilter:["style"]}}),fn({handler(e){for(const{borderBoxSize:[{inlineSize:t,blockSize:r}]}of e)if(t||r)return void this.$emit("resize")},target:({$el:e})=>[e,...Me(e)]})],update:{read(){return{rows:En(Me(this.$el))}},write({rows:e}){for(const t of e)for(const r of t)re(r,this.margin,e[0]!==t),re(r,this.firstColumn,t[ue?t.length-1:0]===r)},events:["resize"]}}
function En(e){const t=[[]],r=e.some((t,r)=>r&&e[r-1].offsetParent!==t.offsetParent)
for(const n of e){if(!_e(n))continue
const e=Cn(n,r)
for(let i=t.length-1;i>=0;i--){const o=t[i]
if(!o[0]){o.push(n)
break}const s=Cn(o[0],r)
if(e.top>=s.bottom-1&&e.top!==s.top){t.push([n])
break}if(e.bottom-1>s.top||e.top===s.top){let t=o.length-1
for(;t>=0;t--){const n=Cn(o[t],r)
if(e.left>=n.left)break}o.splice(t+1,0,n)
break}if(0===i){t.unshift([n])
break}}}return t}function Cn(e,t=!1){let{offsetTop:r,offsetLeft:n,offsetHeight:i,offsetWidth:o}=e
return t&&([r,n]=zt(e)),{top:r,left:n,bottom:r+i,right:n+o}}function kn(){return new Promise(e=>requestAnimationFrame(e))}function On(e){return new Promise(t=>setTimeout(t,e))}const Tn="uk-transition-leave",Sn="uk-transition-enter"
function Pn(e,t,r,n=0){const i=Mn(t,!0),o={opacity:1},s={opacity:0},a=()=>i===Mn(t),l=e=>()=>a()?e():Promise.reject(),u=l(async()=>{X(t,Tn),await(n?An(t).reduce(async(e,t,i,o)=>{if(await e,!Tr(t)||!a())return void st(t,s)
await On(n)
const l=pt.start(t,s,r/2,"ease")
o.length-1===i&&await l},Promise.resolve()):pt.start(t,s,r/2,"ease")),J(t,Tn)}),c=l(async()=>{const i=Ut(t)
X(t,Sn),e(),st(n?Me(t):t,s),Ut(t,i),await On(),Ut(t,"")
const l=Ut(t)
st(t,"alignContent","flex-start"),Ut(t,i)
let u=[],c=r/2
if(n){const e=An(t)
st(Me(t),s),u=e.reduce(async(e,t,i,s)=>{if(await e,!Tr(t)||!a())return void at(t,o)
await On(n)
const l=pt.start(t,o,r/2,"ease").then(()=>a()&&at(t,o))
s.length-1===i&&await l},Promise.resolve()),c+=e.length*n}if(!n||i!==l){const e={height:l,...n?{}:o}
u.push(pt.start(t,e,c,"ease"))}await Promise.all(u),J(t,Sn),a()&&(at(t,{height:"",alignContent:"",...o}),delete t.dataset.transition)})
return te(t,Tn)?Rn(t).then(c):te(t,Sn)?Rn(t).then(u).then(c):u().then(c)}function Mn(e,t){return t&&(e.dataset.transition=1+Mn(e)),M(e.dataset.transition)||0}function Rn(e){return Promise.all(Me(e).filter(pt.inProgress).map(e=>new Promise(t=>Ze(e,"transitionend transitioncanceled",t))))}function An(e){return En(Me(e)).flat().filter(_e)}async function jn(e,t,r){await kn()
let n=Me(t)
const i=n.map(e=>Nn(e,!0)),o={...st(t,["height","padding"]),display:"block"},s=n.filter(e=>Tr(e)),a=n.concat(t)
await Promise.all(a.map(pt.cancel)),st(a,"transitionProperty","none"),await e()
const l=Me(t).filter(e=>!c(n,e))
n=n.concat(l),await Promise.resolve(),st(a,"transitionProperty","")
const u=ie(t,"style"),d=st(t,["height","padding"]),[h,p]=function(e,t,r){const n=t.map((e,t)=>!(!Oe(e)||!(t in r))&&(r[t]?_e(e)?In(e):{opacity:0}:{opacity:_e(e)?1:0})),i=n.map((n,i)=>{const o=Oe(t[i])===e&&(r[i]||Nn(t[i]))
if(!o)return!1
if(n){if(!("opacity"in n)){const{opacity:e}=o
e%1?n.opacity=1:delete o.opacity}}else delete o.opacity
return o})
return[n,i]}(t,n,i),f=n.map(e=>({style:ie(e,"style")}))
s.push(...n.filter(e=>Tr(e))),n.forEach((e,t)=>p[t]&&st(e,p[t])),st(t,o),Ke(t,"scroll"),await kn()
const m=n.map((e,n)=>{if(Oe(e)===t&&s.includes(e))return pt.start(e,h[n],r,"ease",!l.includes(e))}).concat(pt.start(t,d,r,"ease",!0))
try{await Promise.all(m),n.forEach((e,r)=>{ie(e,f[r]),Oe(e)===t&&st(e,"display",0===h[r].opacity?"none":"")}),ie(t,"style",u)}catch{ie(n,"style",""),at(t,o)}}function Nn(e,t){const r=st(e,"zIndex")
return!!_e(e)&&{display:"",opacity:t?st(e,"opacity"):"0",pointerEvents:"none",position:"absolute",zIndex:"auto"===r?Re(e):r,...In(e)}}function In(e){const{height:t,width:r}=Ft(e)
let{top:n,left:i}=Ht(e)
const o=jr(e.ownerDocument)
return n=U(n,o.top-t-o.height,o.bottom+o.height),i=U(i,o.left-r-o.width,o.right+o.width),{height:t,width:r,top:n,left:i,transform:"",...st(e,["marginTop","marginLeft"])}}var Dn={props:{duration:Number,animation:Boolean},data:{duration:150,animation:"slide"},methods:{animate(e,t=this.$el){const r=this.animation
return("fade"===r?Pn:"delayed-fade"===r?(...e)=>Pn(...e,40):r?jn:()=>(e(),Promise.resolve()))(e,t,this.duration).catch(q)}}}
function Ln(e){e.target.closest('a[href="#"],a[href=""]')&&e.preventDefault()}const $n=9,Fn=27,Bn=32,Hn=35,zn=36,Un=37,qn=38,Vn=39,Wn=40
var Yn={mixins:[Dn],args:"target",props:{target:String,selActive:Boolean},data:{target:"",selActive:!1,attrItem:"uk-filter-control",cls:"uk-active",duration:250},computed:{children:({target:e},t)=>Dt(`${e} > *`,t),toggles:({attrItem:e},t)=>Dt(`[${e}],[data-${e}]`,t)},watch:{toggles(e){this.updateState()
const t=Dt(this.selActive,this.$el)
for(const r of e){!1!==this.selActive&&re(r,this.cls,c(t,r))
const e=Kn(r)
yt(e,"a")&&(e.role="button")}},children(e,t){t&&this.updateState()}},events:{name:"click keydown",delegate:({attrItem:e})=>`[${e}],[data-${e}]`,handler(e){"keydown"===e.type&&e.keyCode!==Bn||e.target.closest("a,button")&&(Ln(e),this.apply(e.current))}},methods:{apply(e){const t=this.getState(),r=Qn(e,this.attrItem,this.getState())
var n,i
n=t,i=r,["filter","sort"].every(e=>I(n[e],i[e]))||this.setState(r)},getState(){return this.toggles.filter(e=>te(e,this.cls)).reduce((e,t)=>Qn(t,this.attrItem,e),{filter:{"":""},sort:[]})},async setState(e,t=!0){e={filter:{"":""},sort:[],...e},Ke(this.$el,"beforeFilter",[this,e])
for(const r of this.toggles)re(r,this.cls,Zn(r,this.attrItem,e))
await Promise.all(Dt(this.target,this.$el).map(r=>{const n=()=>function(e,t,r){for(const o of r)st(o,"display",Object.values(e.filter).every(e=>!e||Se(o,e))?"":"none")
const[n,i]=e.sort
if(n){const e=function(e,t,r){return[...e].sort((e,n)=>ae(e,t).localeCompare(ae(n,t),void 0,{numeric:!0})*("asc"===r||-1))}(r,n,i)
I(e,r)||Et(t,e)}}(e,r,Me(r))
return t?this.animate(n,r):n()})),Ke(this.$el,"afterFilter",[this])},updateState(){tr.write(()=>this.setState(this.getState(),!1))}}}
function Gn(e,t){return cn(ae(e,t),["filter"])}function Qn(e,t,r){const{filter:n,group:i,sort:o,order:s="asc"}=Gn(e,t)
return(n||S(o))&&(i?n?(delete r.filter[""],r.filter[i]=n):(delete r.filter[i],(T(r.filter)||""in r.filter)&&(r.filter={"":n||""})):r.filter={"":n||""}),S(o)||(r.sort=[o,s]),r}function Zn(e,t,{filter:r={"":""},sort:[n,i]}){const{filter:o="",group:s="",sort:a,order:l="asc"}=Gn(e,t)
return S(a)?s in r&&o===r[s]||!o&&s&&!(s in r)&&!r[""]:n===a&&i===l}function Kn(e){return It("a,button",e)||e}var Xn={args:"dataSrc",props:{dataSrc:String,sources:String,margin:String,target:String,loading:String},data:{dataSrc:"",sources:!1,margin:"50%",target:!1,loading:"lazy"},connected(){"lazy"!==this.loading?this.load():ni(this.$el)&&(this.$el.loading="lazy",Jn(this.$el))},disconnected(){this.img&&(this.img.onload=""),delete this.img},observe:mn({handler(e,t){this.load(),t.disconnect()},options:({margin:e})=>({rootMargin:e}),filter:({loading:e})=>"lazy"===e,target:({$el:e,$props:t})=>t.target?[e,...Ie(t.target,e)]:e}),methods:{load(){if(this.img)return this.img
const e=ni(this.$el)?this.$el:function(e,t,r){const n=new Image
return ri(n,r),ti(e,n),n.onload=()=>Jn(e,n.currentSrc),n.src=t,n}(this.$el,this.dataSrc,this.sources)
return se(e,"loading"),Jn(this.$el,e.currentSrc),this.img=e}}}
function Jn(e,t){if(ni(e)){const t=Oe(e);(yt(t,"picture")?Me(t):[e]).forEach(e=>ti(e,e))}else if(t){!c(e.style.backgroundImage,t)&&(st(e,"backgroundImage",`url(${Ye(t)})`),Ke(e,Xe("load",!1)))}}const ei=["data-src","data-srcset","sizes"]
function ti(e,t){for(const r of ei){const n=ae(e,r)
n&&ie(t,r.replace(/data-/g,""),n)}}function ri(e,t){if((t=function(e){if(!e)return[]
if(l(e,"["))try{e=JSON.parse(e)}catch{e=[]}else e=cn(e)
h(e)||(e=[e])
return e.filter(e=>!T(e))}(t)).length){const r=At("<picture>")
for(const e of t){const t=At("<source>")
ie(t,e),Et(r,t)}Et(r,e)}}function ni(e){return yt(e,"img")}let ii
function oi(e){const t=Ge(e,"touchstart",t=>{if(1!==t.targetTouches.length||Se(t.target,'input[type="range"'))return
let r=it(t).y
const n=Ge(e,"touchmove",t=>{const n=it(t).y
n!==r&&(r=n,Mr(t.target).some(t=>{if(!e.contains(t))return!1
...
if(ii)return t
ii=!0
const{scrollingElement:r}=document,n={overflowY:CSS.supports("overflow","clip")?"clip":"hidden",touchAction:"none",scrollbarGutter:qt(window)-r.clientWidth?"stable":""}
return st(r,n),()=>{ii=!1,t(),at(r,n)}}var si={props:{container:Boolean},data:{container:!0},computed:{container({container:e}){return!0===e&&this.$container||e&&It(e)}}},ai={props:{pos:String,offset:Boolean,flip:Boolean,shift:Boolean,inset:Boolean},data:{pos:"bottom-"+(ue?"right":"left"),offset:!1,flip:!0,shift:!0,inset:!1},connected(){this.pos=this.$props.pos.split("-").concat("center").slice(0,2),[this.dir,this.align]=this.pos,this.axis=c(["top","bottom"],this.dir)?"y":"x"},methods:{positionAt(e,t,r){let n=[this.getPositionOffset(e),this.getShiftOffset(e)]
const i=[this.flip&&"flip",this.shift&&"shift"],o={element:[this.inset?this.dir:Yt(this.dir),this.align],target:[this.dir,this.align]}
if("y"===this.axis){for(const e in o)o[e].reverse()
n.reverse(),i.reverse()}const s=li(e),a=Ft(e)
st(e,{top:-a.height,left:-a.width}),Fr(e,t,{attach:o,offset:n,boundary:r,placement:i,viewportOffset:this.getViewportOffset(e)}),s()},getPositionOffset(e=this.$el){return Gt(!1===this.offset?st(e,"--uk-position-offset"):this.offset,"x"===this.axis?"width":"height",e)*(c(["left","top"],this.dir)?-1:1)*(this.inset?-1:1)},getShiftOffset(e=this.$el){return"center"===this.align?0:Gt(st(e,"--uk-position-shift-offset"),"y"===this.axis?"width":"height",e)*(c(["left","top"],this.align)?1:-1)},getViewportOffset:e=>Gt(st(e,"--uk-position-viewport-offset"))}}
function li(e){const t=Rr(e),{scrollTop:r}=t,n=()=>{r!==t.scrollTop&&(t.scrollTop=r)}
return()=>{n(),setTimeout(n)}}var ui={props:{cls:Boolean,animation:"list",duration:Number,velocity:Number,origin:String,transition:String},data:{cls:!1,animation:[!1],duration:200,velocity:.2,origin:!1,transition:"ease",clsEnter:"uk-togglable-enter",clsLeave:"uk-togglable-leave"},computed:{hasAnimation:({animation:e})=>!!e[0],hasTransition:({animation:e})=>["slide","reveal"].some(t=>l(e[0],t))},methods:{async toggleElement(e,t,r){try{return await Promise.all(j(e).map(e=>{const n=E(t)?t:!this.isToggled(e)
if(!Ke(e,"before"+(n?"show":"hide"),[this]))return Promise.reject()
const i=(m(r)?r:!1!==r&&this.hasAnimation?this.hasTransition?di:hi:ci)(e,n,this),o=n?this.clsEnter:this.clsLeave
X(e,o),Ke(e,n?"show":"hide",[this])
const s=()=>{var t
if(J(e,o),Ke(e,n?"shown":"hidden",[this]),n){const r=li(e)
null==(t=Dt("[autofocus]",e).find(_e))||t.focus(),r()}}
return i?i.then(s,()=>(J(e,o),Promise.reject())):s()})),!0}catch{return!1}},isToggled(e=this.$el){return!!te(e=A(e),this.clsEnter)||!te(e,this.clsLeave)&&(this.cls?te(e,this.cls.split(" ")[0]):_e(e))},_toggle(e,t){if(!e)return
let r
t=Boolean(t),this.cls?(r=c(this.cls," ")||t!==te(e,this.cls),r&&re(e,this.cls,c(this.cls," ")?void 0:t)):(r=t===e.hidden,r&&(e.hidden=!t)),r&&Ke(e,"toggled",[t,this])}}}
function ci(e,t,{_toggle:r}){return bt.cancel(e),pt.cancel(e),r(e,t)}async function di(e,t,{animation:r,duration:n,velocity:i,transition:o,_toggle:s}){var a
...
let v=Ft(e)[f]
const b=pt.inProgress(e)
await pt.cancel(e),t&&s(e,!0)
const y=Object.fromEntries(["padding","border","width","height","minWidth","minHeight","overflowY","overflowX",m,g].map(t=>[t,e.style[t]])),w=Ft(e),_=R(st(e,m)),x=R(st(e,g)),E=w[f]+x
b||t||(v+=x)
const[C]=Pt(e,"<div>")
...
n=(i*E+n)*(t?1-k:k)
const O={[f]:t?E:0}
p&&(st(e,m,E-v+_),O[m]=t?_:E+_),!p^"reveal"===l&&(st(C,m,-E+v),pt.start(C,{[m]:t?0:-E},n,o))
try{await pt.start(e,O,n,o)}finally{st(e,y),Mt(C.firstChild),t||s(e,!1)}}function hi(e,t,r){const{animation:n,duration:i,_toggle:o}=r
return t?(o(e,!0),bt.in(e,n[0],i,r.origin)):bt.out(e,n[1]||n[0],i,r.origin).then(()=>o(e,!1))}const pi=[]
var fi={mixins:[tn,si,ui],props:{selPanel:String,selClose:String,escClose:Boolean,bgClose:Boolean,stack:Boolean,role:String},data:{cls:"uk-open",escClose:!0,bgClose:!0,overlay:!0,stack:!1,role:"dialog"},computed:{panel:({selPanel:e},t)=>It(e,t),transitionElement(){return this.panel}},connected(){const e=this.panel||this.$el
e.role=this.role,this.overlay&&(e.ariaModal=!0)},beforeDisconnect(){c(pi,this)&&this.toggleElement(this.$el,!1,!1)},events:[{name:"click",delegate:({selClose:e})=>`${e},a[href*="#"]`,handler(e){const{current:t,defaultPrevented:r}=e,{hash:n}=t
!r&&n&&Ae(t)&&!this.$el.contains(It(n))?this.hide():Se(t,this.selClose)&&(Ln(e),this.hide())}},{name:"toggle",self:!0,handler(e,t){e.defaultPrevented||(e.preventDefault(),this.target=null==t?void 0:t.$el,this.isToggled()===c(pi,this)&&this.toggle())}},{name:"beforeshow",self:!0,handler(e){if(c(pi,this))return!1
!this.stack&&pi.length?(Promise.all(pi.map(e=>e.hide())).then(this.show),e.preventDefault()):pi.push(this)}},{name:"show",self:!0,handler(){this.stack&&st(this.$el,"zIndex",R(st(this.$el,"zIndex"))+pi.length)
const e=[this.overlay&&gi(this),this.overlay&&oi(this.$el),this.bgClose&&vi(this),this.escClose&&bi(this)]
Ze(this.$el,"hidden",()=>e.forEach(e=>e&&e()),{self:!0}),X(document.documentElement,this.clsPage),yi(this.target,!0)}},{name:"shown",self:!0,handler(){ke(this.$el)||(this.$el.tabIndex=-1),Se(this.$el,":focus-within")||this.$el.focus()}},{name:"hidden",self:!0,handler(){c(pi,this)&&pi.splice(pi.indexOf(this),1),st(this.$el,"zIndex","")
const{target:e}=this
pi.some(e=>e.clsPage===this.clsPage)||(J(document.documentElement,this.clsPage),queueMicrotask(()=>{if(ke(e)){const t=li(e)
e.focus(),t()}})),yi(e,!1),this.target=null}}],methods:{toggle(){return this.isToggled()?this.hide():this.show()},async show(){return this.container&&Oe(this.$el)!==this.container&&(Et(this.container,this.$el),await kn()),this.toggleElement(this.$el,!0,mi)},hide(){return this.toggleElement(this.$el,!1,mi)}}}
function mi(e,t,{transitionElement:r,_toggle:n}){return new Promise((i,o)=>Ze(e,"show hide",()=>{var s
...
var c})).then(()=>delete e._reject)}function gi(e){return Ge(document,"focusin",t=>{L(pi)!==e||e.$el.contains(t.target)||e.$el.focus()})}function vi(e){return Ge(document,he,({target:t})=>{L(pi)!==e||e.overlay&&!e.$el.contains(t)||!e.panel||e.panel.contains(t)||Ze(document,`${fe} ${ve} scroll`,({defaultPrevented:r,type:n,target:i})=>{r||n!==fe||t!==i||e.hide()},!0)})}function bi(e){return Ge(document,"keydown",t=>{27===t.keyCode&&L(pi)===e&&e.hide()})}function yi(e,t){(null==e?void 0:e.ariaExpanded)&&(e.ariaExpanded=t)}var wi={slide:{show:e=>[{transform:xi(-100*e)},{transform:xi()}],percent:e=>_i(e),translate:(e,t)=>[{transform:xi(-100*t*e)},{transform:xi(100*t*(1-e))}]}}
function _i(e){return Math.abs(new DOMMatrix(st(e,"transform")).m41/e.offsetWidth)}function xi(e=0,t="%"){return e?`translate3d(${e+t}, 0, 0)`:""}function Ei(e,t,r){Ke(e,Xe(t,!1,!1,r))}function Ci(){let e
return{promise:new Promise(t=>e=t),resolve:e}}var ki={props:{i18n:Object},data:{i18n:null},methods:{t(e,...t){var r,n,i
let o=0
return(null==(i=(null==(r=this.i18n)?void 0:r[e])||(null==(n=this.$options.i18n)?void 0:n[e]))?void 0:i.replace(/%s/g,()=>t[o++]||""))||""}}},Oi={props:{autoplay:Boolean,autoplayInterval:Number,pauseOnHover:Boolean},data:{autoplay:!1,autoplayInterval:7e3,pauseOnHover:!0},connected(){ie(this.list,"aria-live",this.autoplay?"off":"polite"),this.autoplay&&this.startAutoplay()},disconnected(){this.stopAutoplay()},update(){ie(this.slides,"tabindex","-1")},events:[{name:"visibilitychange",el:()=>document,filter:({autoplay:e})=>e,handler(){document.hidden?this.stopAutoplay():this.startAutoplay()}}],methods:{startAutoplay(){this.stopAutoplay(),this.interval=setInterval(()=>{this.stack.length||!_e(this.$el)||this.draggable&&Se(this.$el,":focus-within")&&!Se(this.$el,":focus")||this.pauseOnHover&&Se(this.$el,":hover")||this.show("next")},this.autoplayInterval)},stopAutoplay(){clearInterval(this.interval)}}}
const Ti={passive:!1,capture:!0},Si={passive:!0,capture:!0},Pi="touchmove mousemove",Mi="touchend touchcancel mouseup click input scroll"
var Ri={props:{draggable:Boolean},data:{draggable:!0,threshold:10},created(){for(const e of["start","move","end"]){const t=this[e]
...
!this.draggable||this.parallax||!nt(e)&&(t=e.target,"none"!==st(t,"userSelect")&&p(t.childNodes).some(e=>3===e.nodeType&&e.textContent.trim()))||e.target.closest(xe)||e.button>0||this.length<2||this.start(e)}},{name:"dragstart",handler(e){e.preventDefault()}},{name:Pi,el:({list:e})=>e,handler:q,...Ti}],methods:{start(){this.drag=this.pos,this._transitioner?(this.percent=this._transitioner.percent(),this.drag+=this._transitioner.getDistance()*this.percent*this.dir,this._transitioner.cancel(),this._transitioner.translate(this.percent),this.dragging=!0,this.stack=[]):this.prevIndex=this.index,Ge(document,Pi,this.move,Ti),Ge(document,Mi,this.end,Si),st(this.list,"userSelect","none")},move(e){const t=this.pos-this.drag
if(0===t||this.prevPos===this.pos||!this.dragging&&Math.abs(t)<this.threshold)return
e.cancelable&&e.preventDefault(),this.dragging=!0,this.dir=t<0?1:-1
let{slides:r,prevIndex:n}=this,i=Math.abs(t),o=this.getIndex(n+this.dir),s=Ai.call(this,n,o)
for(;o!==n&&i>s;)this.drag-=s*this.dir,n=o,i-=s,o=this.getIndex(n+this.dir),s=Ai.call(this,n,o)
this.percent=i/s
const a=r[n],l=r[o],u=this.index!==o,d=n===o
let h
for(const p of[this.index,this.prevIndex])c([o,n],p)||(Ke(r[p],"itemhidden",[this]),d&&(h=!0,this.prevIndex=n));(this.index===n&&this.prevIndex!==n||h)&&Ke(r[this.index],"itemshown",[this]),u&&(this.prevIndex=n,this.index=o,d||(Ke(a,"beforeitemhide",[this]),Ke(a,"itemhide",[this])),Ke(l,"beforeitemshow",[this]),Ke(l,"itemshow",[this])),this._transitioner=this._translate(Math.abs(this.percent),a,!d&&l)},end(){if(Qe(document,Pi,this.move,Ti),Qe(document,Mi,this.end,Si),this.dragging)if(setTimeout(Ge(this.list,"click",e=>e.preventDefault(),Ti)),this.dragging=null,this.index===this.prevIndex)this.percent=1-this.percent,this.dir*=-1,this._show(!1,this.index,!0),this._transitioner=null
else{const e=(ue?this.dir*(ue?1:-1):this.dir)<0==this.prevPos>this.pos
this.index=e?this.index:this.prevIndex,e&&(Ke(this.slides[this.prevIndex],"itemhidden",[this]),Ke(this.slides[this.index],"itemshown",[this]),this.percent=1-this.percent),this.show(this.dir>0&&!e||this.dir<0&&e?"next":"previous",!0)}st(this.list,{userSelect:""}),this.drag=this.percent=null}}}
function Ai(e,t){return this._getTransitioner(e,e!==t&&t).getDistance()||this.slides[e].offsetWidth}function ji(e,t,r){e._watches.push({name:r,...v(t)?t:{handler:t}})}const Ni={subtree:!0,childList:!0}
function Ii(e,t,n){e._hasComputed=!0,Object.defineProperty(e,t,{enumerable:!0,get(){const{_computed:i,$props:o,$el:s}=e
if(!r(i,t)&&(i[t]=(n.get||n).call(e,o,s),n.observe&&e._computedObserver)){const t=n.observe.call(e,o)
e._computedObserver.observe(["~","+","-"].includes(t[0])?s.parentElement:s.getRootNode(),Ni)}return i[t]},set(r){const{_computed:i}=e
i[t]=n.set?n.set.call(e,r):r,S(i[t])&&delete i[t]}})}function Di(e){e._hasComputed&&(function(e,t){e._updates.unshift(t)}(e,{read:()=>function(e,t){for(const{name:n,handler:i,immediate:o=!0}of e._watches)(e._initial&&o||r(t,n)&&!I(t[n],e[n]))&&i.call(e,e[n],t[n])
e._initial=!1}(e,Li(e)),events:["resize","computed"]}),e._computedObserver=fr(e.$el,()=>pn(e,"computed"),Ni),e._disconnect.push(()=>{e._computedObserver.disconnect(),e._computedObserver=null,Li(e)}))}function Li(e){const t={...e._computed}
return e._computed={},t}function $i(e,{name:t,el:r,handler:n,capture:i,passive:o,delegate:s,filter:a,self:l}){a&&!a.call(e,e)||e._disconnect.push(Ge(r?r.call(e,e):e.$el,t,null==s?void 0:s.call(e,e),n.bind(e),{passive:o,capture:i,self:l}))}function Fi(e,t){let{observe:n,target:i=e.$el,handler:o,options:s,filter:a,args:l}=t
if(a&&!a.call(e,e))return
const u=`_observe${e._disconnect.length}`
m(i)&&!r(e,u)&&Ii(e,u,()=>{const t=i.call(e,e)
return h(t)?j(t):t}),o=C(o)?e[o]:o.bind(e),m(s)&&(s=s.call(e,e))
const c=n(r(e,u)?e[u]:i,o,s,l)
m(i)&&h(e[u])&&ji(e,{handler:Bi(c,s),immediate:!1},u),e._disconnect.push(()=>c.disconnect())}function Bi(e,t){return(r,n)=>{for(const t of n)c(r,t)||(e.unobserve?e.unobserve(t):e.observe&&e.disconnect())
for(const i of r)c(n,i)&&e.unobserve||e.observe(i,t)}}function Hi(e){const t={},{args:r=[],props:n={},el:o,id:a}=e
if(!n)return t
for(const s in n){const e=i(s)
let r=ae(o,e)
S(r)||(r=n[s]===Boolean&&""===r||dn(n[s],r),"target"===e&&l(r,"_")||(t[s]=r))}const u=cn(ae(o,a),r)
for(const i in u){const e=s(i)
S(n[e])||(t[e]=dn(n[e],u[i]))}return t}const zi=K((e,t)=>{const r=Object.keys(t),n=r.concat(e).map(e=>[i(e),`data-${i(e)}`]).flat()
return{attributes:r,filter:n}})
function Ui(e,t){var r
null==(r=e.$options[t])||r.forEach(t=>t.call(e))}function qi(e){e._connected||(function(e){const{$options:t,$props:n}=e,i=Hi(t)
f(n,i)
const{computed:o,methods:s}=t
for(let a in n)!(a in i)||o&&r(o,a)||s&&r(s,a)||(e[a]=n[a])}(e),Ui(e,"beforeConnect"),e._connected=!0,e._disconnect=[],function(e){for(const t of e.$options.events||[])if(r(t,"handler"))$i(e,t)
else for(const r in t)$i(e,{name:r,handler:t[r]})}(e),function(e){e._data={},e._updates=[...e.$options.update||[]],e._disconnect.push(()=>e._updates=e._data=null)}(e),function(e){e._watches=[]
for(const t of e.$options.watch||[])for(const[r,n]of Object.entries(t))ji(e,n,r)
e._initial=!0}(e),function(e){for(const t of e.$options.observe||[])Fi(e,t)}(e),function(e){const{$options:t,$props:r}=e,{id:n,props:i,el:o}=t
if(!i)return
const{attributes:a,filter:l}=zi(n,i),u=new MutationObserver(i=>{const o=Hi(t)
i.some(({attributeName:e})=>{const t=e.replace("data-","")
return(t===n?a:[s(t),s(e)]).some(e=>!S(o[e])&&o[e]!==r[e])})&&e.$reset()})
u.observe(o,{attributes:!0,attributeFilter:l}),e._disconnect.push(()=>u.disconnect())}(e),Di(e),Ui(e,"connected"),pn(e))}function Vi(e){e._connected&&(Ui(e,"beforeDisconnect"),e._disconnect.forEach(e=>e()),e._disconnect=null,Ui(e,"disconnected"),e._connected=!1)}let Wi=0
function Yi(e,t={}){t.data=function({data:e={}},{args:t=[],props:r={}}){h(e)&&(e=e.slice(0,t.length).reduce((e,r,n)=>(v(r)?f(e,r):e[t[n]]=r,e),{}))
for(const n in e)S(e[n])?delete e[n]:r[n]&&(e[n]=dn(r[n],e[n]))
return e}(t,e.constructor.options),e.$options=un(e.constructor.options,t,e),e.$props={},e._uid=Wi++,function(e){const{data:t={}}=e.$options
...
if(e._computed={},t)for(const r in t)Ii(e,r,t[r])}(e),Ui(e,"created"),t.el&&e.$mount(t.el)}const Gi=function(e){Yi(this,e)}
Gi.util=en,Gi.options={},Gi.version="3.25.2"
const Qi="__uikit__",Zi={}
function Ki(e,t){var r,n
const o="uk-"+i(e)
if(!t)return Zi[o].options||(Zi[o]=Gi.extend(Zi[o])),Zi[o]
e=s(e),Gi[e]=(t,r)=>Xi(e,t,r)
const a=null!=(r=t.options)?r:{...t}
return a.id=o,a.name=e,null==(n=a.install)||n.call(a,Gi,a,e),Gi._initialized&&!a.functional&&requestAnimationFrame(()=>Xi(e,`[${o}],[data-${o}]`)),Zi[o]=a}function Xi(e,t,r,...n){const i=Ki(e)
return i.options.functional?new i({data:v(t)?t:[t,r,...n]}):t?Dt(t).map(o)[0]:o()
function o(t){const n=eo(t,e)
if(n){if(!r)return n
n.$destroy()}return new i({el:t,data:r})}}function Ji(e){return(null==e?void 0:e[Qi])||{}}function eo(e,t){return Ji(e)[t]}function to(e,t){e=e?A(e):document.body
for(const r of Pe(e).reverse())ro(r,t)
Nt(e,e=>ro(e,t))}function ro(e,t){const r=Ji(e)
for(const n in r)pn(r[n],t)}let no=1
function io(e,t=null){return(null==t?void 0:t.id)||`${e.$options.id}-${no++}`}var oo={i18n:{next:"Next slide",previous:"Previous slide",slideX:"Slide %s",slideLabel:"%s of %s"},data:{selNav:!1,role:"region"},computed:{nav:({selNav:e},t)=>Dt(e,t),navChildren(){return this.nav.map(e=>Me(e)).flat()},selNavItem:({attrItem:e})=>`[${e}],[data-${e}]`,navItems(e,t){return Dt(this.selNavItem,t)}},watch:{nav(e,t){ie(e,"role","tablist"),this.padNavitems(),t&&this.$emit()},list(e){yt(e,"ul")&&ie(e,"role","presentation")},navChildren(e){ie(e,"role","presentation"),this.padNavitems(),this.updateNav()},navItems(e){for(const t of e){const e=ae(t,this.attrItem),r=It("a,button",t)||t
let n,i=null
if(O(e)){const t=M(e),o=this.slides[t]
o&&(o.id||(o.id=io(this,o)),i=o.id),n=this.t("slideX",R(e)+1),r.role="tab"}else this.list&&(this.list.id||(this.list.id=io(this,this.list)),i=this.list.id),n=this.t(e)
r.ariaControls=i,r.ariaLabel=r.ariaLabel||n}},slides(e){e.forEach((e,t)=>ie(e,{role:this.nav.length?"tabpanel":"group","aria-label":this.t("slideLabel",t+1,this.length),"aria-roledescription":this.nav.length?null:"slide"})),this.padNavitems()}},connected(){this.$el.role=this.role,this.$el.ariaRoleDescription="carousel"},update:[{write(){this.navItems.concat(this.nav).forEach(e=>e&&(e.hidden=!this.maxIndex)),this.updateNav()},events:["resize"]}],events:[{name:"click keydown",delegate:({selNavItem:e})=>e,filter:({parallax:e})=>!e,handler(e){!e.target.closest("a,button")||"click"!==e.type&&e.keyCode!==Bn||(Ln(e),this.show(ae(e.current,this.attrItem)))}},{name:"itemshow",handler(){this.updateNav()}},{name:"keydown",delegate:({selNavItem:e})=>e,filter:({parallax:e})=>!e,handler(e){const{current:t,keyCode:r}=e
if(!O(ae(t,this.attrItem)))return
let n=r===zn?0:r===Hn?"last":r===Un?"previous":r===Vn?"next":-1
~n&&(e.preventDefault(),this.show(n))}}],methods:{updateNav(){const e=this.getValidIndex()
for(const t of this.navItems){const r=ae(t,this.attrItem),n=It("a,button",t)||t
if(O(r)){const i=M(r)===e
re(t,this.clsActive,i),re(n,"uk-disabled",!!this.parallax),n.ariaSelected=i,n.tabIndex=i&&!this.parallax?null:-1,i&&n&&Se(Oe(t),":focus-within")&&n.focus()}else re(t,"uk-invisible",this.finite&&("previous"===r&&0===e||"next"===r&&e>=this.maxIndex))}},padNavitems(){for(const e of this.nav){const t=Me(e),r=[]
for(let e=0;e<this.length;e++){const n=`${this.attrItem}="${e}"`
r[e]=t.findLast(e=>e.matches(`[${n}]`))||It(`<li ${n}><a href></a></li>`)}I(r,t)||_t(this.nav,r)}}}}
var so={mixins:[Oi,Ri,oo,ki],props:{clsActivated:String,easing:String,index:Number,finite:Boolean,velocity:Number},data:()=>({easing:"ease",finite:!1,velocity:1,index:0,prevIndex:-1,stack:[],percent:0,clsActive:"uk-active",clsActivated:"",clsEnter:"uk-slide-enter",clsLeave:"uk-slide-leave",clsSlideActive:"uk-slide-active",Transitioner:!1,transitionOptions:{}}),connected(){this.prevIndex=-1,this.index=this.getValidIndex(this.$props.index),this.stack=[]},disconnected(){J(this.slides,this.clsActive)},computed:{duration:({velocity:e},t)=>ao(t.offsetWidth/e),list:({selList:e},t)=>It(e,t),maxIndex(){return this.length-1},slides(){return Me(this.list)},length(){return this.slides.length}},watch:{slides(e,t){t&&this.$emit()}},events:{itemshow({target:e}){X(e,this.clsEnter,this.clsSlideActive)},itemshown({target:e}){J(e,this.clsEnter)},itemhide({target:e}){X(e,this.clsLeave)},itemhidden({target:e}){J(e,this.clsLeave,this.clsSlideActive)}},methods:{async show(e,t=!1){var r
...
if(a!==u){if(this.dir=function(e,t){return"next"===e?1:"previous"===e||e<t?-1:1}(e,s),this.prevIndex=s,this.index=l,a&&!Ke(a,"beforeitemhide",[this])||!Ke(u,"beforeitemshow",[this,a]))return this.index=this.prevIndex,void o()
a&&Ke(a,"itemhide",[this]),Ke(u,"itemshow",[this]),await this._show(a,u,t),a&&Ke(a,"itemhidden",[this]),Ke(u,"itemshown",[this]),n.shift(),this._transitioner=null,await kn(),n.length&&this.show(n.shift(),!0)}else o()},getIndex(e=this.index,t=this.index){return U(Z(e,this.slides,t,this.finite),0,Math.max(0,this.maxIndex))},getValidIndex(e=this.index,t=this.prevIndex){return this.getIndex(e,t)},async _show(e,t,r){if(this._transitioner=this._getTransitioner(e,t,this.dir,{easing:r?t.offsetWidth<600?"cubic-bezier(0.25, 0.46, 0.45, 0.94)":"cubic-bezier(0.165, 0.84, 0.44, 1)":this.easing,...this.transitionOptions}),!r&&!e)return void this._translate(1)
...
function ao(e){return.5*e+300}var lo={mixins:[so],props:{animation:String},data:{animation:"slide",clsActivated:"uk-transition-active",Animations:wi,Transitioner:function(e,t,r,{animation:n,easing:i}){const{percent:o,translate:s,show:a=q}=n,l=a(r),{promise:u,resolve:c}=Ci()
return{dir:r,show(n,o=0,s){const a=s?"linear":i
return n-=Math.round(n*U(o,-1,1)),this.translate(o),Ei(t,"itemin",{percent:o,duration:n,timing:a,dir:r}),Ei(e,"itemout",{percent:1-o,duration:n,timing:a,dir:r}),Promise.all([pt.start(t,l[1],n,a),pt.start(e,l[0],n,a)]).then(()=>{this.reset(),c()},q),u},cancel:()=>pt.cancel([t,e]),reset(){at([t,e],l[0])},async forward(e,t=this.percent()){return await this.cancel(),this.show(e,t,!0)},translate(n){this.reset()
const i=s(n,r)
st(t,i[1]),st(e,i[0]),Ei(t,"itemtranslatein",{percent:n,dir:r}),Ei(e,"itemtranslateout",{percent:1-n,dir:r})},percent:()=>o(e||t,t,r),getDistance:()=>null==e?void 0:e.offsetWidth}}},computed:{animation:({animation:e,Animations:t})=>({...t[e]||t.slide,name:e}),transitionOptions(){return{animation:this.animation}}},observe:fn(),events:{itemshow({target:e}){X(e,this.clsActive)},itemshown({target:e}){X(e,this.clsActivated)},itemhidden({target:e}){J(e,this.clsActive,this.clsActivated)}}},uo={...wi,fade:{show:()=>[{opacity:0,zIndex:0},{zIndex:-1}],percent:e=>1-st(e,"opacity"),translate:e=>[{opacity:1-e,zIndex:0},{zIndex:-1}]},scale:{show:()=>[{opacity:0,transform:co(1.5),zIndex:0},{zIndex:-1}],percent:e=>1-st(e,"opacity"),translate:e=>[{opacity:1-e,transform:co(1+.5*e),zIndex:0},{zIndex:-1}]},pull:{show:e=>e<0?[{transform:xi(30),zIndex:-1},{transform:xi(),zIndex:0}]:[{transform:xi(-100),zIndex:0},{transform:xi(),zIndex:-1}],percent:(e,t,r)=>r<0?1-_i(t):_i(e),translate:(e,t)=>t<0?[{transform:xi(30*e),zIndex:-1},{transform:xi(-100*(1-e)),zIndex:0}]:[{transform:xi(100*-e),zIndex:0},{transform:xi(30*(1-e)),zIndex:-1}]},push:{show:e=>e<0?[{transform:xi(100),zIndex:0},{transform:xi(),zIndex:-1}]:[{transform:xi(-30),zIndex:-1},{transform:xi(),zIndex:0}],percent:(e,t,r)=>r>0?1-_i(t):_i(e),translate:(e,t)=>t<0?[{transform:xi(100*e),zIndex:0},{transform:xi(-30*(1-e)),zIndex:-1}]:[{transform:xi(-30*e),zIndex:-1},{transform:xi(100*(1-e)),zIndex:0}]}}
function co(e){return`scale3d(${e}, ${e}, 1)`}var ho={...wi,fade:{show:()=>[{opacity:0},{opacity:1}],percent:e=>1-st(e,"opacity"),translate:e=>[{opacity:1-e},{opacity:e}]},scale:{show:()=>[{opacity:0,transform:co(.8)},{opacity:1,transform:co(1)}],percent:e=>1-st(e,"opacity"),translate:e=>[{opacity:1-e,transform:co(1-.2*e)},{opacity:e,transform:co(.8+.2*e)}]}},po={i18n:{counter:"%s / %s"},mixins:[fi,lo],functional:!0,props:{counter:Boolean,preload:Number,nav:Boolean,slidenav:Boolean,delayControls:Number,videoAutoplay:Boolean,template:String},data:()=>({counter:!1,preload:1,nav:!1,slidenav:!0,delayControls:3e3,videoAutoplay:!1,items:[],cls:"uk-open",clsPage:"uk-lightbox-page",clsFit:"uk-lightbox-items-fit",clsZoom:"uk-lightbox-zoom",attrItem:"uk-lightbox-item",selList:".uk-lightbox-items",selClose:".uk-close-large",selNav:".uk-lightbox-thumbnav, .uk-lightbox-dotnav",selCaption:".uk-lightbox-caption",selCounter:".uk-lightbox-counter",pauseOnHover:!1,velocity:2,Animations:ho,template:'<div class="uk-lightbox uk-overflow-hidden">  <div class="uk-lightbox-items"></div>  <div class="uk-position-top-right uk-position-small uk-transition-fade" uk-inverse>  <button class="uk-lightbox-close uk-close-large" type="button" uk-close></button>  </div>  <div class="uk-lightbox-slidenav uk-position-center-left uk-position-medium uk-transition-fade" uk-inverse>  <a href uk-slidenav-previous uk-lightbox-item="previous"></a>  </div>  <div class="uk-lightbox-slidenav uk-position-center-right uk-position-medium uk-transition-fade" uk-inverse>  <a href uk-slidenav-next uk-lightbox-item="next"></a>  </div>  <div class="uk-position-center-right uk-position-medium uk-transition-fade" uk-inverse style="max-height: 90vh; overflow: auto;">  <ul class="uk-lightbox-thumbnav uk-lightbox-thumbnav-vertical uk-thumbnav uk-thumbnav-vertical"></ul>  <ul class="uk-lightbox-dotnav uk-dotnav uk-dotnav-vertical"></ul>  </div>  <div class="uk-lightbox-counter uk-text-large uk-position-top-left uk-position-small uk-transition-fade" uk-inverse></div>  <div class="uk-lightbox-caption uk-position-bottom uk-text-center uk-transition-slide-bottom uk-transition-opaque"></div>  </div>'}),created(){let e=It(this.template)
yt(e,"template")&&(e=At(_t(e)))
const t=It(this.selList,e),r=this.$props.nav
Tt(Dt(this.selNav,e).filter(e=>!Se(e,`.uk-${r}`)))
for(const[o,s]of this.items.entries())Et(t,"<div>"),"thumbnav"===r&&St(mo(s,this.videoAutoplay),Et(It(this.selNav,e),`<li uk-lightbox-item="${o}"><a href></a></li>`))
this.slidenav||Tt(Dt(".uk-lightbox-slidenav",e)),this.counter||Tt(It(this.selCounter,e)),X(t,this.clsFit)
const n=It("[uk-close]",e),i=this.t("close")
n&&i&&(n.dataset.i18n=JSON.stringify({label:i})),this.$mount(Et(this.container,e))},events:[{name:"click",self:!0,filter:({bgClose:e})=>e,delegate:({selList:e})=>`${e} > *`,handler(e){e.defaultPrevented||this.hide()}},{name:"click",self:!0,delegate:({clsZoom:e})=>`.${e}`,handler(e){e.defaultPrevented||re(this.list,this.clsFit)}},{name:`${pe} ${he} keydown`,filter:({delayControls:e})=>e,handler(){this.showControls()}},{name:"shown",self:!0,handler(){this.showControls()}},{name:"hide",self:!0,handler(){this.hideControls(),J(this.slides,this.clsActive),pt.stop(this.slides)}},{name:"hidden",self:!0,handler(){this.$destroy(!0)}},{name:"keyup",el:()=>document,handler({keyCode:e}){if(!this.isToggled()||!this.draggable)return
let t=-1
e===Un?t="previous":e===Vn?t="next":e===zn?t=0:e===Hn&&(t="last"),~t&&this.show(t)}},{name:"beforeitemshow",handler(e){_t(It(this.selCaption,this.$el),this.getItem().caption||""),_t(It(this.selCounter,this.$el),this.t("counter",this.index+1,this.slides.length))
for(let t=-this.preload;t<=this.preload;t++)this.loadItem(this.index+t)
this.isToggled()||(this.draggable=!1,e.preventDefault(),this.toggleElement(this.$el,!0,!1),this.animation=ho.scale,J(e.target,this.clsActive),this.stack.splice(1,0,this.index))}},{name:"itemshown",handler(){this.draggable=this.$props.draggable}},{name:"itemload",async handler(e,t){const{source:r,type:n,attrs:i={}}=t
if(this.setItem(t,"<span uk-spinner uk-inverse></span>"),!r)return
let o
const s={allowfullscreen:"",style:"max-width: 100%; box-sizing: border-box;","uk-responsive":"","uk-video":Boolean(this.videoAutoplay)}
if("image"===n||go(r)){const e=fo("img")
ri(e,t.sources),ie(e,{src:r,...z(t,["alt","srcset","sizes"]),...i}),Ge(e,"load",()=>this.setItem(t,Oe(e)||e)),Ge(e,"error",()=>this.setError(t))}else if("video"===n||vo(r)){const e="inline"===this.videoAutoplay,n=fo("video",{src:r,playsinline:"",controls:e?null:"",loop:e?"":null,muted:e?"":null,poster:this.videoAutoplay?null:t.poster,"uk-video":Boolean(this.videoAutoplay),...i})
Ge(n,"loadedmetadata",()=>this.setItem(t,n)),Ge(n,"error",()=>this.setError(t))}else if("iframe"===n||r.match(/\.(html|php)($|\?)/i))this.setItem(t,fo("iframe",{src:r,allowfullscreen:"",class:"uk-lightbox-iframe",...i}))
else if(o=r.match(/\/\/(?:.*?youtube(-nocookie)?\..*?(?:[?&]v=|\/shorts\/)|youtu\.be\/)([\w-]{11})[&?]?(.*)?/))this.setItem(t,fo("iframe",{src:`https://www.youtube${o[1]||""}.com/embed/${o[2]}${o[3]?`?${o[3]}`:""}`,width:1920,height:1080,...s,...i}))
else if(o=r.match(/\/\/.*?vimeo\.[a-z]+\/(\d+)[&?]?(.*)?/))try{const{height:e,width:n}=await(await fetch(`https://vimeo.com/api/oembed.json?maxwidth=1920&url=${encodeURI(r)}`,{credentials:"omit"})).json()
this.setItem(t,fo("iframe",{src:`https://player.vimeo.com/video/${o[1]}${o[2]?`?${o[2]}`:""}`,width:n,height:e,...s,...i}))}catch{this.setError(t)}}},{name:"itemloaded",handler(){this.$emit("resize")}}],update:{read(){for(const e of Dt(`${this.selList} :not([controls]):is(img,video)`,this.$el))re(e,this.clsZoom,(e.naturalHeight||e.videoHeight)-this.$el.offsetHeight>Math.max(0,(e.naturalWidth||e.videoWidth)-this.$el.offsetWidth))},events:["resize"]},methods:{loadItem(e=this.index){const t=this.getItem(e)
...
function fo(e,t){const r=At(`<${e}>`)
return ie(r,t),r}function mo(e,t){const r=e.poster||e.thumb&&("image"===e.type||go(e.thumb))?fo("img",{src:e.poster||e.thumb,alt:""}):e.thumb&&("video"===e.type||vo(e.thumb))?fo("video",{src:e.thumb,loop:"",playsinline:"",muted:"","uk-video":"inline"===t}):fo("canvas")
return e.thumbRatio&&(r.style.aspectRatio=e.thumbRatio),r}function go(e){return null==e?void 0:e.match(/\.(avif|jpe?g|jfif|a?png|gif|svg|webp)($|\?)/i)}function vo(e){return null==e?void 0:e.match(/\.(mp4|webm|ogv)($|\?)/i)}var bo={install:function(e,t){e.lightboxPanel||e.component("lightboxPanel",po)
f(t.props,e.component("lightboxPanel").options.props)},props:{toggle:String},data:{toggle:"a"},computed:{toggles:({toggle:e},t)=>Dt(e,t)},watch:{toggles(e){this.hide()
for(const t of e)yt(t,"a")&&(t.role="button")}},disconnected(){this.hide()},events:{name:"click",delegate:({toggle:e})=>e,handler(e){e.defaultPrevented||(e.preventDefault(),Se(e.current,".uk-disabled *, .uk-disabled, [disabled]")||this.show(e.current))}},methods:{show(e){let t=this.toggles.map(wo)
if("thumbnav"===this.nav&&yo.call(this,this.toggles,t),t=H(t,"source"),_(e)){const{source:r}=wo(e)
...
function yo(e,t){for(const[r,n]of Object.entries(e)){if(t[r].thumb)continue
const e=Pe(n).reverse().concat(n).find(e=>this.$el.contains(e)&&(e===n||1===Dt(this.toggle,e).length))
if(!e)continue
const i=It("img,video",e)
i&&(t[r].thumb=i.currentSrc||i.poster||i.src,t[r].thumbRatio=(i.naturalWidth||i.videoWidth)/(i.naturalHeight||i.videoHeight))}}function wo(e){const t={}
for(const r of e.getAttributeNames()){const n=r.replace(/^data-/,"")
t["href"===n?"source":n]=e.getAttribute(r)}return t.attrs=cn(t.attrs),t}var _o={mixins:[si],functional:!0,args:["message","status"],data:{message:"",status:"",timeout:5e3,group:"",pos:"top-center",clsContainer:"uk-notification",clsClose:"uk-notification-close",clsMsg:"uk-notification-message"},install:function(e){e.notification.closeAll=function(t,r){Nt(document.body,n=>{const i=e.getComponent(n,"notification")
!i||t&&t!==i.group||i.close(r)})}},computed:{marginProp:({pos:e})=>`margin-${e.match(/[a-z]+(?=-)/)[0]}`,startProps(){return{opacity:0,[this.marginProp]:-this.$el.offsetHeight}}},created(){const e=`${this.clsContainer}-${this.pos}`,t=`data-${this.clsContainer}-container`,r=It(`.${e}[${t}]`,this.container)||Et(this.container,`<div class="${this.clsContainer} ${e}" ${t}></div>`)
this.$mount(Et(r,`<div class="${this.clsMsg}${this.status?` ${this.clsMsg}-${this.status}`:""}" role="alert">  <a href class="${this.clsClose}" data-uk-close></a>  <div>${this.message}</div>  </div>`))},async connected(){const e=R(st(this.$el,this.marginProp))
await pt.start(st(this.$el,this.startProps),{opacity:1,[this.marginProp]:e}),this.timeout&&(this.timer=setTimeout(this.close,this.timeout))},events:{click(e){Ln(e),this.close()},[me](){this.timer&&clearTimeout(this.timer)},[ge](){this.timeout&&(this.timer=setTimeout(this.close,this.timeout))}},methods:{async close(e){this.timer&&clearTimeout(this.timer),e||await pt.start(this.$el,this.startProps),(e=>{const t=Oe(e)
Ke(e,"close",[this]),Tt(e),(null==t?void 0:t.hasChildNodes())||Tt(t)})(this.$el)}}}
var xo={props:{media:Boolean},data:{media:!1},connected(){const e=function(e,t){if(C(e))if(l(e,"@"))e=R(st(t,`--uk-breakpoint-${e.slice(1)}`))
...
function Eo(e){return _e(e)?Math.ceil(Math.max(0,...Dt("[stroke]",e).map(e=>{var t
return(null==(t=e.getTotalLength)?void 0:t.call(e))||0}))):0}const Co={x:To,y:To,rotate:To,scale:To,color:So,backgroundColor:So,borderColor:So,blur:Po,hue:Po,fopacity:Po,grayscale:Po,invert:Po,saturate:Po,sepia:Po,opacity:function(e,t,r){1===r.length&&r.unshift(Ho(t,e,""))
return r=Do(r),(t,n)=>{t[e]=$o(r,n)}},stroke:function(e,t,r){1===r.length&&r.unshift(0)
const n=Bo(r),i=Eo(t)
if(r=Do(r.reverse(),e=>(e=R(e),"%"===n?e*i/100:e)),!r.some(([e])=>e))return q
return st(t,"strokeDasharray",i),(e,t)=>{e.strokeDashoffset=$o(r,t)}},bgx:Mo,bgy:Mo},{keys:ko}=Object
var Oo={mixins:[xo],props:zo(ko(Co),"list"),data:zo(ko(Co),void 0),computed:{props(e,t){const r={}
for(const i in e)i in Co&&!S(e[i])&&(r[i]=e[i].slice())
const n={}
for(const i in r)n[i]=Co[i](i,t,r[i],r)
return n}},events:{load(){this.$emit()}},methods:{reset(){at(this.$el,this.getCss(0))},getCss(e){const t={}
for(const r in this.props)this.props[r](t,U(e))
return t.willChange=Object.keys(t).map(lt).join(","),t}}}
function To(e,t,r){let n,i=Bo(r)||{x:"px",y:"px",rotate:"deg"}[e]||""
return"x"===e||"y"===e?(e=`translate${a(e)}`,n=e=>R(R(e).toFixed("px"===i?0:6))):"scale"===e&&(i="",n=e=>{var r
return Bo([e])?Gt(e,"width",t,!0)/t["offset"+((null==(r=e.endsWith)?void 0:r.call(e,"vh"))?"Height":"Width")]:R(e)}),1===r.length&&r.unshift("scale"===e?1:0),r=Do(r,n),(t,n)=>{t.transform=`${t.transform||""} ${e}(${$o(r,n)}${i})`}}function So(e,t,r){return 1===r.length&&r.unshift(Ho(t,e,"")),r=Do(r,e=>function(e,t){return Ho(e,"color",t).split(/[(),]/g).slice(1,-1).concat(1).slice(0,4).map(R)}(t,e)),(t,n)=>{const[i,o,s]=Lo(r,n),a=i.map((e,t)=>(e+=s*(o[t]-e),3===t?R(e):parseInt(e,10))).join(",")
t[e]=`rgba(${a})`}}function Po(e,t,r){1===r.length&&r.unshift(0)
const n=Bo(r)||{blur:"px",hue:"deg"}[e]||"%"
return e={fopacity:"opacity",hue:"hue-rotate"}[e]||e,r=Do(r),(t,i)=>{const o=$o(r,i)
t.filter=`${t.filter||""} ${e}(${o+n})`}}function Mo(e,t,r,n){1===r.length&&r.unshift(0)
const i="bgy"===e?"height":"width"
n[e]=Do(r,e=>Gt(e,i,t))
const o=["bgx","bgy"].filter(e=>e in n)
if(2===o.length&&"bgx"===e)return q
if("cover"===Ho(t,"backgroundSize",""))return function(e,t,r,n){const i=function(e){const t=st(e,"backgroundImage").replace(/^none|url\(["']?(.+?)["']?\)$/,"$1")
if(No[t])return No[t]
const r=new Image
if(t&&(r.src=t,!r.naturalWidth&&!jo[t]))return Ze(r,"error load",()=>{No[t]=Io(r),Ke(e,Xe("load",!1))}),jo[t]=!0,Io(r)
return No[t]=Io(r)}(t)
if(!i.width)return q
...
a[c]=`max(${Ro(t,c)},-${r}px) + ${a[c]}`}const u=Ao(s,a,n)
return(e,t)=>{u(e,t),e.backgroundSize=`${l.width}px ${l.height}px`,e.backgroundRepeat="no-repeat"}}(0,t,0,n)
const s={}
for(const a of o)s[a]=Ro(t,a)
return Ao(o,s,n)}function Ro(e,t){return Ho(e,`background-position-${t.slice(-1)}`,"")}function Ao(e,t,r){return function(n,i){for(const o of e){const e=$o(r[o],i)
n[`background-position-${o.slice(-1)}`]=`calc(${t[o]} + ${e}px)`}}}const jo={},No={}
function Io(e){return{width:e.naturalWidth,height:e.naturalHeight}}function Do(e,t=R){const r=[],{length:n}=e
let i=0
...
i=0}}return r}function Lo(e,t){const r=d(e.slice(1),([,e])=>t<=e)+1
return[e[r-1][0],e[r][0],(t-e[r-1][1])/(e[r][1]-e[r-1][1])]}function $o(e,t){const[r,n,i]=Lo(e,t)
return r+Math.abs(r-n)*i*(r<n?1:-1)}const Fo=/^-?\d+(?:\.\d+)?(\S+)?/
function Bo(e,t){var r
for(const n of e){const e=null==(r=n.match)?void 0:r.call(n,Fo)
if(e)return e[1]}return t}function Ho(e,t,r){const n=e.style[t],i=st(st(e,t,r),t)
return e.style[t]=n,i}function zo(e,t){return e.reduce((e,r)=>(e[r]=t,e),{})}function Uo(e,t){return t>=0?Math.pow(e,t+1):1-Math.pow(1-e,1-t)}var qo={mixins:[Oo],props:{target:String,viewport:Number,easing:Number,start:String,end:String},data:{target:!1,viewport:1,easing:1,start:0,end:0},computed:{target:({target:e},t)=>Vo(e&&Ne(e,t)||t),start({start:e}){return Gt(e,"height",this.target,!0)},end({end:e,viewport:t}){return Gt(e||(t=100*(1-t))&&`${t}vh+${t}%`,"height",this.target,!0)}},observe:[bn(),yn({target:({target:e})=>e}),fn({target:({$el:e,target:t})=>[e,t,Rr(t,!0)]})],update:{read({percent:e},t){if(t.has("scroll")||(e=!1),!_e(this.$el))return!1
if(!this.matchMedia)return
const r=e
return{percent:e=Uo(Pr(this.target,this.start,this.end),this.easing),style:r!==e&&this.getCss(e)}},write({style:e}){this.matchMedia?e&&st(this.$el,e):this.reset()},events:["scroll","resize"]}}
function Vo(e){return e?"offsetTop"in e?e:Vo(Oe(e)):document.documentElement}var Wo={props:{parallax:Boolean,parallaxTarget:Boolean,parallaxStart:String,parallaxEnd:String,parallaxEasing:Number},data:{parallax:!1,parallaxTarget:!1,parallaxStart:0,parallaxEnd:0,parallaxEasing:0},observe:[fn({target:({$el:e,parallaxTarget:t})=>[e,t],filter:({parallax:e})=>e}),yn({filter:({parallax:e})=>e})],computed:{parallaxTarget({parallaxTarget:e},t){return e&&Ne(e,t)||this.list}},update:{read(){if(!this.parallax)return!1
const e=this.parallaxTarget
if(!e)return!1
const t=Uo(Pr(e,Gt(this.parallaxStart,"height",e,!0),Gt(this.parallaxEnd,"height",e,!0)),this.parallaxEasing)
...
var Yo={update:{write(){if(this.stack.length||this.dragging||this.parallax)return
const e=this.getValidIndex()
~this.prevIndex&&this.index===e?this._translate(1):this.show(e)},events:["resize"]}},Go={observe:vn({target:({slides:e})=>e,targets:e=>e.getAdjacentSlides()}),methods:{getAdjacentSlides(){return[1,-1].map(e=>this.slides[this.getIndex(this.index+e)])}}}
function Qo(e,t,r){const n=Xo(e,t)
return r?n-function(e,t){return(Ft(t).width-Ft(e).width)/2}(e,t):Math.min(n,Zo(t))}function Zo(e){return Math.max(0,Ko(e)-Ft(e).width)}function Ko(e,t){return B(Me(e).slice(0,t),e=>Ft(e).width)}function Xo(e,t){return e&&(Ht(e).left+(ue?Ft(e).width-Ft(t).width:0))*(ue?-1:1)||0}function Jo(e,t){t-=1
const r=Ft(e).width,n=t+r+2
return Me(e).filter(i=>{const o=Xo(i,e),s=o+Math.min(Ft(i).width,r)
return o>=t&&s<=n})}var es={mixins:[tn,so,Yo,Wo,Go],props:{center:Boolean,sets:Boolean,active:String},data:{center:!1,sets:!1,attrItem:"uk-slider-item",selList:".uk-slider-items",selNav:".uk-slider-nav",clsContainer:"uk-slider-container",active:"all",Transitioner:function(e,t,r,{center:n,easing:i,list:o}){const s=e?Qo(e,o,n):Qo(t,o,n)+Ft(t).width*r,a=t?Qo(t,o,n):s+Ft(e).width*r*(ue?-1:1),{promise:l,resolve:u}=Ci()
return{dir:r,show(t,n=0,s){const c=s?"linear":i
return t-=Math.round(t*U(n,-1,1)),st(o,"transitionProperty","none"),this.translate(n),st(o,"transitionProperty",""),n=e?n:U(n,0,1),Ei(this.getItemIn(),"itemin",{percent:n,duration:t,timing:c,dir:r}),e&&Ei(this.getItemIn(!0),"itemout",{percent:1-n,duration:t,timing:c,dir:r}),pt.start(o,{transform:xi(-a*(ue?-1:1),"px")},t,c).then(u,q),l},cancel:()=>pt.cancel(o),reset(){st(o,"transform","")},async forward(e,t=this.percent()){return await this.cancel(),this.show(e,t,!0)},translate(n){if(n===this.percent())return
const i=this.getDistance()*r*(ue?-1:1)
st(o,"transform",xi(U(i-i*n-a,-Ko(o),Ft(o).width)*(ue?-1:1),"px"))
const s=this.getActives(),l=this.getItemIn(),u=this.getItemIn(!0)
n=e?U(n,-1,1):0
for(const a of Me(o)){const i=c(s,a),d=a===l,h=a===u
Ei(a,"itemtranslate"+(d||!h&&(i||r*(ue?-1:1)==-1^Xo(a,o)>Xo(e||t))?"in":"out"),{dir:r,percent:h?1-n:d?n:i?1:0})}},percent:()=>Math.abs((new DOMMatrix(st(o,"transform")).m41*(ue?-1:1)+s)/(a-s)),getDistance:()=>Math.abs(a-s),getItemIn(r=!1){let i=this.getActives(),s=Jo(o,Qo(t||e,o,n))
if(r){const e=i
i=s,s=e}return s[d(s,e=>!c(i,e))]},getActives:()=>Jo(o,Qo(e||t,o,n))}}},computed:{finite({finite:e}){return e||function(e,t){if(!e||e.length<2)return!0
const{width:r}=Ft(e)
if(!t)return Math.ceil(Ko(e))<Math.trunc(r+function(e){return Math.max(0,...Me(e).map(e=>Ft(e).width))}(e))
const n=Me(e),i=Math.trunc(r/2)
for(const o in n){const e=n[o],t=Ft(e).width,r=new Set([e])
let s=0
for(const a of[-1,1]){let e=t/2,l=0
for(;e<i;){const t=n[Z(+o+a+l++*a,n)]
if(r.has(t))return!0
e+=Ft(t).width,r.add(t)}s=Math.max(s,(t+Ft(n[Z(+o+a,n)]).width)/2-(e-i))}if(Math.trunc(s)>B(n.filter(e=>!r.has(e)),e=>Ft(e).width))return!0}return!1}(this.list,this.center)},maxIndex(){if(!this.finite||this.center&&!this.sets)return this.length-1
if(this.center)return L(this.sets)
let e=0
const t=Zo(this.list),r=d(this.slides,r=>{if(e>=t-.005)return!0
e+=Ft(r).width})
return~r?r:this.length-1},sets({sets:e}){if(!e||this.parallax)return
let t=0
const r=[],n=Ft(this.list).width
for(let i=0;i<this.length;i++){const e=Ft(this.slides[i]).width
t+e>n&&(t=0),this.center?t<n/2&&t+e+Ft(this.slides[Z(i+1,this.slides)]).width/2>n/2&&(r.push(i),t=(n-e)/2):0===t&&r.push(Math.min(i,this.maxIndex)),t+=e}return r.length?r:void 0},transitionOptions(){return{center:this.center,list:this.list}},slides(){return Me(this.list).filter(_e)}},connected(){re(this.$el,this.clsContainer,!It(`.${this.clsContainer}`,this.$el))},observe:fn({target:({slides:e,$el:t})=>[t,...e]}),update:{write(){for(const e of this.navItems){const t=M(ae(e,this.attrItem))
...
return void e.preventDefault()}const r=this.dir<0||!this.slides[this.prevIndex]?this.index:this.prevIndex,n=Ko(this.list)/this.length
this.duration=ao(n/this.velocity)*(Ft(this.slides[r]).width/n),this.reorder()},itemshow(){~this.prevIndex&&X(this._getTransitioner().getItemIn(),this.clsActive),this.updateActiveClasses(this.prevIndex)},itemshown(){this.updateActiveClasses()}},methods:{reorder(){if(this.finite)return void st(this.slides,"order","")
...
let r=(Ft(this.list).width-Ft(t).width)/2,n=0
for(;r>0;){const t=this.getIndex(--n+e,e),i=this.slides[t]
st(i,"order",t>e?-2:-1),r-=Ft(i).width}},updateActiveClasses(e=this.index){let t=this._getTransitioner(e).getActives()
...
re(i,n,e),i.ariaHidden=!e
for(const t of Dt(Ce,i))r(t,"_tabindex")||(t._tabindex=t.tabIndex),t.tabIndex=e?t._tabindex:-1}},getValidIndex(e=this.index,t=this.prevIndex){if(e=this.getIndex(e,t),!this.sets)return e
let r
do{if(c(this.sets,e))return e
r=e,e=this.getIndex(e+this.dir,t)}while(e!==r)
return e},getAdjacentSlides(){const{width:e}=Ft(this.list),t=-e,r=2*e,n=Ft(this.slides[this.index]).width,i=this.center?(e-n)/2:0,o=new Set
for(const s of[-1,1]){let e=i+(s>0?n:0),a=0
do{const t=this.slides[this.getIndex(this.index+s+a++*s)]
e+=Ft(t).width*s,o.add(t)}while(this.length>a&&e>t&&e<r)}return Array.from(o)},getIndexAt(e){let t=-1
let r=e*(this.center?Ko(this.list)-(Ft(this.slides[0]).width+Ft(L(this.slides)).width)/2:Ko(this.list,this.maxIndex)),n=0
do{const e=Ft(this.slides[++t]).width,i=this.center?(e+Ft(this.slides[t+1]).width)/2:e
n=r/i%1,r-=i}while(r>=0&&t<this.maxIndex)
return[t,n]}}}
var ts={mixins:[Oo],beforeConnect(){this.item=this.$el.closest(`.${this.$options.id.replace("parallax","items")} > *`)},disconnected(){this.item=null},events:[{name:"itemin itemout",self:!0,el:({item:e})=>e,handler({type:e,detail:{percent:t,duration:r,timing:n,dir:i}}){tr.read(()=>{if(!this.matchMedia)return
const o=this.getCss(ns(e,i,t)),s=this.getCss(rs(e)?.5:i>0?1:0)
tr.write(()=>{st(this.$el,o),pt.start(this.$el,s,r,n).catch(q)})})}},{name:"transitioncanceled transitionend",self:!0,el:({item:e})=>e,handler(){pt.cancel(this.$el)}},{name:"itemtranslatein itemtranslateout",self:!0,el:({item:e})=>e,handler({type:e,detail:{percent:t,dir:r}}){tr.read(()=>{if(!this.matchMedia)return void this.reset()
const n=this.getCss(ns(e,r,t))
tr.write(()=>st(this.$el,n))})}}]}
function rs(e){return u(e,"in")}function ns(e,t,r){return r/=2,rs(e)^t<0?r:1-r}var is={mixins:[tn,lo,Yo,Wo,Go],props:{ratio:String,minHeight:String,maxHeight:String},data:{ratio:"16:9",minHeight:void 0,maxHeight:void 0,selList:".uk-slideshow-items",attrItem:"uk-slideshow-item",selNav:".uk-slideshow-nav",Animations:uo},watch:{list(e){st(e,{aspectRatio:this.ratio?this.ratio.replace(":","/"):void 0,minHeight:this.minHeight,maxHeight:this.maxHeight,width:"100%"})}},methods:{getAdjacentSlides(){return[1,-1].map(e=>this.slides[this.getIndex(this.index+e)])}}},os={mixins:[tn,Dn],props:{group:String,threshold:Number,clsItem:String,clsPlaceholder:String,clsDrag:String,clsDragState:String,clsBase:String,clsNoDrag:String,clsEmpty:String,clsCustom:String,handle:String},data:{group:!1,threshold:5,clsItem:"uk-sortable-item",clsPlaceholder:"uk-sortable-placeholder",clsDrag:"uk-sortable-drag",clsDragState:"uk-drag",clsBase:"uk-sortable",clsNoDrag:"uk-sortable-nodrag",clsEmpty:"uk-sortable-empty",clsCustom:"",handle:!1,pos:{}},events:{name:he,passive:!1,handler(e){this.init(e)}},computed:{target:(e,t)=>(t.tBodies||[t])[0],items(){return Me(this.target)},isEmpty(){return!this.items.length},handles({handle:e},t){return e?Dt(e,t):this.items}},watch:{isEmpty(e){re(this.target,this.clsEmpty,e)},handles(e,t){const r={touchAction:"none",userSelect:"none"}
at(t,r),st(e,r)}},update:{write(e){if(!this.drag||!Oe(this.placeholder))return
...
if(!s)return
const{items:a}=s
if(a.some(pt.inProgress))return
const l=function(e,t){return e[d(e,e=>W(t,Ft(e)))]}(a,{x:t,y:r})
...
r&&Et(e,t)
const n=Me(e),i=n.some((e,t)=>{const r=Ft(e)
return n.slice(t+1).some(e=>{const t=Ft(e)
return!as([r.left,r.right],[t.left,t.right])})})
r&&Tt(t)
return i}(e,r)||i<s.top+s.height/2?t:t.nextElementSibling
const a=Ft(r),l=as([s.top,s.bottom],[a.top,a.bottom]),[u,c,d,h]=l?[n,"width","left","right"]:[i,"height","top","bottom"],p=a[c]<s[c]?s[c]-a[c]:0
...
if(yt(t,"li","tr")){r=It("<div>"),Et(r,t.cloneNode(!0).children)
for(const e of t.getAttributeNames())ie(r,e,t.getAttribute(e))}else r=t.cloneNode(!0)
return Et(e,r),st(r,"margin","0","important"),st(r,{boxSizing:"border-box",width:t.offsetWidth,height:t.offsetHeight,padding:st(t,"padding")}),Ut(r.firstElementChild,Ut(t.firstElementChild)),r}(this.$container,this.placeholder)
const{left:t,top:r}=Ft(this.placeholder)
...
ss=setInterval(()=>{let{x:r,y:n}=e
n+=document.scrollingElement.scrollTop
const i=.3*(Date.now()-t)
t=Date.now(),Mr(document.elementFromPoint(r,e.y)).reverse().some(e=>{let{scrollTop:t,scrollHeight:r}=e
const{top:o,bottom:s,height:a}=jr(e)
if(o<n&&o+35>n)t-=i
...
this===e?this.origin.index!==Re(this.placeholder)&&Ke(this.$el,"moved",[this,this.placeholder]):(Ke(e.$el,"added",[e,this.placeholder]),Ke(this.$el,"removed",[this,this.placeholder])),Ke(this.$el,"stop",[this,this.placeholder]),Tt(this.drag),this.drag=null
for(const{clsPlaceholder:t,clsItem:r}of this.touched)for(const e of this.touched)J(e.items,t,r)
this.touched=null,J(document.documentElement,this.clsDragState)},insert(e,t){X(this.items,this.clsItem),t&&t.previousElementSibling!==e?this.animate(()=>Ct(t,e)):t||this.target.lastElementChild===e||this.animate(()=>Et(this.target,e))},remove(e){this.target.contains(e)&&this.animate(()=>Tt(e))},getSortable(e){do{const t=this.$getComponent(e,"sortable")
if(t&&(t===this||!1!==this.group&&t.group===this.group))return t}while(e=Oe(e))}}}
let ss
function as(e,t){return e[1]>t[0]&&t[1]>e[0]}var ls={mixins:[si,ui,ai],data:{pos:"top",animation:["uk-animation-scale-up"],duration:100,cls:"uk-active"},connected(){var e
ke(e=this.$el)||(e.tabIndex=0)},disconnected(){this.hide()},methods:{show(){if(this.isToggled(this.tooltip||null))return
const{delay:e=0,title:t}=function(e){const{el:t,id:r,data:n}=e
return["delay","title"].reduce((e,r)=>({[r]:ae(t,r),...e}),{...cn(ae(t,r),["title"]),...n})}(this.$options)
if(!t)return
...
Se(this.$el,"input:focus")||(clearTimeout(this.showTimer),this.isToggled(this.tooltip||null)&&await this.toggleElement(this.tooltip,!1,!1),null==(e=this.reset)||e.call(this),Tt(this.tooltip),this.tooltip=null)},async _show(e,t){this.tooltip=Et(this.container,`<div id="${t}" class="uk-${this.$options.name}" role="tooltip">  <div class="uk-${this.$options.name}-inner">${e}</div>  </div>`),Ge(this.tooltip,"toggled",(e,t)=>{if(!t)return
const r=()=>this.positionAt(this.tooltip,this.$el)
r()
const[n,i]=function(e,t,[r,n]){const i=Bt(e),o=Bt(t),s=[["left","right"],["top","bottom"]]
...
this.origin="y"===this.axis?`${Yt(n)}-${i}`:`${i}-${Yt(n)}`
const o=[Ze(document,`keydown ${he}`,this.hide,!1,e=>e.type===he&&!this.$el.contains(e.target)||"keydown"===e.type&&e.keyCode===Fn),Ge([document,...Ar(this.$el)],"scroll",r,{passive:!0})]
Ze(this.tooltip,"hide",()=>o.forEach(e=>e()),{self:!0})}),await this.toggleElement(this.tooltip,!0)||this.hide()}},events:{[`focus ${me} ${he}`](e){nt(e)&&e.type!==he||"loading"===document.readyState||this.show()}}}
var us={mixins:[ki],i18n:{invalidMime:"Invalid File Type: %s",invalidName:"Invalid File Name: %s",invalidSize:"Invalid File Size: %s Kilobytes Max"},props:{allow:String,clsDragover:String,concurrent:Number,maxSize:Number,method:String,mime:String,multiple:Boolean,name:String,params:Object,type:String,url:String},data:{allow:!1,clsDragover:"uk-dragover",concurrent:1,maxSize:0,method:"POST",mime:!1,multiple:!1,name:"files[]",params:{},type:"",url:"",abort:q,beforeAll:q,beforeSend:q,complete:q,completeAll:q,error:q,fail:q,load:q,loadEnd:q,loadStart:q,progress:q},events:{change(e){Se(e.target,'input[type="file"]')&&(e.preventDefault(),e.target.files&&this.upload(e.target.files),e.target.value="")},drop(e){ds(e)
const t=e.dataTransfer;(null==t?void 0:t.files)&&(J(this.$el,this.clsDragover),this.upload(t.files))},dragenter(e){ds(e)},dragover(e){ds(e),X(this.$el,this.clsDragover)},dragleave(e){ds(e),J(this.$el,this.clsDragover)}},methods:{async upload(e){if(!(e=p(e)).length)return
Ke(this.$el,"upload",[e])
for(const n of e){if(this.maxSize&&1e3*this.maxSize<n.size)return void this.fail(this.t("invalidSize",this.maxSize))
if(this.allow&&!cs(this.allow,n.name))return void this.fail(this.t("invalidName",this.allow))
if(this.mime&&!cs(this.mime,n.type))return void this.fail(this.t("invalidMime",this.mime))}this.multiple||(e=e.slice(0,1)),this.beforeAll(this,e)
...
for(const e in t)if(e in i)try{i[e]=t[e]}catch{}i.open(t.method.toUpperCase(),e)
...
await r(t.shift())}}}
function cs(e,t){return t.match(new RegExp(`^${e.replace(/\//g,"\\/").replace(/\*\*/g,"(\\/[^\\/]+)*").replace(/\*/g,"[^\\/]+").replace(/((?!\\))\?/g,"$1.")}$`,"i"))}function ds(e){e.preventDefault(),e.stopPropagation()}var hs=Object.freeze({__proto__:null,Countdown:nn,Filter:Yn,Lightbox:bo,LightboxPanel:po,Notification:_o,Parallax:qo,Slider:es,SliderParallax:ts,Slideshow:is,SlideshowParallax:ts,Sortable:os,Tooltip:ls,Upload:us})
function ps(e){Ke(document,"uikit:init",e),document.body&&Nt(document.body,ms),new MutationObserver(fs).observe(document,{subtree:!0,childList:!0,attributes:!0}),e._initialized=!0}function fs(e){var t
for(const{addedNodes:r,removedNodes:n,target:i,attributeName:o}of e){for(const t of r)Nt(t,ms)
for(const t of n)Nt(t,gs)
const e=o&&vs(o)
e&&(oe(i,o)?Xi(e,i):null==(t=eo(i,e))||t.$destroy())}}function ms(e){const t=Ji(e)
for(const r in t)qi(t[r])
for(const r of e.getAttributeNames()){const t=vs(r)
t&&Xi(t,e)}}function gs(e){const t=Ji(e)
for(const r in t)Vi(t[r])}function vs(e){l(e,"data-")&&(e=e.slice(5))
const t=Zi[e]
return t&&(t.options||t).name}(function(e){let t
e.component=Ki,e.getComponents=Ji,e.getComponent=eo,e.update=to,e.use=function(e){if(!e.installed)return e.call(null,this),e.installed=!0,this},e.mixin=function(e,t){(t=(C(t)?this.component(t):t)||this).options=un(t.options,e)},e.extend=function(e){e||(e={})
const t=this,r=function(e){Yi(this,e)}
return(r.prototype=Object.create(t.prototype)).constructor=r,r.options=un(t.options,e),r.super=t,r.extend=t.extend,r},Object.defineProperty(e,"container",{get:()=>t||document.body,set(e){t=It(e)}})})(Gi),function(e){e.prototype.$mount=function(e){const t=this;(function(e,t){e[Qi]||(e[Qi]={}),e[Qi][t.$options.name]=t})(e,t),t.$options.el=e,e.isConnected&&qi(t)},e.prototype.$destroy=function(e=!1){const t=this,{el:r}=t.$options
r&&Vi(t),Ui(t,"destroy"),function(e,t){var r
null==(r=e[Qi])||delete r[t.$options.name],T(e[Qi])&&delete e[Qi]}(r,t),e&&Tt(t.$el)},e.prototype.$create=Xi,e.prototype.$emit=function(e){pn(this,e)},e.prototype.$update=function(e=this.$el,t){to(e,t)},e.prototype.$reset=function(){Vi(this),qi(this)},e.prototype.$getComponent=eo,Object.defineProperties(e.prototype,{$el:{get(){return this.$options.el}},$container:Object.getOwnPropertyDescriptor(e,"container")})}(Gi)
var bs={mixins:[tn,ui],props:{animation:Boolean,targets:String,active:null,collapsible:Boolean,multiple:Boolean,toggle:String,content:String,offset:Number},data:{targets:"> *",active:!1,animation:!0,collapsible:!0,multiple:!1,clsOpen:"uk-open",toggle:".uk-accordion-title",content:".uk-accordion-content",offset:0},computed:{items:({targets:e},t)=>Dt(e,t),toggles({toggle:e}){return this.items.map(t=>It(e,t))},contents({content:e}){return this.items.map(t=>{var r
return(null==(r=t._wrapper)?void 0:r.firstElementChild)||It(e,t)})}},watch:{items(e,t){if(t||te(e,this.clsOpen))return
...
ys(t,!e)}this.$emit()}},observe:vn(),events:[{name:"click keydown",delegate:({targets:e,$props:t})=>`${e} ${t.toggle}`,handler(e){if("keydown"===e.type&&e.keyCode!==Bn)return
Ln(e)
const t=function(e){const t=Rr(e,!0)
let r
return function n(){r=requestAnimationFrame(()=>{const{top:r}=Ft(e)
r<0&&(t.scrollTop+=r),n()})}(),()=>requestAnimationFrame(()=>cancelAnimationFrame(r))}(e.target)
this.toggle(Re(this.toggles,e.current)).finally(t)}},{name:"show hide shown hidden",self:!0,delegate:({targets:e})=>e,handler(){this.$emit()}}],update(){const e=Te(this.items,`.${this.clsOpen}`)
for(const t in this.items){const r=this.toggles[t],n=this.contents[t]
if(!r||!n)continue
r.id=io(this,r),n.id=io(this,n)
const i=c(e,this.items[t])
ie(r,{role:yt(r,"a")?"button":null,"aria-controls":n.id,"aria-expanded":i,"aria-disabled":!this.collapsible&&e.length<2&&i}),ie(n,{role:"region","aria-labelledby":r.id}),yt(n,"ul")&&ie(Me(n),"role","presentation")}},methods:{toggle(e,t){let r=[e=this.items[Z(e,this.items)]]
const n=Te(this.items,`.${this.clsOpen}`)
return this.multiple||c(n,r[0])||(r=r.concat(n)),!this.collapsible&&n.length<2&&c(n,e)&&(r=[]),Promise.all(r.map(e=>this.toggleElement(e,!c(n,e),(e,r)=>{if(re(e,this.clsOpen,r),!1!==t&&this.animation)return async function(e,t,{content:r,duration:n,velocity:i,transition:o}){var s
r=(null==(s=e._wrapper)?void 0:s.firstElementChild)||It(r,e),e._wrapper||(e._wrapper=St(r,"<div>"))
const a=e._wrapper
st(a,"overflow","hidden")
const l=R(st(a,"height"))
await pt.cancel(a),ys(r,!1)
const u=B(["marginTop","marginBottom"],e=>st(r,e))+Ft(r).height,c=l/u
n=u?(i*u+n)*(t?1-c:c):0,st(a,"height",l),await pt.start(a,{height:t?u:0},n,o),Mt(r),delete e._wrapper,t||ys(r,!0)}(e,r,this)
ys(It(this.content,e),!r)})))}}}
function ys(e,t){e&&(e.hidden=t)}var ws={mixins:[tn,ui],args:"animation",props:{animation:Boolean,close:String},data:{animation:!0,selClose:".uk-alert-close",duration:150},events:{name:"click",delegate:({selClose:e})=>e,handler(e){Ln(e),this.close()}},methods:{async close(){await this.toggleElement(this.$el,!1,_s),this.$destroy(!0)}}}
function _s(e,t,{duration:r,transition:n,velocity:i}){const o=R(st(e,"height"))
return st(e,"height",o),pt.start(e,{height:0,marginTop:0,marginBottom:0,paddingTop:0,paddingBottom:0,borderTop:0,borderBottom:0,opacity:0},i*o+r,n)}var xs={args:"autoplay",props:{automute:Boolean,autoplay:Boolean,restart:Boolean,hoverTarget:Boolean},data:{automute:!1,autoplay:!0,restart:!1,hoverTarget:!1},beforeConnect(){const e=yt(this.$el,"video")
"inview"===this.autoplay&&e&&!oe(this.$el,"preload")&&(this.$el.preload="none"),e||oe(this.$el,"allow")||(this.$el.allow="autoplay"),"hover"===this.autoplay&&(e?this.$el.tabIndex=0:this.autoplay=!0),(this.automute||oe(this.$el,"muted"))&&br(this.$el)},events:[{name:`${me} focusin`,el:({hoverTarget:e,$el:t})=>Ne(e,t)||t,filter:({autoplay:e})=>c(e,"hover"),handler(e){var t
!nt(e)||((t=this.$el).paused||t.ended)?gr(this.$el):Es(this.$el,this.restart)}},{name:`${ge} focusout`,el:({hoverTarget:e,$el:t})=>Ne(e,t)||t,filter:({autoplay:e})=>c(e,"hover"),handler(e){nt(e)||Es(this.$el,this.restart)}}],observe:[mn({filter:({$el:e})=>"none"===e.preload,handler([{target:e}]){e.preload="",this.$reset()}}),mn({filter:({$el:e,autoplay:t})=>"hover"!==t&&"none"!==e.preload,handler([{isIntersecting:e,target:t}]){document.fullscreenElement||(e?this.autoplay&&gr(t):Es(t,this.restart))},args:{intersecting:!1},options:({$el:e,autoplay:t})=>({root:"inview"===t?null:Oe(e).closest(":not(a)")})})]}
function Es(e,t){vr(e),t&&yt(e,"video")&&(e.currentTime=0)}var Cs={mixins:[xs],props:{width:Number,height:Number},data:{automute:!0},created(){this.useObjectFit=yt(this.$el,"img","video")},observe:fn({target:({$el:e})=>ks(e)||Oe(e),filter:({useObjectFit:e})=>!e}),update:{read(){if(this.useObjectFit)return!1
const{$el:e,width:t=e.clientWidth,height:r=e.clientHeight}=this,n=ks(e)||Oe(e),i=Q.cover({width:t,height:r},{width:n.offsetWidth,height:n.offsetHeight})
return!(!i.width||!i.height)&&i},write({height:e,width:t}){st(this.$el,{height:e,width:t})},events:["resize"]}}
function ks(e){for(;e=Oe(e);)if("static"!==st(e,"position"))return e}let Os
var Ts={mixins:[tn,si,ai,ui],args:"pos",props:{mode:"list",toggle:Boolean,boundary:Boolean,boundaryX:Boolean,boundaryY:Boolean,target:Boolean,targetX:Boolean,targetY:Boolean,stretch:Boolean,delayShow:Number,delayHide:Number,autoUpdate:Boolean,animateOut:Boolean,bgScroll:Boolean,closeOnScroll:Boolean},data:{mode:["click","hover"],toggle:"- *",boundary:!1,boundaryX:!1,boundaryY:!1,target:!1,targetX:!1,targetY:!1,stretch:!1,delayShow:0,delayHide:800,autoUpdate:!0,animateOut:!1,bgScroll:!0,animation:["uk-animation-fade"],cls:"uk-open",container:!1,closeOnScroll:!1,selClose:".uk-drop-close"},computed:{boundary:({boundary:e,boundaryX:t,boundaryY:r},n)=>[Ne(t||e,n)||window,Ne(r||e,n)||window],target({target:e,targetX:t,targetY:r},n){return t||(t=e||this.targetEl),r||(r=e||this.targetEl),[!0===t?window:Ne(t,n),!0===r?window:Ne(r,n)]}},created(){this.tracker=new ur},connected(){X(this.$el,"uk-drop"),this.toggle&&!this.targetEl&&(this.targetEl=function(e){const{$el:t}=e.$create("toggle",Ne(e.toggle,e.$el),{target:e.$el,mode:e.mode})
return t.ariaHasPopup=!0,t}(this)),ie(this.targetEl,"aria-expanded",!1),this._style=z(this.$el.style,["width","height"])},disconnected(){this.isActive()&&(this.hide(!1),Os=null),st(this.$el,this._style)},events:[{name:"click",delegate:({selClose:e})=>e,handler(e){Ln(e),this.hide(!1)}},{name:"click",delegate:()=>'a[href*="#"]',handler({defaultPrevented:e,current:t}){const{hash:r}=t
!e&&r&&Ae(t)&&!this.$el.contains(It(r))&&this.hide(!1)}},{name:"beforescroll",handler(){this.hide(!1)}},{name:"toggle",self:!0,handler(e,t){e.preventDefault(),this.isToggled()?this.hide(!1):this.show(null==t?void 0:t.$el,!1)}},{name:"toggleshow",self:!0,handler(e,t){e.preventDefault(),this.show(null==t?void 0:t.$el)}},{name:"togglehide",self:!0,handler(e){e.preventDefault(),Se(this.$el,":focus,:hover")||this.hide()}},{name:`${me} focusin`,filter:({mode:e})=>c(e,"hover"),handler(e){nt(e)||this.clearTimers()}},{name:`${ge} focusout`,filter:({mode:e})=>c(e,"hover"),handler(e){!nt(e)&&e.relatedTarget&&this.hide()}},{name:"toggled",self:!0,handler(e,t){t&&(this.clearTimers(),this.position())}},{name:"show",self:!0,handler(){Os=this,this.tracker.init(),ie(this.targetEl,"aria-expanded",!0)
const e=[Ss(this),Ms(this),As(this),this.autoUpdate&&Ps(this),this.closeOnScroll&&Rs(this)]
Ze(this.$el,"hide",()=>e.forEach(e=>e&&e()),{self:!0}),this.bgScroll||Ze(this.$el,"hidden",oi(this.$el),{self:!0})}},{name:"beforehide",self:!0,handler(){this.clearTimers()}},{name:"hide",handler({target:e}){this.$el===e?(Os=this.isActive()?null:Os,this.tracker.cancel(),ie(this.targetEl,"aria-expanded",!1)):Os=null===Os&&this.$el.contains(e)&&this.isToggled()?this:Os}}],update:{write(){this.isToggled()&&!te(this.$el,this.clsEnter)&&this.position()}},methods:{show(e=this.targetEl,t=!0){if(this.isToggled()&&e&&this.targetEl&&e!==this.targetEl&&this.hide(!1,!1),this.targetEl=e,this.clearTimers(),!this.isActive()){if(Os){if(t&&Os.isDelaying())return void(this.showTimer=setTimeout(()=>Se(e,":hover")&&this.show(),10))
let r
for(;Os&&r!==Os&&!Os.$el.contains(this.$el);)r=Os,Os.hide(!1,!1)
t=!1}this.container&&Oe(this.$el)!==this.container&&Et(this.container,this.$el),this.showTimer=setTimeout(()=>this.toggleElement(this.$el,!0),t&&this.delayShow||0)}},hide(e=!0,t=!0){const r=()=>this.toggleElement(this.$el,!1,this.animateOut&&t)
this.clearTimers(),this.isDelayedHide=e,e&&this.isDelaying()?this.hideTimer=setTimeout(this.hide,50):e&&this.delayHide?this.hideTimer=setTimeout(r,this.delayHide):r()},clearTimers(){clearTimeout(this.showTimer),clearTimeout(this.hideTimer),this.showTimer=null,this.hideTimer=null},isActive(){return Os===this},isDelaying(){return[this.$el,...Dt(".uk-drop",this.$el)].some(e=>this.tracker.movesTo(e))},position(){const e=li(this.$el)
J(this.$el,"uk-drop-stack"),st(this.$el,this._style),this.$el.hidden=!0
const t=this.target.map(e=>function(e,t){return jr(Ar(t).find(t=>t.contains(e)))}(this.$el,e)),r=this.getViewportOffset(this.$el),n=[[0,["x","width","left","right"]],[1,["y","height","top","bottom"]]]
for(const[o,[s,a]]of n)this.axis!==s&&c([s,!0],this.stretch)&&st(this.$el,{[a]:Math.min(Bt(this.boundary[o])[a],t[o][a]-2*r),[`overflow-${s}`]:"auto"})
...
for(const[o,[s,a,l,u]]of n)if(this.axis===s&&c([s,!0],this.stretch)){const e=Math.abs(this.getPositionOffset()),n=Bt(this.target[o]),i=Bt(this.$el)
st(this.$el,{[a]:(n[l]>i[l]?n[this.inset?u:l]-Math.max(Bt(this.boundary[o])[l],t[o][l]+r):Math.min(Bt(this.boundary[o])[u],t[o][u]-r)-n[this.inset?l:u])-e,[`overflow-${s}`]:"auto"}),this.positionAt(this.$el,this.target,this.boundary)}e()}}}
function Ss(e){const t=()=>e.$emit(),r=[pr(t),hr(Ar(e.$el).concat(e.target),t)]
return()=>r.map(e=>e.disconnect())}function Ps(e,t=()=>e.$emit()){return Ge([document,...Ar(e.$el)],"scroll",t,{passive:!0})}function Ms(e){return Ge(document,"keydown",t=>{t.keyCode===Fn&&e.hide(!1)})}function Rs(e){return Ps(e,()=>e.hide(!1))}function As(e){return Ge(document,he,({target:t})=>{e.$el.contains(t)||Ze(document,`${fe} ${ve} scroll`,({defaultPrevented:r,type:n,target:i})=>{var o
r||n!==fe||t!==i||(null==(o=e.targetEl)?void 0:o.contains(t))||e.hide(!1)},!0)})}var js={mixins:[tn,si],props:{align:String,boundary:Boolean,dropbar:Boolean,dropbarAnchor:Boolean,duration:Number,mode:Boolean,offset:Boolean,stretch:Boolean,delayShow:Boolean,delayHide:Boolean,target:Boolean,targetX:Boolean,targetY:Boolean,animation:Boolean,animateOut:Boolean,closeOnScroll:Boolean},data:{align:ue?"right":"left",clsDrop:"uk-dropdown",clsDropbar:"uk-dropnav-dropbar",boundary:!0,dropbar:!1,dropbarAnchor:!1,flip:!0,delayShow:160,duration:200,container:!1,selNavItem:"> li > a, > ul > li > a"},computed:{dropbarAnchor:({dropbarAnchor:e},t)=>Ne(e,t)||t,dropbar({dropbar:e}){return e?(e=this._dropbar||Ne(e,this.$el)||It(`+ .${this.clsDropbar}`,this.$el))||(this._dropbar=It("<div>")):null},dropContainer(e,t){return this.container||t},dropdowns({clsDrop:e},t){var r
const n=Dt(`.${e}`,t)
if(this.dropContainer!==t)for(const i of Dt(`.${e}`,this.dropContainer)){const e=null==(r=this.getDropdown(i))?void 0:r.targetEl
!c(n,i)&&e&&this.$el.contains(e)&&n.push(i)}return n},items:({selNavItem:e},t)=>Dt(e,t)},watch:{dropbar(e){X(e,"uk-dropbar","uk-dropbar-top",this.clsDropbar,`uk-${this.$options.name}-dropbar`)},dropdowns(){this.initializeDropdowns()}},connected(){this.initializeDropdowns(),function(e){const t=()=>r.forEach(e=>e()),r=[Ze(e.ownerDocument,pe,r=>e.contains(r.target)||t()),Ge(e,`mouseenter ${me}`,e=>e.stopPropagation(),{capture:!0}),Ge(e,`mouseleave ${ge}`,t,{capture:!0})]}(this.$el)},disconnected(){Tt(this._dropbar),delete this._dropbar},events:[{name:"mouseover focusin",delegate:({selNavItem:e})=>e,handler({current:e}){const t=this.getActive()
...
if(n===Wn)if((null==i?void 0:i.targetEl)===r)e.preventDefault(),null==(t=It(Ce,i.$el))||t.focus()
else{const t=this.dropdowns.find(e=>{var t
return(null==(t=this.getDropdown(e))?void 0:t.targetEl)===r})
t&&(e.preventDefault(),r.click(),Ze(t,"show",e=>{var t
return null==(t=It(Ce,e.target))?void 0:t.focus()}))}Ns(e,this.items,i)}},{name:"keydown",el:({dropContainer:e})=>e,delegate:({clsDrop:e})=>`.${e}`,handler(e){var t
const{current:r,keyCode:n,target:i}=e
if(Ee(i)||!c(this.dropdowns,r))return
const o=this.getActive()
let s=-1
if(n===zn?s=0:n===Hn?s="last":n===qn?s="previous":n===Wn?s="next":n===Fn&&(null==(t=o.targetEl)||t.focus()),~s){e.preventDefault()
const t=Dt(Ce,r)
return void t[Z(s,t,d(t,e=>Se(e,":focus")))].focus()}Ns(e,this.items,o)}},{name:"mouseleave",el:({dropbar:e})=>e,filter:({dropbar:e})=>e,handler(){const e=this.getActive()
...
const t=this.getDropdown(e),r=()=>{const r=Math.max(...Pe(e,`.${this.clsDrop}`).concat(e).map(e=>Bt(e).bottom))
Bt(this.dropbar,{left:Bt(this.dropbar).left,top:this.getDropbarOffset(t.getPositionOffset())}),this.transitionTo(r-Bt(this.dropbar).top+R(st(e,"marginBottom")),e)}
this._observer=hr([t.$el,...t.target],r),r()}},{name:"beforehide",el:({dropContainer:e})=>e,filter:({dropbar:e})=>e,handler(e){const t=this.getActive()
...
return c(this.dropdowns,null==(e=Os)?void 0:e.$el)&&Os},async transitionTo(e,t){const{dropbar:r}=this,n=Ut(r)
if(t=n<e&&t,await pt.cancel([t,r]),t){const i=Bt(t).top-Bt(r).top-n
i>0&&st(t,"transitionDelay",i/e*this.duration+"ms")}st(t,"clipPath",`polygon(0 0,100% 0,100% ${n}px,0 ${n}px)`),Ut(r,n),await Promise.all([pt.start(r,{height:e},this.duration),pt.start(t,{clipPath:`polygon(0 0,100% 0,100% ${e}px,0 ${e}px)`},this.duration).finally(()=>st(t,{clipPath:"",transitionDelay:""}))]).catch(q)},getDropdown(e){return this.$getComponent(e,"drop")||this.$getComponent(e,"dropdown")},isDropbarDrop(e){return c(this.dropdowns,e)&&te(e,this.clsDrop)},getDropbarOffset(e){const{$el:t,target:r,targetY:n}=this,{top:i,height:o}=Bt(Ne(n||r||t,t))
return i+o+e},initializeDropdowns(){this.$create("drop",this.dropdowns.filter(e=>!this.getDropdown(e)),{...this.$props,flip:this.flip&&!this.$props.dropbar,shift:!0,pos:`bottom-${this.align}`,boundaryX:!0===this.boundary?this.$el:this.boundary})}}}
function Ns(e,t,r){var n,i,o
const{current:s,keyCode:a}=e
let l=-1
a===zn?l=0:a===Hn?l="last":a===Un?l="previous":a===Vn?l="next":a===$n&&(null==(n=r.targetEl)||n.focus(),null==(i=r.hide)||i.call(r,!1)),~l&&(e.preventDefault(),null==(o=r.hide)||o.call(r,!1),t[Z(l,t,t.indexOf(r.targetEl||s))].focus())}var Is={mixins:[tn],args:"target",props:{target:Boolean},data:{target:!1},computed:{input:(e,t)=>It(xe,t),state(){return this.input.nextElementSibling},target({target:e},t){return e&&(!0===e&&Oe(this.input)===t&&this.input.nextElementSibling||It(e,t))}},update(){var e
const{target:t,input:r}=this
if(!t)return
let n
const i=Ee(t)?"value":"textContent",o=t[i],s=(null==(e=r.files)?void 0:e[0])?r.files[0].name:Se(r,"select")&&(n=Dt("option",r).filter(e=>e.selected)[0])?n.textContent:r.value
o!==s&&(t[i]=s)},events:[{name:"change",handler(){this.$emit()}},{name:"reset",el:({$el:e})=>e.closest("form"),handler(){this.$emit()}}]},Ds={extends:xn,mixins:[tn],name:"grid",props:{masonry:Boolean,parallax:String,parallaxStart:String,parallaxEnd:String,parallaxJustify:Boolean},data:{margin:"uk-grid-margin",clsStack:"uk-grid-stack",masonry:!1,parallax:0,parallaxStart:0,parallaxEnd:0,parallaxJustify:!1},connected(){this.masonry&&X(this.$el,"uk-flex-top","uk-flex-wrap-top")},observe:yn({filter:({parallax:e,parallaxJustify:t})=>e||t}),update:[{write({rows:e}){re(this.$el,this.clsStack,!e.some(e=>e.length>1))},events:["resize"]},{read(e){const{rows:t}=e
let{masonry:r,parallax:n,parallaxJustify:i,margin:o}=this
if(n=Math.max(0,Gt(n)),!(r||n||i)||Ls(t)||t[0].some((e,r)=>t.some(t=>t[r]&&t[r].offsetWidth!==e.offsetWidth)))return e.translates=e.scrollColumns=!1
...
let s=0
for(let a of e){ue&&a.reverse()
let e=0
for(const l in a){const{offsetWidth:u,offsetHeight:c}=a[l],d=r?l:o.indexOf(Math.min(...o))
$s(n,d,a[l]),$s(i,d,[(d-l)*u*(ue?-1:1),o[d]-s]),o[d]+=c+t,e=Math.max(e,c)}s+=e+t}return[n,i]}(t,l,"next"===r):s=function(e){const t=[]
for(const r of e)for(const e in r)$s(t,e,r[e])
return t}(t)
const u=s.map(e=>B(e,"offsetHeight")+l*(e.length-1)),c=Math.max(0,...u)
let d,h,p
return(n||i)&&(d=u.map((e,t)=>i?c-e+n:n/(t%2||8)),i||(n=Math.max(...u.map((e,t)=>e+d[t]-c))),h=Gt(this.parallaxStart,"height",this.$el,!0),p=Gt(this.parallaxEnd,"height",this.$el,!0)),{columns:s,translates:a,scrollColumns:d,parallaxStart:h,parallaxEnd:p,padding:n,height:a?c:""}},write({height:e,padding:t}){st(this.$el,"paddingBottom",t||""),!1!==e&&st(this.$el,"height",e)},events:["resize"]},{read({rows:e,scrollColumns:t,parallaxStart:r,parallaxEnd:n}){return{scrolled:!(!t||Ls(e))&&Pr(this.$el,r,n)}},write({columns:e,scrolled:t,scrollColumns:r,translates:n}){(t||n)&&e.forEach((e,i)=>e.forEach((e,o)=>{let[s,a]=n&&n[i][o]||[0,0]
t&&(a+=t*r[i]),st(e,"transform",`translate(${s}px, ${a}px)`)}))},events:["scroll","resize"]}]}
function Ls(e){return e.flat().some(e=>"absolute"===st(e,"position"))}function $s(e,t,r){e[t]||(e[t]=[]),e[t].push(r)}var Fs={args:"target",props:{target:String,row:Boolean},data:{target:"> *",row:!0},computed:{elements:({target:e},t)=>Dt(e,t)},observe:fn({target:({$el:e,elements:t})=>t.reduce((e,t)=>e.concat(t,...t.children),[e])}),events:{name:"loadingdone",el:()=>document.fonts,handler(){this.$emit("resize")}},update:{read(){return{rows:(this.row?En(this.elements):[this.elements]).map(Bs)}},write({rows:e}){for(const{heights:t,elements:r}of e)r.forEach((e,r)=>st(e,"minHeight",t[r]))},events:["resize"]}}
function Bs(e){if(e.length<2)return{heights:[""],elements:e}
let t=e.map(Hs)
const r=Math.max(...t)
return{heights:e.map((e,n)=>t[n].toFixed(2)===r.toFixed(2)?"":r),elements:e}}function Hs(e){const t=z(e.style,["display","minHeight"])
_e(e)||st(e,"display","block","important"),st(e,"minHeight","")
const r=Ft(e).height-Wt(e,"height","content-box")
return st(e,t),r}var zs={args:"target",props:{target:String},data:{target:""},computed:{target:{get:({target:e},t)=>Ne(e,t),observe:({target:e})=>e}},observe:fn({target:({target:e})=>e}),update:{read(){return!!this.target&&{height:this.target.offsetHeight}},write({height:e}){st(this.$el,"minHeight",e)},events:["resize"]}},Us={mixins:[xo],props:{expand:Boolean,offsetTop:Boolean,offsetBottom:Boolean,min:Number,property:String},data:{expand:!1,offsetTop:!1,offsetBottom:!1,min:0,property:"min-height"},observe:[bn({filter:({expand:e})=>e}),fn({target:({$el:e})=>Mr(e)})],update:{read(){if(!_e(this.$el))return!1
if(!this.matchMedia)return{minHeight:!1}
let e=""
const t=Wt(this.$el,"height","content-box"),{body:r,scrollingElement:n}=document,i=Rr(this.$el),{height:o}=jr(i===r?n:i),s=n===i||r===i
if(e="calc("+(s?"100vh":`${o}px`),this.expand){e+=` - ${Ft(i).height-Ft(this.$el).height}px`}else{if(this.offsetTop)if(s){const t=!0===this.offsetTop?this.$el:Ne(this.offsetTop,this.$el),{top:r}=Bt(t)
e+=r>0&&r<o/2?` - ${r}px`:""}else e+=` - ${Wt(i,"height",st(i,"boxSizing"))}px`
!0===this.offsetBottom?e+=` - ${Ft(this.$el.nextElementSibling).height}px`:O(this.offsetBottom)?e+=` - ${this.offsetBottom}vh`:this.offsetBottom&&u(this.offsetBottom,"px")?e+=` - ${R(this.offsetBottom)}px`:C(this.offsetBottom)&&(e+=` - ${Ft(Ne(this.offsetBottom,this.$el)).height}px`)}return e+=(t?` - ${t}px`:"")+")",{minHeight:e}},write({minHeight:e}){st(this.$el,this.property,!1===e?"":`max(${this.min||0}px, ${e})`)},events:["resize"]}},qs='<svg width="20" height="20" viewBox="0 0 20 20"><circle fill="none" stroke="#000" stroke-width="1.1" cx="9" cy="9" r="7"/><path fill="none" stroke="#000" stroke-width="1.1" d="M14,14 L18,18 L14,14 Z"/></svg>',Vs={args:"src",props:{width:Number,height:Number,ratio:Number},data:{ratio:1},connected(){this.svg=this.getSvg().then(e=>{if(!this._connected)return
const t=function(e,t){if(ye(t)||yt(t,"canvas")){t.hidden=!0
const r=t.nextElementSibling
return Ws(e,r)?r:kt(t,e)}const r=t.lastElementChild
return Ws(e,r)?r:Et(t,e)}(e,this.$el)
return this.svgEl&&t!==this.svgEl&&Tt(this.svgEl),Ys.call(this,t,e),this.svgEl=t},q)},disconnected(){this.svg.then(e=>{this._connected||(ye(this.$el)&&(this.$el.hidden=!1),Tt(e),this.svgEl=null)}),this.svg=null},methods:{async getSvg(){}}}
function Ws(e,t){return yt(e,"svg")&&yt(t,"svg")&&e.innerHTML===t.innerHTML}function Ys(e,t){const r=["width","height"]
let n=r.map(e=>this[e])
n.some(e=>e)||(n=r.map(e=>ie(t,e)))
const i=ie(t,"viewBox")
i&&!n.some(e=>e)&&(n=i.split(" ").slice(2)),n.forEach((t,n)=>ie(e,r[n],R(t)*this.ratio||null))}function Gs(e,t){return t&&c(e,"<symbol")&&(e=Zs(e)[t]||e),j(At(e)).filter(_)[0]}const Qs=/<symbol([^]*?id=(['"])(.+?)\2[^]*?<\/)symbol>/g,Zs=K(function(e){const t={}
let r
for(;r=Qs.exec(e);)t[r[3]]=`<svg ${r[1]}svg>`
return t}),Ks={spinner:'<svg width="30" height="30" viewBox="0 0 30 30"><circle fill="none" stroke="#000" cx="15" cy="15" r="14"/></svg>',totop:'<svg width="18" height="10" viewBox="0 0 18 10"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 9 9 1 17 9"/></svg>',marker:'<svg width="20" height="20" viewBox="0 0 20 20"><rect width="1" height="11" x="9" y="4"/><rect width="11" height="1" x="4" y="9"/></svg>',"accordion-icon":'<svg width="13" height="13" viewBox="0 0 13 13"><style>.uk-accordion-icon svg&gt;[class*=&quot;line-&quot;]{transition:0.2s ease-out;transition-property:transform, opacity;transform-origin:center}[aria-expanded=&quot;true&quot;] .uk-accordion-icon svg&gt;.line-1{transform:rotate(-45deg);opacity:0}[aria-expanded=&quot;true&quot;] .uk-accordion-icon svg&gt;.line-2{transform:rotate(90deg)}</style><rect width="13" height="1" fill="#000" x="0" y="6" class="line-1"/><rect width="1" height="13" fill="#000" x="6" y="0" class="line-2"/></svg>',"close-icon":'<svg width="14" height="14" viewBox="0 0 14 14"><line fill="none" stroke="#000" stroke-width="1.1" x1="1" y1="1" x2="13" y2="13"/><line fill="none" stroke="#000" stroke-width="1.1" x1="13" y1="1" x2="1" y2="13"/></svg>',"close-large":'<svg width="20" height="20" viewBox="0 0 20 20"><line fill="none" stroke="#000" stroke-width="1.4" x1="1" y1="1" x2="19" y2="19"/><line fill="none" stroke="#000" stroke-width="1.4" x1="19" y1="1" x2="1" y2="19"/></svg>',"drop-parent-icon":'<svg width="12" height="12" viewBox="0 0 12 12"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 3.5 6 8.5 11 3.5"/></svg>',"nav-parent-icon":'<svg width="12" height="12" viewBox="0 0 12 12"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 3.5 6 8.5 11 3.5"/></svg>',"nav-parent-icon-large":'<svg width="14" height="14" viewBox="0 0 14 14"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 4 7 10 13 4"/></svg>',"navbar-parent-icon":'<svg width="12" height="12" viewBox="0 0 12 12"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 3.5 6 8.5 11 3.5"/></svg>',"navbar-toggle-icon":'<svg width="20" height="20" viewBox="0 0 20 20"><style>.uk-navbar-toggle-icon svg&gt;[class*=&quot;line-&quot;]{transition:0.2s ease-in-out;transition-property:transform, opacity;transform-origin:center;opacity:1}.uk-navbar-toggle-icon svg&gt;.line-3{opacity:0}[aria-expanded=&quot;true&quot;].uk-navbar-toggle-icon svg&gt;.line-3,[aria-expanded=&quot;true&quot;]&gt;.uk-navbar-toggle-icon svg&gt;.line-3{opacity:1}[aria-expanded=&quot;true&quot;].uk-navbar-toggle-icon svg&gt;.line-2,[aria-expanded=&quot;true&quot;]&gt;.uk-navbar-toggle-icon svg&gt;.line-2{transform:rotate(45deg)}[aria-expanded=&quot;true&quot;].uk-navbar-toggle-icon svg&gt;.line-3,[aria-expanded=&quot;true&quot;]&gt;.uk-navbar-toggle-icon svg&gt;.line-3{transform:rotate(-45deg)}[aria-expanded=&quot;true&quot;].uk-navbar-toggle-icon svg&gt;.line-1,[aria-expanded=&quot;true&quot;]&gt;.uk-navbar-toggle-icon svg&gt;.line-1,[aria-expanded=&quot;true&quot;].uk-navbar-toggle-icon svg&gt;.line-4,[aria-expanded=&quot;true&quot;]&gt;.uk-navbar-toggle-icon svg&gt;.line-4{opacity:0}[aria-expanded=&quot;true&quot;].uk-navbar-toggle-icon svg&gt;.line-1,[aria-expanded=&quot;true&quot;]&gt;.uk-navbar-toggle-icon svg&gt;.line-1{transform:translateY(6px) scaleX(0)}[aria-expanded=&quot;true&quot;].uk-navbar-toggle-icon svg&gt;.line-4,[aria-expanded=&quot;true&quot;]&gt;.uk-navbar-toggle-icon svg&gt;.line-4{transform:translateY(-6px) scaleX(0)}</style><rect width="20" height="2" y="3" class="line-1"/><rect width="20" height="2" y="9" class="line-2"/><rect width="20" height="2" y="9" class="line-3"/><rect width="20" height="2" y="15" class="line-4"/></svg>',"overlay-icon":'<svg width="40" height="40" viewBox="0 0 40 40"><rect width="1" height="40" x="19" y="0"/><rect width="40" height="1" x="0" y="19"/></svg>',"pagination-next":'<svg width="7" height="12" viewBox="0 0 7 12"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 1 6 6 1 11"/></svg>',"pagination-previous":'<svg width="7" height="12" viewBox="0 0 7 12"><polyline fill="none" stroke="#000" stroke-width="1.2" points="6 1 1 6 6 11"/></svg>',"search-icon":qs,"search-medium":'<svg width="24" height="24" viewBox="0 0 24 24"><circle fill="none" stroke="#000" stroke-width="1.1" cx="10.5" cy="10.5" r="9.5"/><line fill="none" stroke="#000" stroke-width="1.1" x1="23" y1="23" x2="17" y2="17"/></svg>',"search-large":'<svg width="40" height="40" viewBox="0 0 40 40"><circle fill="none" stroke="#000" stroke-width="1.8" cx="17.5" cy="17.5" r="16.5"/><line fill="none" stroke="#000" stroke-width="1.8" x1="38" y1="39" x2="29" y2="30"/></svg>',"search-toggle-icon":qs,"slidenav-next":'<svg width="14" height="24" viewBox="0 0 14 24"><polyline fill="none" stroke="#000" stroke-width="1.4" points="1.225,23 12.775,12 1.225,1"/></svg>',"slidenav-next-large":'<svg width="25" height="40" viewBox="0 0 25 40"><polyline fill="none" stroke="#000" stroke-width="2" points="4.002,38.547 22.527,20.024 4,1.5"/></svg>',"slidenav-previous":'<svg width="14" height="24" viewBox="0 0 14 24"><polyline fill="none" stroke="#000" stroke-width="1.4" points="12.775,1 1.225,12 12.775,23"/></svg>',"slidenav-previous-large":'<svg width="25" height="40" viewBox="0 0 25 40"><polyline fill="none" stroke="#000" stroke-width="2" points="20.527,1.5 2,20.024 20.525,38.547"/></svg>'},Xs={install:function(e){e.icon.add=(t,r)=>{const n=C(t)?{[t]:r}:t
$(n,(e,t)=>{Ks[t]=e,delete da[t]}),e._initialized&&Nt(document.body,t=>$(e.getComponents(t),e=>{e.$options.isIcon&&e.icon in n&&e.$reset()}))}},mixins:[Vs],args:"icon",props:{icon:String},isIcon:!0,beforeConnect(){X(this.$el,"uk-icon")},async connected(){const e=await this.svg
e&&(e.ariaHidden=!0)},methods:{async getSvg(){const e=function(e){if(e=ha[e]||e,!Ks[e])return null
da[e]||(da[e]=Gs(Ks[function(e){return ue?D(D(e,"left","right"),"previous","next"):e}(e)]||Ks[e]))
return da[e].cloneNode(!0)}(this.icon)
if(!e)throw"Icon not found."
return e}}},Js={args:!1,extends:Xs,data:e=>({icon:i(e.constructor.options.name)}),beforeConnect(){X(this.$el,this.$options.id)}},ea={extends:Js,beforeConnect(){const e=this.$props.icon
this.icon=this.$el.closest(".uk-nav-primary")?`${e}-large`:e}},ta={extends:Js,mixins:[ki],i18n:{toggle:"Open Search",submit:"Submit Search"},beforeConnect(){const e=te(this.$el,"uk-search-toggle")||te(this.$el,"uk-navbar-toggle")
if(this.icon=e?"search-toggle-icon":te(this.$el,"uk-search-icon")&&this.$el.closest(".uk-search-large")?"search-large":this.$el.closest(".uk-search-medium")?"search-medium":this.$props.icon,!oe(this.$el,"aria-label"))if(e)this.$el.ariaLabel=this.t("toggle")
else{const e=this.$el.closest("a,button")
e&&(e.ariaLabel=this.t("submit"))}}},ra={extends:Js,beforeConnect(){this.$el.role="status"},methods:{async getSvg(){const e=await Xs.methods.getSvg.call(this)
return 1!==this.ratio&&st(It("circle",e),"strokeWidth",1/this.ratio),e}}},na={extends:Js,mixins:[ki],beforeConnect(){const e=this.$el.closest("a,button")
ie(e,"role",null!==this.role&&yt(e,"a")?"button":this.role)
const t=this.t("label")
t&&!oe(e,"aria-label")&&ie(e,"aria-label",t)}},ia={extends:na,beforeConnect(){X(this.$el,"uk-slidenav")
const e=this.$props.icon
this.icon=te(this.$el,"uk-slidenav-large")?`${e}-large`:e}},oa={extends:na,i18n:{label:"Open menu"},beforeConnect(){const e=this.$el.closest("a,button")
e&&(e.ariaExpanded=!1)}},sa={extends:na,i18n:{label:"Close"},beforeConnect(){this.icon="close-"+(te(this.$el,"uk-close-large")?"large":"icon")}},aa={extends:na,i18n:{label:"Open"}},la={extends:na,i18n:{label:"Back to top"}},ua={extends:na,i18n:{label:"Next page"},data:{role:null}},ca={extends:na,i18n:{label:"Previous page"},data:{role:null}},da={}
const ha={twitter:"x"}
var pa={props:{target:String,selActive:String},data:{target:!1,selActive:!1},connected(){this.isIntersecting=0},computed:{target:({target:e},t)=>e?Dt(e,t):t},watch:{target:{handler(){queueMicrotask(()=>this.$reset())},immediate:!1}},observe:[mn({handler(e){this.isIntersecting=e.reduce((e,{isIntersecting:t})=>e+(t?1:this.isIntersecting?-1:0),this.isIntersecting),this.$emit()},target:({target:e})=>e,args:{intersecting:!1}}),gn({target:({target:e})=>e,options:{attributes:!0,attributeFilter:["class"]}}),{target:({target:e})=>e,observe:(e,t)=>{const r=hr([...j(e),document.documentElement],t),n=[Ge(document,"scroll itemshown itemhidden",t,{passive:!0,capture:!0}),Ge(document,"show hide transitionstart",e=>(t(),r.observe(e.target))),Ge(document,"shown hidden transitionend transitioncancel",e=>(t(),r.unobserve(e.target)))]
...
for(const e of j(this.target)){let t=!this.selActive||Se(e,this.selActive)?fa(e):""
!1!==t&&ee(e,"uk-light uk-dark",t)}}}}
function fa(e){const t=Ft(e),r=Ft(window)
if(!V(t,r))return!1
...
for(const r of t){if(e.contains(r)||!ma(r)||r.closest('[class*="-leave"]')&&t.some(e=>r!==e&&Se(e,'[class*="-enter"]')))continue
const n=st(r,"--uk-inverse")
if(n){if(n===a)return`uk-${n}`
a=n
break}}}return a?`uk-${a}`:""}function ma(e){if("visible"!==st(e,"visibility"))return!1
for(;e;){if("0"===st(e,"opacity"))return!1
e=Oe(e)}return!0}var ga={mixins:[tn,xo],props:{fill:String},data:{fill:"",clsWrapper:"uk-leader-fill",clsHide:"uk-leader-hide",attrFill:"data-fill"},computed:{fill:({fill:e},t)=>e||st(t,"--uk-leader-fill-content")},connected(){[this.wrapper]=Pt(this.$el,`<span class="${this.clsWrapper}">`)},disconnected(){Mt(this.wrapper.childNodes)},observe:fn(),update:{read(){return{width:Math.trunc(this.$el.offsetWidth/2),fill:this.fill,hide:!this.matchMedia}},write({width:e,fill:t,hide:r}){re(this.wrapper,this.clsHide,r),ie(this.wrapper,this.attrFill,new Array(e).join(t))},events:["resize"]}},va={install:function({modal:e}){function t(t,r,n=q,i=q){r={bgClose:!1,escClose:!0,...r,i18n:{...e.i18n,...null==r?void 0:r.i18n}}
const o=e.dialog(t(r),r)
return f(new Promise(e=>{const t=Ge(o.$el,"hide",()=>e(n()))
Ge(o.$el,"submit","form",r=>{r.preventDefault(),e(i(o)),t(),o.hide()})}),{dialog:o})}e.dialog=function(t,r){const n=e(It(`<div><div class="uk-modal-dialog">${t}</div></div>`),{stack:!0,role:"alertdialog",...r})
return n.show(),Ge(n.$el,"hidden",async()=>{await Promise.resolve(),n.$destroy(!0)},{self:!0}),n},e.alert=function(e,r){return t(({i18n:t})=>`<div class="uk-modal-body">${C(e)?e:_t(e)}</div>  <div class="uk-modal-footer uk-text-right">  <button class="uk-button uk-button-primary uk-modal-close" type="button" autofocus>${t.ok}</button>  </div>`,r)},e.confirm=function(e,r){return t(({i18n:t})=>`<form>  <div class="uk-modal-body">${C(e)?e:_t(e)}</div>  <div class="uk-modal-footer uk-text-right">  <button class="uk-button uk-button-default uk-modal-close" type="button">${t.cancel}</button>  <button class="uk-button uk-button-primary" autofocus>${t.ok}</button>  </div>  </form>`,r,()=>Promise.reject())},e.prompt=function(e,r,n){const i=t(({i18n:t})=>`<form class="uk-form-stacked">  <div class="uk-modal-body">  <label>${C(e)?e:_t(e)}</label>  <input class="uk-input" autofocus>  </div>  <div class="uk-modal-footer uk-text-right">  <button class="uk-button uk-button-default uk-modal-close" type="button">${t.cancel}</button>  <button class="uk-button uk-button-primary">${t.ok}</button>  </div>  </form>`,n,()=>null,()=>s.value),{$el:o}=i.dialog,s=It("input",o)
return s.value=r||"",Ge(o,"show",()=>s.select()),i},e.i18n={ok:"Ok",cancel:"Cancel"}},mixins:[fi],data:{clsPage:"uk-modal-page",selPanel:".uk-modal-dialog",selClose:'[class*="uk-modal-close"]'},events:[{name:"fullscreenchange webkitendfullscreen",capture:!0,handler(e){yt(e.target,"video")&&this.isToggled()&&!document.fullscreenElement&&this.hide()}},{name:"show",self:!0,handler(){te(this.panel,"uk-margin-auto-vertical")?X(this.$el,"uk-flex"):st(this.$el,"display","block"),Ut(this.$el)}},{name:"hidden",self:!0,handler(){st(this.$el,"display",""),J(this.$el,"uk-flex")}}]}
var ba={extends:bs,data:{targets:"> .uk-parent",toggle:"> a",content:"> ul"}}
const ya="uk-navbar-transparent"
var wa={extends:js,props:{dropbarTransparentMode:Boolean},data:{flip:!1,delayShow:200,clsDrop:"uk-navbar-dropdown",selNavItem:".uk-navbar-nav > li > a,a.uk-navbar-item,button.uk-navbar-item,.uk-navbar-item a,.uk-navbar-item button,.uk-navbar-toggle",dropbarTransparentMode:!1},computed:{navbarContainer:(e,t)=>t.closest(".uk-navbar-container")},watch:{items(){const e=te(this.$el,"uk-navbar-justify"),t=Dt(".uk-navbar-nav, .uk-navbar-left, .uk-navbar-right",this.$el)
for(const r of t){st(r,"flexGrow",e?Dt(".uk-navbar-nav > li > a, .uk-navbar-item, .uk-navbar-toggle",r).length:"")}}},events:[{name:"show",el:({dropContainer:e})=>e,handler({target:e}){"remove"===this.getTransparentMode(e)&&te(this.navbarContainer,ya)&&(J(this.navbarContainer,ya),this._transparent=!0)}},{name:"hide",el:({dropContainer:e})=>e,async handler(){await On(),!this._transparent||Os&&this.dropContainer.contains(Os.$el)||(X(this.navbarContainer,ya),this._transparent=null)}}],methods:{getTransparentMode(e){if(!this.navbarContainer)return
if(this.dropbar&&this.isDropbarDrop(e))return this.dropbarTransparentMode
const t=this.getDropdown(e)
return t&&te(e,"uk-dropbar")?t.inset?"behind":"remove":void 0},getDropbarOffset(e){const{top:t,height:r}=Bt(this.navbarContainer)
return t+("behind"===this.dropbarTransparentMode?0:r+e)}}},_a={mixins:[fi],args:"mode",props:{mode:String,flip:Boolean,overlay:Boolean,swiping:Boolean},data:{mode:"slide",flip:!1,overlay:!1,clsPage:"uk-offcanvas-page",clsContainer:"uk-offcanvas-container",selPanel:".uk-offcanvas-bar",clsFlip:"uk-offcanvas-flip",clsContainerAnimation:"uk-offcanvas-container-animation",clsSidebarAnimation:"uk-offcanvas-bar-animation",clsMode:"uk-offcanvas",clsOverlay:"uk-offcanvas-overlay",selClose:".uk-offcanvas-close",container:!1,swiping:!0},computed:{clsFlip:({flip:e,clsFlip:t})=>e?t:"",clsOverlay:({overlay:e,clsOverlay:t})=>e?t:"",clsMode:({mode:e,clsMode:t})=>`${t}-${e}`,clsSidebarAnimation:({mode:e,clsSidebarAnimation:t})=>"none"===e||"reveal"===e?"":t,clsContainerAnimation:({mode:e,clsContainerAnimation:t})=>"push"!==e&&"reveal"!==e?"":t,transitionElement({mode:e}){return"reveal"===e?Oe(this.panel):this.panel}},observe:wn({filter:({swiping:e})=>e}),update:{read(){this.isToggled()&&!_e(this.$el)&&this.hide()},events:["resize"]},events:[{name:"touchmove",self:!0,passive:!1,filter:({overlay:e})=>e,handler(e){e.cancelable&&e.preventDefault()}},{name:"show",self:!0,handler(){"reveal"!==this.mode||te(Oe(this.panel),this.clsMode)||X(St(this.panel,"<div>"),this.clsMode)
const{body:e,scrollingElement:t}=document
X(e,this.clsContainer,this.clsFlip),st(e,"touchAction","pan-y pinch-zoom"),st(this.$el,"display","block"),st(this.panel,"maxWidth",t.clientWidth),X(this.$el,this.clsOverlay),X(this.panel,this.clsSidebarAnimation,"reveal"===this.mode?"":this.clsMode),Ut(e),X(e,this.clsContainerAnimation),this.clsContainerAnimation&&(xa().content+=",user-scalable=0")}},{name:"hide",self:!0,handler(){J(document.body,this.clsContainerAnimation),st(document.body,"touchAction","")}},{name:"hidden",self:!0,handler(){this.clsContainerAnimation&&function(){const e=xa()
e.content=e.content.replace(/,user-scalable=0$/,"")}(),"reveal"===this.mode&&te(Oe(this.panel),this.clsMode)&&Mt(this.panel),J(this.panel,this.clsSidebarAnimation,this.clsMode),J(this.$el,this.clsOverlay),st(this.$el,"display",""),st(this.panel,"maxWidth",""),J(document.body,this.clsContainer,this.clsFlip)}},{name:"swipeLeft swipeRight",handler(e){this.isToggled()&&u(e.type,"Left")^this.flip&&this.hide()}}]}
function xa(){return It('meta[name="viewport"]',document.head)||Et(document.head,'<meta name="viewport">')}var Ea={mixins:[tn],props:{selContainer:String,selContent:String,minHeight:Number},data:{selContainer:".uk-modal",selContent:".uk-modal-dialog",minHeight:150},computed:{container:({selContainer:e},t)=>t.closest(e),content:({selContent:e},t)=>t.closest(e)},observe:fn({target:({container:e,content:t})=>[e,t]}),update:{read(){return!!(this.content&&this.container&&_e(this.$el))&&{max:Math.max(this.minHeight,Ut(this.container)-(Ft(this.content).height-Ut(this.$el)))}},write({max:e}){st(this.$el,{minHeight:this.minHeight,maxHeight:e})},events:["resize"]}},Ca={data:{fadeDuration:.05},events:{name:"scroll",self:!0,passive:!0,handler(){this.$emit()}},observe:[gn({options:{subtree:!0,childList:!0}}),fn({target:({$el:e})=>[e,...Me(e)]})],update:{read(){const e=[]
for(const t of["Width","Height"])e.push(this.$el[`scroll${t}`]-this.$el[`client${t}`])
return{overflow:e}},write({overflow:e}){for(let t=0;t<2;t++)if(re(this.$el,`${this.$options.id}-${t?"vertical":"horizontal"}`,e[t]&&!e[t-1]),!e[t-1]){const r=t?"Top":"Left",n=e[t]?this.$el[`scroll${r}`]/e[t]:0,i=r=>e[t]?U((this.fadeDuration-r)/this.fadeDuration):1
st(this.$el,{"--uk-overflow-fade-start-opacity":i(n),"--uk-overflow-fade-end-opacity":i(1-n)})}},events:["resize"]}},ka={props:["width","height"],connected(){X(this.$el,"uk-responsive-width"),st(this.$el,"aspectRatio",`${this.width}/${this.height}`)}},Oa={props:{offset:Number},data:{offset:0},connected(){(function(e){Ta.size||Ge(document,"click",Sa)
Ta.add(e)})(this)},disconnected(){var e
e=this,Ta.delete(e),Ta.size||Qe(document,"click",Sa)},methods:{async scrollTo(e){e=e&&It(e)||document.body,Ke(this.$el,"beforescroll",[this,e])&&(await Sr(e,{offset:this.offset}),Ke(this.$el,"scrolled",[this,e]))}}}
const Ta=new Set
function Sa(e){if(!e.defaultPrevented)for(const t of Ta)t.$el.contains(e.target)&&Ae(t.$el)&&(e.preventDefault(),window.location.href!==t.$el.href&&window.history.pushState({},"",t.$el.href),t.scrollTo(je(t.$el)))}const Pa="uk-scrollspy-inview"
var Ma={args:"cls",props:{cls:String,target:String,hidden:Boolean,margin:String,repeat:Boolean,delay:Number},data:()=>({cls:"",target:!1,hidden:!0,margin:"-1px",repeat:!1,delay:0}),computed:{elements:({target:e},t)=>e?Dt(e,t):[t]},watch:{elements(e){this.hidden&&st(Te(e,`:not(.${Pa})`),"opacity",0)}},connected(){this.elementData=new Map},disconnected(){for(const[e,t]of this.elementData.entries())J(e,Pa,t.cls||"")
delete this.elementData},observe:mn({target:({elements:e})=>e,handler(e){const t=this.elementData
for(const{target:r,isIntersecting:n}of e){t.has(r)||t.set(r,{cls:ae(r,"uk-scrollspy-class")||this.cls})
const e=t.get(r)
!this.repeat&&e.show||(e.show=n)}this.$emit()},options:({margin:e})=>({rootMargin:e}),args:{intersecting:!1}}),update:[{write(e){for(const[t,r]of this.elementData.entries())!r.show||r.inview||r.queued?!r.show&&r.inview&&!r.queued&&this.repeat&&this.toggle(t,!1):(r.queued=!0,e.promise=(e.promise||Promise.resolve()).then(async()=>{await On(r.show?this.delay:0),this.toggle(t,!0),setTimeout(()=>{r.queued=!1,this.$emit()},300)}))}}],methods:{toggle(e,t){var r,n
const i=null==(r=this.elementData)?void 0:r.get(e)
if(!i)return
let o
if(null==(n=i.off)||n.call(i),st(e,"opacity",!t&&this.hidden?0:""),re(e,Pa,t),re(e,i.cls),o=i.cls.match(/\buk-animation-[\w-]+/g)){const r=()=>J(e,o)
t?i.off=Ze(e,"animationcancel animationend",r,{self:!0}):r()}Ke(e,t?"inview":"outview"),i.inview=t}}},Ra={props:{cls:String,closest:Boolean,scroll:Boolean,target:String,offset:Number},data:{cls:"uk-active",closest:!1,scroll:!1,target:'a[href]:not([role="button"])',offset:0},computed:{links:{get:({target:e},t)=>Dt(e,t).filter(je),observe:()=>"*"},targets(){return this.links.map(e=>je(e))},elements({closest:e}){return this.links.map(t=>t.closest(e||"*"))}},watch:{links(e){this.scroll&&this.$create("scroll",e,{offset:this.offset})}},observe:[mn(),yn()],update:[{read(){const{targets:e}=this,{length:t}=e
if(!t||!_e(this.$el))return!1
const r=Rr(e,!0),{scrollTop:n,scrollHeight:i}=r,o=jr(r)
let s=!1
if(n>=i-o.height)s=t-1
else{const t=this.offset+Ft(Nr()).height+.1*o.height
for(let r=0;r<e.length&&!(Bt(e[r]).top-o.top-t>0);r++)s=+r}return{active:s}},write({active:e}){const{elements:t}=this,r=!1!==e&&!te(t[e],this.cls)
this.links.forEach(e=>e.blur())
for(let n=0;n<t.length;n++)re(t[n],this.cls,+n===e)
r&&Ke(this.$el,"active",[e,t[e]])},events:["scroll","resize"]}]},Aa={mixins:[tn,xo],props:{position:String,top:null,bottom:null,start:null,end:null,offset:String,offsetEnd:String,overflowFlip:Boolean,animation:String,clsActive:String,clsInactive:String,clsFixed:String,clsBelow:String,selTarget:String,showOnUp:Boolean,targetOffset:Number},data:{position:"top",top:!1,bottom:!1,start:!1,end:!1,offset:0,offsetEnd:0,overflowFlip:!1,animation:"",clsActive:"uk-active",clsInactive:"",clsFixed:"uk-sticky-fixed",clsBelow:"uk-sticky-below",selTarget:"",showOnUp:!1,targetOffset:!1},computed:{target:({selTarget:e},t)=>e&&It(e,t)||t},connected(){this.start=Na(this.start||this.top),this.end=Na(this.end||this.bottom),this.placeholder=It("+ .uk-sticky-placeholder",this.$el)||It('<div class="uk-sticky-placeholder"></div>'),this.isFixed=!1,this.setActive(!1)},beforeDisconnect(){this.isFixed&&(this.hide(),J(this.target,this.clsInactive)),Ia(this.$el),Tt(this.placeholder),this.placeholder=null},observe:[bn(),yn({target:()=>document.scrollingElement}),fn({target:({$el:e})=>[e,$a(e),document.scrollingElement],handler(e){this.$emit(this._data.resized&&e.some(({target:e})=>e===$a(this.$el))?"update":"resize"),this._data.resized=!0}})],events:[{name:"load hashchange popstate",el:()=>window,filter:({targetOffset:e})=>!1!==e,async handler(){const{scrollingElement:e}=document
if(!location.hash||0===e.scrollTop)return
await On()
const t=Bt(It(location.hash)),r=Bt(this.$el)
this.isFixed&&V(t,r)&&(e.scrollTop=Math.ceil(t.top-r.height-Gt(this.targetOffset,"height",this.placeholder)-Gt(this.offset,"height",this.placeholder)))}}],update:[{read({height:e,width:t,margin:r,sticky:n},i){if(this.inactive=!this.matchMedia||!_e(this.$el)||!this.$el.offsetHeight,this.inactive)return
const o=Ut(window),s=Math.max(0,document.scrollingElement.scrollHeight-o)
if(!s)return void(this.inactive=!0)
const a=this.isFixed&&i.has("update")
a&&(La(this.target),this.hide()),this.active||(({height:e,width:t}=Ft(this.$el)),r=st(this.$el,"margin")),a&&this.show()
const l=Gt("100vh","height")
let u=this.position
this.overflowFlip&&e>l&&(u="top"===u?"bottom":"top")
const c=this.isFixed?this.placeholder:this.$el
let[d,h]=[this.offset,this.offsetEnd].map(e=>Gt(e,"height",n?this.$el:c))
"bottom"===u&&(e<o||this.overflowFlip)&&(d+=o-e)
const p=e+d+h,f=this.overflowFlip?0:Math.max(0,p-l),m=Bt(c).top-new DOMMatrix(st(c,"transform")).m42,g=Ft(this.$el).height,v=(!1===this.start?m:ja(this.start,this.$el,m))-d,b=!1===this.end?s:Math.min(s,ja(this.end,this.$el,m+e,!0)-g-d+f)
return n=!this.showOnUp&&v+d===m&&b===Math.min(s,ja(!0,this.$el,0,!0)-g-d+f)&&"hidden"!==st($a(this.$el),"overflowY"),{start:v,end:b,offset:d,overflow:f,height:e,elHeight:g,width:t,margin:r,top:zt(c)[0],sticky:n,viewport:l,maxScrollHeight:s}},write({height:e,width:t,margin:r,offset:n,sticky:i}){if((this.inactive||i||!this.isFixed)&&Ia(this.$el),this.inactive)return
...
return{dir:d,prevDir:t,scroll:c,prevScroll:e,below:c>Bt(h).top+(l?Math.min(a,s):a),offsetParentTop:Bt(h.offsetParent).top,overflowScroll:U(n+U(c,i,o)-U(e,i,o),0,r)}},write(e,t){const r=t.has("scroll"),{initTimestamp:n=0,dir:i,prevDir:o,scroll:s,prevScroll:a=0,top:l,start:u,below:c}=e
if(s<0||s===a&&r||this.showOnUp&&!r&&!this.isFixed)return
const d=Date.now()
if((d-n>300||i!==o)&&(e.initScroll=s,e.initTimestamp=d),!(this.showOnUp&&!this.isFixed&&Math.abs(e.initScroll-s)<=30&&Math.abs(a-s)<=10))if(this.inactive||s<u||this.showOnUp&&(s<=u||"down"===i&&r||"up"===i&&!this.isFixed&&!c)){if(!this.isFixed)return void(bt.inProgress(this.$el)&&l>s&&(bt.cancel(this.$el),this.hide()))
if(this.animation&&c){if(te(this.$el,"uk-animation-leave"))return
bt.out(this.$el,this.animation).then(()=>this.hide(),q)}else this.hide()}else this.isFixed?this.update():this.animation&&c?(this.show(),bt.in(this.$el,this.animation).catch(q)):(La(this.target),this.show())},events:["resize","resizeViewport","scroll"]}],methods:{show(){this.isFixed=!0,this.update(),this.placeholder.hidden=!1},hide(){const{offset:e,sticky:t}=this._data
this.setActive(!1),J(this.$el,this.clsFixed,this.clsBelow),t?st(this.$el,"top",e):Ia(this.$el),this.placeholder.hidden=!0,this.isFixed=!1},update(){let{width:e,scroll:t=0,overflow:r,overflowScroll:n=0,start:i,end:o,offset:s,offsetParentTop:a,sticky:l,below:u}=this._data
const c=0!==i||t>i
if(!l){let i="fixed"
...
this.active=e,e?(ee(this.target,this.clsInactive,this.clsActive),t!==e&&Ke(this.$el,"active")):(ee(this.target,this.clsActive,this.clsInactive),t!==e&&(La(this.target),Ke(this.$el,"inactive")))}}}
function ja(e,t,r,n){if(!e)return 0
if(O(e)||C(e)&&e.match(/^-?\d/))return r+Gt(e,"height",t,!0)
{const r=!0===e?$a(t):Ne(e,t)
return Bt(r).bottom-(n&&(null==r?void 0:r.contains(t))?R(st(r,"paddingBottom"))+R(st(r,"borderBottomWidth")):0)}}function Na(e){return"true"===e||"false"!==e&&e}function Ia(e){st(e,{position:"",top:"",marginTop:"",width:""})}const Da="uk-transition-disable"
async function La(e){te(e,Da)||(X(e,Da),await kn(),J(e,Da))}function $a(e){for(;e=Oe(e);)if(_e(e))return e}var Fa={mixins:[Vs],args:"src",props:{src:String,icon:String,attributes:"list",strokeAnimation:Boolean},data:{strokeAnimation:!1},observe:[gn({async handler(){const e=await this.svg
e&&Ba.call(this,e)},options:{attributes:!0,attributeFilter:["id","class","style"]}})],async connected(){c(this.src,"#")&&([this.src,this.icon]=this.src.split("#",2))
const e=await this.svg
e&&(Ba.call(this,e),this.strokeAnimation&&function(e){const t=Eo(e)
t&&st(e,"--uk-animation-stroke",t)}(e))},methods:{async getSvg(){return yt(this.$el,"img")&&!this.$el.complete&&"lazy"===this.$el.loading&&await new Promise(e=>Ze(this.$el,"load",e)),Gs(await Ha(this.src),this.icon)||Promise.reject("SVG not found.")}}}
function Ba(e){const{$el:t}=this
...
ie(e,t,n)}e.ariaHidden=this.$el.ariaHidden,this.$el.id||se(e,"id")}const Ha=K(async e=>{if(e){const t=await fetch(e)
if("image/svg+xml"===t.headers.get("Content-Type"))return t.text()}return Promise.reject()})
const za=".uk-disabled *, .uk-disabled, [disabled]"
var Ua={mixins:[ui],args:"connect",props:{connect:String,toggle:String,itemNav:String,active:Number,followFocus:Boolean,swiping:Boolean},data:{connect:"~.uk-switcher",toggle:"> * > :first-child",itemNav:!1,active:0,cls:"uk-active",attrItem:"uk-switcher-item",selVertical:".uk-nav",followFocus:!1,swiping:!0},computed:{connects:{get:({connect:e},t)=>Ie(e,t),observe:({connect:e})=>e},connectChildren(){return this.connects.map(e=>Me(e)).flat()},toggles:({toggle:e},t)=>Dt(e,t),children(e,t){return Me(t).filter(e=>this.toggles.some(t=>e.contains(t)))}},watch:{connects(e){this.swiping&&st(e,"touchAction","pan-y pinch-zoom"),this.$emit()},connectChildren(){let e=Math.max(0,this.index())
for(const t of this.connects)Me(t).forEach((t,r)=>re(t,this.cls,r===e))
this.$emit()},toggles(e){this.$emit()
const t=this.index()
this.show(~t?t:e[this.active]||e[0])}},connected(){this.$el.role="tablist"},observe:[vn({targets:({connectChildren:e})=>e}),wn({target:({connects:e})=>e,filter:({swiping:e})=>e})],events:[{name:"click keydown",delegate:({toggle:e})=>e,handler(e){Se(e.current,za)||"click"!==e.type&&e.keyCode!==Bn||(Ln(e),this.show(e.current))}},{name:"keydown",delegate:({toggle:e})=>e,handler(e){const{current:t,keyCode:r}=e,n=Se(this.$el,this.selVertical)
let i=r===zn?0:r===Hn?"last":r===Un&&!n||r===qn&&n?"previous":r===Vn&&!n||r===Wn&&n?"next":-1
if(~i){e.preventDefault()
const r=this.toggles.filter(e=>!Se(e,za)),n=r[Z(i,r,r.indexOf(t))]
n.focus(),this.followFocus&&this.show(n)}}},{name:"click",el:({$el:e,connects:t,itemNav:r})=>t.concat(r?Ie(r,e):[]),delegate:({attrItem:e})=>`[${e}],[data-${e}]`,handler(e){e.target.closest("a,button")&&(Ln(e),this.show(ae(e.current,this.attrItem)))}},{name:"swipeRight swipeLeft",filter:({swiping:e})=>e,el:({connects:e})=>e,handler({type:e}){this.show(u(e,"Left")?"next":"previous")}}],update(){var e
for(const t of this.connects)yt(t,"ul")&&(t.role="presentation")
...
r.role="tab",n&&(r.id=io(this,r),n.id=io(this,n),r.ariaControls=n.id,ie(n,{role:"tabpanel","aria-labelledby":r.id}))}ie(this.$el,"aria-orientation",Se(this.$el,this.selVertical)?"vertical":null)},methods:{index(){return d(this.children,e=>te(e,this.cls))},show(e){const t=this.toggles.filter(e=>!Se(e,za)),r=this.index(),n=Z(!w(e)||c(t,e)?e:0,t,Z(this.toggles[r],t)),i=Z(t[n],this.toggles)
...
await this.toggleElement(t,!1,o)&&await this.toggleElement(e[i],!0,o)})}}},qa={mixins:[tn],extends:Ua,props:{media:Boolean},data:{media:960,attrItem:"uk-tab-item",selVertical:".uk-tab-left,.uk-tab-right"},connected(){const e=te(this.$el,"uk-tab-left")?"uk-tab-left":!!te(this.$el,"uk-tab-right")&&"uk-tab-right"
e&&this.$create("toggle",this.$el,{cls:e,mode:"media",media:this.media})}}
var Va={mixins:[xo,ui],args:"target",props:{href:String,target:null,mode:"list",queued:Boolean},data:{href:!1,target:!1,mode:"click",queued:!0},computed:{target:{get:({target:e},t)=>(e=Ie(e||t.hash,t)).length?e:[t],observe:({target:e})=>e}},connected(){c(this.mode,"media")||(ke(this.$el)||(this.$el.tabIndex=0),!this.cls&&yt(this.$el,"a")&&(this.$el.role="button"))},observe:vn({targets:({target:e})=>e}),events:[{name:he,filter:({mode:e})=>c(e,"hover"),handler(e){this._preventClick=null,!nt(e)||E(this._showState)||this.$el.disabled||(Ke(this.$el,"focus"),Ze(document,he,()=>Ke(this.$el,"blur"),!0,e=>!this.$el.contains(e.target)),c(this.mode,"click")&&(this._preventClick=!0))}},{name:`${me} ${ge} focus blur`,filter:({mode:e})=>c(e,"hover"),handler(e){if(nt(e)||this.$el.disabled||"loading"===document.readyState)return
const t=c([me,"focus"],e.type),r=this.isToggled(this.target)
t||!(!E(this._showState)||e.type===ge&&Se(this.$el,":focus")||"blur"===e.type&&Se(this.$el,":hover"))?t&&E(this._showState)&&r!==this._showState||(this._showState=t?r:null,this.toggle("toggle"+(t?"show":"hide"))):r===this._showState&&(this._showState=null)}},{name:"keydown",filter:({$el:e,mode:t})=>c(t,"click")&&!yt(e,"input"),handler(e){32!==e.keyCode&&13!==e.keyCode||(e.preventDefault(),this.$el.click())}},{name:"click",filter:({mode:e})=>["click","hover"].some(t=>c(e,t)),handler(e){if(e.defaultPrevented)return
const t=e.target.closest("a[href]"),r=Ae(t)&&(!t.hash||Se(this.target,t.hash));(this._preventClick||r||t&&!this.isToggled(this.target))&&e.preventDefault(),this._preventClick||!c(this.mode,"click")||t&&!r&&!e.defaultPrevented||this.toggle()}},{name:"mediachange",filter:({mode:e})=>c(e,"media"),el:({target:e})=>e,handler(e,t){t.matches^this.isToggled(this.target)&&this.toggle()}}],methods:{async toggle(e){if(!Ke(this.target,e||"toggle",[this]))return
if(oe(this.$el,"aria-expanded")&&(this.$el.ariaExpanded=!this.isToggled(this.target)),!this.queued)return this.toggleElement(this.target)
...
return $(Object.freeze({__proto__:null,Accordion:bs,AccordionIcon:Js,Alert:ws,Close:sa,Cover:Cs,Drop:Ts,DropParentIcon:Js,Dropdown:Ts,Dropnav:js,FormCustom:Is,Grid:Ds,HeightMatch:Fs,HeightPlaceholder:zs,HeightViewport:Us,Icon:Xs,Img:Xn,Inverse:pa,Leader:ga,Margin:xn,Marker:aa,Modal:va,Nav:ba,NavParentIcon:ea,Navbar:wa,NavbarParentIcon:Js,NavbarToggleIcon:oa,Offcanvas:_a,OverflowAuto:Ea,OverflowFade:Ca,OverlayIcon:Js,PaginationNext:ua,PaginationPrevious:ca,Responsive:ka,Scroll:Oa,Scrollspy:Ma,ScrollspyNav:Ra,SearchIcon:ta,SlidenavNext:ia,SlidenavPrevious:ia,Spinner:ra,Sticky:Aa,Svg:Fa,Switcher:Ua,Tab:qa,Toggle:Va,Totop:la,Video:xs}),(e,t)=>Gi.component(t,e)),function(e){le&&window.MutationObserver&&(document.body?requestAnimationFrame(()=>ps(e)):new MutationObserver((t,r)=>{document.body&&(ps(e),r.disconnect())}).observe(document.documentElement,{childList:!0}))}(Gi),$(hs,(e,t)=>Gi.component(t,e)),Gi}),/*! UIkit 3.25.2 | https://www.getuikit.com | (c) 2014 - 2025 YOOtheme | MIT License */
...
t(N)
var I=r(function(e,t){Object.defineProperty(t,"__esModule",{value:!0}),t.default=function(e){return function(t){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=t.match(e.matchPattern)
if(!n)return null
...
t($)
var F=r(function(e,t){var r=n.default
Object.defineProperty(t,"__esModule",{value:!0}),t.default=function(e,t,r){var n,o,a,l,u,d,C,k,O,S,P,M,R,A,j,N,I,D;(0,g.default)(2,arguments)
...
if(!(B>=1&&B<=7))throw new RangeError("firstWeekContainsDate must be between 1 and 7 inclusively")
var H=(0,m.default)(null!==(P=null!==(M=null!==(R=null!==(A=null==r?void 0:r.weekStartsOn)&&void 0!==A?A:null==r||null===(j=r.locale)||void 0===j||null===(N=j.options)||void 0===N?void 0:N.weekStartsOn)&&void 0!==R?R:$.weekStartsOn)&&void 0!==M?M:null===(I=$.locale)||void 0===I||null===(D=I.options)||void 0===D?void 0:D.weekStartsOn)&&void 0!==P?P:0)
...
t=u.pageX,n=u.pageY}window.addEventListener("mousemove",f),window.addEventListener("touchmove",f),window.addEventListener("mouseup",m),window.addEventListener("touchend",m),document.body.style[r]="none"}}function f(r){var s=r.pageX,a=r.pageY
if(r.preventDefault(),r.touches){var c=r.touches[0]
s=c.pageX,a=c.pageY}var h=s-t,p=a-n,f=l.options.viewport.height+p,m=l.options.viewport.width+h
"v"===e&&f>=50&&f<=o?(d(u,{height:f+"px"}),l.options.boundary.height+=p,d(l.elements.boundary,{height:l.options.boundary.height+"px"}),l.options.viewport.height+=p,d(l.elements.viewport,{height:l.options.viewport.height+"px"})):"h"===e&&m>=50&&m<=i&&(d(u,{width:m+"px"}),l.options.boundary.width+=h,d(l.elements.boundary,{width:l.options.boundary.width+"px"}),l.options.viewport.width+=h,d(l.elements.viewport,{width:l.options.viewport.width+"px"})),M.call(l),F.call(l),S.call(l),D.call(l),n=a,t=s}function m(){c=!1,window.removeEventListener("mousemove",f),window.removeEventListener("touchmove",f),window.removeEventListener("mouseup",m),window.removeEventListener("touchend",m),document.body.style[r]=""}h(u,"cr-resizer"),d(u,{width:this.options.viewport.width+"px",height:this.options.viewport.height+"px"}),this.options.resizeControls.height&&(h(s=document.createElement("div"),"cr-resizer-vertical"),u.appendChild(s)),this.options.resizeControls.width&&(h(a=document.createElement("div"),"cr-resizer-horisontal"),u.appendChild(a)),s&&(s.addEventListener("mousedown",p),s.addEventListener("touchstart",p)),a&&(a.addEventListener("mousedown",p),a.addEventListener("touchstart",p)),this.elements.boundary.appendChild(u)}function C(e){if(this.options.enableZoom){var t=this.elements.zoomer,r=Q(e,4)
...
i.x>=u.maxX&&(s.x=c.minX,i.x=u.maxX),i.x<=u.minX&&(s.x=c.maxX,i.x=u.minX),i.y>=u.maxY&&(s.y=c.minY,i.y=u.maxY),i.y<=u.minY&&(s.y=c.maxY,i.y=u.minY)}a(),I.call(n),D.call(n)}function T(e){var t=this,r=t._currentZoom,n=e.width,i=e.height,o=t.elements.boundary.clientWidth/2,s=t.elements.boundary.clientHeight/2,a=t.elements.preview.getBoundingClientRect(),l=a.width,u=a.height,c=n/2,d=i/2,h=-1*(c/r-o),p=-1*(d/r-s),f=1/r*c,m=1/r*d
...
var y=b/i
return C.call(a,y),void c(a.elements.zoomer)}u(p,f),m[t]=s.toString(),d(a.elements.preview,m),M.call(a),n=l,e=o}function m(){h(l=!1),window.removeEventListener("mousemove",f),window.removeEventListener("touchmove",f),window.removeEventListener("mouseup",m),window.removeEventListener("touchend",m),document.body.style[r]="",S.call(a),D.call(a),i=0}a.elements.overlay.addEventListener("mousedown",p),a.elements.viewport.addEventListener("keydown",function(e){var n
...
var R,A,j,N,I=(R=M,A=500,function(){var e=this,t=arguments,r=j&&!N
clearTimeout(N),N=setTimeout(function(){N=null,j||R.apply(e,t)},A),r&&R.apply(e,t)})
function D(){var e,t=this,r=t.get()
...
else{if(void 0===e&&n.data.url)return $.call(n),D.call(n),null
