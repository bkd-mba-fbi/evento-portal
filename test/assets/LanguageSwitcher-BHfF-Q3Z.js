...
`;function Ns(t){const e=document.createElement("style");e.innerText=t,document.querySelector("body")?.appendChild(e)}const Ds=(t,e,n)=>{for(const s of e)if(s[0]===t)return(0,s[1])();return n?.()};const vt={ATTRIBUTE:1,CHILD:2},yt=t=>(...e)=>({_$litDirective$:t,values:e});class $t{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,n,s){this._$Ct=e,this._$AM=n,this._$Ci=s}_$AS(e,n){return this.update(e,n)}update(e,n){return this.render(...n)}}const{I:ns}=Kt,et=()=>document.createComment(""),F=(t,e,n)=>{const s=t._$AA.parentNode,r=e===void 0?t._$AB:e._$AA;if(n===void 0){const i=s.insertBefore(et(),r),o=s.insertBefore(et(),r);n=new ns(i,o,t,t.options)}else{const i=n._$AB.nextSibling,o=n._$AM,c=o!==t;if(c){let l;n._$AQ?.(t),n._$AM=t,n._$AP!==void 0&&(l=t._$AU)!==o._$AU&&n._$AP(l)}if(i!==r||c){let l=n._$AA;for(;l!==i;){const u=l.nextSibling;s.insertBefore(l,r),l=u}}}return n},E=(t,e,n=t)=>(t._$AI(e,n),t),ss={},rs=(t,e=ss)=>t._$AH=e,is=t=>t._$AH,fe=t=>{t._$AP?.(!1,!0);let e=t._$AA;const n=t._$AB.nextSibling;for(;e!==n;){const s=e.nextSibling;e.remove(),e=s}};var os=Object.getOwnPropertyDescriptor,as=(t,e,n,s)=>{for(var r=s>1?void 0:s?os(e,n):e,i=t.length-1,o;i>=0;i--)(o=t[i])&&(r=o(r)||r);return r};let we=class extends k{render(){return P`<p>
    ...
    </p>`}};we.styles=[ee,Me];we=as([J("bkd-contact"),Q()],we);function*ls(t,e){const n=typeof e=="function";if(t!==void 0){let s=-1;for(const r of t)s>-1&&(yield n?e(s):e),s++,yield r}}function oe(t){return ls(t?.split(`
`),P`<br />`)}var cs=Object.getOwnPropertyDescriptor,hs=(t,e,n,s)=>{for(var r=s>1?void 0:s?cs(e,n):e,i=t.length-1,o;i>=0;i--)(o=t[i])&&(r=o(r)||r);return r};let Ae=class extends k{constructor(){super(),new xe(this,_)}render(){return P`
...
3012 Bern`))}
    ...
    `}};Ae.styles=[ee,Me];Ae=hs([J("bkd-imprint"),Q()],Ae);var us=Object.getOwnPropertyDescriptor,ds=(t,e,n,s)=>{for(var r=s>1?void 0:s?us(e,n):e,i=t.length-1,o;i>=0;i--)(o=t[i])&&(r=o(r)||r);return r};let _e=class extends k{render(){return P`
      <div class="content-section">
...
3012 Bern`))}
    ...
    `];_e=ds([J("bkd-legal"),Q()],_e);const tt=(t,e,n)=>{const s=new Map;for(let r=e;r<=n;r++)s.set(t[r],r);return s},ps=yt(class extends $t{constructor(t){if(super(t),t.type!==vt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,n){let s;n===void 0?n=e:e!==void 0&&(s=e);const r=[],i=[];let o=0;for(const c of t)r[o]=s?s(c,o):o,i[o]=n(c,o),o++;return{values:i,keys:r}}render(t,e,n){return this.dt(t,e,n).values}update(t,[e,n,s]){const r=is(t),{values:i,keys:o}=this.dt(e,n,s);if(!Array.isArray(r))return this.ut=o,i;const c=this.ut??=[],l=[];let u,g,h=0,d=r.length-1,p=0,f=i.length-1;for(;h<=d&&p<=f;)if(r[h]===null)h++;else if(r[d]===null)d--;else if(c[h]===o[p])l[p]=E(r[h],i[p]),h++,p++;else if(c[d]===o[f])l[f]=E(r[d],i[f]),d--,f--;else if(c[h]===o[f])l[f]=E(r[h],i[f]),F(t,l[f+1],r[h]),h++,f--;else if(c[d]===o[p])l[p]=E(r[d],i[p]),F(t,r[h],r[d]),d--,p++;else if(u===void 0&&(u=tt(o,p,f),g=tt(c,h,d)),u.has(c[h]))if(u.has(c[d])){const w=g.get(o[p]),ue=w!==void 0?r[w]:null;if(ue===null){const Ne=F(t,r[h]);E(Ne,i[p]),l[p]=Ne}else l[p]=E(ue,i[p]),F(t,r[h],ue),r[w]=null;p++}else fe(r[d]),d--;else fe(r[h]),h++;for(;p<=f;){const w=F(t,l[f+1]);E(w,i[p]),l[p++]=w}for(;h<=d;){const w=r[h++];w!==null&&fe(w)}return this.ut=o,rs(t,l),R}});var gs=Object.getOwnPropertyDescriptor,fs=(t,e,n,s)=>{for(var r=s>1?void 0:s?gs(e,n):e,i=t.length-1,o;i>=0;i--)(o=t[i])&&(r=o(r)||r);return r};let ke=class extends k{constructor(){super(),new xe(this,_)}renderFooterLink(t){const e=Xn(t);return P`
      <a
        href=${e}
    ...
    `}render(){return P`
      <footer role="contentinfo">
        ...
        <div class="footer-nav">
          ${ps(m.footer,t=>t.key,this.renderFooterLink.bind(this))}
        </div>
      </footer>
    `}};ke.styles=[ee,O`
      /* Large screen */
    ...
    `];ke=fs([J("bkd-footer"),Q()],ke);const bs=yt(class extends $t{constructor(t){if(super(t),t.type!==vt.ATTRIBUTE||t.name!=="class"||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter((e=>t[e])).join(" ")+" "}update(t,[e]){if(this.st===void 0){this.st=new Set,t.strings!==void 0&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter((s=>s!==""))));for(const s in e)e[s]&&!this.nt?.has(s)&&this.st.add(s);return this.render(e)}const n=t.element.classList;for(const s of this.st)s in e||(n.remove(s),this.st.delete(s));for(const s in e){const r=!!e[s];r===this.st.has(s)||this.nt?.has(s)||(r?(n.add(s),this.st.add(s)):(n.remove(s),this.st.delete(s)))}return R}});var ms=Object.getOwnPropertyDescriptor,vs=(t,e,n,s)=>{for(var r=s>1?void 0:s?ms(e,n):e,i=t.length-1,o;i>=0;i--)(o=t[i])&&(r=o(r)||r);return r};let Se=class extends k{constructor(){super(),new xe(this,_)}handleLocaleChange(t,e){t.preventDefault(),_.locale=e}render(){return P`<ul>
      ${Oe.map(t=>P`<li>
            <a
              href="#"
              class=${bs({active:t===_.locale})}
    ...
    `];Se=vs([J("bkd-language-switcher"),Q()],Se);export{a as A,_s as B,J as C,Q as D,b as E,vt as F,R as G,ze as H,bs as I,ps as J,Os as K,D as L,Ls as M,Cs as N,zn as O,Us as P,Ns as Q,ts as R,xe as S,un as T,es as U,Ms as V,zs as W,jn as X,he as Y,xn as _,Es as a,mn as b,U as c,hn as d,Ts as e,st as f,Ps as g,Rs as h,Ss as i,dn as j,Xn as k,m as l,ks as m,xs as n,yt as o,_ as p,$t as q,rs as r,Is as s,M as t,be as u,ee as v,O as w,k as x,P as y,Ds as z};
