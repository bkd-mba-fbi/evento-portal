import{p as s,v as h,w as l,x as b,S as u,z as f,y as n,l as w,Y as x,C as v,D as p,E as k,B as z,Q as y,R as $,U as _}from"./LanguageSwitcher-BXGydb-U.js";var O=Object.getOwnPropertyDescriptor,C=(r,a,d,o)=>{for(var e=o>1?void 0:o?O(a,d):a,t=r.length-1,i;t>=0;t--)(i=r[t])&&(e=i(e)||e);return e};s.init();let g=class extends b{constructor(){super(),new u(this,s)}renderFooterContent(){return n`
      ${f(s.navigationItemKey,[["contact",()=>n`<bkd-contact></bkd-contact>`],["legal",()=>n`<bkd-legal></bkd-legal>`],["imprint",()=>n`<bkd-imprint></bkd-imprint>`]],()=>n``)}
    `}render(){const r=w.footer.find(({key:d})=>d===s.navigationItemKey),a=r?x(r):null;return n`
      <main role="main">
