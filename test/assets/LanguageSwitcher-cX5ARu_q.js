...
3012 Bern`))}
    ...
    `}};Ae.styles=[ee,Me];Ae=cs([J("bkd-imprint"),Q()],Ae);var hs=Object.getOwnPropertyDescriptor,ds=(t,e,n,s)=>{for(var r=s>1?void 0:s?hs(e,n):e,i=t.length-1,o;i>=0;i--)(o=t[i])&&(r=o(r)||r);return r};let _e=class extends k{render(){return P`
      <div class="content-section">
...
3012 Bern`))}
    ...
    `];_e=ds([J("bkd-legal"),Q()],_e);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const tt=(t,e,n)=>{const s=new Map;for(let r=e;r<=n;r++)s.set(t[r],r);return s},us=yt(class extends $t{constructor(t){if(super(t),t.type!==vt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,n){let s;n===void 0?n=e:e!==void 0&&(s=e);const r=[],i=[];let o=0;for(const c of t)r[o]=s?s(c,o):o,i[o]=n(c,o),o++;return{values:i,keys:r}}render(t,e,n){return this.dt(t,e,n).values}update(t,[e,n,s]){const r=rs(t),{values:i,keys:o}=this.dt(e,n,s);if(!Array.isArray(r))return this.ut=o,i;const c=this.ut??=[],l=[];let d,g,h=0,u=r.length-1,p=0,f=i.length-1;for(;h<=u&&p<=f;)if(r[h]===null)h++;else if(r[u]===null)u--;else if(c[h]===o[p])l[p]=I(r[h],i[p]),h++,p++;else if(c[u]===o[f])l[f]=I(r[u],i[f]),u--,f--;else if(c[h]===o[f])l[f]=I(r[h],i[f]),F(t,l[f+1],r[h]),h++,f--;else if(c[u]===o[p])l[p]=I(r[u],i[p]),F(t,r[h],r[u]),u--,p++;else if(d===void 0&&(d=tt(o,p,f),g=tt(c,h,u)),d.has(c[h]))if(d.has(c[u])){const w=g.get(o[p]),de=w!==void 0?r[w]:null;if(de===null){const Ne=F(t,r[h]);I(Ne,i[p]),l[p]=Ne}else l[p]=I(de,i[p]),F(t,r[h],de),r[w]=null;p++}else fe(r[u]),u--;else fe(r[h]),h++;for(;p<=f;){const w=F(t,l[f+1]);I(w,i[p]),l[p++]=w}for(;h<=u;){const w=r[h++];w!==null&&fe(w)}return this.ut=o,ss(t,l),R}});var ps=Object.getOwnPropertyDescriptor,gs=(t,e,n,s)=>{for(var r=s>1?void 0:s?ps(e,n):e,i=t.length-1,o;i>=0;i--)(o=t[i])&&(r=o(r)||r);return r};let ke=class extends k{constructor(){super(),new xe(this,_)}renderFooterLink(t){const e=Yn(t);return P`
      <a
        href=${e}
 ...
 */const fs=yt(class extends $t{constructor(t){if(super(t),t.type!==vt.ATTRIBUTE||t.name!=="class"||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(this.st===void 0){this.st=new Set,t.strings!==void 0&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in e)e[s]&&!this.nt?.has(s)&&this.st.add(s);return this.render(e)}const n=t.element.classList;for(const s of this.st)s in e||(n.remove(s),this.st.delete(s));for(const s in e){const r=!!e[s];r===this.st.has(s)||this.nt?.has(s)||(r?(n.add(s),this.st.add(s)):(n.remove(s),this.st.delete(s)))}return R}});var bs=Object.getOwnPropertyDescriptor,ms=(t,e,n,s)=>{for(var r=s>1?void 0:s?bs(e,n):e,i=t.length-1,o;i>=0;i--)(o=t[i])&&(r=o(r)||r);return r};let Se=class extends k{constructor(){super(),new xe(this,_)}handleLocaleChange(t,e){t.preventDefault(),_.locale=e}render(){return P`<ul>
    ...
    `];Se=ms([J("bkd-language-switcher"),Q()],Se);export{a as A,As as B,J as C,Q as D,b as E,vt as F,R as G,ze as H,fs as I,us as J,Ls as K,D as L,Cs as M,xs as N,zn as O,Ms as P,Us as Q,es as R,xe as S,dn as T,Zn as U,zs as V,Os as W,jn as X,he as Y,xn as _,Es as a,mn as b,U as c,hn as d,Is as e,st as f,Ss as g,Ps as h,ks as i,un as j,Yn as k,m as l,_s as m,Ts as n,yt as o,_ as p,$t as q,ss as r,Rs as s,M as t,be as u,ee as v,O as w,k as x,P as y,Ns as z};
