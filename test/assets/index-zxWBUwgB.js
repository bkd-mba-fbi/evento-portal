 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ee(t,e){return(n,r,i)=>{const o=s=>{var c;return((c=s.renderRoot)==null?void 0:c.querySelector(t))??null};return Fo(n,r,{get(){return o(this)}})}}/**
 * @license
...
`),w`<br />`)}var ma=Object.defineProperty,ba=Object.getOwnPropertyDescriptor,va=(t,e,n,r)=>{for(var i=r>1?void 0:r?ba(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(r?s(e,n,i):s(i))||i);return r&&i&&ma(e,n,i),i};let zn=class extends R{constructor(){super(),new Z(this,v)}render(){return w`
...
3012 Bern`))}
    ...
    `];nr([ee("bkd-service-nav")],ft.prototype,"serviceNavElement",2);nr([ee("bkd-mobile-nav")],ft.prototype,"mobileNavElement",2);ft=nr([D("bkd-header"),N()],ft);var Ea=Object.defineProperty,Ta=Object.getOwnPropertyDescriptor,Wi=(t,e,n,r)=>{for(var i=r>1?void 0:r?Ta(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(r?s(e,n,i):s(i))||i);return r&&i&&Ea(e,n,i),i};let Kt=class extends R{constructor(){super(...arguments),this.open=!1}toggle(){this.dispatchEvent(new CustomEvent("bkdhamburgertoggle",{bubbles:!0,composed:!0}))}render(){const t=this.open?"/icons/close.svg":"/icons/hamburger.svg";return w`
      <button
        class="hamburger"
...
`;function Ki(t){return[{key:"myProfile",label:f("Mein Profil"),href:ve("myProfile")},{key:"mySettings",label:f("Einstellungen"),href:ve("mySettings")},{key:"videos",label:f("Video-Tutorials"),href:t==="de-CH"?"https://www.youtube.com/playlist?list=PLLDtLiOuctbx-_EQWgWqTO1MRbX845OEf":"https://www.youtube.com/playlist?list=PLLDtLiOuctbyEegnquAkaW4u8cm62lFAU",img:"/icons/external-link.svg",external:!0},{key:"logout",label:f("Logout"),href:"#",img:"/icons/logout.svg"}]}var xa=Object.defineProperty,Ia=Object.getOwnPropertyDescriptor,Gi=(t,e,n,r)=>{for(var i=r>1?void 0:r?Ia(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(r?s(e,n,i):s(i))||i);return r&&i&&xa(e,n,i),i};let Gt=class extends R{constructor(){super(),this.openGroup=null,this.handleKeyup=t=>{t.key==="Tab"&&this.openGroupOfFocusedItem()},new Z(this,v)}connectedCallback(){super.connectedCallback(),this.openGroupOfCurrentItem(),this.addEventListener("keyup",this.handleKeyup)}disconnectedCallback(){this.removeEventListener("keyup",this.handleKeyup),super.disconnectedCallback()}openGroupOfCurrentItem(){this.openGroup||(this.openGroup=v.navigationGroup)}openGroupOfFocusedItem(){var e,n;const t=(e=this.shadowRoot)==null?void 0:e.activeElement;if(t instanceof HTMLElement){const r=t.dataset.itemKey;if(r){const{group:i}=en(O.navigation,r);i&&i.label!==((n=this.openGroup)==null?void 0:n.label)&&(this.openGroup=i)}}}handleGroupClick(t,e){var n;t.preventDefault(),this.openGroup=e.label!==((n=this.openGroup)==null?void 0:n.label)?e:null}handleNavItemClick(t,e){t.preventDefault(),this.dispatchEvent(new CustomEvent("bkdnavitemclick",{detail:{item:e},composed:!0,bubbles:!0}))}handleSettingsItemClick(t,e){this.dispatchEvent(new CustomEvent("bkdsettingsitemclick",{detail:{item:e,event:t},composed:!0,bubbles:!0}))}renderGroup(t){var n;const e=t.label===((n=this.openGroup)==null?void 0:n.label);return w`
    ...
    `];Fn=Da([D("bkd-nav"),N()],Fn);var Na=Object.defineProperty,Ma=Object.getOwnPropertyDescriptor,rr=(t,e,n,r)=>{for(var i=r>1?void 0:r?Ma(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(r?s(e,n,i):s(i))||i);return r&&i&&Na(e,n,i),i};let gt=class extends R{constructor(){super(),this.open=!1,new Z(this,v)}handleItemClick(t,e){t.preventDefault(),this.dispatchEvent(new CustomEvent("bkdnavitemclick",{detail:{item:e},composed:!0,bubbles:!0}))}renderItem(t){const e=t.key===v.navigationItemKey;return w`
    ...
    `];_t([q()],Ie.prototype,"group",2);_t([q({type:Boolean})],Ie.prototype,"active",2);_t([ee("a")],Ie.prototype,"toggleElement",2);_t([ee("bkd-nav-group-dropdown")],Ie.prototype,"menuElement",2);Ie=_t([D("bkd-nav-group-toggle"),N()],Ie);var ja=Object.defineProperty,Ha=Object.getOwnPropertyDescriptor,Vi=(t,e,n,r)=>{for(var i=r>1?void 0:r?Ha(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(r?s(e,n,i):s(i))||i);return r&&i&&ja(e,n,i),i};let Vt=class extends R{handleClick(t){t.preventDefault()}render(){if(this.item)return w`<a href="#" @click=${this.handleClick.bind(this)}
      >${this.item.label}</a
    >`}};Vt.styles=[M,I``];Vi([q()],Vt.prototype,"item",2);Vt=Vi([D("bkd-nav-item-link"),N()],Vt);var Fa=Object.defineProperty,Ba=Object.getOwnPropertyDescriptor,qi=(t,e,n,r)=>{for(var i=r>1?void 0:r?Ba(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(r?s(e,n,i):s(i))||i);return r&&i&&Fa(e,n,i),i};let qt=class extends R{constructor(){super(),this.mobileNavOpen=!1,new Z(this,v)}render(){return w`
