 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ft=t=>typeof t!="string"&&"strTag"in t,lt=(t,e,n)=>{let s=t[0];for(let r=1;r<t.length;r++)s+=e[n?n[r-1]:r-1],s+=t[r];return s};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ct=t=>Ft(t)?lt(t.strings,t.values):t;let a=ct,Ye=!1;function Wt(t){if(Ye)throw new Error("lit-localize can only be configured once");a=t,Ye=!0}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Vt{constructor(e){this.__litLocalizeEventHandler=n=>{n.detail.status==="ready"&&this.host.requestUpdate()},this.host=e}hostConnected(){window.addEventListener(me,this.__litLocalizeEventHandler)}hostDisconnected(){window.removeEventListener(me,this.__litLocalizeEventHandler)}}const Gt=t=>t.addController(new Vt(t)),qt=Gt;/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Q=()=>(t,e)=>(t.addInitializer(qt),t);/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class ht{constructor(){this.settled=!1,this.promise=new Promise((e,n)=>{this._resolve=e,this._reject=n})}resolve(e){this.settled=!0,this._resolve(e)}reject(e){this.settled=!0,this._reject(e)}}/**
 * @license
 * Copyright 2014 Travis Webb
 * SPDX-License-Identifier: MIT
 */const A=[];for(let t=0;t<256;t++)A[t]=(t>>4&15).toString(16)+(t&15).toString(16);function Yt(t){let e=0,n=8997,s=0,r=33826,i=0,o=40164,h=0,l=52210;for(let u=0;u<t.length;u++)n^=t.charCodeAt(u),e=n*435,s=r*435,i=o*435,h=l*435,i+=n<<8,h+=r<<8,s+=e>>>16,n=e&65535,i+=s>>>16,r=s&65535,l=h+(i>>>16)&65535,o=i&65535;return A[l>>8]+A[l&255]+A[o>>8]+A[o&255]+A[r>>8]+A[r&255]+A[n>>8]+A[n&255]}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;function Us(t){const e=document.createElement("style");e.innerText=t,document.querySelector("body")?.appendChild(e)}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ns=(t,e,n)=>{for(const s of e)if(s[0]===t)return(0,s[1])();return n?.()};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const vt={ATTRIBUTE:1,CHILD:2},yt=t=>(...e)=>({_$litDirective$:t,values:e});class $t{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,n,s){this._$Ct=e,this._$AM=n,this._$Ci=s}_$AS(e,n){return this.update(e,n)}update(e,n){return this.render(...n)}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:ts}=Kt,et=()=>document.createComment(""),F=(t,e,n)=>{const s=t._$AA.parentNode,r=e===void 0?t._$AB:e._$AA;if(n===void 0){const i=s.insertBefore(et(),r),o=s.insertBefore(et(),r);n=new ts(i,o,t,t.options)}else{const i=n._$AB.nextSibling,o=n._$AM,h=o!==t;if(h){let l;n._$AQ?.(t),n._$AM=t,n._$AP!==void 0&&(l=t._$AU)!==o._$AU&&n._$AP(l)}if(i!==r||h){let l=n._$AA;for(;l!==i;){const u=l.nextSibling;s.insertBefore(l,r),l=u}}}return n},I=(t,e,n=t)=>(t._$AI(e,n),t),ns={},ss=(t,e=ns)=>t._$AH=e,rs=t=>t._$AH,fe=t=>{t._$AP?.(!1,!0);let e=t._$AA;const n=t._$AB.nextSibling;for(;e!==n;){const s=e.nextSibling;e.remove(),e=s}};var is=Object.getOwnPropertyDescriptor,os=(t,e,n,s)=>{for(var r=s>1?void 0:s?is(e,n):e,i=t.length-1,o;i>=0;i--)(o=t[i])&&(r=o(r)||r);return r};let we=class extends k{render(){return P`<p>
    ...
    </p>`}};we.styles=[ee,Me];we=os([J("bkd-contact"),Q()],we);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*as(t,e){const n=typeof e=="function";if(t!==void 0){let s=-1;for(const r of t)s>-1&&(yield n?e(s):e),s++,yield r}}function oe(t){return as(t?.split(`
...
3012 Bern`))}
    ...
    `];_e=us([J("bkd-legal"),Q()],_e);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const tt=(t,e,n)=>{const s=new Map;for(let r=e;r<=n;r++)s.set(t[r],r);return s},ds=yt(class extends $t{constructor(t){if(super(t),t.type!==vt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,n){let s;n===void 0?n=e:e!==void 0&&(s=e);const r=[],i=[];let o=0;for(const h of t)r[o]=s?s(h,o):o,i[o]=n(h,o),o++;return{values:i,keys:r}}render(t,e,n){return this.dt(t,e,n).values}update(t,[e,n,s]){const r=rs(t),{values:i,keys:o}=this.dt(e,n,s);if(!Array.isArray(r))return this.ut=o,i;const h=this.ut??=[],l=[];let u,g,c=0,d=r.length-1,p=0,f=i.length-1;for(;c<=d&&p<=f;)if(r[c]===null)c++;else if(r[d]===null)d--;else if(h[c]===o[p])l[p]=I(r[c],i[p]),c++,p++;else if(h[d]===o[f])l[f]=I(r[d],i[f]),d--,f--;else if(h[c]===o[f])l[f]=I(r[c],i[f]),F(t,l[f+1],r[c]),c++,f--;else if(h[d]===o[p])l[p]=I(r[d],i[p]),F(t,r[c],r[d]),d--,p++;else if(u===void 0&&(u=tt(o,p,f),g=tt(h,c,d)),u.has(h[c]))if(u.has(h[d])){const w=g.get(o[p]),ue=w!==void 0?r[w]:null;if(ue===null){const Ne=F(t,r[c]);I(Ne,i[p]),l[p]=Ne}else l[p]=I(ue,i[p]),F(t,r[c],ue),r[w]=null;p++}else fe(r[d]),d--;else fe(r[c]),c++;for(;p<=f;){const w=F(t,l[f+1]);I(w,i[p]),l[p++]=w}for(;c<=d;){const w=r[c++];w!==null&&fe(w)}return this.ut=o,ss(t,l),R}});var ps=Object.getOwnPropertyDescriptor,gs=(t,e,n,s)=>{for(var r=s>1?void 0:s?ps(e,n):e,i=t.length-1,o;i>=0;i--)(o=t[i])&&(r=o(r)||r);return r};let ke=class extends k{constructor(){super(),new xe(this,_)}renderFooterLink(t){const e=Yn(t);return P`
      <a
        href=${e}
    ...
    `];ke=gs([J("bkd-footer"),Q()],ke);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const fs=yt(class extends $t{constructor(t){if(super(t),t.type!==vt.ATTRIBUTE||t.name!=="class"||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(this.st===void 0){this.st=new Set,t.strings!==void 0&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in e)e[s]&&!this.nt?.has(s)&&this.st.add(s);return this.render(e)}const n=t.element.classList;for(const s of this.st)s in e||(n.remove(s),this.st.delete(s));for(const s in e){const r=!!e[s];r===this.st.has(s)||this.nt?.has(s)||(r?(n.add(s),this.st.add(s)):(n.remove(s),this.st.delete(s)))}return R}});var bs=Object.getOwnPropertyDescriptor,ms=(t,e,n,s)=>{for(var r=s>1?void 0:s?bs(e,n):e,i=t.length-1,o;i>=0;i--)(o=t[i])&&(r=o(r)||r);return r};let Se=class extends k{constructor(){super(),new xe(this,_)}handleLocaleChange(t,e){t.preventDefault(),_.locale=e}render(){return P`<ul>
      ${Oe.map(t=>P`<li>
            <a
              href="#"
    ...
    `];Se=ms([J("bkd-language-switcher"),Q()],Se);export{a as A,As as B,J as C,Q as D,b as E,vt as F,R as G,ze as H,fs as I,ds as J,Ls as K,D as L,Cs as M,xs as N,zn as O,Ms as P,Us as Q,es as R,xe as S,un as T,Zn as U,zs as V,Os as W,jn as X,he as Y,xn as _,Es as a,mn as b,U as c,hn as d,Is as e,st as f,Ss as g,Ps as h,ks as i,dn as j,Yn as k,m as l,_s as m,Ts as n,yt as o,_ as p,$t as q,ss as r,Rs as s,M as t,be as u,ee as v,O as w,k as x,P as y,Ns as z};
