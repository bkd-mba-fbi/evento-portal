define(['appConfig', 'storage', 'urlHelpers', 'translate', 'guiHelpers', 'settings', 'uiSettings', 'icons'],
    ...
    var loginHelpers = {
        ...
        tryAddLanguageInfo: function (currentUiCulture) {
            ...
            if (uiSettings.usedLanguages.length === 2) {
                ...
                var languageButton = guiHelpers.getTextButton('<span class="material-icons">language</span>', currentUiCulture, 'clx_languageButton')
