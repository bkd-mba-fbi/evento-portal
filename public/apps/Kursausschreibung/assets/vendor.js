...
var c=0
function d(e){return c--,e}i.Test?(i.Test.registerWaiter(function(){return 0===c}),t.default=function(){return c++,t.fetch.apply(e,arguments).then(function(e){return e.clone().blob().then(d,d),e},function(e){throw d(e),e})}):t.default=t.fetch,s.forEach(function(e){delete t[e]})})})("undefined"!=typeof window&&window||"undefined"!=typeof globalThis&&globalThis||"undefined"!=typeof self&&self||"undefined"!=typeof global&&global)}/*! UIkit 3.24.2 | https://www.getuikit.com | (c) 2014 - 2025 YOOtheme | MIT License */
...
Gi.util=en,Gi.options={},Gi.version="3.24.2"
...
function io(e,t=null){return(null==t?void 0:t.id)||`${e.$options.id}-${no++}`}var oo={i18n:{next:"Next slide",previous:"Previous slide",slideX:"Slide %s",slideLabel:"%s of %s",role:"String"},data:{selNav:!1,role:"region"},computed:{nav:({selNav:e},t)=>It(e,t),navChildren(){return Me(this.nav)},selNavItem:({attrItem:e})=>`[${e}],[data-${e}]`,navItems(e,t){return Dt(this.selNavItem,t)}},watch:{nav(e,t){ie(e,"role","tablist"),this.padNavitems(),t&&this.$emit()},list(e){yt(e,"ul")&&ie(e,"role","presentation")},navChildren(e){ie(e,"role","presentation"),this.padNavitems(),this.updateNav()},navItems(e){for(const t of e){const e=ae(t,this.attrItem),r=It("a,button",t)||t
let n,i=null
...
re(t,this.clsActive,i),re(n,"uk-disabled",!!this.parallax),n.ariaSelected=i,n.tabIndex=i&&!this.parallax?null:-1,i&&n&&Se(Oe(t),":focus-within")&&n.focus()}else re(t,"uk-invisible",this.finite&&("previous"===r&&0===e||"next"===r&&e>=this.maxIndex))}},padNavitems(){if(!this.nav)return
const e=[]
for(let t=0;t<this.length;t++){const r=`${this.attrItem}="${t}"`
e[t]=this.navChildren.findLast(e=>e.matches(`[${r}]`))||It(`<li ${r}><a href></a></li>`)}I(e,this.navChildren)||_t(this.nav,e)}}}
...
return r?n-function(e,t){return Ft(t).width/2-Ft(e).width/2}(e,t):Math.min(n,Zo(t))}function Zo(e){return Math.max(0,Ko(e)-Ft(e).width)}function Ko(e,t){return B(Me(e).slice(0,t),e=>Ft(e).width)}function Xo(e,t){return e&&(Ht(e).left+(ue?Ft(e).width-Ft(t).width:0))*(ue?-1:1)||0}function Jo(e,t){t-=1
...
if(r.has(t))return!0
e+=Ft(t).width,r.add(t)}s=Math.max(s,t/2+Ft(n[Z(+o+a,n)]).width/2-(e-i))}if(Math.trunc(s)>B(n.filter(e=>!r.has(e)),e=>Ft(e).width))return!0}return!1}(this.list,this.center)},maxIndex(){if(!this.finite||this.center&&!this.sets)return this.length-1
...
let r=Ft(this.list).width/2-Ft(t).width/2,n=0
...
return e},getAdjacentSlides(){const{width:e}=Ft(this.list),t=-e,r=2*e,n=Ft(this.slides[this.index]).width,i=this.center?e/2-n/2:0,o=new Set
...
let r=e*(this.center?Ko(this.list)-(Ft(this.slides[0]).width/2+Ft(L(this.slides)).width/2):Ko(this.list,this.maxIndex)),n=0
do{const e=Ft(this.slides[++t]).width,i=this.center?e/2+Ft(this.slides[t+1]).width/2:e
...
ys(t,!e)}this.$emit()}},observe:vn(),events:[{name:"click keydown",delegate:({targets:e,$props:t})=>`${e} ${t.toggle}`,async handler(e){var t
"keydown"===e.type&&e.keyCode!==Bn||(Ln(e),null==(t=this._off)||t.call(this),this._off=function(e){const t=Rr(e,!0)
let r
...
n=(i*u+n)*(t?1-c:c),st(a,"height",l),await pt.start(a,{height:t?u:0},n,o),Mt(r),delete e._wrapper,t||ys(r,!0)}(e,r,this)
