...
var c=0
function d(e){return c--,e}i.Test?(i.Test.registerWaiter(function(){return 0===c}),t.default=function(){return c++,t.fetch.apply(e,arguments).then(function(e){return e.clone().blob().then(d,d),e},function(e){throw d(e),e})}):t.default=t.fetch,s.forEach(function(e){delete t[e]})})})("undefined"!=typeof window&&window||"undefined"!=typeof globalThis&&globalThis||"undefined"!=typeof self&&self||"undefined"!=typeof global&&global)}/*! UIkit 3.23.11 | https://www.getuikit.com | (c) 2014 - 2025 YOOtheme | MIT License */
...
e+=`${e?",":""}${We(a)} ${s}`}}return y(t)||(t=t.ownerDocument),Ve(t,r,e)}function Ve(e,t,r){try{return e[t](r)}catch(n){return null}}function We(e){const t=[]
...
const pt={start:function(e,t,r=400,n="linear"){return r=Math.round(r),Promise.all(j(e).map(e=>new Promise((i,o)=>{for(const r in t)st(e,r)
const s=setTimeout(()=>Ke(e,dt),r)
Ze(e,[dt,ht],({type:t})=>{clearTimeout(s),J(e,ct),at(e,a),t===ht?o():i(e)},{self:!0}),X(e,ct)
const a={transitionProperty:Object.keys(t).map(lt).join(","),transitionDuration:`${r}ms`,transitionTimingFunction:n}
st(e,{...a,...t})})))},async stop(e){Ke(e,dt),await Promise.resolve()},async cancel(e){Ke(e,ht),await Promise.resolve()},inProgress:e=>te(e,ct)},ft="uk-animation",mt="animationend",gt="animationcanceled"
...
let Or=0
function Tr(e,{offset:t=0}={}){const r=_e(e)?Pr(e,!1,["hidden"]):[]
return r.reduce((n,i,o)=>{const{scrollTop:s,scrollHeight:a,offsetHeight:l}=i,u=Ar(i),c=a-u.height,{height:d,top:h}=r[o-1]?Ar(r[o-1]):Bt(e)
...
var l
const u=Date.now(),c=Dr(e)===e,d=Bt(n).top+(c?0:s)
let h=0,p=15;(function l(){const f=(m=U((Date.now()-u)/a),.5*(1-Math.cos(Math.PI*m)))
var m
let g=0
r[0]===e&&s+t<i&&(g=Bt(n).top+(c?0:e.scrollTop)-d-Ft(jr(n)).height),"auto"!==st(e,"scrollBehavior")&&st(e,"scrollBehavior","auto"),e.scrollTop=s+(t+g)*f,st(e,"scrollBehavior",""),1!==f||h!==g&&p--?(h=g,requestAnimationFrame(l)):o()})()})}(i,p-s,e,c).then(n)},()=>Promise.resolve())()}function Sr(e,t=0,r=0){if(!_e(e))return 0
const n=Mr(e,!0),{scrollHeight:i,scrollTop:o}=n,{height:s}=Ar(n),a=i-s,l=zt(e)[0]-zt(n)[0],u=Math.max(0,l-s+t),c=Math.min(a,l+e.offsetHeight-r)
return u<c?U((o-u)/(c-u)):1}function Pr(e,t=!1,r=[]){const n=Dr(e)
let i=Pe(e).reverse()
i=i.slice(i.indexOf(n)+1)
const o=d(i,e=>"fixed"===st(e,"position"))
return~o&&(i=i.slice(o)),[n].concat(i.filter(e=>st(e,"overflow").split(" ").some(e=>c(["auto","scroll",...r],e))&&(!t||e.scrollHeight>Ar(e).height))).reverse()}function Mr(...e){return Pr(...e)[0]}function Rr(e){return Pr(e,!1,["hidden","clip"])}function Ar(e){const t=N(e),r=Dr(e),n=!w(e)||e.contains(r)
...
i[d]+=R(st(l,`border-${d}-width`)),i[u]=i[c]=l[`client${a(u)}`]-(e?e<.5?-e:1-e:0),i[h]=i[u]+i[d]}return i}function jr(e){const{left:t,width:r,top:n}=Ft(e)
for(const i of n?[0,n]:[0]){let n
for(const o of N(e).document.elementsFromPoint(t+r/2,i))o.contains(e)||te(o,"uk-togglable-leave")||!(Ir(o,"fixed")&&Nr(Pe(e).reverse().find(e=>!e.contains(o)&&!Ir(e,"static")))<Nr(o)||Ir(o,"sticky")&&Oe(o).contains(e))||n&&!(Ft(n).height<Ft(o).height)||(n=o)
if(n)return n}}function Nr(e){return R(st(e,"zIndex"))}function Ir(e,t){return st(e,"position")===t}function Dr(e){return N(e).document.scrollingElement}const Lr=[["width","x","left","right"],["height","y","top","bottom"]]
function $r(e,t,r){r={attach:{element:["left","top"],target:["left","top"],...r.attach},offset:[0,0],placement:[],...r},h(t)||(t=[t,t]),Bt(e,Fr(e,t,r))}function Fr(e,t,r){const n=Br(e,t,r),{boundary:i,viewportOffset:o=0,placement:s}=r
let a=n
for(const[l,[u,,c,d]]of Object.entries(Lr)){const h=Ur(e,t[l],o,i,l)
if(Yr(n,h,l))continue
let p=0
if("flip"===s[l]){const i=r.attach.target[l]
if(i===d&&n[d]<=h[d]||i===c&&n[c]>=h[c])continue
p=Gr(e,t,r,l)[c]-n[c]
const s=qr(e,t[l],o,l)
if(!Yr(Hr(n,p,l),s,l)){if(Yr(n,s,l))continue
if(r.recursion)return!1
const i=Qr(e,t,r)
if(i&&Yr(i,s,1-l))return i
continue}}else if("shift"===s[l]){const e=Bt(t[l]),{offset:i}=r
p=U(U(n[c],h[c],h[d]-n[u]),e[c]-n[u]+i[l],e[d]-i[l])-n[c]}a=Hr(a,p,l)}return a}function Br(e,t,r){let{attach:n,offset:i}={attach:{element:["left","top"],target:["left","top"],...r.attach},offset:[0,0],...r},o=Bt(e)
for(const[s,[a,,l,u]]of Object.entries(Lr)){const e=n.target[s]===n.element[s]?Ar(t[s]):Bt(t[s])
o=Hr(o,e[l]-o[l]+zr(n.target[s],u,e[a])-zr(n.element[s],u,o[a])+ +i[s],s)}return o}function Hr(e,t,r){const[,n,i,o]=Lr[r],s={...e}
return s[i]=e[n]=e[i]+t,s[o]+=t,s}function zr(e,t,r){return"center"===e?r/2:e===t?r:0}function Ur(e,t,r,n,i){let o=Wr(...Vr(e,t).map(Ar))
return r&&(o[Lr[i][2]]+=r,o[Lr[i][3]]-=r),n&&(o=Wr(o,Bt(h(n)?n[i]:n))),o}function qr(e,t,r,n){const[i,o,s,l]=Lr[n],[u]=Vr(e,t),c=Ar(u)
return["auto","scroll"].includes(st(u,`overflow-${o}`))&&(c[s]-=u[`scroll${a(s)}`],c[l]=c[s]+u[`scroll${a(i)}`]),c[s]+=r,c[l]-=r,c}function Vr(e,t){return Rr(t).filter(t=>t.contains(e))}function Wr(...e){let t={}
for(const r of e)for(const[,,e,n]of Lr)t[e]=Math.max(t[e]||0,r[e]),t[n]=Math.min(...[t[n],r[n]].filter(Boolean))
return t}function Yr(e,t,r){const[,,n,i]=Lr[r]
return e[n]>=t[n]&&e[i]<=t[i]}function Gr(e,t,{offset:r,attach:n},i){return Br(e,t,{attach:{element:Zr(n.element,i),target:Zr(n.target,i)},offset:Xr(r,i)})}function Qr(e,t,r){return Fr(e,t,{...r,attach:{element:r.attach.element.map(Kr).reverse(),target:r.attach.target.map(Kr).reverse()},offset:r.offset.reverse(),placement:r.placement.reverse(),recursion:!0})}function Zr(e,t){const r=[...e],n=Lr[t].indexOf(e[t])
return~n&&(r[t]=Lr[t][1-n%2+2]),r}function Kr(e){for(let t=0;t<Lr.length;t++){const r=Lr[t].indexOf(e)
if(~r)return Lr[1-t][r%2+2]}}function Xr(e,t){return(e=[...e])[t]*=-1,e}var Jr=Object.freeze({__proto__:null,$:It,$$:Dt,Animation:bt,Dimensions:Q,MouseTracker:ur,Transition:pt,addClass:X,after:kt,append:Et,apply:Nt,assign:f,attr:ie,before:Ct,boxModelAdjust:Wt,camelize:s,children:Me,clamp:U,createEvent:Xe,css:st,data:ae,dimensions:Ft,each:$,empty:wt,endsWith:u,escape:Ye,fastdom:tr,filter:Te,find:De,findAll:Le,findIndex:d,flipPosition:Yt,fragment:At,getCoveringElement:jr,getEventPos:it,getIndex:Z,getTargetedElement:je,hasAttr:oe,hasClass:te,hasOwn:r,hasTouch:ce,height:Ut,html:_t,hyphenate:i,inBrowser:le,includes:c,index:Re,intersectRect:V,isArray:h,isBoolean:E,isDocument:y,isElement:_,isEmpty:T,isEqual:I,isFocusable:ke,isFunction:m,isInView:function(e,t=0,r=0){return!!_e(e)&&V(...Rr(e).map(e=>{const{top:n,left:i,bottom:o,right:s}=Ar(e)
return{top:n-t,left:i-r,bottom:o+t,right:s+r}}).concat(Bt(e)))},isInput:Ee,isNode:w,isNumber:k,isNumeric:O,isObject:g,isPlainObject:v,isRtl:ue,isSameSiteAnchor:Ae,isString:C,isTag:yt,isTouch:nt,isUndefined:S,isVisible:_e,isVoidElement:ye,isWindow:b,last:L,matches:Se,memoize:K,mute:br,noop:q,observeIntersection:cr,observeMutation:fr,observeResize:hr,observeViewportResize:pr,off:Qe,offset:Bt,offsetPosition:zt,offsetViewport:Ar,on:Ge,once:Ze,overflowParents:Rr,parent:Oe,parents:Pe,pause:vr,pick:z,play:gr,pointInRect:W,pointerCancel:ve,pointerDown:he,pointerEnter:me,pointerLeave:ge,pointerMove:pe,pointerUp:fe,position:Ht,positionAt:$r,prepend:xt,propName:lt,query:Ne,queryAll:Ie,ready:function(e){"loading"===document.readyState?Ze(document,"DOMContentLoaded",e):e()},remove:Tt,removeAttr:se,removeClass:J,replaceClass:ee,resetProps:at,scrollIntoView:Tr,scrollParent:Mr,scrollParents:Pr,scrolledOver:Sr,selFocusable:Ce,selInput:xe,sortBy:F,startsWith:l,sumBy:B,swap:D,toArray:p,toBoolean:P,toEventTargets:rt,toFloat:R,toNode:A,toNodes:j,toNumber:M,toPx:Gt,toWindow:N,toggleClass:re,trigger:Ke,ucfirst:a,uniqueBy:H,unwrap:Mt,width:qt,wrapAll:St,wrapInner:Pt}),en={connected(){X(this.$el,this.$options.id)}}
const tn=["days","hours","minutes","seconds"]
var rn={mixins:[en],props:{date:String,clsWrapper:String,role:String,reload:Boolean},data:{date:"",clsWrapper:".uk-countdown-%unit%",role:"timer",reload:!1},connected(){this.$el.role=this.role,this.date=R(Date.parse(this.$props.date)),this.started=this.end=!1,this.start()},disconnected(){this.stop()},events:{name:"visibilitychange",el:()=>document,handler(){document.hidden?this.stop():this.start()}},methods:{start(){this.stop(),this.update()},stop(){this.timer&&(clearInterval(this.timer),Ke(this.$el,"countdownstop"),this.timer=null)},update(){const e=function(e){const t=Math.max(0,e-Date.now())/1e3
...
for(const t of tn){const r=It(this.clsWrapper.replace("%unit%",t),this.$el)
if(!r)continue
...
const nn={}
function on(e,t,r){return nn.computed(m(e)?e.call(r,r):e,m(t)?t.call(r,r):t)}function sn(e,t){return e=e&&!h(e)?[e]:e,t?e?e.concat(t):h(t)?t:[t]:e}function an(e,t){return S(t)?e:t}function ln(e,t,n){const i={}
if(m(t)&&(t=t.options),t.extends&&(e=ln(e,t.extends,n)),t.mixins)for(const r of t.mixins)e=ln(e,r,n)
for(const r in e)o(r)
for(const s in t)r(e,s)||o(s)
function o(r){i[r]=(nn[r]||an)(e[r],t[r],n)}return i}function un(e,t=[]){try{return e?l(e,"{")?JSON.parse(e):t.length&&!c(e,":")?{[t[0]]:e}:e.split(";").reduce((e,t)=>{const[r,n]=t.split(/:(.*)/)
return r&&!S(n)&&(e[r.trim()]=n.trim()),e},{}):{}}catch(r){return{}}}function cn(e,t){return e===Boolean?P(t):e===Number?M(t):"list"===e?function(e){return h(e)?e:C(e)?e.split(dn).map(e=>O(e)?M(e):P(e.trim())):[e]}(t):e===Object&&C(t)?un(t):e?e(t):t}nn.events=nn.watch=nn.observe=nn.created=nn.beforeConnect=nn.connected=nn.beforeDisconnect=nn.disconnected=nn.destroy=sn,nn.args=function(e,t){return!1!==t&&sn(t||e)},nn.update=function(e,t){return F(sn(e,m(t)?{read:t}:t),"order")},nn.props=function(e,t){if(h(t)){const e={}
for(const r of t)e[r]=String
t=e}return nn.methods(e,t)},nn.computed=nn.methods=function(e,t){return t?e?{...e,...t}:t:e},nn.i18n=nn.data=function(e,t,r){return r?on(e,t,r):t?e?function(r){return on(e,t,r)}:t:e}
const dn=/,(?![^(]*\))/
function hn(e,t="update"){e._connected&&e._updates.length&&(e._queued||(e._queued=new Set,tr.read(()=>{e._connected&&function(e,t){for(const{read:r,write:n,events:i=[]}of e._updates){if(!t.has("update")&&!i.some(e=>t.has(e)))continue
let o
r&&(o=r.call(e,e._data,t),o&&v(o)&&f(e._data,o)),n&&!1!==o&&tr.write(()=>{e._connected&&n.call(e,e._data,t)})}}(e,e._queued),e._queued=null})),e._queued.add(t.type||t))}function pn(e){return wn(hr,e,"resize")}function fn(e){return wn(cr,e)}function mn(e){return wn(fr,e)}function gn(e={}){return fn({handler:function(t,r){const{targets:n=this.$el,preload:i=5}=e
for(const e of j(m(n)?n(this):n))Dt('[loading="lazy"]',e).slice(0,i-1).forEach(e=>se(e,"loading"))
for(const e of t.filter(({isIntersecting:e})=>e).map(({target:e})=>e))r.unobserve(e)},...e})}function vn(e){return wn((e,t)=>pr(t),e,"resize")}function bn(e){return wn((e,t)=>{return{disconnect:Ge((r=e,j(r).map(e=>{const{ownerDocument:t}=e,r=Mr(e,!0)
return r===t.scrollingElement?t:r})),"scroll",t,{passive:!0})}
var r},e,"scroll")}function yn(e){return{observe:(e,t)=>({observe:q,unobserve:q,disconnect:Ge(e,he,t,{passive:!0})}),handler(e){if(!nt(e))return
...
Ke(r,"swipe"),Ke(r,"swipe"+(e=t.x,o=t.y,s=n,a=i,Math.abs(e-s)>=Math.abs(o-a)?e-s>0?"Left":"Right":o-a>0?"Up":"Down"))})})},...e}}function wn(e,t,r){return{observe:e,handler(){hn(this,r)},...t}}var _n={props:{margin:String,firstColumn:Boolean},data:{margin:"uk-margin-small-top",firstColumn:"uk-first-column"},observe:[mn({options:{childList:!0}}),mn({options:{attributes:!0,attributeFilter:["style"]}}),pn({handler(e){for(const{borderBoxSize:[{inlineSize:t,blockSize:r}]}of e)if(t||r)return void this.$emit("resize")},target:({$el:e})=>[e,...Me(e)]})],update:{read(){return{rows:xn(Me(this.$el))}},write({rows:e}){for(const t of e)for(const r of t)re(r,this.margin,e[0]!==t),re(r,this.firstColumn,t[ue?t.length-1:0]===r)},events:["resize"]}}
function xn(e){const t=[[]],r=e.some((t,r)=>r&&e[r-1].offsetParent!==t.offsetParent)
for(const n of e){if(!_e(n))continue
const e=En(n,r)
for(let i=t.length-1;i>=0;i--){const o=t[i]
if(!o[0]){o.push(n)
break}const s=En(o[0],r)
if(e.top>=s.bottom-1&&e.top!==s.top){t.push([n])
break}if(e.bottom-1>s.top||e.top===s.top){let t=o.length-1
for(;t>=0;t--){const n=En(o[t],r)
if(e.left>=n.left)break}o.splice(t+1,0,n)
break}if(0===i){t.unshift([n])
break}}}return t}function En(e,t=!1){let{offsetTop:r,offsetLeft:n,offsetHeight:i,offsetWidth:o}=e
return t&&([r,n]=zt(e)),{top:r,left:n,bottom:r+i,right:n+o}}const Cn="uk-transition-leave",kn="uk-transition-enter"
function On(e,t,r,n=0){const i=Tn(t,!0),o={opacity:1},s={opacity:0},a=()=>i===Tn(t),l=e=>()=>a()?e():Promise.reject(),u=l(async()=>{X(t,Cn),await(n?Promise.all(Pn(t).map(async(e,t)=>(await Mn(t*n),pt.start(e,s,r/2,"ease")))):pt.start(t,s,r/2,"ease")),J(t,Cn)}),c=l(async()=>{const i=Ut(t)
X(t,kn),e(),st(n?Me(t):t,s),Ut(t,i),await Mn(),Ut(t,"")
const l=Ut(t)
st(t,"alignContent","flex-start"),Ut(t,i)
let u=[],c=r/2
if(n){const e=Pn(t)
st(Me(t),s),u=e.map(async(e,t)=>{await Mn(t*n),await pt.start(e,o,r/2,"ease"),a()&&at(e,o)}),c+=e.length*n}if(!n||i!==l){const e={height:l,...n?{}:o}
u.push(pt.start(t,e,c,"ease"))}await Promise.all(u),J(t,kn),a()&&(at(t,{height:"",alignContent:"",...o}),delete t.dataset.transition)})
return te(t,Cn)?Sn(t).then(c):te(t,kn)?Sn(t).then(u).then(c):u().then(c)}function Tn(e,t){return t&&(e.dataset.transition=1+Tn(e)),M(e.dataset.transition)||0}function Sn(e){return Promise.all(Me(e).filter(pt.inProgress).map(e=>new Promise(t=>Ze(e,"transitionend transitioncanceled",t))))}function Pn(e){return xn(Me(e)).flat().filter(_e)}function Mn(e){return new Promise(t=>setTimeout(t,e))}async function Rn(e,t,r){await Nn()
let n=Me(t)
const i=n.map(e=>An(e,!0)),o={...st(t,["height","padding"]),display:"block"},s=n.concat(t)
await Promise.all(s.map(pt.cancel)),st(s,"transitionProperty","none"),await e(),n=n.concat(Me(t).filter(e=>!c(n,e))),await Promise.resolve(),st(s,"transitionProperty","")
const a=ie(t,"style"),l=st(t,["height","padding"]),[u,d]=function(e,t,r){const n=t.map((e,t)=>!(!Oe(e)||!(t in r))&&(r[t]?_e(e)?jn(e):{opacity:0}:{opacity:_e(e)?1:0})),i=n.map((n,i)=>{const o=Oe(t[i])===e&&(r[i]||An(t[i]))
if(!o)return!1
...
n.forEach((e,t)=>d[t]&&st(e,d[t])),st(t,o),Ke(t,"scroll"),await Nn()
const p=n.map((e,n)=>Oe(e)===t&&pt.start(e,u[n],r,"ease")).concat(pt.start(t,l,r,"ease"))
try{await Promise.all(p),n.forEach((e,r)=>{ie(e,h[r]),Oe(e)===t&&st(e,"display",0===u[r].opacity?"none":"")}),ie(t,"style",a)}catch(f){ie(n,"style",""),at(t,o)}}function An(e,t){const r=st(e,"zIndex")
return!!_e(e)&&{display:"",opacity:t?st(e,"opacity"):"0",pointerEvents:"none",position:"absolute",zIndex:"auto"===r?Re(e):r,...jn(e)}}function jn(e){const{height:t,width:r}=Ft(e)
return{height:t,width:r,transform:"",...Ht(e),...st(e,["marginTop","marginLeft"])}}function Nn(){return new Promise(e=>requestAnimationFrame(e))}var In={props:{duration:Number,animation:Boolean},data:{duration:150,animation:"slide"},methods:{animate(e,t=this.$el){const r=this.animation
return("fade"===r?On:"delayed-fade"===r?(...e)=>On(...e,40):r?Rn:()=>(e(),Promise.resolve()))(e,t,this.duration).catch(q)}}}
function Dn(e){e.target.closest('a[href="#"],a[href=""]')&&e.preventDefault()}const Ln=9,$n=27,Fn=32,Bn=35,Hn=36,zn=37,Un=38,qn=39,Vn=40
var Wn={mixins:[In],args:"target",props:{target:String,selActive:Boolean},data:{target:"",selActive:!1,attrItem:"uk-filter-control",cls:"uk-active",duration:250},computed:{children:({target:e},t)=>Dt(`${e} > *`,t),toggles:({attrItem:e},t)=>Dt(`[${e}],[data-${e}]`,t)},watch:{toggles(e){this.updateState()
const t=Dt(this.selActive,this.$el)
for(const r of e){!1!==this.selActive&&re(r,this.cls,c(t,r))
const e=Zn(r)
yt(e,"a")&&(e.role="button")}},children(e,t){t&&this.updateState()}},events:{name:"click keydown",delegate:({attrItem:e})=>`[${e}],[data-${e}]`,handler(e){"keydown"===e.type&&e.keyCode!==Fn||e.target.closest("a,button")&&(Dn(e),this.apply(e.current))}},methods:{apply(e){const t=this.getState(),r=Gn(e,this.attrItem,this.getState())
var n,i
n=t,i=r,["filter","sort"].every(e=>I(n[e],i[e]))||this.setState(r)},getState(){return this.toggles.filter(e=>te(e,this.cls)).reduce((e,t)=>Gn(t,this.attrItem,e),{filter:{"":""},sort:[]})},async setState(e,t=!0){e={filter:{"":""},sort:[],...e},Ke(this.$el,"beforeFilter",[this,e])
for(const r of this.toggles)re(r,this.cls,Qn(r,this.attrItem,e))
...
function Yn(e,t){return un(ae(e,t),["filter"])}function Gn(e,t,r){const{filter:n,group:i,sort:o,order:s="asc"}=Yn(e,t)
return(n||S(o))&&(i?n?(delete r.filter[""],r.filter[i]=n):(delete r.filter[i],(T(r.filter)||""in r.filter)&&(r.filter={"":n||""})):r.filter={"":n||""}),S(o)||(r.sort=[o,s]),r}function Qn(e,t,{filter:r={"":""},sort:[n,i]}){const{filter:o="",group:s="",sort:a,order:l="asc"}=Yn(e,t)
return S(a)?s in r&&o===r[s]||!o&&s&&!(s in r)&&!r[""]:n===a&&i===l}function Zn(e){return It("a,button",e)||e}var Kn={args:"dataSrc",props:{dataSrc:String,sources:String,margin:String,target:String,loading:String},data:{dataSrc:"",sources:!1,margin:"50%",target:!1,loading:"lazy"},connected(){"lazy"!==this.loading?this.load():ri(this.$el)&&(this.$el.loading="lazy",Xn(this.$el))},disconnected(){this.img&&(this.img.onload=""),delete this.img},observe:fn({handler(e,t){this.load(),t.disconnect()},options:({margin:e})=>({rootMargin:e}),filter:({loading:e})=>"lazy"===e,target:({$el:e,$props:t})=>t.target?[e,...Ie(t.target,e)]:e}),methods:{load(){if(this.img)return this.img
const e=ri(this.$el)?this.$el:function(e,t,r){const n=new Image
return ti(n,r),ei(e,n),n.onload=()=>Xn(e,n.currentSrc),n.src=t,n}(this.$el,this.dataSrc,this.sources)
return se(e,"loading"),Xn(this.$el,e.currentSrc),this.img=e}}}
function Xn(e,t){if(ri(e)){const t=Oe(e);(yt(t,"picture")?Me(t):[e]).forEach(e=>ei(e,e))}else if(t){!c(e.style.backgroundImage,t)&&(st(e,"backgroundImage",`url(${Ye(t)})`),Ke(e,Xe("load",!1)))}}const Jn=["data-src","data-srcset","sizes"]
function ei(e,t){for(const r of Jn){const n=ae(e,r)
n&&ie(t,r.replace(/data-/g,""),n)}}function ti(e,t){if((t=function(e){if(!e)return[]
if(l(e,"["))try{e=JSON.parse(e)}catch(t){e=[]}else e=un(e)
h(e)||(e=[e])
return e.filter(e=>!T(e))}(t)).length){const r=At("<picture>")
for(const e of t){const t=At("<source>")
ie(t,e),Et(r,t)}Et(r,e)}}function ri(e){return yt(e,"img")}let ni
function ii(e){const t=Ge(e,"touchstart",t=>{if(1!==t.targetTouches.length||Se(t.target,'input[type="range"'))return
let r=it(t).y
const n=Ge(e,"touchmove",t=>{const n=it(t).y
n!==r&&(r=n,Pr(t.target).some(t=>{if(!e.contains(t))return!1
...
if(ni)return t
ni=!0
const{scrollingElement:r}=document,n={overflowY:CSS.supports("overflow","clip")?"clip":"hidden",touchAction:"none",paddingRight:qt(window)-r.clientWidth||""}
return st(r,n),()=>{ni=!1,t(),at(r,n)}}var oi={props:{container:Boolean},data:{container:!0},computed:{container({container:e}){return!0===e&&this.$container||e&&It(e)}}},si={props:{pos:String,offset:Boolean,flip:Boolean,shift:Boolean,inset:Boolean},data:{pos:"bottom-"+(ue?"right":"left"),offset:!1,flip:!0,shift:!0,inset:!1},connected(){this.pos=this.$props.pos.split("-").concat("center").slice(0,2),[this.dir,this.align]=this.pos,this.axis=c(["top","bottom"],this.dir)?"y":"x"},methods:{positionAt(e,t,r){let n=[this.getPositionOffset(e),this.getShiftOffset(e)]
...
function ui(e,t,{_toggle:r}){return bt.cancel(e),pt.cancel(e),r(e,t)}async function ci(e,t,{animation:r,duration:n,velocity:i,transition:o,_toggle:s}){var a
...
try{await pt.start(e,O,n,o)}finally{st(e,y),Mt(C.firstChild),t||s(e,!1)}}function di(e,t,r){const{animation:n,duration:i,_toggle:o}=r
return t?(o(e,!0),bt.in(e,n[0],i,r.origin)):bt.out(e,n[1]||n[0],i,r.origin).then(()=>o(e,!1))}const hi=[]
var pi={mixins:[en,oi,li],props:{selPanel:String,selClose:String,escClose:Boolean,bgClose:Boolean,stack:Boolean,role:String},data:{cls:"uk-open",escClose:!0,bgClose:!0,overlay:!0,stack:!1,role:"dialog"},computed:{panel:({selPanel:e},t)=>It(e,t),transitionElement(){return this.panel}},connected(){const e=this.panel||this.$el
e.role=this.role,this.overlay&&(e.ariaModal=!0)},beforeDisconnect(){c(hi,this)&&this.toggleElement(this.$el,!1,!1)},events:[{name:"click",delegate:({selClose:e})=>`${e},a[href*="#"]`,handler(e){const{current:t,defaultPrevented:r}=e,{hash:n}=t
!r&&n&&Ae(t)&&!this.$el.contains(It(n))?this.hide():Se(t,this.selClose)&&(Dn(e),this.hide())}},{name:"toggle",self:!0,handler(e,t){e.defaultPrevented||(e.preventDefault(),this.target=null==t?void 0:t.$el,this.isToggled()===c(hi,this)&&this.toggle())}},{name:"beforeshow",self:!0,handler(e){if(c(hi,this))return!1
!this.stack&&hi.length?(Promise.all(hi.map(e=>e.hide())).then(this.show),e.preventDefault()):hi.push(this)}},{name:"show",self:!0,handler(){this.stack&&st(this.$el,"zIndex",R(st(this.$el,"zIndex"))+hi.length)
const e=[this.overlay&&mi(this),this.overlay&&ii(this.$el),this.bgClose&&gi(this),this.escClose&&vi(this)]
Ze(this.$el,"hidden",()=>e.forEach(e=>e&&e()),{self:!0}),X(document.documentElement,this.clsPage),bi(this.target,!0)}},{name:"shown",self:!0,handler(){ke(this.$el)||(this.$el.tabIndex=-1),Se(this.$el,":focus-within")||this.$el.focus()}},{name:"hidden",self:!0,handler(){c(hi,this)&&hi.splice(hi.indexOf(this),1),st(this.$el,"zIndex","")
const{target:e}=this
hi.some(e=>e.clsPage===this.clsPage)||(J(document.documentElement,this.clsPage),queueMicrotask(()=>ke(e)&&e.focus())),bi(e,!1),this.target=null}}],methods:{toggle(){return this.isToggled()?this.hide():this.show()},show(){return this.container&&Oe(this.$el)!==this.container?(Et(this.container,this.$el),new Promise(e=>requestAnimationFrame(()=>this.show().then(e)))):this.toggleElement(this.$el,!0,fi)},hide(){return this.toggleElement(this.$el,!1,fi)}}}
function fi(e,t,{transitionElement:r,_toggle:n}){return new Promise((i,o)=>Ze(e,"show hide",()=>{var s
...
var c})).then(()=>delete e._reject)}function mi(e){return Ge(document,"focusin",t=>{L(hi)!==e||e.$el.contains(t.target)||e.$el.focus()})}function gi(e){return Ge(document,he,({target:t})=>{L(hi)!==e||e.overlay&&!e.$el.contains(t)||!e.panel||e.panel.contains(t)||Ze(document,`${fe} ${ve} scroll`,({defaultPrevented:r,type:n,target:i})=>{r||n!==fe||t!==i||e.hide()},!0)})}function vi(e){return Ge(document,"keydown",t=>{27===t.keyCode&&L(hi)===e&&e.hide()})}function bi(e,t){(null==e?void 0:e.ariaExpanded)&&(e.ariaExpanded=t)}var yi={slide:{show:e=>[{transform:_i(-100*e)},{transform:_i()}],percent:e=>wi(e),translate:(e,t)=>[{transform:_i(-100*t*e)},{transform:_i(100*t*(1-e))}]}}
function wi(e){return Math.abs(new DOMMatrix(st(e,"transform")).m41/e.offsetWidth)}function _i(e=0,t="%"){return e?`translate3d(${e+t}, 0, 0)`:""}function xi(e,t,r){Ke(e,Xe(t,!1,!1,r))}function Ei(){let e
return{promise:new Promise(t=>e=t),resolve:e}}var Ci={props:{i18n:Object},data:{i18n:null},methods:{t(e,...t){var r,n,i
let o=0
return(null==(i=(null==(r=this.i18n)?void 0:r[e])||(null==(n=this.$options.i18n)?void 0:n[e]))?void 0:i.replace(/%s/g,()=>t[o++]||""))||""}}},ki={props:{autoplay:Boolean,autoplayInterval:Number,pauseOnHover:Boolean},data:{autoplay:!1,autoplayInterval:7e3,pauseOnHover:!0},connected(){ie(this.list,"aria-live",this.autoplay?"off":"polite"),this.autoplay&&this.startAutoplay()},disconnected(){this.stopAutoplay()},update(){ie(this.slides,"tabindex","-1")},events:[{name:"visibilitychange",el:()=>document,filter:({autoplay:e})=>e,handler(){document.hidden?this.stopAutoplay():this.startAutoplay()}}],methods:{startAutoplay(){this.stopAutoplay(),this.interval=setInterval(()=>{this.stack.length||this.draggable&&Se(this.$el,":focus-within")&&!Se(this.$el,":focus")||this.pauseOnHover&&Se(this.$el,":hover")||this.show("next")},this.autoplayInterval)},stopAutoplay(){clearInterval(this.interval)}}}
const Oi={passive:!1,capture:!0},Ti={passive:!0,capture:!0},Si="touchmove mousemove",Pi="touchend touchcancel mouseup click input scroll"
var Mi={props:{draggable:Boolean},data:{draggable:!0,threshold:10},created(){for(const e of["start","move","end"]){const t=this[e]
...
!this.draggable||this.parallax||!nt(e)&&(t=e.target,"none"!==st(t,"userSelect")&&p(t.childNodes).some(e=>3===e.nodeType&&e.textContent.trim()))||e.target.closest(xe)||e.button>0||this.length<2||this.start(e)}},{name:"dragstart",handler(e){e.preventDefault()}},{name:Si,el:({list:e})=>e,handler:q,...Oi}],methods:{start(){this.drag=this.pos,this._transitioner?(this.percent=this._transitioner.percent(),this.drag+=this._transitioner.getDistance()*this.percent*this.dir,this._transitioner.cancel(),this._transitioner.translate(this.percent),this.dragging=!0,this.stack=[]):this.prevIndex=this.index,Ge(document,Si,this.move,Oi),Ge(document,Pi,this.end,Ti),st(this.list,"userSelect","none")},move(e){const t=this.pos-this.drag
...
let{slides:r,prevIndex:n}=this,i=Math.abs(t),o=this.getIndex(n+this.dir),s=Ri.call(this,n,o)
for(;o!==n&&i>s;)this.drag-=s*this.dir,n=o,i-=s,o=this.getIndex(n+this.dir),s=Ri.call(this,n,o)
this.percent=i/s
const a=r[n],l=r[o],u=this.index!==o,d=n===o
let h
for(const p of[this.index,this.prevIndex])c([o,n],p)||(Ke(r[p],"itemhidden",[this]),d&&(h=!0,this.prevIndex=n));(this.index===n&&this.prevIndex!==n||h)&&Ke(r[this.index],"itemshown",[this]),u&&(this.prevIndex=n,this.index=o,d||(Ke(a,"beforeitemhide",[this]),Ke(a,"itemhide",[this])),Ke(l,"beforeitemshow",[this]),Ke(l,"itemshow",[this])),this._transitioner=this._translate(Math.abs(this.percent),a,!d&&l)},end(){if(Qe(document,Si,this.move,Oi),Qe(document,Pi,this.end,Ti),this.dragging)if(setTimeout(Ge(this.list,"click",e=>e.preventDefault(),Oi)),this.dragging=null,this.index===this.prevIndex)this.percent=1-this.percent,this.dir*=-1,this._show(!1,this.index,!0),this._transitioner=null
...
function Ri(e,t){return this._getTransitioner(e,e!==t&&t).getDistance()||this.slides[e].offsetWidth}function Ai(e,t,r){e._watches.push({name:r,...v(t)?t:{handler:t}})}const ji={subtree:!0,childList:!0}
function Ni(e,t,n){e._hasComputed=!0,Object.defineProperty(e,t,{enumerable:!0,get(){const{_computed:i,$props:o,$el:s}=e
if(!r(i,t)&&(i[t]=(n.get||n).call(e,o,s),n.observe&&e._computedObserver)){const t=n.observe.call(e,o)
e._computedObserver.observe(["~","+","-"].includes(t[0])?s.parentElement:s.getRootNode(),ji)}return i[t]},set(r){const{_computed:i}=e
i[t]=n.set?n.set.call(e,r):r,S(i[t])&&delete i[t]}})}function Ii(e){e._hasComputed&&(function(e,t){e._updates.unshift(t)}(e,{read:()=>function(e,t){for(const{name:n,handler:i,immediate:o=!0}of e._watches)(e._initial&&o||r(t,n)&&!I(t[n],e[n]))&&i.call(e,e[n],t[n])
e._initial=!1}(e,Di(e)),events:["resize","computed"]}),e._computedObserver=fr(e.$el,()=>hn(e,"computed"),ji),e._disconnect.push(()=>{e._computedObserver.disconnect(),e._computedObserver=null,Di(e)}))}function Di(e){const t={...e._computed}
return e._computed={},t}function Li(e,{name:t,el:r,handler:n,capture:i,passive:o,delegate:s,filter:a,self:l}){a&&!a.call(e,e)||e._disconnect.push(Ge(r?r.call(e,e):e.$el,t,null==s?void 0:s.call(e,e),n.bind(e),{passive:o,capture:i,self:l}))}function $i(e,t){let{observe:n,target:i=e.$el,handler:o,options:s,filter:a,args:l}=t
if(a&&!a.call(e,e))return
const u=`_observe${e._disconnect.length}`
m(i)&&!r(e,u)&&Ni(e,u,()=>{const t=i.call(e,e)
return h(t)?j(t):t}),o=C(o)?e[o]:o.bind(e),m(s)&&(s=s.call(e,e))
const c=n(r(e,u)?e[u]:i,o,s,l)
m(i)&&h(e[u])&&Ai(e,{handler:Fi(c,s),immediate:!1},u),e._disconnect.push(()=>c.disconnect())}function Fi(e,t){return(r,n)=>{for(const t of n)c(r,t)||(e.unobserve?e.unobserve(t):e.observe&&e.disconnect())
for(const i of r)c(n,i)&&e.unobserve||e.observe(i,t)}}function Bi(e){const t={},{args:r=[],props:n={},el:o,id:a}=e
if(!n)return t
for(const s in n){const e=i(s)
let r=ae(o,e)
S(r)||(r=n[s]===Boolean&&""===r||cn(n[s],r),"target"===e&&l(r,"_")||(t[s]=r))}const u=un(ae(o,a),r)
for(const i in u){const e=s(i)
S(n[e])||(t[e]=cn(n[e],u[i]))}return t}const Hi=K((e,t)=>{const r=Object.keys(t),n=r.concat(e).map(e=>[i(e),`data-${i(e)}`]).flat()
return{attributes:r,filter:n}})
function zi(e,t){var r
null==(r=e.$options[t])||r.forEach(t=>t.call(e))}function Ui(e){e._connected||(function(e){const{$options:t,$props:n}=e,i=Bi(t)
f(n,i)
const{computed:o,methods:s}=t
for(let a in n)!(a in i)||o&&r(o,a)||s&&r(s,a)||(e[a]=n[a])}(e),zi(e,"beforeConnect"),e._connected=!0,e._disconnect=[],function(e){for(const t of e.$options.events||[])if(r(t,"handler"))Li(e,t)
else for(const r in t)Li(e,{name:r,handler:t[r]})}(e),function(e){e._data={},e._updates=[...e.$options.update||[]],e._disconnect.push(()=>e._updates=e._data=null)}(e),function(e){e._watches=[]
for(const t of e.$options.watch||[])for(const[r,n]of Object.entries(t))Ai(e,n,r)
e._initial=!0}(e),function(e){for(const t of e.$options.observe||[])$i(e,t)}(e),function(e){const{$options:t,$props:r}=e,{id:n,props:i,el:o}=t
if(!i)return
const{attributes:a,filter:l}=Hi(n,i),u=new MutationObserver(i=>{const o=Bi(t)
i.some(({attributeName:e})=>{const t=e.replace("data-","")
return(t===n?a:[s(t),s(e)]).some(e=>!S(o[e])&&o[e]!==r[e])})&&e.$reset()})
u.observe(o,{attributes:!0,attributeFilter:l}),e._disconnect.push(()=>u.disconnect())}(e),Ii(e),zi(e,"connected"),hn(e))}function qi(e){e._connected&&(zi(e,"beforeDisconnect"),e._disconnect.forEach(e=>e()),e._disconnect=null,zi(e,"disconnected"),e._connected=!1)}let Vi=0
function Wi(e,t={}){t.data=function({data:e={}},{args:t=[],props:r={}}){h(e)&&(e=e.slice(0,t.length).reduce((e,r,n)=>(v(r)?f(e,r):e[t[n]]=r,e),{}))
for(const n in e)S(e[n])?delete e[n]:r[n]&&(e[n]=cn(r[n],e[n]))
return e}(t,e.constructor.options),e.$options=ln(e.constructor.options,t,e),e.$props={},e._uid=Vi++,function(e){const{data:t={}}=e.$options
...
if(e._computed={},t)for(const r in t)Ni(e,r,t[r])}(e),zi(e,"created"),t.el&&e.$mount(t.el)}const Yi=function(e){Wi(this,e)}
Yi.util=Jr,Yi.options={},Yi.version="3.23.11"
const Gi="__uikit__",Qi={}
function Zi(e,t){var r,n
const o="uk-"+i(e)
if(!t)return Qi[o].options||(Qi[o]=Yi.extend(Qi[o])),Qi[o]
e=s(e),Yi[e]=(t,r)=>Ki(e,t,r)
const a=null!=(r=t.options)?r:{...t}
return a.id=o,a.name=e,null==(n=a.install)||n.call(a,Yi,a,e),Yi._initialized&&!a.functional&&requestAnimationFrame(()=>Ki(e,`[${o}],[data-${o}]`)),Qi[o]=a}function Ki(e,t,r,...n){const i=Zi(e)
return i.options.functional?new i({data:v(t)?t:[t,r,...n]}):t?Dt(t).map(o)[0]:o()
function o(t){const n=Ji(t,e)
if(n){if(!r)return n
n.$destroy()}return new i({el:t,data:r})}}function Xi(e){return(null==e?void 0:e[Gi])||{}}function Ji(e,t){return Xi(e)[t]}function eo(e,t){e=e?A(e):document.body
for(const r of Pe(e).reverse())to(r,t)
Nt(e,e=>to(e,t))}function to(e,t){const r=Xi(e)
for(const n in r)hn(r[n],t)}let ro=1
function no(e,t=null){return(null==t?void 0:t.id)||`${e.$options.id}-${ro++}`}var io={i18n:{next:"Next slide",previous:"Previous slide",slideX:"Slide %s",slideLabel:"%s of %s",role:"String"},data:{selNav:!1,role:"region"},computed:{nav:({selNav:e},t)=>It(e,t),navChildren(){return Me(this.nav)},selNavItem:({attrItem:e})=>`[${e}],[data-${e}]`,navItems(e,t){return Dt(this.selNavItem,t)}},watch:{nav(e,t){ie(e,"role","tablist"),this.padNavitems(),t&&this.$emit()},list(e){yt(e,"ul")&&ie(e,"role","presentation")},navChildren(e){ie(e,"role","presentation"),this.padNavitems(),this.updateNav()},navItems(e){for(const t of e){const e=ae(t,this.attrItem),r=It("a,button",t)||t
let n,i=null
if(O(e)){const t=M(e),o=this.slides[t]
o&&(o.id||(o.id=no(this,o)),i=o.id),n=this.t("slideX",R(e)+1),r.role="tab"}else this.list&&(this.list.id||(this.list.id=no(this,this.list)),i=this.list.id),n=this.t(e)
r.ariaControls=i,r.ariaLabel=r.ariaLabel||n}},slides(e){e.forEach((e,t)=>ie(e,{role:this.nav?"tabpanel":"group","aria-label":this.t("slideLabel",t+1,this.length),"aria-roledescription":this.nav?null:"slide"})),this.padNavitems()}},connected(){this.$el.role=this.role,this.$el.ariaRoleDescription="carousel"},update:[{write(){this.navItems.concat(this.nav).forEach(e=>e&&(e.hidden=!this.maxIndex)),this.updateNav()},events:["resize"]}],events:[{name:"click keydown",delegate:({selNavItem:e})=>e,filter:({parallax:e})=>!e,handler(e){!e.target.closest("a,button")||"click"!==e.type&&e.keyCode!==Fn||(Dn(e),this.show(ae(e.current,this.attrItem)))}},{name:"itemshow",handler(){this.updateNav()}},{name:"keydown",delegate:({selNavItem:e})=>e,filter:({parallax:e})=>!e,handler(e){const{current:t,keyCode:r}=e
if(!O(ae(t,this.attrItem)))return
let n=r===Hn?0:r===Bn?"last":r===zn?"previous":r===qn?"next":-1
...
var oo={mixins:[ki,Mi,io,Ci],props:{clsActivated:String,easing:String,index:Number,finite:Boolean,velocity:Number},data:()=>({easing:"ease",finite:!1,velocity:1,index:0,prevIndex:-1,stack:[],percent:0,clsActive:"uk-active",clsActivated:"",clsEnter:"uk-slide-enter",clsLeave:"uk-slide-leave",clsSlideActive:"uk-slide-active",Transitioner:!1,transitionOptions:{}}),connected(){this.prevIndex=-1,this.index=this.getValidIndex(this.$props.index),this.stack=[]},disconnected(){J(this.slides,this.clsActive)},computed:{duration:({velocity:e},t)=>so(t.offsetWidth/e),list:({selList:e},t)=>It(e,t),maxIndex(){return this.length-1},slides(){return Me(this.list)},length(){return this.slides.length}},watch:{slides(e,t){t&&this.$emit()}},events:{itemshow({target:e}){X(e,this.clsEnter,this.clsSlideActive)},itemshown({target:e}){J(e,this.clsEnter)},itemhide({target:e}){X(e,this.clsLeave)},itemhidden({target:e}){J(e,this.clsLeave,this.clsSlideActive)}},methods:{async show(e,t=!1){var r
...
function so(e){return.5*e+300}var ao={mixins:[oo],props:{animation:String},data:{animation:"slide",clsActivated:"uk-transition-active",Animations:yi,Transitioner:function(e,t,r,{animation:n,easing:i}){const{percent:o,translate:s,show:a=q}=n,l=a(r),{promise:u,resolve:c}=Ei()
return{dir:r,show(n,o=0,s){const a=s?"linear":i
return n-=Math.round(n*U(o,-1,1)),this.translate(o),xi(t,"itemin",{percent:o,duration:n,timing:a,dir:r}),xi(e,"itemout",{percent:1-o,duration:n,timing:a,dir:r}),Promise.all([pt.start(t,l[1],n,a),pt.start(e,l[0],n,a)]).then(()=>{this.reset(),c()},q),u},cancel:()=>pt.cancel([t,e]),reset(){at([t,e],l[0])},async forward(e,t=this.percent()){return await this.cancel(),this.show(e,t,!0)},translate(n){this.reset()
const i=s(n,r)
st(t,i[1]),st(e,i[0]),xi(t,"itemtranslatein",{percent:n,dir:r}),xi(e,"itemtranslateout",{percent:1-n,dir:r})},percent:()=>o(e||t,t,r),getDistance:()=>null==e?void 0:e.offsetWidth}}},computed:{animation:({animation:e,Animations:t})=>({...t[e]||t.slide,name:e}),transitionOptions(){return{animation:this.animation}}},observe:pn(),events:{itemshow({target:e}){X(e,this.clsActive)},itemshown({target:e}){X(e,this.clsActivated)},itemhidden({target:e}){J(e,this.clsActive,this.clsActivated)}}},lo={...yi,fade:{show:()=>[{opacity:0,zIndex:0},{zIndex:-1}],percent:e=>1-st(e,"opacity"),translate:e=>[{opacity:1-e,zIndex:0},{zIndex:-1}]},scale:{show:()=>[{opacity:0,transform:uo(1.5),zIndex:0},{zIndex:-1}],percent:e=>1-st(e,"opacity"),translate:e=>[{opacity:1-e,transform:uo(1+.5*e),zIndex:0},{zIndex:-1}]},pull:{show:e=>e<0?[{transform:_i(30),zIndex:-1},{transform:_i(),zIndex:0}]:[{transform:_i(-100),zIndex:0},{transform:_i(),zIndex:-1}],percent:(e,t,r)=>r<0?1-wi(t):wi(e),translate:(e,t)=>t<0?[{transform:_i(30*e),zIndex:-1},{transform:_i(-100*(1-e)),zIndex:0}]:[{transform:_i(100*-e),zIndex:0},{transform:_i(30*(1-e)),zIndex:-1}]},push:{show:e=>e<0?[{transform:_i(100),zIndex:0},{transform:_i(),zIndex:-1}]:[{transform:_i(-30),zIndex:-1},{transform:_i(),zIndex:0}],percent:(e,t,r)=>r>0?1-wi(t):wi(e),translate:(e,t)=>t<0?[{transform:_i(100*e),zIndex:0},{transform:_i(-30*(1-e)),zIndex:-1}]:[{transform:_i(-30*e),zIndex:-1},{transform:_i(100*(1-e)),zIndex:0}]}}
function uo(e){return`scale3d(${e}, ${e}, 1)`}var co={...yi,fade:{show:()=>[{opacity:0},{opacity:1}],percent:e=>1-st(e,"opacity"),translate:e=>[{opacity:1-e},{opacity:e}]},scale:{show:()=>[{opacity:0,transform:uo(.8)},{opacity:1,transform:uo(1)}],percent:e=>1-st(e,"opacity"),translate:e=>[{opacity:1-e,transform:uo(1-.2*e)},{opacity:e,transform:uo(.8+.2*e)}]}},ho={i18n:{counter:"%s / %s"},mixins:[pi,ao],functional:!0,props:{counter:Boolean,preload:Number,nav:Boolean,slidenav:Boolean,delayControls:Number,videoAutoplay:Boolean,template:String},data:()=>({counter:!1,preload:1,nav:!1,slidenav:!0,delayControls:3e3,videoAutoplay:!1,items:[],cls:"uk-open",clsPage:"uk-lightbox-page",clsFit:"uk-lightbox-items-fit",clsZoom:"uk-lightbox-zoom",attrItem:"uk-lightbox-item",selList:".uk-lightbox-items",selClose:".uk-close-large",selNav:".uk-lightbox-thumbnav, .uk-lightbox-dotnav",selCaption:".uk-lightbox-caption",selCounter:".uk-lightbox-counter",pauseOnHover:!1,velocity:2,Animations:co,template:'<div class="uk-lightbox uk-overflow-hidden"> <div class="uk-lightbox-items"></div> <div class="uk-position-top-right uk-position-small uk-transition-fade" uk-inverse> <button class="uk-lightbox-close uk-close-large" type="button" uk-close></button> </div> <div class="uk-lightbox-slidenav uk-position-center-left uk-position-medium uk-transition-fade" uk-inverse> <a href uk-slidenav-previous uk-lightbox-item="previous"></a> </div> <div class="uk-lightbox-slidenav uk-position-center-right uk-position-medium uk-transition-fade" uk-inverse> <a href uk-slidenav-next uk-lightbox-item="next"></a> </div> <div class="uk-position-center-right uk-position-medium uk-transition-fade" uk-inverse style="max-height: 90vh; overflow: auto;"> <ul class="uk-lightbox-thumbnav uk-lightbox-thumbnav-vertical uk-thumbnav uk-thumbnav-vertical"></ul> <ul class="uk-lightbox-dotnav uk-dotnav uk-dotnav-vertical"></ul> </div> <div class="uk-lightbox-counter uk-text-large uk-position-top-left uk-position-small uk-transition-fade" uk-inverse></div> <div class="uk-lightbox-caption uk-position-bottom uk-text-center uk-transition-slide-bottom uk-transition-opaque"></div> </div>'}),created(){let e=It(this.template)
yt(e,"template")&&(e=At(_t(e)))
const t=It(this.selList,e),r=this.$props.nav
Tt(Dt(this.selNav,e).filter(e=>!Se(e,`.uk-${r}`)))
for(const[o,s]of this.items.entries())Et(t,"<div>"),"thumbnav"===r&&St(fo(s,this.videoAutoplay),Et(It(this.selNav,e),`<li uk-lightbox-item="${o}"><a href></a></li>`))
...
let t=-1
e===zn?t="previous":e===qn?t="next":e===Hn?t=0:e===Bn&&(t="last"),~t&&this.show(t)}},{name:"beforeitemshow",handler(e){_t(It(this.selCaption,this.$el),this.getItem().caption||""),_t(It(this.selCounter,this.$el),this.t("counter",this.index+1,this.slides.length))
for(let t=-this.preload;t<=this.preload;t++)this.loadItem(this.index+t)
this.isToggled()||(this.draggable=!1,e.preventDefault(),this.toggleElement(this.$el,!0,!1),this.animation=co.scale,J(e.target,this.clsActive),this.stack.splice(1,0,this.index))}},{name:"itemshown",handler(){this.draggable=this.$props.draggable}},{name:"itemload",async handler(e,t){const{source:r,type:n,attrs:i={}}=t
...
if("image"===n||mo(r)){const e=po("img")
ti(e,t.sources),ie(e,{src:r,...z(t,["alt","srcset","sizes"]),...i}),Ge(e,"load",()=>this.setItem(t,Oe(e)||e)),Ge(e,"error",()=>this.setError(t))}else if("video"===n||go(r)){const e="inline"===this.videoAutoplay,n=po("video",{src:r,playsinline:"",controls:e?null:"",loop:e?"":null,poster:this.videoAutoplay?null:t.poster,"uk-video":e?"automute: true":Boolean(this.videoAutoplay),...i})
Ge(n,"loadedmetadata",()=>this.setItem(t,n)),Ge(n,"error",()=>this.setError(t))}else if("iframe"===n||r.match(/\.(html|php)($|\?)/i))this.setItem(t,po("iframe",{src:r,allowfullscreen:"",class:"uk-lightbox-iframe",...i}))
else if(o=r.match(/\/\/(?:.*?youtube(-nocookie)?\..*?(?:[?&]v=|\/shorts\/)|youtu\.be\/)([\w-]{11})[&?]?(.*)?/))this.setItem(t,po("iframe",{src:`https://www.youtube${o[1]||""}.com/embed/${o[2]}${o[3]?`?${o[3]}`:""}`,width:1920,height:1080,...s,...i}))
...
function po(e,t){const r=At(`<${e}>`)
return ie(r,t),r}function fo(e,t){const r=e.poster||e.thumb&&("image"===e.type||mo(e.thumb))?po("img",{src:e.poster||e.thumb,alt:""}):e.thumb&&("video"===e.type||go(e.thumb))?po("video",{src:e.thumb,loop:"",playsinline:"","uk-video":`autoplay: ${Boolean(t)}; automute: true`}):po("canvas")
return e.thumbRatio&&(r.style.aspectRatio=e.thumbRatio),r}function mo(e){return null==e?void 0:e.match(/\.(avif|jpe?g|jfif|a?png|gif|svg|webp)($|\?)/i)}function go(e){return null==e?void 0:e.match(/\.(mp4|webm|ogv)($|\?)/i)}var vo={install:function(e,t){e.lightboxPanel||e.component("lightboxPanel",ho)
...
for(const t of e)yt(t,"a")&&(t.role="button")}},disconnected(){this.hide()},events:{name:"click",delegate:({toggle:e})=>e,handler(e){e.defaultPrevented||(e.preventDefault(),Se(e.current,".uk-disabled *, .uk-disabled, [disabled]")||this.show(e.current))}},methods:{show(e){let t=this.toggles.map(yo)
if("thumbnav"===this.nav&&bo.call(this,this.toggles,t),t=H(t,"source"),_(e)){const{source:r}=yo(e)
...
function bo(e,t){for(const[r,n]of Object.entries(e)){if(t[r].thumb)continue
const e=Pe(n).reverse().concat(n).find(e=>this.$el.contains(e)&&(e===n||1===Dt(this.toggle,e).length))
if(!e)continue
const i=It("img,video",e)
i&&(t[r].thumb=i.currentSrc||i.poster||i.src,t[r].thumbRatio=(i.naturalWidth||i.videoWidth)/(i.naturalHeight||i.videoHeight))}}function yo(e){const t={}
for(const r of e.getAttributeNames()){const n=r.replace(/^data-/,"")
t["href"===n?"source":n]=e.getAttribute(r)}return t.attrs=un(t.attrs),t}var wo={mixins:[oi],functional:!0,args:["message","status"],data:{message:"",status:"",timeout:5e3,group:"",pos:"top-center",clsContainer:"uk-notification",clsClose:"uk-notification-close",clsMsg:"uk-notification-message"},install:function(e){e.notification.closeAll=function(t,r){Nt(document.body,n=>{const i=e.getComponent(n,"notification")
...
await pt.start(st(this.$el,this.startProps),{opacity:1,[this.marginProp]:e}),this.timeout&&(this.timer=setTimeout(this.close,this.timeout))},events:{click(e){Dn(e),this.close()},[me](){this.timer&&clearTimeout(this.timer)},[ge](){this.timeout&&(this.timer=setTimeout(this.close,this.timeout))}},methods:{async close(e){this.timer&&clearTimeout(this.timer),e||await pt.start(this.$el,this.startProps),(e=>{const t=Oe(e)
Ke(e,"close",[this]),Tt(e),(null==t?void 0:t.hasChildNodes())||Tt(t)})(this.$el)}}}
var _o={props:{media:Boolean},data:{media:!1},connected(){const e=function(e,t){if(C(e))if(l(e,"@"))e=R(st(t,`--uk-breakpoint-${e.slice(1)}`))
...
function xo(e){return _e(e)?Math.ceil(Math.max(0,...Dt("[stroke]",e).map(e=>{var t
return(null==(t=e.getTotalLength)?void 0:t.call(e))||0}))):0}const Eo={x:Oo,y:Oo,rotate:Oo,scale:Oo,color:To,backgroundColor:To,borderColor:To,blur:So,hue:So,fopacity:So,grayscale:So,invert:So,saturate:So,sepia:So,opacity:function(e,t,r){1===r.length&&r.unshift(Bo(t,e,""))
return r=Io(r),(t,n)=>{t[e]=Lo(r,n)}},stroke:function(e,t,r){1===r.length&&r.unshift(0)
const n=Fo(r),i=xo(t)
if(r=Io(r.reverse(),e=>(e=R(e),"%"===n?e*i/100:e)),!r.some(([e])=>e))return q
return st(t,"strokeDasharray",i),(e,t)=>{e.strokeDashoffset=Lo(r,t)}},bgx:Po,bgy:Po},{keys:Co}=Object
var ko={mixins:[_o],props:Ho(Co(Eo),"list"),data:Ho(Co(Eo),void 0),computed:{props(e,t){const r={}
for(const i in e)i in Eo&&!S(e[i])&&(r[i]=e[i].slice())
const n={}
for(const i in r)n[i]=Eo[i](i,t,r[i],r)
...
function Oo(e,t,r){let n,i=Fo(r)||{x:"px",y:"px",rotate:"deg"}[e]||""
return"x"===e||"y"===e?(e=`translate${a(e)}`,n=e=>R(R(e).toFixed("px"===i?0:6))):"scale"===e&&(i="",n=e=>{var r
return Fo([e])?Gt(e,"width",t,!0)/t["offset"+((null==(r=e.endsWith)?void 0:r.call(e,"vh"))?"Height":"Width")]:R(e)}),1===r.length&&r.unshift("scale"===e?1:0),r=Io(r,n),(t,n)=>{t.transform=`${t.transform||""} ${e}(${Lo(r,n)}${i})`}}function To(e,t,r){return 1===r.length&&r.unshift(Bo(t,e,"")),r=Io(r,e=>function(e,t){return Bo(e,"color",t).split(/[(),]/g).slice(1,-1).concat(1).slice(0,4).map(R)}(t,e)),(t,n)=>{const[i,o,s]=Do(r,n),a=i.map((e,t)=>(e+=s*(o[t]-e),3===t?R(e):parseInt(e,10))).join(",")
t[e]=`rgba(${a})`}}function So(e,t,r){1===r.length&&r.unshift(0)
const n=Fo(r)||{blur:"px",hue:"deg"}[e]||"%"
return e={fopacity:"opacity",hue:"hue-rotate"}[e]||e,r=Io(r),(t,i)=>{const o=Lo(r,i)
...
if("cover"===Bo(t,"backgroundSize",""))return function(e,t,r,n){const i=function(e){const t=st(e,"backgroundImage").replace(/^none|url\(["']?(.+?)["']?\)$/,"$1")
if(jo[t])return jo[t]
const r=new Image
if(t&&(r.src=t,!r.naturalWidth&&!Ao[t]))return Ze(r,"error load",()=>{jo[t]=No(r),Ke(e,Xe("load",!1))}),Ao[t]=!0,No(r)
return jo[t]=No(r)}(t)
if(!i.width)return q
...
a[c]=`max(${Mo(t,c)},-${r}px) + ${a[c]}`}const u=Ro(s,a,n)
return(e,t)=>{u(e,t),e.backgroundSize=`${l.width}px ${l.height}px`,e.backgroundRepeat="no-repeat"}}(0,t,0,n)
const s={}
for(const a of o)s[a]=Mo(t,a)
return Ro(o,s,n)}function Mo(e,t){return Bo(e,`background-position-${t.slice(-1)}`,"")}function Ro(e,t,r){return function(n,i){for(const o of e){const e=Lo(r[o],i)
n[`background-position-${o.slice(-1)}`]=`calc(${t[o]} + ${e}px)`}}}const Ao={},jo={}
function No(e){return{width:e.naturalWidth,height:e.naturalHeight}}function Io(e,t=R){const r=[],{length:n}=e
let i=0
...
i=0}}return r}function Do(e,t){const r=d(e.slice(1),([,e])=>t<=e)+1
return[e[r-1][0],e[r][0],(t-e[r-1][1])/(e[r][1]-e[r-1][1])]}function Lo(e,t){const[r,n,i]=Do(e,t)
return r+Math.abs(r-n)*i*(r<n?1:-1)}const $o=/^-?\d+(?:\.\d+)?(\S+)?/
function Fo(e,t){var r
for(const n of e){const e=null==(r=n.match)?void 0:r.call(n,$o)
if(e)return e[1]}return t}function Bo(e,t,r){const n=e.style[t],i=st(st(e,t,r),t)
return e.style[t]=n,i}function Ho(e,t){return e.reduce((e,r)=>(e[r]=t,e),{})}function zo(e,t){return t>=0?Math.pow(e,t+1):1-Math.pow(1-e,1-t)}var Uo={mixins:[ko],props:{target:String,viewport:Number,easing:Number,start:String,end:String},data:{target:!1,viewport:1,easing:1,start:0,end:0},computed:{target:({target:e},t)=>qo(e&&Ne(e,t)||t),start({start:e}){return Gt(e,"height",this.target,!0)},end({end:e,viewport:t}){return Gt(e||(t=100*(1-t))&&`${t}vh+${t}%`,"height",this.target,!0)}},observe:[vn(),bn({target:({target:e})=>e}),pn({target:({$el:e,target:t})=>[e,t,Mr(t,!0)]})],update:{read({percent:e},t){if(t.has("scroll")||(e=!1),!_e(this.$el))return!1
if(!this.matchMedia)return
const r=e
return{percent:e=zo(Sr(this.target,this.start,this.end),this.easing),style:r!==e&&this.getCss(e)}},write({style:e}){this.matchMedia?e&&st(this.$el,e):this.reset()},events:["scroll","resize"]}}
function qo(e){return e?"offsetTop"in e?e:qo(Oe(e)):document.documentElement}var Vo={props:{parallax:Boolean,parallaxTarget:Boolean,parallaxStart:String,parallaxEnd:String,parallaxEasing:Number},data:{parallax:!1,parallaxTarget:!1,parallaxStart:0,parallaxEnd:0,parallaxEasing:0},observe:[pn({target:({$el:e,parallaxTarget:t})=>[e,t],filter:({parallax:e})=>e}),bn({filter:({parallax:e})=>e})],computed:{parallaxTarget({parallaxTarget:e},t){return e&&Ne(e,t)||this.list}},update:{read(){if(!this.parallax)return!1
const e=this.parallaxTarget
if(!e)return!1
const t=zo(Sr(e,Gt(this.parallaxStart,"height",e,!0),Gt(this.parallaxEnd,"height",e,!0)),this.parallaxEasing)
...
var Wo={update:{write(){if(this.stack.length||this.dragging||this.parallax)return
const e=this.getValidIndex()
~this.prevIndex&&this.index===e?this._translate(1):this.show(e)},events:["resize"]}},Yo={observe:gn({target:({slides:e})=>e,targets:e=>e.getAdjacentSlides()}),methods:{getAdjacentSlides(){return[1,-1].map(e=>this.slides[this.getIndex(this.index+e)])}}}
function Go(e,t,r){const n=Ko(e,t)
return r?n-function(e,t){return Ft(t).width/2-Ft(e).width/2}(e,t):Math.min(n,Qo(t))}function Qo(e){return Math.max(0,Zo(e)-Ft(e).width)}function Zo(e,t){return B(Me(e).slice(0,t),e=>Ft(e).width)}function Ko(e,t){return e&&(Ht(e).left+(ue?Ft(e).width-Ft(t).width:0))*(ue?-1:1)||0}function Xo(e,t){t-=1
const r=Ft(e).width,n=t+r+2
return Me(e).filter(i=>{const o=Ko(i,e),s=o+Math.min(Ft(i).width,r)
return o>=t&&s<=n})}var Jo={mixins:[en,oo,Wo,Vo,Yo],props:{center:Boolean,sets:Boolean,active:String},data:{center:!1,sets:!1,attrItem:"uk-slider-item",selList:".uk-slider-items",selNav:".uk-slider-nav",clsContainer:"uk-slider-container",active:"all",Transitioner:function(e,t,r,{center:n,easing:i,list:o}){const s=e?Go(e,o,n):Go(t,o,n)+Ft(t).width*r,a=t?Go(t,o,n):s+Ft(e).width*r*(ue?-1:1),{promise:l,resolve:u}=Ei()
return{dir:r,show(t,n=0,s){const c=s?"linear":i
return t-=Math.round(t*U(n,-1,1)),st(o,"transitionProperty","none"),this.translate(n),st(o,"transitionProperty",""),n=e?n:U(n,0,1),xi(this.getItemIn(),"itemin",{percent:n,duration:t,timing:c,dir:r}),e&&xi(this.getItemIn(!0),"itemout",{percent:1-n,duration:t,timing:c,dir:r}),pt.start(o,{transform:_i(-a*(ue?-1:1),"px")},t,c).then(u,q),l},cancel:()=>pt.cancel(o),reset(){st(o,"transform","")},async forward(e,t=this.percent()){return await this.cancel(),this.show(e,t,!0)},translate(n){if(n===this.percent())return
const i=this.getDistance()*r*(ue?-1:1)
st(o,"transform",_i(U(i-i*n-a,-Zo(o),Ft(o).width)*(ue?-1:1),"px"))
const s=this.getActives(),l=this.getItemIn(),u=this.getItemIn(!0)
n=e?U(n,-1,1):0
for(const a of Me(o)){const i=c(s,a),d=a===l,h=a===u
xi(a,"itemtranslate"+(d||!h&&(i||r*(ue?-1:1)==-1^Ko(a,o)>Ko(e||t))?"in":"out"),{dir:r,percent:h?1-n:d?n:i?1:0})}},percent:()=>Math.abs((new DOMMatrix(st(o,"transform")).m41*(ue?-1:1)+s)/(a-s)),getDistance:()=>Math.abs(a-s),getItemIn(r=!1){let i=this.getActives(),s=Xo(o,Go(t||e,o,n))
if(r){const e=i
i=s,s=e}return s[d(s,e=>!c(i,e))]},getActives:()=>Xo(o,Go(e||t,o,n))}}},computed:{finite({finite:e}){return e||function(e,t){if(!e||e.length<2)return!0
const{width:r}=Ft(e)
if(!t)return Math.ceil(Zo(e))<Math.trunc(r+function(e){return Math.max(0,...Me(e).map(e=>Ft(e).width))}(e))
...
let e=0
const t=Qo(this.list),r=d(this.slides,r=>{if(e>=t-.005)return!0
e+=Ft(r).width})
...
return void e.preventDefault()}const r=this.dir<0||!this.slides[this.prevIndex]?this.index:this.prevIndex,n=Zo(this.list)/this.length
this.duration=so(n/this.velocity)*(Ft(this.slides[r]).width/n),this.reorder()},itemshow(){~this.prevIndex&&X(this._getTransitioner().getItemIn(),this.clsActive),this.updateActiveClasses(this.prevIndex)},itemshown(){this.updateActiveClasses()}},methods:{reorder(){if(this.finite)return void st(this.slides,"order","")
...
let r=e*(this.center?Zo(this.list)-(Ft(this.slides[0]).width/2+Ft(L(this.slides)).width/2):Zo(this.list,this.maxIndex)),n=0
do{const e=Ft(this.slides[++t]).width,i=this.center?e/2+Ft(this.slides[t+1]).width/2:e
n=r/i%1,r-=i}while(r>=0&&t<this.maxIndex)
return[t,n]}}}
var es={mixins:[ko],beforeConnect(){this.item=this.$el.closest(`.${this.$options.id.replace("parallax","items")} > *`)},disconnected(){this.item=null},events:[{name:"itemin itemout",self:!0,el:({item:e})=>e,handler({type:e,detail:{percent:t,duration:r,timing:n,dir:i}}){tr.read(()=>{if(!this.matchMedia)return
const o=this.getCss(rs(e,i,t)),s=this.getCss(ts(e)?.5:i>0?1:0)
...
return!ss([r.left,r.right],[t.left,t.right])})})
r&&Tt(t)
return i}(e,r)||i<s.top+s.height/2?t:t.nextElementSibling
const a=Ft(r),l=ss([s.top,s.bottom],[a.top,a.bottom]),[u,c,d,h]=l?[n,"width","left","right"]:[i,"height","top","bottom"],p=a[c]<s[c]?s[c]-a[c]:0
...
os=setInterval(()=>{let{x:r,y:n}=e
n+=document.scrollingElement.scrollTop
const i=.3*(Date.now()-t)
t=Date.now(),Pr(document.elementFromPoint(r,e.y)).reverse().some(e=>{let{scrollTop:t,scrollHeight:r}=e
const{top:o,bottom:s,height:a}=Ar(e)
if(o<n&&o+35>n)t-=i
...
let os
function ss(e,t){return e[1]>t[0]&&t[1]>e[0]}var as={mixins:[oi,li,si],data:{pos:"top",animation:["uk-animation-scale-up"],duration:100,cls:"uk-active"},connected(){var e
...
return["delay","title"].reduce((e,r)=>({[r]:ae(t,r),...e}),{...un(ae(t,r),["title"]),...n})}(this.$options)
if(!t)return
...
const o=[Ze(document,`keydown ${he}`,this.hide,!1,e=>e.type===he&&!this.$el.contains(e.target)||"keydown"===e.type&&e.keyCode===$n),Ge([document,...Rr(this.$el)],"scroll",r,{passive:!0})]
...
var ls={mixins:[Ci],i18n:{invalidMime:"Invalid File Type: %s",invalidName:"Invalid File Name: %s",invalidSize:"Invalid File Size: %s Kilobytes Max"},props:{allow:String,clsDragover:String,concurrent:Number,maxSize:Number,method:String,mime:String,multiple:Boolean,name:String,params:Object,type:String,url:String},data:{allow:!1,clsDragover:"uk-dragover",concurrent:1,maxSize:0,method:"POST",mime:!1,multiple:!1,name:"files[]",params:{},type:"",url:"",abort:q,beforeAll:q,beforeSend:q,complete:q,completeAll:q,error:q,fail:q,load:q,loadEnd:q,loadStart:q,progress:q},events:{change(e){Se(e.target,'input[type="file"]')&&(e.preventDefault(),e.target.files&&this.upload(e.target.files),e.target.value="")},drop(e){cs(e)
const t=e.dataTransfer;(null==t?void 0:t.files)&&(J(this.$el,this.clsDragover),this.upload(t.files))},dragenter(e){cs(e)},dragover(e){cs(e),X(this.$el,this.clsDragover)},dragleave(e){cs(e),J(this.$el,this.clsDragover)}},methods:{async upload(e){if(!(e=p(e)).length)return
Ke(this.$el,"upload",[e])
for(const n of e){if(this.maxSize&&1e3*this.maxSize<n.size)return void this.fail(this.t("invalidSize",this.maxSize))
if(this.allow&&!us(this.allow,n.name))return void this.fail(this.t("invalidName",this.allow))
if(this.mime&&!us(this.mime,n.type))return void this.fail(this.t("invalidMime",this.mime))}this.multiple||(e=e.slice(0,1)),this.beforeAll(this,e)
...
await r(t.shift())}}}
function us(e,t){return t.match(new RegExp(`^${e.replace(/\//g,"\\/").replace(/\*\*/g,"(\\/[^\\/]+)*").replace(/\*/g,"[^\\/]+").replace(/((?!\\))\?/g,"$1.")}$`,"i"))}function cs(e){e.preventDefault(),e.stopPropagation()}var ds=Object.freeze({__proto__:null,Countdown:rn,Filter:Wn,Lightbox:vo,LightboxPanel:ho,Notification:wo,Parallax:Uo,Slider:Jo,SliderParallax:es,Slideshow:ns,SlideshowParallax:es,Sortable:is,Tooltip:as,Upload:ls})
function hs(e){Ke(document,"uikit:init",e),document.body&&Nt(document.body,fs),new MutationObserver(ps).observe(document,{subtree:!0,childList:!0,attributes:!0}),e._initialized=!0}function ps(e){var t
for(const{addedNodes:r,removedNodes:n,target:i,attributeName:o}of e){for(const t of r)Nt(t,fs)
for(const t of n)Nt(t,ms)
const e=o&&gs(o)
e&&(oe(i,o)?Ki(e,i):null==(t=Ji(i,e))||t.$destroy())}}function fs(e){const t=Xi(e)
for(const r in t)Ui(t[r])
for(const r of e.getAttributeNames()){const t=gs(r)
t&&Ki(t,e)}}function ms(e){const t=Xi(e)
for(const r in t)qi(t[r])}function gs(e){l(e,"data-")&&(e=e.slice(5))
const t=Qi[e]
return t&&(t.options||t).name}(function(e){let t
e.component=Zi,e.getComponents=Xi,e.getComponent=Ji,e.update=eo,e.use=function(e){if(!e.installed)return e.call(null,this),e.installed=!0,this},e.mixin=function(e,t){(t=(C(t)?this.component(t):t)||this).options=ln(t.options,e)},e.extend=function(e){e||(e={})
const t=this,r=function(e){Wi(this,e)}
return(r.prototype=Object.create(t.prototype)).constructor=r,r.options=ln(t.options,e),r.super=t,r.extend=t.extend,r},Object.defineProperty(e,"container",{get:()=>t||document.body,set(e){t=It(e)}})})(Yi),function(e){e.prototype.$mount=function(e){const t=this;(function(e,t){e[Gi]||(e[Gi]={}),e[Gi][t.$options.name]=t})(e,t),t.$options.el=e,e.isConnected&&Ui(t)},e.prototype.$destroy=function(e=!1){const t=this,{el:r}=t.$options
r&&qi(t),zi(t,"destroy"),function(e,t){var r
null==(r=e[Gi])||delete r[t.$options.name],T(e[Gi])&&delete e[Gi]}(r,t),e&&Tt(t.$el)},e.prototype.$create=Ki,e.prototype.$emit=function(e){hn(this,e)},e.prototype.$update=function(e=this.$el,t){eo(e,t)},e.prototype.$reset=function(){qi(this),Ui(this)},e.prototype.$getComponent=Ji,Object.defineProperties(e.prototype,{$el:{get(){return this.$options.el}},$container:Object.getOwnPropertyDescriptor(e,"container")})}(Yi)
var vs={mixins:[en,li],props:{animation:Boolean,targets:String,active:null,collapsible:Boolean,multiple:Boolean,toggle:String,content:String,offset:Number},data:{targets:"> *",active:!1,animation:!0,collapsible:!0,multiple:!1,clsOpen:"uk-open",toggle:"> .uk-accordion-title",content:"> .uk-accordion-content",offset:0},computed:{items:({targets:e},t)=>Dt(e,t),toggles({toggle:e}){return this.items.map(t=>It(e,t))},contents({content:e}){return this.items.map(t=>{var r
...
bs(t,!e)}this.$emit()}},observe:gn(),events:[{name:"click keydown",delegate:({targets:e,$props:t})=>`${e} ${t.toggle}`,async handler(e){var t
"keydown"===e.type&&e.keyCode!==Fn||(Dn(e),null==(t=this._off)||t.call(this),this._off=function(e){const t=Mr(e,!0)
let r
...
await pt.cancel(a),bs(r,!1)
const u=B(["marginTop","marginBottom"],e=>st(r,e))+Ft(r).height,c=l/u
n=(i*u+n)*(t?1-c:c),st(a,"height",l),await pt.start(a,{height:t?u:0},n,o),Mt(r),delete e._wrapper,t||bs(r,!0)}(e,r,this)
bs(It(this.content,e),!r)})))}}}
function bs(e,t){e&&(e.hidden=t)}var ys={mixins:[en,li],args:"animation",props:{animation:Boolean,close:String},data:{animation:!0,selClose:".uk-alert-close",duration:150},events:{name:"click",delegate:({selClose:e})=>e,handler(e){Dn(e),this.close()}},methods:{async close(){await this.toggleElement(this.$el,!1,ws),this.$destroy(!0)}}}
function ws(e,t,{duration:r,transition:n,velocity:i}){const o=R(st(e,"height"))
return st(e,"height",o),pt.start(e,{height:0,marginTop:0,marginBottom:0,paddingTop:0,paddingBottom:0,borderTop:0,borderBottom:0,opacity:0},i*o+r,n)}var _s={args:"autoplay",props:{automute:Boolean,autoplay:Boolean},data:{automute:!1,autoplay:!0},beforeConnect(){"inview"!==this.autoplay||oe(this.$el,"preload")||(this.$el.preload="none"),yt(this.$el,"iframe")&&!oe(this.$el,"allow")&&(this.$el.allow="autoplay"),"hover"===this.autoplay&&(yt(this.$el,"video")?this.$el.tabIndex=0:this.autoplay=!0),this.automute&&br(this.$el)},events:[{name:`${me} focusin`,filter:({autoplay:e})=>c(e,"hover"),handler(e){var t
!nt(e)||((t=this.$el).paused||t.ended)?gr(this.$el):vr(this.$el)}},{name:`${ge} focusout`,filter:({autoplay:e})=>c(e,"hover"),handler(e){nt(e)||vr(this.$el)}}],observe:[fn({filter:({autoplay:e})=>"hover"!==e,handler([{isIntersecting:e}]){document.fullscreenElement||(e?this.autoplay&&gr(this.$el):vr(this.$el))},args:{intersecting:!1},options:({$el:e,autoplay:t})=>({root:"inview"===t?null:Oe(e).closest(":not(a)")})})]}
var xs={mixins:[_s],props:{width:Number,height:Number},data:{automute:!0},created(){this.useObjectFit=yt(this.$el,"img","video")},observe:pn({target:({$el:e})=>Es(e)||Oe(e),filter:({useObjectFit:e})=>!e}),update:{read(){if(this.useObjectFit)return!1
...
o=n?e(t,"width",n):i?e(t,"height",i):t}const{offsetHeight:s,offsetWidth:a}=Es(r)||Oe(r),l=t(o,{width:a,height:s})
return!(!l.width||!l.height)&&l},write({height:e,width:t}){st(this.$el,{height:e,width:t})},events:["resize"]}}
function Es(e){for(;e=Oe(e);)if("static"!==st(e,"position"))return e}let Cs
var ks={mixins:[oi,si,li],args:"pos",props:{mode:"list",toggle:Boolean,boundary:Boolean,boundaryX:Boolean,boundaryY:Boolean,target:Boolean,targetX:Boolean,targetY:Boolean,stretch:Boolean,delayShow:Number,delayHide:Number,autoUpdate:Boolean,clsDrop:String,animateOut:Boolean,bgScroll:Boolean,closeOnScroll:Boolean},data:{mode:["click","hover"],toggle:"- *",boundary:!1,boundaryX:!1,boundaryY:!1,target:!1,targetX:!1,targetY:!1,stretch:!1,delayShow:0,delayHide:800,autoUpdate:!0,clsDrop:!1,animateOut:!1,bgScroll:!0,animation:["uk-animation-fade"],cls:"uk-open",container:!1,closeOnScroll:!1,selClose:".uk-drop-close"},computed:{boundary:({boundary:e,boundaryX:t,boundaryY:r},n)=>[Ne(t||e,n)||window,Ne(r||e,n)||window],target({target:e,targetX:t,targetY:r},n){return t||(t=e||this.targetEl),r||(r=e||this.targetEl),[!0===t?window:Ne(t,n),!0===r?window:Ne(r,n)]}},created(){this.tracker=new ur},beforeConnect(){this.clsDrop=this.$props.clsDrop||this.$options.id},connected(){X(this.$el,"uk-drop",this.clsDrop),this.toggle&&!this.targetEl&&(this.targetEl=function(e){const{$el:t}=e.$create("toggle",Ne(e.toggle,e.$el),{target:e.$el,mode:e.mode})
return t.ariaHasPopup=!0,t}(this)),ie(this.targetEl,"aria-expanded",!1),this._style=z(this.$el.style,["width","height"])},disconnected(){this.isActive()&&(this.hide(!1),Cs=null),st(this.$el,this._style)},events:[{name:"click",delegate:({selClose:e})=>e,handler(e){Dn(e),this.hide(!1)}},{name:"click",delegate:()=>'a[href*="#"]',handler({defaultPrevented:e,current:t}){const{hash:r}=t
!e&&r&&Ae(t)&&!this.$el.contains(It(r))&&this.hide(!1)}},{name:"beforescroll",handler(){this.hide(!1)}},{name:"toggle",self:!0,handler(e,t){e.preventDefault(),this.isToggled()?this.hide(!1):this.show(null==t?void 0:t.$el,!1)}},{name:"toggleshow",self:!0,handler(e,t){e.preventDefault(),this.show(null==t?void 0:t.$el)}},{name:"togglehide",self:!0,handler(e){e.preventDefault(),Se(this.$el,":focus,:hover")||this.hide()}},{name:`${me} focusin`,filter:({mode:e})=>c(e,"hover"),handler(e){nt(e)||this.clearTimers()}},{name:`${ge} focusout`,filter:({mode:e})=>c(e,"hover"),handler(e){!nt(e)&&e.relatedTarget&&this.hide()}},{name:"toggled",self:!0,handler(e,t){t&&(this.clearTimers(),this.position())}},{name:"show",self:!0,handler(){Cs=this,this.tracker.init(),ie(this.targetEl,"aria-expanded",!0)
const e=[Os(this),Ss(this),Ms(this),this.autoUpdate&&Ts(this),this.closeOnScroll&&Ps(this)]
Ze(this.$el,"hide",()=>e.forEach(e=>e&&e()),{self:!0}),this.bgScroll||Ze(this.$el,"hidden",ii(this.$el),{self:!0})}},{name:"beforehide",self:!0,handler(){this.clearTimers()}},{name:"hide",handler({target:e}){this.$el===e?(Cs=this.isActive()?null:Cs,this.tracker.cancel(),ie(this.targetEl,"aria-expanded",!1)):Cs=null===Cs&&this.$el.contains(e)&&this.isToggled()?this:Cs}}],update:{write(){this.isToggled()&&!te(this.$el,this.clsEnter)&&this.position()}},methods:{show(e=this.targetEl,t=!0){if(this.isToggled()&&e&&this.targetEl&&e!==this.targetEl&&this.hide(!1,!1),this.targetEl=e,this.clearTimers(),!this.isActive()){if(Cs){if(t&&Cs.isDelaying())return void(this.showTimer=setTimeout(()=>Se(e,":hover")&&this.show(),10))
let r
for(;Cs&&r!==Cs&&!Cs.$el.contains(this.$el);)r=Cs,Cs.hide(!1,!1)}this.container&&Oe(this.$el)!==this.container&&Et(this.container,this.$el),this.showTimer=setTimeout(()=>this.toggleElement(this.$el,!0),t&&this.delayShow||0)}},hide(e=!0,t=!0){const r=()=>this.toggleElement(this.$el,!1,this.animateOut&&t)
this.clearTimers(),this.isDelayedHide=e,e&&this.isDelaying()?this.hideTimer=setTimeout(this.hide,50):e&&this.delayHide?this.hideTimer=setTimeout(r,this.delayHide):r()},clearTimers(){clearTimeout(this.showTimer),clearTimeout(this.hideTimer),this.showTimer=null,this.hideTimer=null},isActive(){return Cs===this},isDelaying(){return[this.$el,...Dt(".uk-drop",this.$el)].some(e=>this.tracker.movesTo(e))},position(){const e=ai(this.$el)
J(this.$el,"uk-drop-stack"),st(this.$el,this._style),this.$el.hidden=!0
const t=this.target.map(e=>function(e,t){return Ar(Rr(t).find(t=>t.contains(e)))}(this.$el,e)),r=this.getViewportOffset(this.$el),n=[[0,["x","width","left","right"]],[1,["y","height","top","bottom"]]]
...
function Os(e){const t=()=>e.$emit(),r=[pr(t),hr(Rr(e.$el).concat(e.target),t)]
return()=>r.map(e=>e.disconnect())}function Ts(e,t=()=>e.$emit()){return Ge([document,...Rr(e.$el)],"scroll",t,{passive:!0})}function Ss(e){return Ge(document,"keydown",t=>{t.keyCode===$n&&e.hide(!1)})}function Ps(e){return Ts(e,()=>e.hide(!1))}function Ms(e){return Ge(document,he,({target:t})=>{e.$el.contains(t)||Ze(document,`${fe} ${ve} scroll`,({defaultPrevented:r,type:n,target:i})=>{var o
r||n!==fe||t!==i||(null==(o=e.targetEl)?void 0:o.contains(t))||e.hide(!1)},!0)})}var Rs={mixins:[en,oi],props:{align:String,clsDrop:String,boundary:Boolean,dropbar:Boolean,dropbarAnchor:Boolean,duration:Number,mode:Boolean,offset:Boolean,stretch:Boolean,delayShow:Boolean,delayHide:Boolean,target:Boolean,targetX:Boolean,targetY:Boolean,animation:Boolean,animateOut:Boolean,closeOnScroll:Boolean},data:{align:ue?"right":"left",clsDrop:"uk-dropdown",clsDropbar:"uk-dropnav-dropbar",boundary:!0,dropbar:!1,dropbarAnchor:!1,delayShow:160,duration:200,container:!1,selNavItem:"> li > a, > ul > li > a"},computed:{dropbarAnchor:({dropbarAnchor:e},t)=>Ne(e,t)||t,dropbar({dropbar:e}){return e?(e=this._dropbar||Ne(e,this.$el)||It(`+ .${this.clsDropbar}`,this.$el))||(this._dropbar=It("<div></div>")):null},dropContainer(e,t){return this.container||t},dropdowns({clsDrop:e},t){var r
const n=Dt(`.${e}`,t)
...
if(n===Vn)if((null==i?void 0:i.targetEl)===r)e.preventDefault(),null==(t=It(Ce,i.$el))||t.focus()
...
return null==(t=It(Ce,e.target))?void 0:t.focus()}))}As(e,this.items,i)}},{name:"keydown",el:({dropContainer:e})=>e,delegate:({clsDrop:e})=>`.${e}`,handler(e){var t
const{current:r,keyCode:n,target:i}=e
if(Ee(i)||!c(this.dropdowns,r))return
const o=this.getActive()
let s=-1
if(n===Hn?s=0:n===Bn?s="last":n===Un?s="previous":n===Vn?s="next":n===$n&&(null==(t=o.targetEl)||t.focus()),~s){e.preventDefault()
const t=Dt(Ce,r)
return void t[Z(s,t,d(t,e=>Se(e,":focus")))].focus()}As(e,this.items,o)}},{name:"mouseleave",el:({dropbar:e})=>e,filter:({dropbar:e})=>e,handler(){const e=this.getActive()
...
return c(this.dropdowns,null==(e=Cs)?void 0:e.$el)&&Cs},async transitionTo(e,t){const{dropbar:r}=this,n=Ut(r)
...
function As(e,t,r){var n,i,o
const{current:s,keyCode:a}=e
let l=-1
a===Hn?l=0:a===Bn?l="last":a===zn?l="previous":a===qn?l="next":a===Ln&&(null==(n=r.targetEl)||n.focus(),null==(i=r.hide)||i.call(r,!1)),~l&&(e.preventDefault(),null==(o=r.hide)||o.call(r,!1),t[Z(l,t,t.indexOf(r.targetEl||s))].focus())}var js={mixins:[en],args:"target",props:{target:Boolean},data:{target:!1},computed:{input:(e,t)=>It(xe,t),state(){return this.input.nextElementSibling},target({target:e},t){return e&&(!0===e&&Oe(this.input)===t&&this.input.nextElementSibling||It(e,t))}},update(){var e
...
o!==s&&(t[i]=s)},events:[{name:"change",handler(){this.$emit()}},{name:"reset",el:({$el:e})=>e.closest("form"),handler(){this.$emit()}}]},Ns={extends:_n,mixins:[en],name:"grid",props:{masonry:Boolean,parallax:String,parallaxStart:String,parallaxEnd:String,parallaxJustify:Boolean},data:{margin:"uk-grid-margin",clsStack:"uk-grid-stack",masonry:!1,parallax:0,parallaxStart:0,parallaxEnd:0,parallaxJustify:!1},connected(){this.masonry&&X(this.$el,"uk-flex-top","uk-flex-wrap-top")},observe:bn({filter:({parallax:e,parallaxJustify:t})=>e||t}),update:[{write({rows:e}){re(this.$el,this.clsStack,!e.some(e=>e.length>1))},events:["resize"]},{read(e){const{rows:t}=e
let{masonry:r,parallax:n,parallaxJustify:i,margin:o}=this
if(n=Math.max(0,Gt(n)),!(r||n||i)||Is(t)||t[0].some((e,r)=>t.some(t=>t[r]&&t[r].offsetWidth!==e.offsetWidth)))return e.translates=e.scrollColumns=!1
...
Ds(n,d,a[l]),Ds(i,d,[(d-l)*u*(ue?-1:1),o[d]-s]),o[d]+=c+t,e=Math.max(e,c)}s+=e+t}return[n,i]}(t,l,"next"===r):s=function(e){const t=[]
for(const r of e)for(const e in r)Ds(t,e,r[e])
return t}(t)
const u=s.map(e=>B(e,"offsetHeight")+l*(e.length-1)),c=Math.max(0,...u)
let d,h,p
return(n||i)&&(d=u.map((e,t)=>i?c-e+n:n/(t%2||8)),i||(n=Math.max(...u.map((e,t)=>e+d[t]-c))),h=Gt(this.parallaxStart,"height",this.$el,!0),p=Gt(this.parallaxEnd,"height",this.$el,!0)),{columns:s,translates:a,scrollColumns:d,parallaxStart:h,parallaxEnd:p,padding:n,height:a?c:""}},write({height:e,padding:t}){st(this.$el,"paddingBottom",t||""),!1!==e&&st(this.$el,"height",e)},events:["resize"]},{read({rows:e,scrollColumns:t,parallaxStart:r,parallaxEnd:n}){return{scrolled:!(!t||Is(e))&&Sr(this.$el,r,n)}},write({columns:e,scrolled:t,scrollColumns:r,translates:n}){(t||n)&&e.forEach((e,i)=>e.forEach((e,o)=>{let[s,a]=n&&n[i][o]||[0,0]
t&&(a+=t*r[i]),st(e,"transform",`translate(${s}px, ${a}px)`)}))},events:["scroll","resize"]}]}
function Is(e){return e.flat().some(e=>"absolute"===st(e,"position"))}function Ds(e,t,r){e[t]||(e[t]=[]),e[t].push(r)}var Ls={args:"target",props:{target:String,row:Boolean},data:{target:"> *",row:!0},computed:{elements:({target:e},t)=>Dt(e,t)},observe:pn({target:({$el:e,elements:t})=>t.reduce((e,t)=>e.concat(t,...t.children),[e])}),events:{name:"loadingdone",el:()=>document.fonts,handler(){this.$emit("resize")}},update:{read(){return{rows:(this.row?xn(this.elements):[this.elements]).map($s)}},write({rows:e}){for(const{heights:t,elements:r}of e)r.forEach((e,r)=>st(e,"minHeight",t[r]))},events:["resize"]}}
function $s(e){if(e.length<2)return{heights:[""],elements:e}
let t=e.map(Fs)
const r=Math.max(...t)
return{heights:e.map((e,n)=>t[n].toFixed(2)===r.toFixed(2)?"":r),elements:e}}function Fs(e){const t=z(e.style,["display","minHeight"])
_e(e)||st(e,"display","block","important"),st(e,"minHeight","")
const r=Ft(e).height-Wt(e,"height","content-box")
return st(e,t),r}var Bs={args:"target",props:{target:String},data:{target:""},computed:{target:{get:({target:e},t)=>Ne(e,t),observe:({target:e})=>e}},observe:pn({target:({target:e})=>e}),update:{read(){return!!this.target&&{height:this.target.offsetHeight}},write({height:e}){st(this.$el,"minHeight",e)},events:["resize"]}},Hs={props:{expand:Boolean,offsetTop:Boolean,offsetBottom:Boolean,min:Number,property:String},data:{expand:!1,offsetTop:!1,offsetBottom:!1,min:0,property:"min-height"},observe:[vn({filter:({expand:e})=>e}),pn({target:({$el:e})=>Pr(e)})],update:{read(){if(!_e(this.$el))return!1
let e=""
const t=Wt(this.$el,"height","content-box"),{body:r,scrollingElement:n}=document,i=Mr(this.$el),{height:o}=Ar(i===r?n:i),s=n===i||r===i
...
!0===this.offsetBottom?e+=` - ${Ft(this.$el.nextElementSibling).height}px`:O(this.offsetBottom)?e+=` - ${this.offsetBottom}vh`:this.offsetBottom&&u(this.offsetBottom,"px")?e+=` - ${R(this.offsetBottom)}px`:C(this.offsetBottom)&&(e+=` - ${Ft(Ne(this.offsetBottom,this.$el)).height}px`)}return e+=(t?` - ${t}px`:"")+")",{minHeight:e}},write({minHeight:e}){st(this.$el,this.property,`max(${this.min||0}px, ${e})`)},events:["resize"]}},zs='<svg width="20" height="20" viewBox="0 0 20 20"><circle fill="none" stroke="#000" stroke-width="1.1" cx="9" cy="9" r="7"/><path fill="none" stroke="#000" stroke-width="1.1" d="M14,14 L18,18 L14,14 Z"/></svg>',Us={args:"src",props:{width:Number,height:Number,ratio:Number},data:{ratio:1},connected(){this.svg=this.getSvg().then(e=>{if(!this._connected)return
const t=function(e,t){if(ye(t)||yt(t,"canvas")){t.hidden=!0
const r=t.nextElementSibling
return qs(e,r)?r:kt(t,e)}const r=t.lastElementChild
return qs(e,r)?r:Et(t,e)}(e,this.$el)
return this.svgEl&&t!==this.svgEl&&Tt(this.svgEl),Vs.call(this,t,e),this.svgEl=t},q)},disconnected(){this.svg.then(e=>{this._connected||(ye(this.$el)&&(this.$el.hidden=!1),Tt(e),this.svgEl=null)}),this.svg=null},methods:{async getSvg(){}}}
function qs(e,t){return yt(e,"svg")&&yt(t,"svg")&&e.innerHTML===t.innerHTML}function Vs(e,t){const r=["width","height"]
let n=r.map(e=>this[e])
n.some(e=>e)||(n=r.map(e=>ie(t,e)))
const i=ie(t,"viewBox")
i&&!n.some(e=>e)&&(n=i.split(" ").slice(2)),n.forEach((t,n)=>ie(e,r[n],R(t)*this.ratio||null))}function Ws(e,t){return t&&c(e,"<symbol")&&(e=Gs(e)[t]||e),j(At(e)).filter(_)[0]}const Ys=/<symbol([^]*?id=(['"])(.+?)\2[^]*?<\/)symbol>/g,Gs=K(function(e){const t={}
let r
for(;r=Ys.exec(e);)t[r[3]]=`<svg ${r[1]}svg>`
return t}),Qs={spinner:'<svg width="30" height="30" viewBox="0 0 30 30"><circle fill="none" stroke="#000" cx="15" cy="15" r="14"/></svg>',totop:'<svg width="18" height="10" viewBox="0 0 18 10"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 9 9 1 17 9"/></svg>',marker:'<svg width="20" height="20" viewBox="0 0 20 20"><rect width="1" height="11" x="9" y="4"/><rect width="11" height="1" x="4" y="9"/></svg>',"close-icon":'<svg width="14" height="14" viewBox="0 0 14 14"><line fill="none" stroke="#000" stroke-width="1.1" x1="1" y1="1" x2="13" y2="13"/><line fill="none" stroke="#000" stroke-width="1.1" x1="13" y1="1" x2="1" y2="13"/></svg>',"close-large":'<svg width="20" height="20" viewBox="0 0 20 20"><line fill="none" stroke="#000" stroke-width="1.4" x1="1" y1="1" x2="19" y2="19"/><line fill="none" stroke="#000" stroke-width="1.4" x1="19" y1="1" x2="1" y2="19"/></svg>',"drop-parent-icon":'<svg width="12" height="12" viewBox="0 0 12 12"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 3.5 6 8.5 11 3.5"/></svg>',"nav-parent-icon":'<svg width="12" height="12" viewBox="0 0 12 12"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 3.5 6 8.5 11 3.5"/></svg>',"nav-parent-icon-large":'<svg width="14" height="14" viewBox="0 0 14 14"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 4 7 10 13 4"/></svg>',"navbar-parent-icon":'<svg width="12" height="12" viewBox="0 0 12 12"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 3.5 6 8.5 11 3.5"/></svg>',"navbar-toggle-icon":'<svg width="20" height="20" viewBox="0 0 20 20"><style>.uk-navbar-toggle-icon svg&gt;[class*=&quot;line-&quot;]{transition:0.2s ease-in-out;transition-property:transform, opacity;transform-origin:center;opacity:1}.uk-navbar-toggle-icon svg&gt;.line-3{opacity:0}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-3{opacity:1}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-2{transform:rotate(45deg)}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-3{transform:rotate(-45deg)}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-1,.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-4{opacity:0}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-1{transform:translateY(6px) scaleX(0)}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-4{transform:translateY(-6px) scaleX(0)}</style><rect width="20" height="2" y="3" class="line-1"/><rect width="20" height="2" y="9" class="line-2"/><rect width="20" height="2" y="9" class="line-3"/><rect width="20" height="2" y="15" class="line-4"/></svg>',"overlay-icon":'<svg width="40" height="40" viewBox="0 0 40 40"><rect width="1" height="40" x="19" y="0"/><rect width="40" height="1" x="0" y="19"/></svg>',"pagination-next":'<svg width="7" height="12" viewBox="0 0 7 12"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 1 6 6 1 11"/></svg>',"pagination-previous":'<svg width="7" height="12" viewBox="0 0 7 12"><polyline fill="none" stroke="#000" stroke-width="1.2" points="6 1 1 6 6 11"/></svg>',"search-icon":zs,"search-medium":'<svg width="24" height="24" viewBox="0 0 24 24"><circle fill="none" stroke="#000" stroke-width="1.1" cx="10.5" cy="10.5" r="9.5"/><line fill="none" stroke="#000" stroke-width="1.1" x1="23" y1="23" x2="17" y2="17"/></svg>',"search-large":'<svg width="40" height="40" viewBox="0 0 40 40"><circle fill="none" stroke="#000" stroke-width="1.8" cx="17.5" cy="17.5" r="16.5"/><line fill="none" stroke="#000" stroke-width="1.8" x1="38" y1="39" x2="29" y2="30"/></svg>',"search-toggle-icon":zs,"slidenav-next":'<svg width="14" height="24" viewBox="0 0 14 24"><polyline fill="none" stroke="#000" stroke-width="1.4" points="1.225,23 12.775,12 1.225,1"/></svg>',"slidenav-next-large":'<svg width="25" height="40" viewBox="0 0 25 40"><polyline fill="none" stroke="#000" stroke-width="2" points="4.002,38.547 22.527,20.024 4,1.5"/></svg>',"slidenav-previous":'<svg width="14" height="24" viewBox="0 0 14 24"><polyline fill="none" stroke="#000" stroke-width="1.4" points="12.775,1 1.225,12 12.775,23"/></svg>',"slidenav-previous-large":'<svg width="25" height="40" viewBox="0 0 25 40"><polyline fill="none" stroke="#000" stroke-width="2" points="20.527,1.5 2,20.024 20.525,38.547"/></svg>'},Zs={install:function(e){e.icon.add=(t,r)=>{const n=C(t)?{[t]:r}:t
$(n,(e,t)=>{Qs[t]=e,delete ua[t]}),e._initialized&&Nt(document.body,t=>$(e.getComponents(t),e=>{e.$options.isIcon&&e.icon in n&&e.$reset()}))}},mixins:[Us],args:"icon",props:{icon:String},isIcon:!0,beforeConnect(){X(this.$el,"uk-icon")},async connected(){const e=await this.svg
e&&(e.ariaHidden=!0)},methods:{async getSvg(){const e=function(e){if(e=ca[e]||e,!Qs[e])return null
ua[e]||(ua[e]=Ws(Qs[function(e){return ue?D(D(e,"left","right"),"previous","next"):e}(e)]||Qs[e]))
return ua[e].cloneNode(!0)}(this.icon)
if(!e)throw"Icon not found."
return e}}},Ks={args:!1,extends:Zs,data:e=>({icon:i(e.constructor.options.name)}),beforeConnect(){X(this.$el,this.$options.id)}},Xs={extends:Ks,beforeConnect(){const e=this.$props.icon
this.icon=this.$el.closest(".uk-nav-primary")?`${e}-large`:e}},Js={extends:Ks,mixins:[Ci],i18n:{toggle:"Open Search",submit:"Submit Search"},beforeConnect(){const e=te(this.$el,"uk-search-toggle")||te(this.$el,"uk-navbar-toggle")
...
e&&(e.ariaLabel=this.t("submit"))}}},ea={extends:Ks,beforeConnect(){this.$el.role="status"},methods:{async getSvg(){const e=await Zs.methods.getSvg.call(this)
return 1!==this.ratio&&st(It("circle",e),"strokeWidth",1/this.ratio),e}}},ta={extends:Ks,mixins:[Ci],beforeConnect(){const e=this.$el.closest("a,button")
ie(e,"role",null!==this.role&&yt(e,"a")?"button":this.role)
const t=this.t("label")
t&&!oe(e,"aria-label")&&ie(e,"aria-label",t)}},ra={extends:ta,beforeConnect(){X(this.$el,"uk-slidenav")
const e=this.$props.icon
this.icon=te(this.$el,"uk-slidenav-large")?`${e}-large`:e}},na={extends:ta,i18n:{label:"Open menu"},beforeConnect(){const e=this.$el.closest("a,button")
e&&(e.ariaExpanded=!1)}},ia={extends:ta,i18n:{label:"Close"},beforeConnect(){this.icon="close-"+(te(this.$el,"uk-close-large")?"large":"icon")}},oa={extends:ta,i18n:{label:"Open"}},sa={extends:ta,i18n:{label:"Back to top"}},aa={extends:ta,i18n:{label:"Next page"},data:{role:null}},la={extends:ta,i18n:{label:"Previous page"},data:{role:null}},ua={}
const ca={twitter:"x"}
var da={props:{target:String,selActive:String},data:{target:!1,selActive:!1},connected(){this.isIntersecting=0},computed:{target:({target:e},t)=>e?Dt(e,t):t},watch:{target:{handler(){queueMicrotask(()=>this.$reset())},immediate:!1}},observe:[fn({handler(e){this.isIntersecting=e.reduce((e,{isIntersecting:t})=>e+(t?1:this.isIntersecting?-1:0),this.isIntersecting),this.$emit()},target:({target:e})=>e,args:{intersecting:!1}}),mn({target:({target:e})=>e,options:{attributes:!0,attributeFilter:["class"]}}),{target:({target:e})=>e,observe:(e,t)=>{const r=hr([...j(e),document.documentElement],t),n=[Ge(document,"scroll itemshown itemhidden",t,{passive:!0,capture:!0}),Ge(document,"show hide transitionstart",e=>(t(),r.observe(e.target))),Ge(document,"shown hidden transitionend transitioncancel",e=>(t(),r.unobserve(e.target)))]
...
for(const e of j(this.target)){let t=!this.selActive||Se(e,this.selActive)?ha(e):""
!1!==t&&ee(e,"uk-light uk-dark",t)}}}}
function ha(e){const t=Ft(e),r=Ft(window)
if(!V(t,r))return!1
...
for(const r of t){if(e.contains(r)||!pa(r)||r.closest('[class*="-leave"]')&&t.some(e=>r!==e&&Se(e,'[class*="-enter"]')))continue
const n=st(r,"--uk-inverse")
if(n){if(n===a)return`uk-${n}`
a=n
break}}}return a?`uk-${a}`:""}function pa(e){if("visible"!==st(e,"visibility"))return!1
for(;e;){if("0"===st(e,"opacity"))return!1
e=Oe(e)}return!0}var fa={mixins:[en,_o],props:{fill:String},data:{fill:"",clsWrapper:"uk-leader-fill",clsHide:"uk-leader-hide",attrFill:"data-fill"},computed:{fill:({fill:e},t)=>e||st(t,"--uk-leader-fill-content")},connected(){[this.wrapper]=Pt(this.$el,`<span class="${this.clsWrapper}">`)},disconnected(){Mt(this.wrapper.childNodes)},observe:pn(),update:{read(){return{width:Math.trunc(this.$el.offsetWidth/2),fill:this.fill,hide:!this.matchMedia}},write({width:e,fill:t,hide:r}){re(this.wrapper,this.clsHide,r),ie(this.wrapper,this.attrFill,new Array(e).join(t))},events:["resize"]}},ma={install:function({modal:e}){function t(t,r,n=q,i=q){r={bgClose:!1,escClose:!0,...r,i18n:{...e.i18n,...null==r?void 0:r.i18n}}
...
var ga={extends:vs,data:{targets:"> .uk-parent",toggle:"> a",content:"> ul"}}
const va="uk-navbar-transparent"
var ba={extends:Rs,props:{dropbarTransparentMode:Boolean},data:{delayShow:200,clsDrop:"uk-navbar-dropdown",selNavItem:".uk-navbar-nav > li > a,a.uk-navbar-item,button.uk-navbar-item,.uk-navbar-item a,.uk-navbar-item button,.uk-navbar-toggle",dropbarTransparentMode:!1},computed:{navbarContainer:(e,t)=>t.closest(".uk-navbar-container")},watch:{items(){const e=te(this.$el,"uk-navbar-justify"),t=Dt(".uk-navbar-nav, .uk-navbar-left, .uk-navbar-right",this.$el)
for(const r of t){st(r,"flexGrow",e?Dt(".uk-navbar-nav > li > a, .uk-navbar-item, .uk-navbar-toggle",r).length:"")}}},events:[{name:"show",el:({dropContainer:e})=>e,handler({target:e}){"remove"===this.getTransparentMode(e)&&te(this.navbarContainer,va)&&(J(this.navbarContainer,va),this._transparent=!0)}},{name:"hide",el:({dropContainer:e})=>e,async handler(){await new Promise(e=>setTimeout(e)),!this._transparent||Cs&&this.dropContainer.contains(Cs.$el)||(X(this.navbarContainer,va),this._transparent=null)}}],methods:{getTransparentMode(e){if(!this.navbarContainer)return
...
var ya={mixins:[pi],args:"mode",props:{mode:String,flip:Boolean,overlay:Boolean,swiping:Boolean},data:{mode:"slide",flip:!1,overlay:!1,clsPage:"uk-offcanvas-page",clsContainer:"uk-offcanvas-container",selPanel:".uk-offcanvas-bar",clsFlip:"uk-offcanvas-flip",clsContainerAnimation:"uk-offcanvas-container-animation",clsSidebarAnimation:"uk-offcanvas-bar-animation",clsMode:"uk-offcanvas",clsOverlay:"uk-offcanvas-overlay",selClose:".uk-offcanvas-close",container:!1,swiping:!0},computed:{clsFlip:({flip:e,clsFlip:t})=>e?t:"",clsOverlay:({overlay:e,clsOverlay:t})=>e?t:"",clsMode:({mode:e,clsMode:t})=>`${t}-${e}`,clsSidebarAnimation:({mode:e,clsSidebarAnimation:t})=>"none"===e||"reveal"===e?"":t,clsContainerAnimation:({mode:e,clsContainerAnimation:t})=>"push"!==e&&"reveal"!==e?"":t,transitionElement({mode:e}){return"reveal"===e?Oe(this.panel):this.panel}},observe:yn({filter:({swiping:e})=>e}),update:{read(){this.isToggled()&&!_e(this.$el)&&this.hide()},events:["resize"]},events:[{name:"touchmove",self:!0,passive:!1,filter:({overlay:e})=>e,handler(e){e.cancelable&&e.preventDefault()}},{name:"show",self:!0,handler(){"reveal"!==this.mode||te(Oe(this.panel),this.clsMode)||X(St(this.panel,"<div>"),this.clsMode)
const{body:e,scrollingElement:t}=document
X(e,this.clsContainer,this.clsFlip),st(e,"touchAction","pan-y pinch-zoom"),st(this.$el,"display","block"),st(this.panel,"maxWidth",t.clientWidth),X(this.$el,this.clsOverlay),X(this.panel,this.clsSidebarAnimation,"reveal"===this.mode?"":this.clsMode),Ut(e),X(e,this.clsContainerAnimation),this.clsContainerAnimation&&(wa().content+=",user-scalable=0")}},{name:"hide",self:!0,handler(){J(document.body,this.clsContainerAnimation),st(document.body,"touchAction","")}},{name:"hidden",self:!0,handler(){this.clsContainerAnimation&&function(){const e=wa()
...
function wa(){return It('meta[name="viewport"]',document.head)||Et(document.head,'<meta name="viewport">')}var _a={mixins:[en],props:{selContainer:String,selContent:String,minHeight:Number},data:{selContainer:".uk-modal",selContent:".uk-modal-dialog",minHeight:150},computed:{container:({selContainer:e},t)=>t.closest(e),content:({selContent:e},t)=>t.closest(e)},observe:pn({target:({container:e,content:t})=>[e,t]}),update:{read(){return!!(this.content&&this.container&&_e(this.$el))&&{max:Math.max(this.minHeight,Ut(this.container)-(Ft(this.content).height-Ut(this.$el)))}},write({max:e}){st(this.$el,{minHeight:this.minHeight,maxHeight:e})},events:["resize"]}},xa={props:["width","height"],connected(){X(this.$el,"uk-responsive-width"),st(this.$el,"aspectRatio",`${this.width}/${this.height}`)}},Ea={props:{offset:Number},data:{offset:0},connected(){(function(e){Ca.size||Ge(document,"click",ka)
Ca.add(e)})(this)},disconnected(){var e
e=this,Ca.delete(e),Ca.size||Qe(document,"click",ka)},methods:{async scrollTo(e){e=e&&It(e)||document.body,Ke(this.$el,"beforescroll",[this,e])&&(await Tr(e,{offset:this.offset}),Ke(this.$el,"scrolled",[this,e]))}}}
const Ca=new Set
function ka(e){if(!e.defaultPrevented)for(const t of Ca)t.$el.contains(e.target)&&Ae(t.$el)&&(e.preventDefault(),window.location.href!==t.$el.href&&window.history.pushState({},"",t.$el.href),t.scrollTo(je(t.$el)))}const Oa="uk-scrollspy-inview"
var Ta={args:"cls",props:{cls:String,target:String,hidden:Boolean,margin:String,repeat:Boolean,delay:Number},data:()=>({cls:"",target:!1,hidden:!0,margin:"-1px",repeat:!1,delay:0}),computed:{elements:({target:e},t)=>e?Dt(e,t):[t]},watch:{elements(e){this.hidden&&st(Te(e,`:not(.${Oa})`),"opacity",0)}},connected(){this.elementData=new Map},disconnected(){for(const[e,t]of this.elementData.entries())J(e,Oa,(null==t?void 0:t.cls)||"")
delete this.elementData},observe:fn({target:({elements:e})=>e,handler(e){const t=this.elementData
...
if(!i)return
let o
if(null==(n=i.off)||n.call(i),st(e,"opacity",!t&&this.hidden?0:""),re(e,Oa,t),re(e,i.cls),o=i.cls.match(/\buk-animation-[\w-]+/g)){const r=()=>J(e,o)
t?i.off=Ze(e,"animationcancel animationend",r,{self:!0}):r()}Ke(e,t?"inview":"outview"),i.inview=t}}},Sa={props:{cls:String,closest:Boolean,scroll:Boolean,target:String,offset:Number},data:{cls:"uk-active",closest:!1,scroll:!1,target:'a[href]:not([role="button"])',offset:0},computed:{links:({target:e},t)=>Dt(e,t).filter(e=>je(e)),elements({closest:e}){return this.links.map(t=>t.closest(e||"*"))}},watch:{links(e){this.scroll&&this.$create("scroll",e,{offset:this.offset})}},observe:[fn(),bn()],update:[{read(){const e=this.links.map(je),{length:t}=e
if(!t||!_e(this.$el))return!1
const r=Mr(e,!0),{scrollTop:n,scrollHeight:i}=r,o=Ar(r)
let s=!1
if(n>=i-o.height)s=t-1
else{const t=this.offset+Ft(jr()).height+.1*o.height
for(let r=0;r<e.length&&!(Bt(e[r]).top-o.top-t>0);r++)s=+r}return{active:s}},write({active:e}){const t=!1!==e&&!te(this.elements[e],this.cls)
this.links.forEach(e=>e.blur())
for(let r=0;r<this.elements.length;r++)re(this.elements[r],this.cls,+r===e)
t&&Ke(this.$el,"active",[e,this.elements[e]])},events:["scroll","resize"]}]},Pa={mixins:[en,_o],props:{position:String,top:null,bottom:null,start:null,end:null,offset:String,offsetEnd:String,overflowFlip:Boolean,animation:String,clsActive:String,clsInactive:String,clsFixed:String,clsBelow:String,selTarget:String,showOnUp:Boolean,targetOffset:Number},data:{position:"top",top:!1,bottom:!1,start:!1,end:!1,offset:0,offsetEnd:0,overflowFlip:!1,animation:"",clsActive:"uk-active",clsInactive:"",clsFixed:"uk-sticky-fixed",clsBelow:"uk-sticky-below",selTarget:"",showOnUp:!1,targetOffset:!1},computed:{target:({selTarget:e},t)=>e&&It(e,t)||t},connected(){this.start=Ra(this.start||this.top),this.end=Ra(this.end||this.bottom),this.placeholder=It("+ .uk-sticky-placeholder",this.$el)||It('<div class="uk-sticky-placeholder"></div>'),this.isFixed=!1,this.setActive(!1)},beforeDisconnect(){this.isFixed&&(this.hide(),J(this.target,this.clsInactive)),Aa(this.$el),Tt(this.placeholder),this.placeholder=null},observe:[vn(),bn({target:()=>document.scrollingElement}),pn({target:({$el:e})=>[e,Ia(e),document.scrollingElement],handler(e){this.$emit(this._data.resized&&e.some(({target:e})=>e===Ia(this.$el))?"update":"resize"),this._data.resized=!0}})],events:[{name:"load hashchange popstate",el:()=>window,filter:({targetOffset:e})=>!1!==e,handler(){const{scrollingElement:e}=document
location.hash&&0!==e.scrollTop&&setTimeout(()=>{const t=Bt(It(location.hash)),r=Bt(this.$el)
...
a&&(Na(this.target),this.hide()),this.active||(({height:e,width:t}=Ft(this.$el)),r=st(this.$el,"margin")),a&&this.show()
...
const p=e+d+h,f=this.overflowFlip?0:Math.max(0,p-l),m=Bt(c).top-new DOMMatrix(st(c,"transform")).m42,g=Ft(this.$el).height,v=(!1===this.start?m:Ma(this.start,this.$el,m))-d,b=!1===this.end?s:Math.min(s,Ma(this.end,this.$el,m+e,!0)-g-d+f)
return n=!this.showOnUp&&v+d===m&&b===Math.min(s,Ma(!0,this.$el,0,!0)-g-d+f)&&"hidden"!==st(Ia(this.$el),"overflowY"),{start:v,end:b,offset:d,overflow:f,height:e,elHeight:g,width:t,margin:r,top:zt(c)[0],sticky:n,viewport:l,maxScrollHeight:s}},write({height:e,width:t,margin:r,offset:n,sticky:i}){if((this.inactive||i||!this.isFixed)&&Aa(this.$el),this.inactive)return
...
bt.out(this.$el,this.animation).then(()=>this.hide(),q)}else this.hide()}else this.isFixed?this.update():this.animation&&c?(this.show(),bt.in(this.$el,this.animation).catch(q)):(Na(this.target),this.show())},events:["resize","resizeViewport","scroll"]}],methods:{show(){this.isFixed=!0,this.update(),this.placeholder.hidden=!1},hide(){const{offset:e,sticky:t}=this._data
this.setActive(!1),J(this.$el,this.clsFixed,this.clsBelow),t?st(this.$el,"top",e):Aa(this.$el),this.placeholder.hidden=!0,this.isFixed=!1},update(){let{width:e,scroll:t=0,overflow:r,overflowScroll:n=0,start:i,end:o,offset:s,offsetParentTop:a,sticky:l,below:u}=this._data
const c=0!==i||t>i
if(!l){let i="fixed"
...
this.active=e,e?(ee(this.target,this.clsInactive,this.clsActive),t!==e&&Ke(this.$el,"active")):(ee(this.target,this.clsActive,this.clsInactive),t!==e&&(Na(this.target),Ke(this.$el,"inactive")))}}}
function Ma(e,t,r,n){if(!e)return 0
if(O(e)||C(e)&&e.match(/^-?\d/))return r+Gt(e,"height",t,!0)
{const r=!0===e?Ia(t):Ne(e,t)
return Bt(r).bottom-(n&&(null==r?void 0:r.contains(t))?R(st(r,"paddingBottom"))+R(st(r,"borderBottomWidth")):0)}}function Ra(e){return"true"===e||"false"!==e&&e}function Aa(e){st(e,{position:"",top:"",marginTop:"",width:""})}const ja="uk-transition-disable"
function Na(e){te(e,ja)||(X(e,ja),requestAnimationFrame(()=>J(e,ja)))}function Ia(e){for(;e=Oe(e);)if(_e(e))return e}var Da={mixins:[Us],args:"src",props:{src:String,icon:String,attributes:"list",strokeAnimation:Boolean},data:{strokeAnimation:!1},observe:[mn({async handler(){const e=await this.svg
e&&La.call(this,e)},options:{attributes:!0,attributeFilter:["id","class","style"]}})],async connected(){c(this.src,"#")&&([this.src,this.icon]=this.src.split("#",2))
const e=await this.svg
e&&(La.call(this,e),this.strokeAnimation&&function(e){const t=xo(e)
t&&st(e,"--uk-animation-stroke",t)}(e))},methods:{async getSvg(){return yt(this.$el,"img")&&!this.$el.complete&&"lazy"===this.$el.loading&&await new Promise(e=>Ze(this.$el,"load",e)),Ws(await $a(this.src),this.icon)||Promise.reject("SVG not found.")}}}
function La(e){const{$el:t}=this
...
ie(e,t,n)}e.ariaHidden=this.$el.ariaHidden,this.$el.id||se(e,"id")}const $a=K(async e=>{if(e){const t=await fetch(e)
if("image/svg+xml"===t.headers.get("Content-Type"))return t.text()}return Promise.reject()})
const Fa=".uk-disabled *, .uk-disabled, [disabled]"
var Ba={mixins:[li],args:"connect",props:{connect:String,toggle:String,itemNav:String,active:Number,followFocus:Boolean,swiping:Boolean},data:{connect:"~.uk-switcher",toggle:"> * > :first-child",itemNav:!1,active:0,cls:"uk-active",attrItem:"uk-switcher-item",selVertical:".uk-nav",followFocus:!1,swiping:!0},computed:{connects:{get:({connect:e},t)=>Ie(e,t),observe:({connect:e})=>e},connectChildren(){return this.connects.map(e=>Me(e)).flat()},toggles:({toggle:e},t)=>Dt(e,t),children(e,t){return Me(t).filter(e=>this.toggles.some(t=>e.contains(t)))}},watch:{connects(e){this.swiping&&st(e,"touchAction","pan-y pinch-zoom"),this.$emit()},connectChildren(){let e=Math.max(0,this.index())
for(const t of this.connects)Me(t).forEach((t,r)=>re(t,this.cls,r===e))
this.$emit()},toggles(e){this.$emit()
const t=this.index()
this.show(~t?t:e[this.active]||e[0])}},connected(){this.$el.role="tablist"},observe:[gn({targets:({connectChildren:e})=>e}),yn({target:({connects:e})=>e,filter:({swiping:e})=>e})],events:[{name:"click keydown",delegate:({toggle:e})=>e,handler(e){Se(e.current,Fa)||"click"!==e.type&&e.keyCode!==Fn||(Dn(e),this.show(e.current))}},{name:"keydown",delegate:({toggle:e})=>e,handler(e){const{current:t,keyCode:r}=e,n=Se(this.$el,this.selVertical)
let i=r===Hn?0:r===Bn?"last":r===zn&&!n||r===Un&&n?"previous":r===qn&&!n||r===Vn&&n?"next":-1
if(~i){e.preventDefault()
const r=this.toggles.filter(e=>!Se(e,Fa)),n=r[Z(i,r,r.indexOf(t))]
n.focus(),this.followFocus&&this.show(n)}}},{name:"click",el:({$el:e,connects:t,itemNav:r})=>t.concat(r?Ie(r,e):[]),delegate:({attrItem:e})=>`[${e}],[data-${e}]`,handler(e){e.target.closest("a,button")&&(Dn(e),this.show(ae(e.current,this.attrItem)))}},{name:"swipeRight swipeLeft",filter:({swiping:e})=>e,el:({connects:e})=>e,handler({type:e}){this.show(u(e,"Left")?"next":"previous")}}],update(){var e
...
r.role="tab",n&&(r.id=no(this,r),n.id=no(this,n),r.ariaControls=n.id,ie(n,{role:"tabpanel","aria-labelledby":r.id}))}ie(this.$el,"aria-orientation",Se(this.$el,this.selVertical)?"vertical":null)},methods:{index(){return d(this.children,e=>te(e,this.cls))},show(e){const t=this.toggles.filter(e=>!Se(e,Fa)),r=this.index(),n=Z(!w(e)||c(t,e)?e:0,t,Z(this.toggles[r],t)),i=Z(t[n],this.toggles)
...
await this.toggleElement(t,!1,o)&&await this.toggleElement(e[i],!0,o)})}}},Ha={mixins:[en],extends:Ba,props:{media:Boolean},data:{media:960,attrItem:"uk-tab-item",selVertical:".uk-tab-left,.uk-tab-right"},connected(){const e=te(this.$el,"uk-tab-left")?"uk-tab-left":!!te(this.$el,"uk-tab-right")&&"uk-tab-right"
e&&this.$create("toggle",this.$el,{cls:e,mode:"media",media:this.media})}}
var za={mixins:[_o,li],args:"target",props:{href:String,target:null,mode:"list",queued:Boolean},data:{href:!1,target:!1,mode:"click",queued:!0},computed:{target:{get:({target:e},t)=>(e=Ie(e||t.hash,t)).length?e:[t],observe:({target:e})=>e}},connected(){c(this.mode,"media")||(ke(this.$el)||(this.$el.tabIndex=0),!this.cls&&yt(this.$el,"a")&&(this.$el.role="button"))},observe:gn({targets:({target:e})=>e}),events:[{name:he,filter:({mode:e})=>c(e,"hover"),handler(e){this._preventClick=null,!nt(e)||E(this._showState)||this.$el.disabled||(Ke(this.$el,"focus"),Ze(document,he,()=>Ke(this.$el,"blur"),!0,e=>!this.$el.contains(e.target)),c(this.mode,"click")&&(this._preventClick=!0))}},{name:`mouseenter mouseleave ${me} ${ge} focus blur`,filter:({mode:e})=>c(e,"hover"),handler(e){if(nt(e)||this.$el.disabled||"loading"===document.readyState)return
...
return $(Object.freeze({__proto__:null,Accordion:vs,Alert:ys,Close:ia,Cover:xs,Drop:ks,DropParentIcon:Ks,Dropdown:ks,Dropnav:Rs,FormCustom:js,Grid:Ns,HeightMatch:Ls,HeightPlaceholder:Bs,HeightViewport:Hs,Icon:Zs,Img:Kn,Inverse:da,Leader:fa,Margin:_n,Marker:oa,Modal:ma,Nav:ga,NavParentIcon:Xs,Navbar:ba,NavbarParentIcon:Ks,NavbarToggleIcon:na,Offcanvas:ya,OverflowAuto:_a,OverlayIcon:Ks,PaginationNext:aa,PaginationPrevious:la,Responsive:xa,Scroll:Ea,Scrollspy:Ta,ScrollspyNav:Sa,SearchIcon:Js,SlidenavNext:ra,SlidenavPrevious:ra,Spinner:ea,Sticky:Pa,Svg:Da,Switcher:Ba,Tab:Ha,Toggle:za,Totop:sa,Video:_s}),(e,t)=>Yi.component(t,e)),function(e){le&&window.MutationObserver&&(document.body?requestAnimationFrame(()=>hs(e)):new MutationObserver((t,r)=>{document.body&&(hs(e),r.disconnect())}).observe(document.documentElement,{childList:!0}))}(Yi),$(ds,(e,t)=>Yi.component(t,e)),Yi}),/*! UIkit 3.23.11 | https://www.getuikit.com | (c) 2014 - 2025 YOOtheme | MIT License */
